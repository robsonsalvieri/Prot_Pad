...
Class PLSCltBqb from CenCollection
...
Method New() Class PLSCltBqb
    _Super:new()
    self:oMapper := PLSMprBqb():New()
    self:oDao := PLSDaoBqb():New(self:oMapper:getFields())
return self

Method initEntity() Class PLSCltBqb
return PLSBqb():New()

Method initRelation() Class PLSCltBqb
