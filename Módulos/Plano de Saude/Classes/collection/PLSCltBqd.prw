...
Class PLSCltBqd from CenCollection
...
Method New() Class PLSCltBqd
    _Super:new()
    self:oMapper := PLSMprBqd():New()
    self:oDao := PLSDaoBqd():New(self:oMapper:getFields())
return self

Method initEntity() Class PLSCltBqd
return PLSBqd():New()

Method initRelation() Class PLSCltBqd
