...
Class PLSCltBg9 from CenCollection
...
Method New() Class PLSCltBg9
    _Super:new()
    self:oMapper := PLSMprBg9():New()
    self:oDao := PLSDaoBg9():New(self:oMapper:getFields())
return self

Method initEntity() Class PLSCltBg9
return PLSBg9():New()

Method initRelation() Class PLSCltBg9
