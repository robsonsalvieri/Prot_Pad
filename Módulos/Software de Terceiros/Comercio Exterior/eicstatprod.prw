...
PRIVATE  aDados   := {}
PRIVATE  aRCampos := {}
PRIVATE  cMV_EASY   :=EasyGParam('MV_EASY')//Se for "S" é integrado com Microsiga
...
IndRegua("Work", cNomArqu+TEOrdBagExt(), "WK_PO_NUM+WK_COD_I+WK_POSICAO")
