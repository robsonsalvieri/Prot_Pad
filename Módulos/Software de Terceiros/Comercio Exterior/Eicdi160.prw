...
If EasyEntryPoint("EICDI160")
   ExecBlock("EICDI160",.F.,.F.)
Else
   ...
   /*+--------------------------------------------------------------+
      ...
      oDlg:= oSend( MSDialog(), "New", 9, 0, 23, 50,;
      ...
      oSend(TSay(),"New",2.0 ,1.0  ,{|| "Processo"},oPanel,,oFntdlg,,,,.F. )
      oSend(TGet(),"New",2.0 ,6.0  ,bSetGet(cHouse)    ,oPanel,50,8,;
      ...
      @ 25, 160 BUTTON STR0002 SIZE 34,11 ACTION (nOpcao:=2,oSend(oDlg,'End')) of oPanel Pixel //"Mensagens"
      oSend( SButton(), "New", 25, 120 ,6 ,{||nOpcao:=1,oSend(oDlg,"End") }, oPanel, .T.,,)
...
//AADD(aVetor,{SWP->WP_REGIST,SW2->W2_MOEDA,SW7->W7_QTDE*SW7->W7_PRECO,SW4->W4_REGIMP,SY8->Y8_DES,SY8->Y8_REG_TRI})
        ...
        DI160VerFim(0)
        oPrn:Say( Linha:=Linha+50 , 50  ,AVSX3("YT_CGC",5)+": " + TRANS(SYT->YT_CGC,TEgetCnpj("YT_CGC")) ,aFontes:TIMES_NEW_ROMAN_12) //"C.G.C.: " //STR0013
