...
Static nVS3BICMSB, nVS3CENCUS, nVS3CLVL, nVS3CODINC, nVS3CODITE, nVS3CODTES, nVS3CONTA, nVS3DEPGAR, nVS3DEPINT, nVS3DESINC, nVS3DESITE, nVS3DIFAL, nVS3DOCSDB, nVS3DTVALI, nVS3FORMUL, nVS3GRUINC, nVS3GRUITE, nVS3ICMCAL, nVS3IMPRES, nVS3INSTAL, nVS3ITEMCT, nVS3KEYALT, nVS3LOCAL, nVS3ESTNA, nVS3LOCALI, nVS3LOCPRO, nVS3LOTECT, nVS3MARLUC, nVS3MOTPED, nVS3NUMLOT, nVS3OPER, nVS3PECKIT, nVS3PERDES, nVS3PICMSB, nVS3PIPIFB, nVS3PROMOC, nVS3QTD2UM, nVS3QTDAGU, nVS3QTDELI, nVS3QTDEST, nVS3QTDINI, nVS3QTDITE, nVS3QTDPED, nVS3QTDRES, nVS3QTDTRA, nVS3REC_WT, nVS3RESERV, nVS3SEQINC, nVS3SEQUEN, nVS3SITTRI, nVS3VALCMP, nVS3VALCOF, nVS3VALDES, nVS3VALLIQ, nVS3VALPEC, nVS3VALPIS, nVS3VALTOT, nVS3VICMSB, nVS3VIPIFB , nVS3VALIPI
Static nVS3BASIRR,nVS3ALIIRR,nVS3VALIRR,nVS3BASCSL,nVS3ALICSL,nVS3VALCSL
Static nVS3SEQVEN, nVS3PESPRO, nVS3SEGMTO
...
Static nVS3VALORI, nVS3PERREC, nVS3VALREC
...
Static CacheSBZ := {}
Static CacheTESInt := {}
Static lCacheTES := GetNewPar("MV_MIL0205",.T.)
Static oOficina

Static lOX001CLI := existBlock("OX001CLI")
...
Private lVeEstoqueNA := oDpm:MostraEstoqueAoDigitar()
Private aNATrf  := {}
//
...
Private lOFX011 := FWSX1Util():ExistPergunte("OFX011")
Private nFilSemEst := 1

lVCFSEGMEN := VCF->(FieldPos("VCF_SEGMTO")) > 0 .and. cPaisLoc != "BRA"
...
If cPaisLoc $ "ARG/MEX/PAR"
	If nOpc == 6 .and. !Empty(VS1->VS1_REMITO) // Tentando FATURAR e já gerou REMITO
		FMX_HELP("OX001ERR008",STR0416,STR0417) // Remito já foi gerado para este Orçamento. Impossível continuar. / Necessário Faturar pela opção Fatura Remitos.
		return .f.
	EndIf
EndIf
...
if GetNewPar("MV_MIL0006","") == "JD" .and. ( nOpc == 3 .or. lAltPedVda )
	AADD(aNewBot, {"IMPORT",    {|| OX0010134_ImportaOrcCSV()           } , IIf(cPaisLoc=="ARG",STR0487,STR0356) }) // "Imp Advisor/Recompra John Deere"  /  "Imp. Advisor John Deere"
endif
if lInconveniente
...
If GetNewPar("MV_MIL0037","S") == "N" .and. VS1->VS1_STATUS == "5"
	AADD(aNewBot, {"SALVAR",    {|| OX0010345_AjustaQtdRequisitadaConferida(.T.)  } , STR0401 }) // "Revisão da Conferência"
EndIf

If cPaisLoc $ "ARG/MEX/PAR"
	AADD(aNewBot, {"SALVAR",    {|| Processa( {|| OX0010415_AlteraTipoFatura() })  } , STR0428 }) // "Alterar Tipo de Fatura"
EndIf

if cPaisLoc $ "ARG/MEX/PAR" .and. lPediVenda .and. (INCLUI .or. ALTERA)
	AADD(aNewBot, {"PEDIDO",    {|| OX0010424_ChamaTransferenciasInternas() } , STR0433 }) //"Transferência Arms."
endif

if nOpc == 3 .or. ( nOpc == 4 .and. !lFaturaPVP .and. !lCancelPVP)
	AADD(aNewBot, {"PEDIDO",    {|| OX001051C_replicaDescontos() } , STR0484 }) // "Replicar % Desconto Peça"
endif

if cPaisLoc == "ARG" .and. ( INCLUI .or. ( ALTERA .and. VS1->VS1_STATUS $ " 0" ) ) .and. ( VS1->(FieldPos("VS1_PERREC")) > 0 )
	AADD(aNewBot, {"PEDIDO",    {|| OX0010511_Preencher_Recargos_nos_Itens() } , STR0481 }) // Preencher Recargo em todos os Itens do Orçamento
EndIf
//
...
lLegendItem := IIf( FindFunction("OXA10001C_GatilhoPerDes") , OXA10001C_GatilhoPerDes( "OF011F12", "04" ) , .f. )
...
elseif cPaisLoc $ "ARG/PAR"

	AAdd(aOrcDynHeader, {'OX001F1ARG(MaFisRet(,"NF_VALMERC") - MaFisRet(,"NF_DESCONTO"),1)', STR0411, 0, 'OX001F1ARG(MaFisRet(,"NF_VALMERC") - MaFisRet(,"NF_DESCONTO"),1)'}) // "Valor em Peso"
	AAdd(aOrcDynHeader, {'OX001F1ARG(MaFisRet(,"NF_VALMERC") - MaFisRet(,"NF_DESCONTO"),2)', STR0412, 0, 'OX001F1ARG(MaFisRet(,"NF_VALMERC") - MaFisRet(,"NF_DESCONTO"),2)'}) // "Valor em Dolar"
	AAdd(aOrcDynFooter, {'OX001F1ARG(MaFisRet(,"NF_TOTAL"),1)'  , STR0414, 0, 'OX001F1ARG(MaFisRet(,"NF_TOTAL"),1)'  }) // "Total em Peso"
	AAdd(aOrcDynFooter, {'OX001F1ARG(MaFisRet(,"NF_TOTAL"),2)'  , STR0415, 0, 'OX001F1ARG(MaFisRet(,"NF_TOTAL"),2)'  }) // "Total em Dolar"

	AAdd(aOrc, {'OX001F1ARG(MaFisRet(,"NF_VALMERC") - MaFisRet(,"NF_DESCONTO"),1)', STR0411, 0, 'OX001F1ARG(MaFisRet(,"NF_VALMERC") - MaFisRet(,"NF_DESCONTO"),1)'}) // "Valor em Peso"
	AAdd(aOrc, {'OX001F1ARG(MaFisRet(,"NF_VALMERC") - MaFisRet(,"NF_DESCONTO"),2)', STR0412, 0, 'OX001F1ARG(MaFisRet(,"NF_VALMERC") - MaFisRet(,"NF_DESCONTO"),2)'}) // "Valor em Dolar"
	AAdd(aOrc, {'MaFisRet(,"NF_VALIV1")'               , STR0413, 0, 'MaFisRet(,"NF_VALIV1") '              }) // "IVA"
	AAdd(aOrc, {'OX001F1ARG(MaFisRet(,"NF_TOTAL"),1)'  , STR0414, 0, 'OX001F1ARG(MaFisRet(,"NF_TOTAL"),1)'  }) // "Total em Peso"
	AAdd(aOrc, {'OX001F1ARG(MaFisRet(,"NF_TOTAL"),2)'  , STR0415, 0, 'OX001F1ARG(MaFisRet(,"NF_TOTAL"),2)'  }) // "Total em Dolar"
...
cVS1nMostra := "VS1_FILIAL,VS1_NOMFOR,VS1_CHAINT,VS1_PROVEI,VS1_LOJAPR,VS1_ENDPRO,VS1_CIDPRO,VS1_ESTPRO,VS1_NOMPRO,"

if VAI->( fieldPos("VAI_FASECS") ) == 0 .or. ( VAI->( fieldPos("VAI_FASECS") ) > 0 .and. VAI->VAI_FASECS != "1" )	// 0=Nao;1=Sim
	cVS1nMostra += "VS1_MVFASE,"
endif
...
If ! lMultMoeda // Se não trabalha com MultMoeda
	cVS1nMostra += "VS1_MOEDA,VS1_TXMOED," // nao mostra os campos para o caso de nao usar multimoeda.
EndIf
cVS1nMostra += IIF(VAI->VAI_RESERV != "1", "VS1_RESERV,","")

If cPaisLoc <> "BRA"
	cVS1nMostra += ",VS1_VALISS,VS1_VALPIS,VS1_VALCOF,VS1_VALIPI,"
EndIf

If cPaisLoc == "BRA"
	cVS1nMostra += "VS1_SEGMTO,"
Endif
//
...
//
// lista de campos não editáveis
cVS3nEdit := "VS3_CODINC,VS3_GRUINC,VS3_DESINC,VS3_SEQINC,VS3_SEQUEN,VS3_QTDAGU,VS3_QTDRES,VS3_QTDTRA,VS3_VICMSB,VS3_PICMSB,VS3_MOTPED,VS3_FLGNAT,"
If !lAltFormula // Usuario NAO pode alterar a Formula
	cVS3nEdit += "VS3_FORMUL,"
EndIf
// lista de campos que não serão mostrados
cVS3nMostra := "VS3_FILIAL,VS3_NUMORC,VS3_ARMORI,VS3_MODVEI,VS3_VBAICM,VS3_ALIICM,VS3_TRSFER," // VS3_ICMCAL,"
...
cVS3nMostra += "VS3_ALQPIS,VS3_ALQCOF,VS3_TESENT,VS3_SQCONF,VS3_QE,"
...
If cPaisLoc <> "BRA"
	cVS3nMostra += ",VS3_VALPIS,VS3_VALCOF,VS3_VALCSL,VS3_PICMSB,VS3_VICMSB,VS3_ICMCAL,"
	cVS3nMostra += ",VS3_BICMSB,VS3_VALCMP,VS3_DIFAL,VS3_IPITRF,VS3_BASIRR,VS3_ALIIRR,VS3_VALIRR,VS3_BASCSL,VS3_ALICSL,"
EndIf

If cPaisLoc == "BRA"
	cVS3nMostra += "VS3_SEGMTO,"
Endif
...
While !Eof().And.(x3_arquivo=="VS3")
	If  X3USO(x3_usado) .and. !(Alltrim(x3_campo)+"," $ cVS3nMostra) .And. ( cNivel>=x3_nivel .or. IIF(cNivel < x3_nivel .and. Alltrim(x3_campo) == "VS3_MARLUC",.t.,.f.) )
		...
		if Alltrim(x3_campo) == "VS3_SEQUEN" .and. lLegendItem
			AAdd(aHeaderP, { STR0478, "ESTOQUE", "@BMP", 1, 0, ".F.", "", "C", "", "V", "", "", "", "V", "", "", "" } )		// Estoque
			AAdd(aHeaderP, { STR0479, "MARGEM" , "@BMP", 1, 0, ".F.", "", "C", "", "V", "", "", "", "V", "", "", "" } )		// Margem
			aadd(aHeaderPObrigat,.F.)
			aadd(aHeaderPObrigat,.F.)
		...
		If Alltrim(x3_campo) == "VS3_QESTNA"
			If GetRPORelease() < "12.1.2510"
				aHeaderP[Len(aHeaderP), 12] := cValToChar(-1) // X3_RELACAO
			Endif
		Endif
...
If !INCLUI // deve-se montar a acols com os registros da base
	...
	While !eof() .and. VS3->VS3_FILIAL == xFilial("VS3").and. VS3->VS3_NUMORC == VS1->VS1_NUMORC
		...
		if lLegendItem
			nPos := FG_POSVAR("ESTOQUE","aHeaderP")
			if nPos > 0



				nAux := aColsP[Len(aColsP),FG_POSVAR("VS3_QTDEST","aHeaderP")]
				nAux -= VS3->VS3_QTDITE
				aColsP[Len(aColsP),nPos] := iif( nAux >= 0 .or. VS3->VS3_RESERV == "1", "br_verde", "br_vermelho" )

			endif

			nPos := FG_POSVAR("MARGEM","aHeaderP")
			if nPos > 0
				aColsP[Len(aColsP),nPos] := iif( OX001050C_ValidaMargem( .T. ), "br_verde", "br_vermelho" )
			endif
		endif
...
If INCLUI .or. Len(aColsP) == 0
	...
	For nCntFor:=1 to nUsadoPX01
		...
		ElseIf aHeaderP[nCntFor,2] $ "ESTOQUE/MARGEM"
			aColsP[1,nCntFor] := ""
		Else
...
If !lOX001Auto
    ...
    SETKEY(VK_F7,{|| OX001042C_ConsultaF7() })
	If lOFX011
		SETKEY(VK_F12,{||Pergunte( "OFX011" , .T.)})
	EndiF
...
//		cDesInc := space(TamSX3("VST_DESINC")[1])
	...
	If INCLUI
		...
		OX0010201_FOLDERS(.f.) // Desabilita os Folders
	else
		If ALTERA .or. FECHA  .or. VISUALIZA
			...
			MaFisIni(;
				VS1->VS1_CLIFAT,; // 01 - Cliente/Fornecedor
				VS1->VS1_LOJA,;   // 02 - Loja
				'C',;             // 03 - C:Cliente , F:Fornecedor
				'N',;             // 04-Tp NF( "N","D","B","C","P","I" )
				IIF(!Empty(VS1->VS1_TIPCLI),VS1->VS1_TIPCLI,SA1->A1_TIPO),; // 05-Tp do Cli/For
				MaFisRelImp("OF110",{"VS1","VS3"}) ,;// 06-Relacao de Impostos que suportados no arquivo 
			...
			FMX_FISCABMI(VS1->VS1_CLIFAT, VS1->VS1_LOJA, "C")

			if lMultMoeda .and. VS1->VS1_MOEDA > 0
				MaFisRef("NF_MOEDA",,VS1->VS1_MOEDA)
				MaFisRef("NF_TXMOEDA",,VS1->VS1_TXMOEDA)
			endif
			...
			If cPaisLoc $ "ARG/MEX/PAR"
				if lFaturaPVP
					Processa( {|| OX0010415_AlteraTipoFatura() })
				EndIf
			EndIf
		...
		OX0010201_FOLDERS(.t.) // Habilita Folders
	...
	oDlgXX001:bInit := {|| EnchoiceBar(oDlgXX001, { || IIf(OX001TUDOK(nOpc),OX001FAT(nOpc),.t.) } , { || lSair := OX001SAIR(nOpc) },,aNewBot ), OX001TELA(nOpc) }
...
Local lDispSegmto := .f. // Dispara SEGMENTO do CLIENTE ?
Local nBkpGetD
Local lPainel := .f. // Painel Orçamento
Default nPosVetor := 0
Default lChmPER   := .f.
Default lMsgGrv   := .T.
...
If M->VS1_TIPORC <> "2" // Diferente de Oficina
	// tenta preencher o segmento usando Cliente
	if lVCFSEGMEN .and. ReadVar() $ "M->VS1_CLIFAT/M->VS1_LOJA"
		dbSelectArea("VCF")
		dbSetOrder(1)
		if msSeek(xFilial("VCF") + M->VS1_CLIFAT + M->VS1_LOJA)
			if ! empty(VCF->VCF_SEGMTO) .and. M->VS1_SEGMTO != VCF->VCF_SEGMTO
				M->VS1_SEGMTO := VCF->VCF_SEGMTO
				lDispSegmto := .t.
			endif
		endif
	endif
...
if lVCFSEGMEN .and. ( ReadVar() == "M->VS1_SEGMTO" .or. lDispSegmto )
	// se tem algum VS3 já, vou perguntar se realmente quer trocar o segmento para atualizar o QESTNA dos itens já lançados
	if len(oGetPecas:aCols) > 1 .or. ( len(oGetPecas:aCols) == 1 .and. !Empty(oGetPecas:aCols[1,nVS3CODITE]) .and. !oGetPecas:aCols[1,Len(oGetPecas:aCols[1])] )
		if MsgYesNo(STR0447, STR0025) // "Tem certeza que deseja alterar o segmento? Isso vai regravar o local dos itens e recalcular o nível de atendimento."
			// ... alterar os VS3 conforme novo segmento
			OX0010434_AtualizaVS3Segmto()
			MsgInfo(STR0448) //"Local dos itens alterado com sucesso."
		else
			alert(STR0449) //"Alteração do segmento cancelada com sucesso."
		endif
	endif
endif
...
If ReadVar() == "M->VS1_TIPVEN"
	...
	if DBSeek(xFilial("VAI")+M->VS1_CODVEN)
		...
		if lRet
			if !lOX001Auto .AND. !Empty(oGetPecas:aCols[1,nVS3CODITE]) .and. !oGetPecas:aCols[1,Len(oGetPecas:aCols[1])] .and. !oGetPecas:aCols[1,Len(oGetPecas:aCols[1])]
...
If ReadVar() == "M->VS1_TIPORC"
	...
	if M->VS1_TIPORC == "1"
		...
		if M->VS1_TIPORC == "3"
			/*+----------------------------------------------------------------------------+
			  | Marcelo Iuspa em 27/12/2024                                                |
			  | DVARMIL-6729                                                               |
			  +----------------------------------------------------------------------------+*/
			If FunName() = "OFIXA011" .And. M->VS1_TIPORC == "3"
				FMX_HELP("TIPORC", STR0443, STR0444) // "Tipo de Orçamento não poderá ser utilizado no Orçamento por Fases", "Usar outro Tipo de Orçamento diferente de 3"
				Return(.F.)
			Endif
			// ######################################
			// Verifica se foi lancado algum servico
...
If ReadVar() == "M->VS1_LOJA" .or. lClie
	...
	If Empty(M->VS1_PGTFRE) 
	   M->VS1_PGTFRE := SA1->A1_TPFRET
	Endif 
	If readvar() <> "M->VS1_TIPCLI"
	...
	if !lRecompra .and. !lOX001Auto
		lPainel := FM_PILHA("OFIXA018") // Painel Orçamento
		dbSelectArea("VE4")
		dbSeek(xFilial("VE4"))
		While !Eof() .and. xFilial("VE4") == VE4->VE4_FILIAL
			if M->VS1_CLIFAT == VE4->VE4_CODFAB .and. ( M->VS1_TIPORC == "1" .or. (lPainel .and. M->VS1_TIPORC == " ") )
	...
	// Ajustes fiscais para o Mercado Internacional
	FMX_FISCABMI(M->VS1_CLIFAT, M->VS1_LOJA, "C")
	//
	...
	// ############################################################################
	if !lOX001Auto
		If ReadVar() $ "M->VS1_CLIFAT/M->VS1_LOJA"
	...
	If cPaisLoc $ "ARG/MEX/PAR"
		If lPediVenda
			M->VS1_TPFATR := "1"
		ElseIf M->VS1_TIPORC <> "2" .and. Empty(M->VS1_TPFATR)
			nTpFatura := Aviso(STR0001,STR0420,{STR0421,STR0422,STR0423,STR0031},2) // Orçamento por Fases / Deseja gerar? / Fatura sem Remito / Remito / Entrega Futura / Cancela
			If nTpFatura == 4
				Return .f.
			EndIf
			M->VS1_TPFATR := If(nTpFatura==3,"4",If(nTpFatura==2,"2","1"))
		EndIf
	EndIf

	If VS1->(FieldPos("VS1_DESFIN")) > 0 .and. M->VS1_TIPORC <> "2"
		...
		cQuery += 	" AND VZO.VZO_CLIENT = '" + M->VS1_CLIFAT + "' "
		cQuery += 	" AND VZO.VZO_LOJA   = '" + M->VS1_LOJA + "' "
		cQuery += 	" AND VZO.D_E_L_E_T_ = ' ' "

		M->VS1_DESFIN := FM_SQL(cQuery)
...
if ReadVar()=="M->VS1_PGTFRE"
	...
	If !lOX001Auto .AND. oGetPecas:aCols[1,nVS3QTDITE] != 0

		nBkpGetD := oGetPecas:nAt // Salva a posicao atual do GetDados
		nPosic := 0
		For nPosic := 1 to Len(oGetPecas:aCols)
			oGetPecas:nAt := nPosic
			if !oGetPecas:aCols[oGetPecas:nAt,Len(oGetPecas:aCols[oGetPecas:nAt])]
...
if ReadVar()=="M->VS1_FORPAG"
	...
	if SA1->A1_COND != M->VS1_FORPAG .and. !Empty(SA1->A1_COND) .and. !Empty(SA1->A1_TIPPER)
		if !lOX001Auto
	...
	if !lOX001Auto .AND. !Empty(oGetPecas:aCols[1,nVS3CODITE]) .and. !oGetPecas:aCols[1,Len(oGetPecas:aCols[1])]
		nPos1    := At(cVS1Status,GetNewPar("MV_FASEORC","0FX"))
...
//
// ###############################################################################################
If Readvar() == "M->VS1_PROVEN" .and. cPaisLoc $ "ARG/PAR"
	// ###############################################################################################
	if Empty(Tabela("12", M->VS1_PROVEN, .t.))
		return .f.
	endif
	lExecProVen := .t.
EndIf

If lExecProVen .and. cPaisLoc $ "ARG/PAR"

	MaFisRef("NF_UFDEST",,M->VS1_PROVEN)
	MaFisRef("NF_PROVENT",,M->VS1_PROVEN)

	for nCntFor := 1 to Len(oGetPecas:aCols)
		if ! oGetPecas:aCols[nCntFor,Len(oGetPecas:aCols[nCntFor])] .and. !Empty(oGetPecas:aCols[nCntFor,nVS3CODITE])
			oGetPecas:nAt := nCntFor
			OX001PecFis()
			FMX_FISITEMI(n, "VS300", .f., M->VS1_PROVEN)
		EndIf
	next
	OX001FisPec()

	for nCntFor := 1 to Len(oGetServ:aCols)
		if ! oGetServ:aCols[nCntFor,Len(oGetServ:aCols[nCntFor])] .and. !Empty(oGetServ:aCols[nCntFor,nVS4CODSER])
...
static Function OX0010373_VS1_PERDES_VALPRE(nPosVetor)
	...
	Local aAuxVlPeca := {}
	Local aVlPecaPretendido := {}
	Local nSomaVlPretendido := 0
	Local nPosVlPretendido

	if ReadVar()=="M->VS1_PERDES"
		...
		if M->VS1_PERDES == 0
			...
			M->VS1_VALPRE := Round( MaFisRet(,"NF_TOTAL") * (1 - (M->VS1_PERDES / 100)), 2 )
			__readvar := "M->VS1_VALPRE"
		endif
	endif
	//
	if ReadVar()=="M->VS1_VALPRE"
		...
		// se o valor pretendido estiver zerado, considera que o usuário quer voltar os valores originais das pecas
		if M->VS1_VALPRE == 0
			return .t.
		endif

		nValMerc := MaFisRet(,"NF_TOTAL")
	...
	nDecVlUni := TamSX3("VS3_VALPEC")[2]
    nDevVlDes := TamSX3("VS3_VALDES")[2]
 
    // Monta um array com os "possíveis" valores de desconto
    aAuxVlPeca := array(16)
    ...
    for nCntFor := 1 to Len(oGetPecas:aCols)
		...
		nValMin := OX005RETMIN(;
			...
			dDatRefPD,;      // dDatRefPD
			nVS1PERREM,;     // nPERREM
			If(lMultMoeda,M->VS1_MOEDA ,0),; // nMoeda
			If(lMultMoeda,M->VS1_TXMOED,0))  // nTaxaMoeda

		OX001FisPec()

		aAuxVlPeca[01] := nCntFor                                            // 1
		aAuxVlPeca[02] := M->VS3_QTDITE                                      // 2
		aAuxVlPeca[03] := MaFisRet(n,"IT_VALMERC")                           // 3
		aAuxVlPeca[04] := MaFisRet(n,"IT_TOTAL")                             // 4
		aAuxVlPeca[05] := aAuxVlPeca[4] - aAuxVlPeca[3]                      // Diferenca entre total de pecas (qtde * vl unitario) e total. Pode ser algum imposto destacadao
		aAuxVlPeca[06] := aAuxVlPeca[5] / aAuxVlPeca[4]                      // percentual do valor do imposto com relação ao total da Peça
		aAuxVlPeca[07] := 1 - aAuxVlPeca[06]                                 // percentual do valor da peça com relação ao total da Peça
		aAuxVlPeca[08] := aAuxVlPeca[4] / nValTotal                          // Percentual do total da peca com relacao ao total GERAL do Orçamento
		aAuxVlPeca[09] := Round(M->VS1_VALPRE * aAuxVlPeca[8] , 2 )          // Parte do valor Pretendido referente a essa peça (Total + Impostos)
		aAuxVlPeca[10] := Round(aAuxVlPeca[09] * aAuxVlPeca[07], nDecVlUni)  // Parte da Peça (SEM Impostos) do valor Pretendido
		aAuxVlPeca[11] := Round(aAuxVlPeca[10] / aAuxVlPeca[02], nDecVlUni)  // Valor Unitario da Peça (Sem Imposto)
		aAuxVlPeca[12] := Round(aAuxVlPeca[03] - aAuxVlPeca[10], nDevVlDes)  // Valor de Desconto para a peca
		aAuxVlPeca[16] := aAuxVlPeca[5] / aAuxVlPeca[3]                      // percentual de imposto em relacao ao valor total da peça (qtde * vl unitario)

		aAuxVlPeca[13] := nValMin                                                                        // Valor minimo possivel para a peca
		aAuxVlpeca[14] := .f.                                                                            // Indica se já foi aplicado o valor minimo para a peca
		aAuxVlpeca[15] := (aAuxVlPeca[09] - Round(nValMin * aAuxVlPeca[2] * ( 1 + aAuxVlPeca[16] ), 2 )) // Valor ainda disponível para dar desconto se for necessário mais desconto no final do processamento

		if aAuxVlPeca[11] < nValMin

			aAuxVlpeca[14] := .t.
			aAuxVlpeca[15] := 0

			aAuxVlPeca[09] := Round(nValMin * aAuxVlPeca[2] * ( 1 + aAuxVlPeca[16] ), 2 ) // Parte da Peça com relacao ao Valor Pretendido
			aAuxVlPeca[10] := Round(aAuxVlPeca[09] * aAuxVlPeca[07], nDecVlUni)           // Parte da Peça (SEM Impostos) do valor Pretendido
			aAuxVlPeca[11] := Round(aAuxVlPeca[10] / aAuxVlPeca[02], nDecVlUni)           // Valor Unitario da Peça (Sem Imposto)
			aAuxVlPeca[12] := Round(aAuxVlPeca[03] - aAuxVlPeca[10], nDevVlDes)           // Valor de Desconto para a peca
		endif

		nSomaVlPretendido += aAuxVlPeca[09]
		AADD( aVlPecaPretendido, aClone(aAuxVlPeca))

	next nCntFor

	lDescontoMaximo := .f.
	if ! lValMaior .and. abs(nSomaVlPretendido - M->VS1_VALPRE) <> 0

		nVlPendente := nSomaVlPretendido - M->VS1_VALPRE

		nVlDisponivel := 0
		aEval( aVlPecaPretendido , { |x| nVlDisponivel += iif( x[14] , 0 , x[15] ) } )
		aEval( aVlPecaPretendido , { |x| iif( x[14] , x[8] := 0 , x[8] := x[15] / nVlDisponivel ) } )
		if nVlPendente >= nVlDisponivel
			// Aplica o valor minimo para todas as peças, pois não será possível atingir o valor pretendido
			if !lOX001Auto
				MsgInfo(STR0032,STR0025)
			endif
			lDescontoMaximo := .t.
		endif

		aSort(aVlPecaPretendido,,, { |a,b| a[15] < b[15] } )

		nVlPendente := nSomaVlPretendido - M->VS1_VALPRE

		for nCntFor := 1 to Len(aVlPecaPretendido)

			if aVlPecaPretendido[nCntfor,14]
				loop
			endif

			aVlPecaPretendido[nCntFor,14] := .t.

			if lDescontoMaximo
				aVlPecaPretendido[nCntFor,09] := Round(aVlPecaPretendido[nCntFor,13] * aVlPecaPretendido[nCntFor,2] * ( 1 + aVlPecaPretendido[nCntFor,16] ), 2 ) // Parte do valor Pretendido referente a essa peça (Total + Impostos)
			else

				// Calcula a parte do valor pendente a patir da soma dos valores disponívels para dar desconto ...
				nPartVlPendente := Round(nVlPendente * aVlPecaPretendido[nCntFor,8],2)
				aVlPecaPretendido[nCntFor,09] -= nPartVlPendente
			endif

			aVlPecaPretendido[nCntFor,10] := Round(aVlPecaPretendido[nCntFor,09] * aVlPecaPretendido[nCntFor,07], nDecVlUni) // Parte da Peça (SEM Impostos) do valor Pretendido
			aVlPecaPretendido[nCntFor,11] := Round(aVlPecaPretendido[nCntFor,10] / aVlPecaPretendido[nCntFor,02], nDecVlUni) // Valor Unitario da Peça (Sem Imposto)
			aVlPecaPretendido[nCntFor,12] := Round(aVlPecaPretendido[nCntFor,03] - aVlPecaPretendido[nCntFor,10], nDevVlDes) // Valor de Desconto para a peca
	...
	for nCntFor := nIniProc to nFimProc
		...
		if lValMaior
			...
			nPosVlPretendido := aScan(aVlPecaPretendido, { |x| x[1] == nCntFor } )
			M->VS3_VALDES := aVlPecaPretendido[nPosVlPretendido,12]

			// executa o fieldok para atualizar os campos
			oGetPecas:aCols[nCntFor,nVS3VALDES] := M->VS3_VALDES
			oGetPecas:nAt := nCntFor
			__ReadVar := 'M->VS3_VALDES'
			OX001FPOK(.f.,,.f.,.f.)

			// armazena o valor total e a diferença depois da alteração
			nSomaVlPretendido += oGetPecas:aCols[nCntFor,nVS3VALTOT]
	...
	// Verifica se tem algum erro de arredondamento e tenta distribuir entre os itens do orçamento....
	// o programa ira tentar processar os itens de maior valor para os de menor valor
	if ! lValMaior .and. ! lDescontoMaximo
		nSomaVlPretendido := MaFisRet(,"NF_TOTAL")

		if ABS(nSomaVlPretendido - M->VS1_VALPRE) <= 0.05

			aSort(aVlPecaPretendido,,, { |a,b| a[4] > b[4] } )

			for nPosVlPretendido := 1 to Len(aVlPecaPretendido)

				nCntFor := aVlPecaPretendido[nPosVlPretendido,1]

				if abs(ogetPecas:aCols[nCntFor,nVS3VALLIQ] - aVlPecaPretendido[nPosVlPretendido,13]) < 1
					loop
				endif

				// monta variáveis de memória a partir da linha da acols
				__ReadVar := 'M->VS1_VALPRE' // Para atualizar o campo VS3_VALDES
				FG_MEMVAR(aHeaderP, oGetPecas:aCols, nCntFor, .f.)

				nDifArred := M->VS1_VALPRE - nSomaVlPretendido
				M->VS3_VALDES -= nDifArred
				...
				nSomaVlPretendido := MaFisRet(,"NF_TOTAL")
				if ABS(nSomaVlPretendido - M->VS1_VALPRE) > 0.10 .or. nSomaVlPretendido == M->VS1_VALPRE
					exit
				endif
			next nPosVlPretendido
		endif
...
lGatilhoPerDes := IIf( FindFunction("OXA10001C_GatilhoPerDes") , OXA10001C_GatilhoPerDes( "OF011F12", "03" ) , .f. )
...
If lNewRes .and. nVS3QTDRES > 0 .and. oGetPecas:aCols[oGetPecas:nAt,nVS3QTDRES] > 0 .and. _cAuxReadVar $ "M->VS3_GRUITE,M->VS3_CODITE,M->VS3_LOCAL"
	MsgStop(STR0437,STR0025) // Não é possível alterar o grupo e código de item reservado.
	return .f.
endif

if _cAuxReadVar == "M->VS3_CODITE" .and. !Empty(M->VS3_CODITE )
	oPeca := DMS_Peca():New()
	if oPeca:Bloqueado(nil,M->VS3_CODITE,M->VS3_GRUITE)  // mostrar mensagem é padrão sim na funcao
		Return .f.
	Endif
Endif
...
if lVCFSEGMEN .and. Empty(M->VS3_SEGMTO) .and. FWAliasInDic("VL0", .F.)
	If (Readvar() == "M->VS3_GRUITE" .and. ! Empty(M->VS3_GRUITE)) .or. (Readvar() == "M->VS3_CODITE" .and. !Empty(M->VS3_CODITE))
		dbSelectArea("VL0")
		dbSetOrder(1)
		if msSeek(xFilial("VL0") + SB1->B1_COD)
			M->VS3_SEGMTO := VL0->VL0_SEGMTO
			oGetPecas:aCols[oGetPecas:nAt,nVS3SEGMTO] := VL0->VL0_SEGMTO
		endif
	endif
endif
...
If _cAuxReadVar == "M->VS3_GRUITE"
	...
	If ! Empty(M->VS1_PEDREF)
		If lMensagem
			MsgAlert(STR0442,STR0025) // Não é permitido alterar um orçamento oriundo de um pedido de venda
		EndIf
		return .f.
	Endif
...
If _cAuxReadVar == "M->VS3_CODITE" //.or. lGrAchou // Desafio: Descubra o que significa lGrAchou
	...
	If !lRecalc
		...
		if oDpm:lNovaConfiguracao
			oGetPecas:aCols[oGetPecas:nAt, nVS3LOCAL ]  := M->VS3_LOCAL  := OX0010444_ArmProvel(.F., oDpm)
		else
	...
	if lLegendItem
		nPos := FG_POSVAR("ESTOQUE","aHeaderP")
		if nPos > 0 .and. OX0010016_MostraQuantidadeEmEstoque(oGetPecas:nAt, M->VS1_TIPORC)
			nAux := oGetPecas:aCols[oGetPecas:nAt,nVS3QTDEST]
			nAux -= VS3->VS3_QTDITE
			oGetPecas:aCols[oGetPecas:nAt,nPos] := iif( nAux >= 0 .or. oGetPecas:aCols[oGetPecas:nAt,nVS3RESERV] == "1", "br_verde", "br_vermelho" )
		endif

		nPos := FG_POSVAR("MARGEM","aHeaderP")
		if nPos > 0
			oGetPecas:aCols[oGetPecas:nAt,nPos] := iif( OX001050C_ValidaMargem( .T. ), "br_verde", "br_vermelho" )
		endif
	endif
EndIf
...
if _cAuxReadVar == "M->VS3_VALPEC"
	VAI->(DBSetOrder(6))
	if ! VAI->(mSSeek(xFilial("VAI") + M->VS1_CODVEN))
		FMX_HELP("OX001ALTVPC1",STR0475) // "Não é possível alterar preço da peça sem equipe tecnica, verifique o vendedor"
		return .f.
	endif
...
If _cAuxReadVar $ "M->VS3_QTDITE,M->VS3_QTD2UM,M->VS3_CODTES,M->VS3_OPER" // tes e oper aqui é por conta do calculo fiscal do Tipo de Frete
	...
	if !lPediVenda .and. (!Empty(M->VS1_PEDREF).and.VS1->VS1_STATUS<>'5') .and. !INCLUI
		If (_cAuxReadVar == "M->VS3_CODTES" .or. _cAuxReadVar == "M->VS3_OPER")
			...
			If SF4->F4_ESTOQUE <> "S" .and. cPaisLoc == "BRA"
				Help(" ",1,"A410TEEST")
				return .f.
			Endif
		Else
	...
	If _cAuxReadVar == "M->VS3_QTD2UM"
		nQtd2Um := Round(Iif(SB1->B1_TIPCONV=="M",M->VS3_QTD2UM/SB1->B1_CONV,M->VS3_QTD2UM*SB1->B1_CONV),TamSX3("VS3_QTDITE")[2])

		If nQtd2Um > 0
			M->VS3_QTDITE := nQtd2Um
		EndIf
	EndIf
	...
	If Empty((M->VS3_CODTES)) .and. _cAuxReadVar == "M->VS3_OPER"
		M->VS3_CODTES := MaTesInt(2,M->VS3_OPER,M->VS1_CLIFAT,M->VS1_LOJA,"C",SB1->B1_COD)
	Endif
		...
		if !lOX001Auto
			...
			if lAprMsg .and. nQtdOrc > 0 // o M->VS3_QTDITE > 0 vai funcionar para o nível de atendimento, mostrando mensagem somente depois de mostrado o saldo
				if nQtdOrc > nSdoPecas
					if !lAgrMsgSld
						if (!lVeEstoqueNA .and. oGetPecas:aCols[oGetPecas:nAt, nVS3REC_WT ] > 0) .Or. lVeEstoqueNA
//							MsgInfo( STR0041 +": "+alltrim(SB1->B1_DESC)+" "+ STR0042+": "+str(nSdoPecas,6)+" "+ STR0182, STR0025 )
			...
			if At("T",GetNewPar("MV_FASEORC","0FX")) > 0 .and. nQtdOrc > nSdoPecas .AND. M->VS1_TIPORC != "2" // removi a checagem de nivel de atendimento devido ao novo tratamento
				if MsgYesNo(STR0243,STR0025)
			   		aPedTra2 := OXA020LBOX(xFilial("VS1"),SB1->B1_GRUPO,SB1->B1_CODITE, nQtdOrc - (nSdoPecas-nEstSeg), nFilSemEst)
					if ! Empty(aPedTra2)
...
If cPaisLoc == "ARG" .and. _cAuxReadVar $ "M->VS3_PERREC/M->VS3_VALPEC" // % Recargo - ARGENTINA
	OX0010235_Atualiza_Preco_Peca(.t.,_cAuxReadVar)
	_cAuxReadVar := "M->VS3_QTDITE"
EndIf
...
If _cAuxReadVar == "M->VS3_LOCAL"
	if ! OFIOM43001_ArmazemValido( M->VS3_LOCAL )
		FMX_HELP("OX001ERR014",STR0438,STR0439)  // "O armazém de origem do item está indisponível." // "Utilize um armazém que não seja de Reserva ou Oficina."
		Return .f.
	EndIf
EndIf
...
If ! lRecalc
	...
	If _cAuxReadVar $ "M->VS3_VALPEC,M->VS3_QTDITE,M->VS3_QTD2UM,M->VS3_PERDES,M->VS3_VALDES,M->VS3_FORMUL,M->VS3_OPER,M->VS3_CODTES,M->VS3_SITTRI" .and. OX001ExistPecFis(oGetPecas:nAt)
		...
		If cPaisLoc == "BRA"
			...
			If INCLUI .And. M->VS1_VALFRE <> 0
				MaFisRef("NF_FRETE",,M->VS1_VALFRE)
				MaFisRef("NF_TPFRETE",,M->VS1_PGTFRE)
			EndIf

			OX0010451_LimpaVariaveisImpostos()
			OX0010461_CarregaVariaveisImpostos(n)
			OX0010471_PreencheaColsImpostos(oGetPecas:nAt)
	...
	If _cAuxReadVar == "M->VS3_LOCAL"
		If OX0010016_MostraQuantidadeEmEstoque(oGetPecas:nAt, M->VS1_TIPORC)
			...
			nAux := nSdoPecas - oGetPecas:aCols[oGetPecas:nAt,FG_POSVAR("VS3_QTDITE","aHeaderP")]
			oGetPecas:aCols[oGetPecas:nAt,FG_POSVAR("ESTOQUE","aHeaderP")] := iif( nAux >= 0 .or. M->VS3_RESERV=="1", "br_verde", "br_vermelho" )
		EndIf
	Endif
...
if _cAuxReadVar == "M->VS3_PERDES" .and. lGatilhoPerDes
	__readvar := "M->VS3_VALDES"
	OX001FPOK(lMensagem, lLibPv, lRefNF, lRecalc, lMsgLotMin, lVerPromo , lAgrMsgSld ,aProdSdEst, lKitChamada)
	__readvar := "M->VS3_PERDES"
endif
...
if !lOX001Auto
	...
	if _cAuxReadVar $ "M->VS3_QTDITE;M->VS3_CODITE;M->VS3_LOCAL;M->VS3_PERDES;M->VS3_VALDES" .and. lLegendItem
		if M->VS3_RESERV == "1"
			oGetPecas:aCols[oGetPecas:nAt,FG_POSVAR("ESTOQUE","aHeaderP")] := "br_verde"
		elseif OX0010016_MostraQuantidadeEmEstoque(oGetPecas:nAt, M->VS1_TIPORC)
			nAux := oGetPecas:aCols[oGetPecas:nAt,FG_POSVAR("VS3_QTDEST","aHeaderP")]
			nAux -= oGetPecas:aCols[oGetPecas:nAt,FG_POSVAR("VS3_QTDITE","aHeaderP")]
			oGetPecas:aCols[oGetPecas:nAt,FG_POSVAR("ESTOQUE","aHeaderP")] := iif( nAux >= 0, "br_verde", "br_vermelho" )
		endif
	endif
	if _cAuxReadVar $ "M->VS3_QTDITE;M->VS3_CODITE;M->VS3_LOCAL;M->VS3_PERDES;M->VS3_VALDES" .and. lLegendItem
		oGetPecas:aCols[oGetPecas:nAt,FG_POSVAR("MARGEM","aHeaderP")] := iif( OX001050C_ValidaMargem( .F. ), "br_verde", "br_vermelho" )
	endif
endif
...
Static Function OX0010253_Kit()
	...
	if Len(aItensKit) == 0 .and. !lOX001Auto  .and. IIF(lInconveniente,( Empty(M->VS3_CODINC) .and. Empty(M->VS3_DESINC) ),.t.)
		...
		Endif
		If lExibeKit
			aItensKit := OFIOC040(M->VS3_GRUITE, M->VS3_CODITE, lKitImp, M->VS1_MOEDA, M->VS1_TXMOED)
		Endif
		...
		if Len(aItensKit) > 0
			...
			If lMultMoeda
				nValKit := FG_MOEDA( nValKit , If( VEH->(FieldPos('VEH_MOEDA')) > 0 , VEH->VEH_MOEDA, 1) , M->VS1_MOEDA , M->VS1_TXMOED )
			EndIf
			...
			If nValKit > 0
				...
				for nCntFor := 1 to Len(aItensKit)
					...
					nValPecKit := FG_VALPEC(;
						...
						.f.,;             		 // lWhen
						.t.,;                    // lValor
						M->VS1_MOEDA,;           // Moeda Desejada
						M->VS1_TXMOED )          // Taxa Moeda
...
If lMultMoeda
	nMoeda   := IIf( M->VS1_MOEDA > 0 , M->VS1_MOEDA , 1 ) // Moeda Padrão 1
	nTxMoeda := M->VS1_TXMOED
EndIf
//
if M->VS1_TIPORC == "1"
...
If ReadVar()=="M->VS4_CODSER" .or. ReadVar()=="M->VS4_TIPSER"
	...
	if lKilometragem
		if ReadVar() == "M->VS4_TIPSER"
			...
			If lVOKMOEDA .and. VOK->VOK_MOEDA <> M->VS1_MOEDA
				nPreKil := FG_MOEDA(nPreKil, VOK->VOK_MOEDA, M->VS1_MOEDA, M->VS1_TXMOED)
			EndIf

			M->VS4_VALHOR := nPreKil
		Endif
		nTemPad := 0
		M->VS4_VALSER := M->VS4_KILROD * M->VS4_VALHOR
	else
		M->VS4_KILROD := 0
		M->VS4_VALHOR := If(VOK->VOK_INCMOB $ "0/2/5/7",0,FG_VALHOR(VOI->VOI_TIPTEM,dDataBase,,,VV1->VV1_CODMAR,M->VS4_CODSER,M->VS4_TIPSER,M->VS1_CLIFAT,M->VS1_LOJA,VV1->VV1_MODVEI,VV1->VV1_SEGMOD,nMoeda,nTxMoeda))
	...
	if !Empty(VOI->VOI_CODOPE)
		...
		SFM->(DBSetOrder(1))
		SFM->(DBSeek(xFilial("SFM")+VOI->VOI_CODOPE))
...
If ReadVar() $ "M->VS4_PERDES,M->VS4_VALDES" .or. lCalc
	...
	While .t.
		...
		//
		If ReadVar()=="M->VS4_VALDES" .or. lGatilhoPerDes
...
Endif
//
If ReadVar() == "M->VS4_VALCUS" .and. VOK->VOK_INCMOB == "2" // Serviço de Terceiro
	M->VS4_VALVEN := oGetServ:aCols[oGetServ:nAt,FG_POSVAR("VS4_VALVEN")] := OFM0300045_ValorServicoTerceiro(M->VS4_VALCUS,oGetServ:aCols[oGetServ:nAt,FG_POSVAR("VS4_CODSER")])
	__ReadVar := "M->VS4_VALVEN"
	OX001FSOK()
EndIf
//
if !lOX001Auto
...
If  lPediVenda .and. !Empty(M->VS1_PEDREF)  .and. lVeEstoqueNA
...
if oGetPecas:aCols[oGetPecas:nAt, nVS3ESTNA] >= 0 // se pode ser um valor real
	aValPers := OX0010484_PecaPersistida(oGetPecas)
	// verifico se ta diferente do banco a peca para regravar o qestna
	// em branco mudou os Codigos
	// se mudou codite ou gruite tbm considero mudanca
	if !lfaturaPVP .And. (Empty(aValPers[1]) .OR. alltrim(aValPers[1]) != alltrim(cPeca) .OR.  alltrim(aValPers[2]) != alltrim(cGrupo)  )
		oGetPecas:aCols[oGetPecas:nAt, nVS3ESTNA] := -1
	endif
endif
...
For nCntFor:=1 to (Len(aHeaderP)-2) // Nao processa as colunas de RECNO e ALIAS
	If aHeaderPObrigat[nCntfor] .and. (Empty(oGetPecas:aCols[oGetPecas:nAt,nCntFor]))
		If lAltPedVda
			If (oGetPecas:aCols[oGetPecas:nAt,nVS3QTDPED]+oGetPecas:aCols[oGetPecas:nAt,nVS3QTDINI] == 0) .or. ;
				Empty(oGetPecas:aCols[oGetPecas:nAt,nVS3GRUITE]+oGetPecas:aCols[oGetPecas:nAt,nVS3CODITE]) .or. ;
...
Local lDadoPec   := .t.
Local lDadoSrv   := .t.
Local lDadoInc   := lInconveniente //O dados incoveniente precisa nascer .F. caso os incovenientes não estejam ativos para gerar validação correta
...
if M->VS1_TIPORC == "2"
	...
	If cMVMIL0006 == "JD" .and. lVCFSEGMEN .and. Empty(M->VS1_SEGMTO)
		Help(" ",1,"OBRIGAT2",,RetTitle("VS1_SEGMTO"),4,1)
		Return .f.
	endif
...
if ! empty(M->VS1_MVFASE)
	if ! getMV( "MV_FASEOR" + M->VS1_MVFASE, .T.)
		FMX_HELP( "MV_FASEOR" + M->VS1_MVFASE, "Parâmetro não encontrado", "Favor cadastrar o parâmetro com as fases desejadas" )
		return .F.
	endif
endif
Return .t.
...
Local cTipo       := "01"
Local cOrigem     := "OR"
Local lVPJSEQUEN  := VPJ->( FieldPos("VPJ_SEQUEN")) > 0
Local lOriImpressao := (FWIsInCallStack("OX001IMPR"))
Local nPosVDD    := 0
Local aVDD       := {}
...
if (EXCLUI .OR. VISUALIZA .OR. FECHA) .and. !lFat .and. !lImp
	if !lOX001Auto .and. !lLibPV .and. lMsgGrv
	...
	if oGetPecas:aCols[nCntFor,len(oGetPecas:aCols[nCntFor])]
		...
		if lCancelPVP .and. lCallPed
			...
			if Empty(oGetPecas:aCols[nCntFor, nVS3MOTPED ])
				if ! empty( cMotivoTodos )
					cMotPed01 := cMotivoTodos
				else
				    if Empty(aMotPed01)
					   aMotPed01 := OFA210MOT(cMotivo,"4",xFilial("VS1"),VS1->VS1_NUMORC,.T.,"P")
					endif
					...
					if empty(cMotPed01)
						...
						if len(aMotPed01) >= 5 .and. aMotPed01[5] == .F.
							DBSelectArea("VS3")
							DBSetOrder(2)
							if DBSeek(xFilial("VS3") + M->VS1_NUMORC + oGetPecas:aCols[nCntFor, nVS3GRUITE ] + oGetPecas:aCols[nCntFor, nVS3CODITE ] )
								reclock("VS3",.f.)
...
if ! lCancelPVP
	...
	if lFaturaPVP .and. lPediVenda .and. !lOriImpressao // .and. !M->VS1_TIPORC $ "P3" - Adiciona validação para casos em que a solicitação ocorre a partir da opção de impressão.
	...
	If INCLUI
		M->VS1_STATUS := VS1->VS1_STATUS
	EndIf
	MSMM(VS1->VS1_OBSMEM,TamSx3("VS1_OBSERV")[1],,&(aMemos[1][2]),1,,,"VS1","VS1_OBSMEM")//gravar a observacao - Rafael - 25/01
	if INCLUI
		VS1->VS1_MVFASE := iif( !empty(M->VS1_MVFASE) .and. ! "VS1_MVFASE" $ cVS1nMostra, M->VS1_MVFASE, VAI->VAI_MVFASE )		// VAI->VAI_MVFASE
	endif
	...
	For nCntFor := 1 to Len(aVetCort)
		...
		if lVPJSEQUEN
			VPJ->VPJ_SEQUEN := aVetCort[nCntFor,12]
		Endif
		MsUnlock()
	Next
	...
	for nCntFor := 1 to Len(oGetPecas:aCols)
		...
		lNaOfi   := ( M->VS1_TIPORC == "2" .AND. lVeEstoqueNA ) // registra na oficina?
		...
		if (lNaOfi .AND. !Empty(cMot)) .OR. ( !Empty(cMot) .AND. !lDeleted ) .OR. ( !Empty(oGetPecas:aCols[nCntFor,FG_POSVAR("VS3_CODITE","aHeaderP")]) .AND. !lDeleted )
			...
			If !lDeleted
				...
				cQuery := "SELECT VPJ.R_E_C_N_O_ AS VPJRECNO "
				cQuery += "FROM " + RetSQLName('VPJ') + " VPJ "
				cQuery += "WHERE VPJ.VPJ_FILIAL = '"+xFiliaL('VPJ')+"' "
				cQuery += 	"AND VPJ.VPJ_NUMORC = '"+M->VS1_NUMORC+"' "
				cQuery += 	"AND VPJ.VPJ_GRUITE = '"+oGetPecas:aCols[nCntFor,FG_POSVAR("VS3_GRUITE","aHeaderP")]+"' "
				cQuery += 	"AND VPJ.VPJ_CODITE = '"+oGetPecas:aCols[nCntFor,FG_POSVAR("VS3_CODITE","aHeaderP")]+"' "

				If lVPJSEQUEN
					cQuery += "AND VPJ.VPJ_SEQUEN = '"+oGetPecas:aCols[nCntFor,FG_POSVAR("VS3_SEQUEN","aHeaderP")]+"' "
				ENDIF

				cQuery += 	"AND VPJ.D_E_L_E_T_ = ' ' "

				TcQuery cQuery NEW ALIAS "TMPVPJ"

				While !TMPVPJ->(Eof())
					DbSelectArea('VPJ')
					DbGoTo(TMPVPJ->VPJRECNO)
						reclock("VPJ",.f.,.t.)
						dbdelete()
						msunlock()
					TMPVPJ->(DbSkip())
			...
			for nCntfor2 := 1 to LEN(aCache)
				...
				if AllTrim(oReg:GetValue("VS3_GRUITE")) == AllTrim(VS3->VS3_GRUITE) .and. ;
				   ...
				   AllTrim(oReg:GetValue("VS3_LOTECT")) == AllTrim(VS3->VS3_LOTECT)
					...
					oGetPecas:aCols[nCntFor, FG_POSVAR("VS3_QESTNA","aHeaderP")] := VS3->VS3_QESTNA
					oGetPecas:aCols[nCntFor, FG_POSVAR("VS3_QTDINI","aHeaderP")] := VS3->VS3_QTDINI

					If ExistBlock("X001NAUN")
						ExecBlock("X001NAUN",.F.,.F.,{VS1->VS1_NUMORC, "OFIXX001", VS3->VS3_CODITE, VS3->VS3_QESTNA, VS3->VS3_QTDINI, VS3->VS3_LOCAL, "X001NAUN", VS1->VS1_FILIAL})
					EndIf
					exit
				EndIf
			Next
			...
			if oGetPecas:aCols[nCntFor,FG_POSVAR("VS3_QESTNA","aHeaderP")] < 0
				if VS1->(FieldPos("VS1_SEGMTO")) > 0 .and. cPaisLoc != "BRA"
					VS3->VS3_QESTNA := oDpm:SaldoDaPeca(SB1->B1_COD, M->VS1_SEGMTO, .T., cFilAnt, oGetPecas:aCols[nCntFor,FG_POSVAR("VS3_LOCAL","aHeaderP")])
					oGetPecas:aCols[nCntFor,FG_POSVAR("VS3_QESTNA","aHeaderP")] := VS3->VS3_QESTNA
				else
					VS3->VS3_QESTNA := oDpm:SaldoDaPeca(SB1->B1_COD, "2", .T., cFilAnt, oGetPecas:aCols[nCntFor,FG_POSVAR("VS3_LOCAL","aHeaderP")])
					oGetPecas:aCols[nCntFor,FG_POSVAR("VS3_QESTNA","aHeaderP")] := VS3->VS3_QESTNA
				endif
				If cPaisLoc == "BRA" // Conceito de filial armazém
					VS3->VS3_QESTNA += OX0010084_TotalNaFilialArmazem(nCntFor, VS3->VS3_GRUITE, VS3->VS3_CODITE)/* soma no qestna o saldo que vem de filiais armazem */
					oGetPecas:aCols[nCntFor,FG_POSVAR("VS3_QESTNA","aHeaderP")] := VS3->VS3_QESTNA
				endif
				VS3->VS3_QTDINI := oGetPecas:aCols[nCntFor,FG_POSVAR("VS3_QTDITE","aHeaderP")]
			endif

			If ExistBlock("X001NAUN")
				ExecBlock("X001NAUN",.F.,.F.,{VS1->VS1_NUMORC, "OFIXX001", VS3->VS3_CODITE, VS3->VS3_QESTNA, VS3->VS3_QTDINI, oGetPecas:aCols[nCntFor,FG_POSVAR("VS3_LOCAL","aHeaderP")], "X001NAUN_2", VS1->VS1_FILIAL})
			EndIf
				...
				If lVeEstoqueNA .and. oGetPecas:aCols[nCntFor,FG_POSVAR("VS3_QTDEST","aHeaderP")] == 0
					SB1->(DBSetOrder(7))
					SB1->(DBSeek(xFilial("SB1")+VS3->VS3_GRUITE+VS3->VS3_CODITE))
					SB1->(DBSetOrder(1))
			...
			Else
				...
				if lResOrc
					if Alltrim(oGetPecas:aCols[nCntFor, FG_POSVAR("VS3_RESERV","aHeaderP")]) != "1"
						...
						// Se não existir saldo disponível para a peça não efetuar a reserva.
						If OX001SLDPC(xFilial("SB2") + SB1->B1_COD + oGetPecas:aCols[nCntFor, nVS3LOCAL] , .t. ) > 0
	...
	for nCntFor := 1 to Len(aPedTransf)
		...
		aRetVDD := OXA0200045_LevantaPedidoTransferencia(xFilial("VS1"), VS1->VS1_NUMORC, aPedTransf[nCntFor,1], aPedTransf[nCntFor,2], aPedTransf[nCntFor,5], "S" )
		...
		if Len(aRetVDD) == 0
			...
			msunlock()
			If lTemEmail
				nPosVDD := aScan(aVDD, {|x| x[1] == aPedTransf[nCntFor,5] }) // Pesquisa a Filial
				If nPosVDD == 0 // Enviar um e-mail por Filial
					aAdd(aVDD,{aPedTransf[nCntFor,5],{}})
					nPosVDD := len(aVDD)
				EndIf
				aAdd(aVDD[nPosVDD,2],{ aPedTransf[nCntFor,1] , aPedTransf[nCntFor,2] , "" , aPedTransf[nCntFor,4] })
			EndIf
		endif
	next
	If len(aVDD) > 0
		For nPosVDD := 1 to len(aVDD)
			If VA0100071_ExisteEmail( aVDD[nPosVDD,1] , "002001" )
				...
				OXA0200051_EnviarEmail( aVDD[nPosVDD,1] , "002001" , STR0472+" - "+STR0473 , "3" , aClone(aVDD[nPosVDD,2]) , VS1->VS1_CODVEN , xFilial("VS1") , VS1->VS1_NUMORC ) // Transferência de Peças - Pedido Incluido
			EndIf
		Next
	EndIf
...
If !lPediVenda .AND. lMsgGrv
	if !lChmPER .and. !lOX001Auto .and. nOpc == 3 .and. lMsgGrv
...
Else
	If nOpc == 3 .and. !lMsg0268
		...
		lMsg0268 := .t.
	ElseIf nOpc == 4 .and. lFaturaPVP .and. !lOriImpressao // Adiciona validação para casos em que a solicitação ocorre a partir da opção de impressão.
...
Local aItemSD2    := {}
Local aItensSD2   := {}
local lAttMargemAut := GetNewPar("MV_MIL0206",.f.) // Controla recalculo automatico de margem
Local cUsuVEJPed  := ""
Local aRetSugCom  := {}
//Variáveis Remito Argentina
Local cNumPed       := Nil
Local aMata410Cab   := Nil
Local aMata410Itens := Nil
Local lRollback := .f.
Local cTpFatura := ""
//
Local nMoedaC   := 0
...
If nOpc == 3 .or. nOpc == 4
	...
	EndIf
	If cPaisLoc == "ARG"
		If M->VS1_TPFATR == "2" // Remito - Validar Condição de Pagamento, não pode ser Negociada ( Tipo 9 ou A )
			If Empty(M->VS1_FORPAG)
				FMX_HELP("OX001ERR017",STR0476+" ( "+Alltrim(RetTitle("VS1_FORPAG"))+" )") // Favor informar uma Condição de Pagamento.
				Return .f.
			Else // !Empty(M->VS1_FORPAG)
				DbSelectArea("SE4")
				DbSetOrder(1)
				If msSeek(xFilial("SE4")+M->VS1_FORPAG) .and. SE4->E4_TIPO $ "9/A"
					FMX_HELP("OX001ERR016",STR0474) // Não é possivel utilizar uma Condição de Pagamento Negociada (tipo 9 ou A) para Remito.
					Return .f.
				EndIf
			EndIf
		EndIf
...
if EXCLUI
	...
	if lOX001Auto .or. MsgYesNo(STR0064,STR0025)
		...
		If cPaisLoc $ "ARG/MEX/PAR" .and. !Empty(VS1->VS1_REMITO) // Remito
			dbSelectArea("SF2")
			SF2->(dbSetOrder(1)) // F2_FILIAL+F2_DOC+F2_SERIE+F2_CLIENTE+F2_LOJA+F2_FORMUL+F2_TIPO
			SF2->(dbSeek(xFilial("SF2")+VS1->VS1_REMITO+VS1->VS1_SERREM)) // Posiciona no SF2
			If SF2->(!Eof())
				...
				SD2->(dbSeek(xFilial("SD2")+SF2->F2_DOC+SF2->F2_SERIE+SF2->F2_CLIENTE+SF2->F2_LOJA)) // Posiciona no SD2
				While SD2->(!Eof() .and. D2_FILIAL+D2_DOC+D2_SERIE+D2_CLIENTE+D2_LOJA == xFilial("SD2")+SF2->F2_DOC+SF2->F2_SERIE+SF2->F2_CLIENTE+SF2->F2_LOJA)
					aItemSD2 := {}
					AAdd(aItemSD2, {"D2_DOC"    , SD2->D2_DOC    , Nil})
					AAdd(aItemSD2, {"D2_SERIE"  , SD2->D2_SERIE  , Nil})
					AAdd(aItemSD2, {"D2_CLIENTE", SD2->D2_CLIENTE, Nil})
					AAdd(aItemSD2, {"D2_LOJA"   , SD2->D2_LOJA   , Nil})
					AAdd(aItensSD2, AClone(aItemSD2))
					SD2->(dbSkip())
				End
		...
		BEGIN TRANSACTION
		If cPaisLoc $ "ARG/PAR" .and. !Empty(VS1->VS1_REMITO) // Remito Argentina
			If !Empty(VS1->VS1_PEDREM) // Pedido Remito Argentina
				cNumPed := VS1->VS1_PEDREM
		...
		If !lOX001Auto
			...
			for nCntFor := 1 to Len(oGetPecas:aCols)
				if ! oGetPecas:aCols[nCntFor,len(oGetPecas:aCols[nCntFor])] // Somente Não Deletados
					if len(aMotCancel) >= 5 .and. aMotCancel[5] == .F.
						DBSelectArea("VS3")
						DBSetOrder(2)
						if DBSeek(xFilial("VS3") + M->VS1_NUMORC + oGetPecas:aCols[nCntFor, nVS3GRUITE ] + oGetPecas:aCols[nCntFor, nVS3CODITE ] )
							reclock("VS3",.f.)
...
if M->VS1_PGTFRE == "S" .and. M->VS1_VALFRE > 0
	FMX_HELP("OX001ERR017",STR0477)//"O campo 'Tipo Frete' está definido como 'Sem frete', mas existe um valor preenchido para o frete. Ajuste o tipo de frete para continuar." / "Atenção"
	Return .f.
EndIf
///////////////////////////////////////////////////////////////
...
if !(cVS1Status $ ("23"+cFaseConfer))
	...
	if cVS1Status == "0" .and. lAttMargemAut
		M->VS1_STATUS := cVS1Status
	 	OX0010432_RecalculoMargem()
		If !IsBlind()
			oGetPecas:oBrowse:refresh()
		Endif
	endif
...
if M->VS1_TIPORC == "2" .and. !lPediVenda
	...
	if lOX001Auto .or. Empty(cNroOS)
		If lMultMoeda // Trabalha com MultMoeda
			nMoeda := IIf( M->VS1_MOEDA > 0 , M->VS1_MOEDA , 1 ) // Moeda Padrão 1
		EndIf
		cNumOrd := FM_ABREOSV( @aCodErro ,,M->VS1_CHAINT , M->VS1_KILOME , M->VS1_CLIFAT, M->VS1_LOJA , M->VS1_OBSMEM, IIf(Type("M->VS1_DATENT")<>"U",M->VS1_DATENT,Ctod("")),M->VS1_HORTRI, .F. , nMoeda )
		if Empty(cNumOrd)
			if !lOX001Auto
	...
	If lSugCompra .and. OX0010463_TemPeca()
		aRetSugCom := OX001045G_VldSugCompra(cOrcAtu, lNewRes)
		lSugCompra := aRetSugCom[1] //Deve ou não gerar sugestão - tipo lógico
		cUsuVEJPed := aRetSugCom[2] //Código do Tipo de Pedido na tabela VEJ
	Endif
...
//
	...
	If GetNewPar("MV_MIL0098","0") == "1" .AND. !(VS1->VS1_STATUS $ 'F/G') // Trabalha com Conferência/Separação na Exportação do Orçamento para a OS
	  ...
	  Else
		...
		If !OX001EXPVSJ(.f.,cOrcAtu, lSugCompra, cUsuVEJPed) // função que exporta peças para o VSJ
			break
	...
	if lRollback
		if lNovaOS
			FMX_HELP("OX001ERR009",STR0426) // "Ordem de serviço criada mas não foi possível exportar o orçamento corretamente."
		else
			FMX_HELP("OX001ERR010",STR0427) // "Não foi possível exportar o orçamento para a ordem de serviço selecionada."
		endif
		if !lOX001Auto
			oDlgXX001:End()
		endif
...
//		endif
		...
		if (lRollback .and. cFaseIni == "0") .or. lRollObrig
			if lOX001Auto .or. lRollObrig .or. MsgYesNo( cMsgFase + CRLF + CRLF + STR0094,STR0025)
				//----------------------------
				BEGIN TRANSACTION
				//----------------------------
	...
	if !lOX001Auto
		...
		if VS1->VS1_STATUS $ "F/G"
			if VAI->VAI_FATBAL == "1"
				If cPaisLoc $ "ARG/MEX/PAR"
					cTpFatura := VS1->VS1_TPFATR // 1=Fatura sem Remito;2=Remito;3=Fatura com Remito;4=Entrega Futura
				Else // BRASIL e demais paises
					cTpFatura := "1" // 1=NF
				EndIf
				If cTpFatura == "1" .or. cTpFatura == "4" // Gerar NF
					OFIXX004("VS1",3,,,,cTpFatura)
					If VS1->VS1_STATUS == "X" // Orcamento Faturado
						...
						lContGrav := .t.
					EndIf
				ElseIf cTpFatura == "2" // Gerar Remito ( Somente ARGENTINA )
					OX0040161_Gera_Remito(cOrcAtu) // Gera Remito
					lContGrav := .t.
				EndIf
			else
...
//
if lContGrav .and. ( "/"+cMVMIL0006+"/" ) $ "/VAL/MSF/FDT/" // VMI somente para VALTRA / MASSEY / FENDT
...
###############################################################################
##+----------+------------+-------+-----------------------+------+----------+##
##|Função    |OX0010463_TemPeca | Autor | Rubens Takahashi| Data | 09/04/25 |##
##+----------+------------+-------+-----------------------+------+----------+##
##|Descrição | Verificar se tem peça no orçamento                           |##
##+----------+--------------------------------------------------------------+##
###############################################################################
===============================================================================
*/

Static Function OX0010463_TemPeca()
...
###############################################################################
##+----------+------------+-------+-----------------------+------+----------+##
##|Função    |OX001047H_TemServico | Autor | João Silva | Data | 24/04/25   |##
##+----------+------------+-------+-----------------------+------+----------+##
##|Descrição | Verificar se tem serviço no orçamento                        |##
##+----------+--------------------------------------------------------------+##
###############################################################################
===============================================================================
*/

Static Function OX001047H_TemServico()
...
if M->VS1_TIPORC == "2"	.and. !Empty(M->VS1_NUMORC)
	...
	if oGetPecas:aCols[oGetPecas:nAt,Len(oGetPecas:aCols[oGetPecas:nAt])]
		if !Empty(cACodGrp+cACodIte)
			if lVeEstoqueNA // Verifica se registra nivel de atendimento
...
if (lPediVenda.OR.(M->VS1_TIPORC=="2" .AND. !lVeEstoqueNA)) .and. !lCancelPVP
	if !Empty(M->VS1_NUMORC) .and. !Empty(M->VS3_GRUITE) .and. !Empty(M->VS3_CODITE)
		...
		if DBSeek(xFilial("VS3") + M->VS1_NUMORC + M->VS3_GRUITE + M->VS3_CODITE)
			...
			if ! ( VS1->VS1_TIPORC=="2" .AND. lVeEstoqueNA )
				VS3->VS3_QTDITE := 0
...
if OX001ExistPecFis(oGetPecas:nAt) .and. MafisFound('IT',n) 
...
Function OX001SLDPC(cChave, lUtilCache)
	...
	// Tratamento da FG_POSSB1 dentro do Orçamento por Fases
	If FWIsInCallStack("OFIXX001") .and. FWIsInCallStack("FG_POSSB1") // Dentro do Orçamento e estiver na FG_POSSB1 nao deve mostrar o Estoque quando ainda esta calculando o Nivel de Atendimento
		If Type("lVeEstoqueNA") <> "U" .and. !lVeEstoqueNA // NAO mostra SALDO para montar nivel de Atendimento
			Return 0
		EndIf
		If Type("oDpm") <> "U" .and. oDpm:lNovaConfiguracao
			cChave := substr(cChave,1,len(cChave)-GetSX3Cache("VS3_LOCAL","X3_TAMANHO")) + OX0010444_ArmProvel(.F., oDpm) // Utilizar o LOCAL da linha (verde/amerela)
		EndIf
	EndIf
	...
	do case
		...
		OtherWise
			...
			If ( SB2->(dbSeek(cChave)) )
				Pergunte("MTA260",.F.)
				nSaldo := SaldoMov(nil, nil, nil, If(mv_par03 == 1, .F., Nil), nil, nil, nil, nil)
			EndIf
			RestArea(aAlias)
	endcase
...
if M->VS1_TIPORC == "2"
	...
	If cPaisLoc $ "ARG/MEX/PAR" .and. lVOITESPEC .and. !Empty(VOI->VOI_TESPEC) // Argentina/México/Argentina - Tem TES default para PEÇAS no Cadastro do Tipo de Tempo
		oGetPecas:aCols[oGetPecas:nAt,nVS3OPER]   := M->VS3_OPER   := Space(GetSX3Cache("VS3_OPER","X3_TAMANHO"))
		oGetPecas:aCols[oGetPecas:nAt,nVS3CODTES] := M->VS3_CODTES := VOI->VOI_TESPEC
	Elseif Empty(M->VS3_OPER)
		If !Empty(VOI->VOI_CODOPE)
...
if Empty(oGetPecas:aCols[oGetPecas:nAt,nVS3OPER]) .and. Empty(oGetPecas:aCols[oGetPecas:nAt,nVS3CODTES])
	if cAuxReadVar $ "M->VS3_GRUITE,M->VS3_CODITE"
		cB1_TS := FM_PRODSBZ(SB1->B1_COD,"SB1->B1_TS")//SB1->B1_TS
		If cPaisLoc $ "ARG/MEX/PAR"
			If ExistBlock("OX001PTES")
				cTES := ExecBlock("OX001PTES",.f.,.f.,{M->VS1_TPFATR,cB1_TS})
			EndIf
		EndIf
		If Empty(cTES)
			cTES := cB1_TS
...
if 	oGetPecas:aCols[oGetPecas:nAt,nVS3QTDITE] > 0 .and. ;
	...
	if OX001PecFis() // item novo
		...
		cProVen := IIf( cPaisLoc $ "ARG/PAR" , M->VS1_PROVEN , "" )
		FMX_FISITEMI(n, "VS300" , .t., cProVen)
		...
		if MaFisRet(n,"IT_PRODUTO") <> SB1->B1_COD
			MaFisRef("IT_PRODUTO","VS300",SB1->B1_COD)
			cProVen := IIf( cPaisLoc $ "ARG/PAR" , M->VS1_PROVEN , "" )
			FMX_FISITEMI(n, "VS300", .f., cProVen)
		endif
...
Static Function OX0010235_Atualiza_Preco_Peca(lInitialLoad, _cAuxReadVar, cPromocao)
	...
	If cPaisLoc == "ARG" .and. ( ;
		Readvar()    $ "M->VS3_FORMUL/M->VS3_GRUITE/M->VS3_CODITE/M->VS3_VALPEC/M->VS3_PERREC" .or. ;
		_cAuxReadVar $ "M->VS3_FORMUL/M->VS3_GRUITE/M->VS3_CODITE/M->VS3_VALPEC/M->VS3_PERREC" )
		lDigRecVS3 :=  ( "M->VS3_PERREC" $ Readvar()+"/"+_cAuxReadVar ) // Esta digitando o campo de % de Recargo do Item ?
		lDefRecVS1 := !( "M->VS3_VALPEC" $ Readvar()+"/"+_cAuxReadVar ) // Se NAO for a digtação do VALOR da PEÇA, utilizar o % de Recargo Default do VS1
		OX0010501_Recargo_do_Item( lDigRecVS3 , lDefRecVS1 ) // Soma o RECARGO no VALOR da PEÇA ( VS3_VALPEC + RECARGO )
	EndIf
	...
	if M->VS3_PERDES <> 0 .or. lInitialLoad
...
if !oGetPecas:aCols[oGetPecas:nAt,Len(oGetPecas:aCols[oGetPecas:nAt])] .and. !Empty(cGrupoVal+cCodIteVal)
	...
	If ! lMultMoeda .and. (nPos_ITRelCache := aScan(ITRelCache, { |x| x[1] == M->VS1_TIPTEM + cGrupoVal + cCodIteVal + cForVal })) <> 0
	...
	Else
		...
		aIteRel := FG_ITEREL(M->VS1_TIPTEM,cGrupoVal,cCodIteVal,"cForVal",,nMoeda,nTxMoeda)
		If lRelSec // Fazer os Relacionamentos Secundarios ?
			...
			For nCntFor := 1 to len(aRelPri) // Percorrer os Relacionamenos Primarios
				aRelSec := FG_ITEREL(M->VS1_TIPTEM,aRelPri[nCntFor,1],aRelPri[nCntFor,2],"cForVal",,nMoeda,nTxMoeda) // Buscar Relacionamentos Secundarios
...
EndIf
//
If ! lMultMoeda .and. ! lUtilCache .and. ! oGetPecas:aCols[oGetPecas:nAt,Len(oGetPecas:aCols[oGetPecas:nAt])] .and. ! Empty(cGrupoVal+cCodIteVal)
...
Function OX001PecFis()
	...
	if nPos == 0
		...
		lNovo := .t.
	Else
		lNovo := !MAFISFOUND('IT',aNumP[nPos,2])
	endif
	//
	n := aNumP[nPos,2]
return lNovo
...
//
if !Empty(cPesqVV1)
	if !(FG_POSVEI("cPesqVV1",,M->VS1_TIPORC=="1"))
		FS_LIMPAVEI()
		return .f.
	endif
	if M->VS1_TIPORC=="1"
		...
		__ReadVar := "M->VS1_LOJA"
		OX001VLDENC(,,.F.) // Disparar o VALID do campo LOJA
		return .T.
	endif
...
If INCLUI .or. ALTERA
	If VV2->(FieldPos("VV2_SEGMTO")) > 0 .and. VVR->(FieldPos("VVR_SEGMTO")) > 0
		If !Empty(VV2->VV2_SEGMTO)
			M->VS1_SEGMTO := VV2->VV2_SEGMTO
		Else
			VVR->(DbSetOrder(2))
			VVR->(msSeek(xFilial("VVR")+VV1->VV1_CODMAR+VV2->VV2_GRUMOD))
			If !Empty(VVR->VVR_SEGMTO)
				M->VS1_SEGMTO := VVR->VVR_SEGMTO
			EndIf
		EndIf
	EndIf
	__ReadVar := "M->VS1_LOJA"
...
If MaFisFound('NF')
	if cPaisLoc $ "ARG/PAR"
		aOrc := OX0010403_ResumoImpostosArgentin()
	else
...
function OX0010403_ResumoImpostosArgentin()
	...
	for nCntFor := 1 to Len(aOrcDynHeader)
		if INCLUI .or. ALTERA .or. (cVS1Status $ "5.F" .and. FECHA) .or. lPediVenda
			...
			xValor := &(aOrcDynHeader[nCntFor,4])
		endif
	...
	for nCntFor := 1 to Len(aOrcDynFooter)
		if INCLUI .or. ALTERA .or. (cVS1Status $ "5.F" .and. FECHA) .or. lPediVenda
			...
			xValor := &(aOrcDynFooter[nCntFor,4])
		endif
...
static function OX001F1ARG(nValor, nF1Moeda)
	local nRetorno := 0
	...
	if nF1Moeda == M->VS1_MOEDA .or. (nF1Moeda == 1 .and. M->VS1_MOEDA == 0)
		return nValor
	else
		nRetorno := FG_MOEDA( nValor , M->VS1_MOEDA , nF1Moeda , M->VS1_TXMOED , 2 , /* dDataRef */ )
	endif
	...
	Else
		...
		Else
			...
			For i := 1 to Len(aRecVS3)
				...
				//
			Next
			if Type("oGetPecas:aCols") == "A" .And. (Type("lOX001Auto") == "U" .or. !lOX001Auto)
				oGetPecas:oBrowse:refresh()
			EndIf
		Endif
		// -----------------------------------------------
...
if lImprime
	OC1700038_Imprimir_Orcamento() // Executa RdMake de Impressao do Orcamento
else
	return .f.
endif
//
...
===============================================================================
*/
Function OX001AVARES(nOpc, lWs, cIdMap)
local oMapa := nil
...
if lWs
	oMapa := VEMapasAvaliacao():new()
	oMapa:getMapa(VS1->VS1_NUMORC, cIdMap)
	return oMapa:aStru
else
	dbSelectArea("VEC")
...
Local cNumREL := ""
Local cNumIDE := ""
Local nPosSeq := fg_posvar("VS3_SEQUEN","aHeaderP")
...
For ix_:=1 to Len(oGetPecas:aCols)
	...
	while !eof() .and. VOQ->VOQ_FILIAL == xFilial("VOQ")
		...
		aadd(aStru,{ VS1->VS1_NUMORC,,SB1->B1_COD + oGetPecas:aCols[ix_,nPosSeq],VOQ_CLAAVA,cDescVOQ,VOQ_ANASIN,;
	...
	FG_CalcVlrs(aStru,SB1->B1_COD + oGetPecas:aCols[ix_,nPosSeq])
...
if lGrava
	if cPecSer == "P"  //Pecas
		...
		Else
			cCont := 1
		Endif
		aAdd( aVetCort,{xFilial("VPJ"),M->VS1_NUMORC,dDataBase,val(left(time(),2)+substr(time(),4,2)),oGetPecas:aCols[oGetPecas:nAt,nVS3GRUITE],oGetPecas:aCols[oGetPecas:nAt,nVS3CODITE],oGetPecas:aCols[oGetPecas:nAt,nVS3QTDITE],oGetPecas:aCols[oGetPecas:nAt,nVS3VALTOT],cMotCort,STRZERO(cCont,3),M->VS1_NCLIFT,oGetPecas:aCols[oGetPecas:nAt,nVS3SEQUEN]} )
	Else       // Servicos
		cCont := 0
		DBSelectArea("SX2")
		if DBSeek("VPM")
...
If Len(aPeca) > 0
	...
	for nCntFor := 1 to Len(aPeca)
		...
		for nCntFor2 := 1 to Len(aVetCmp)
			...
			&("M->"+aVetCmp[nCntFor2,1]) := aVetCmp[nCntFor2,2]
			oGetPecas:aCols[oGetPecas:nAt,FG_POSVAR(aVetCmp[nCntFor2,1],"aHeaderP")] := aVetCmp[nCntFor2,2]
			if aVetCmp[nCntFor2,1] == "VS3_QESTNA" .and. M->VS3_QESTNA >= 0
				oGetPecas:aCols[oGetPecas:nAt,FG_POSVAR(aVetCmp[nCntFor2,1],"aHeaderP")] := M->VS3_QESTNA
			endif
			if !OX001FPOK(,,.f.,.f.)
				aSize(oGetPecas:aCols,Len(oGetPecas:aCols)-1)
				exit
...
oLboxFAI:bLine := { || { IIF(aSugest[oLboxFAI:nAt,01],oTik,oNo),;
	...
	if lNewRes == .f. .and. lFaseReserv == .t.
...
for nCntFor := 1 to Len(aImpSug)
	...
	if aImpSug[nCntFor,1]
		...
		@ nLin++ , 00 psay aImpSug[nCntFor,02]+"  "+aImpSug[nCntFor,03]+" "+Substr(aImpSug[nCntFor,04],1,30)+" "+Transform(aImpSug[nCntFor,05], "@E 999,999,999.99")+" "+Transform(SB2->B2_SALPEDI,"@E 999,999,999.99")
	endif
...
nLin +=1
@ nLin++ , 00 PSAY RetTitle("VE6_SUGCOM") + " : " + SFJ->FJ_CODIGO + "        " +  RetTitle("VEJ_TIPPED") + " : " + VEJ->VEJ_TIPPED + " - "  + VEJ->VEJ_DESCRI
...
Function OFXX01V2UM()
	...
	if M->VS3_QTD2UM <> 0
		If !FWIsInCallStack("OFIOM430")
			IF (Type("lOX001Auto") == "U" .or. !lOX001Auto)
				oGetPecas:aCols[oGetPecas:nAt,fg_posvar("VS3_QTD2UM","aHeaderP")]:= M->VS3_QTD2UM := 0
				oGetPecas:oBrowse:refresh()
			Else
				aCols[n,fg_posvar("VS3_QTD2UM","aHeaderP")] := M->VS3_QTD2UM := 0
			ENDIF
		Else
			aCols[n,FG_POSVAR("VS3_QTD2UM")] := 0
		EndIf
	endif
...
Else
	...
	While !eof() .and. xFilial("VS3") + VS1->VS1_NUMORC == VS3->VS3_FILIAL + VS3->VS3_NUMORC
		...
		If !Empty(VS3->VS3_MOTPED) // Desconsidera caso item tenha sido cancelado
			VS3->(DbSkip())
			Loop
		EndIf	
...
For nCont := 1 to Len(aSrvcAdic)
	...
	if VOK->VOK_INCMOB == "5"
		...
		aVO4Cols[nCont,FG_POSVAR("VO4_VALHOR","aVO4Header")] := M->VO4_VALHOR := nPreKil
		aVO4Cols[nCont,FG_POSVAR("VO4_VALTOT","aVO4Header")] := M->VO4_VALTOT := M->VS4_KILROD * nPreKil
	else
...
If lMultMoeda // Trabalha com MultMoeda ?
	If M->VS1_MOEDA > 1
		cQuery += "AND VO1.VO1_MOEDA = "+Alltrim(str(M->VS1_MOEDA))+" " // utilizar a mesma MOEDA do Orçamento
	Else
		cQuery += "AND VO1.VO1_MOEDA <= 1 " // utilizar Moeda <= 1
	EndIf
EndIf
	...
	if !Empty(M->VS1_CHASSI)
		...
		If DbSeek(xFilial("VV1")+Alltrim(M->VS1_CHASSI))
			...
			For nCntFor := 1 to Len(aFatParS)
				...
				ElseIf aFatParS[nCntFor,6] == "3" // FILIAL CORRENTE
					aRetEmp := FWArrFilAtu()
					DBSelectArea("SA1")
					DBSetOrder(3)
					If DBSeek(xFilial("SA1")+aRetEmp[18]) //CGC
...
If (VS1->VS1_STATUS $ "5.F" .and. FECHA) .or. ALTERA
	If lNewRes .and. lMovDiverg
		// Verifica se existe pelo menos uma PEÇA lançada na acols
        If !Empty(oGetPecas:aCols[1,FG_POSVAR("VS3_CODITE","aHeaderP")])
		OX0010345_AjustaQtdRequisitadaConferida()
		Endif
	Endif
Endif
	...
	For ny := 1 to Len(oGetPecas:aCols)
		...
		if !oGetPecas:aCols[ny,Len(oGetPecas:aCols[ny])] .and. !Empty(oGetPecas:aCols[ny,nVS3CODITE])
			...
			If cPaisLoc == "BRA"
				...
				OX0010471_PreencheaColsImpostos(ny)
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Function OX001EXPVSJ(lChamaExt,cNroOrcAtu,lUsuSugCom, cUsuVEJPed)

Default cNroOrcAtu := VS1->VS1_NUMORC
Default lChamaExt := .t.
   
if FM_IMPVSJ( @aItensNImp , VS1->VS1_NUMORC , VO1->VO1_NUMOSV,,, .F.,,lUsuSugCom, cUsuVEJPed)
...
If nLinha > 0
	...
	If oGetPecas:aCols[nLinha, nVS3REC_WT ] > 0
		return .t.
	EndIf
EndIf
Return .f.
...
Static Function OX0010105_ArmazemOrigem()
	...
	If M->VS1_TIPORC <> "2" .and. ExistBlock("OX001LOC")
        cArmazem := ExecBlock("OX001LOC",.F.,.F.)
    Endif
...
Static Function OX0010123_FGPosVar_VS3()
	...
	nVS3ESTNA  := FG_POSVAR("VS3_QESTNA","AHEADERP")
	...
	nVS3VALORI := FG_POSVAR("VS3_VALORI","AHEADERP")
	nVS3PERREC := FG_POSVAR("VS3_PERREC","AHEADERP")
	nVS3VALREC := FG_POSVAR("VS3_VALREC","AHEADERP")
	nVS3VALTOT := FG_POSVAR("VS3_VALTOT","AHEADERP")
	nVS3SEQVEN := FG_POSVAR("VS3_SEQVEN","aHeaderP")
	nVS3PESPRO := FG_POSVAR("VS3_PESPRO","aHeaderP")

	if lVCFSEGMEN
		nVS3SEGMTO := FG_POSVAR("VS3_SEGMTO","AHEADERP")
	endif
	...
	If cPaisLoc == "BRA"
		...
		nVS3VALIPI := FG_POSVAR("VS3_VALIPI","AHEADERP")
...
Function OX0010124_IncluiItemOrc(cCod, nQuant, cDet, aDadosExt)
	...
	For nX := 1 to nUsadoPX01
		...
		if ! lFeito
			if cField == "VS3_QTDEST" .and. ! lVeEstoqueNA
...
Function OX0010134_ImportaOrcCSV()
	...
	cFile := cGetFile(iif(lAllExt, "", "XML Advisor|*.xml|CSV Advisor|*.csv"), STR0363, , , .t. , nOR( GETF_NETWORKDRIVE, GETF_LOCALHARD) ) // se tem o PE libera todas as extensões senão só CSV e XML
	If Empty(cFile)
		Return .f.
	EndIf

	if  Right(cFile,4) == ".xml" // Leitura do arquivo XML
		OX0010135_ImportaOrcXML(cFile,aExtData)
		Return .t.
	Endif
...
/*/{Protheus.doc} OX0010135_ImportaOrcXML
	Importação de orçamentos em XML modelo john deere Advisor
	
	@type function
	@author Jose Silveira
	@since 09/09/2024
/*/
Function OX0010135_ImportaOrcXML(cFile,aExtData)
	...
	cVerXML := oXmlHelper:GetValue("_PICKLIST:REALNAME")
	IF !Empty(cVerXML)
		lPickList := .t.
		nPecas := LEN(oXml:_PICKLIST:_ITEMS:_ITEM)
	Else
		nPecas := LEN(oXml:_PARTSORDERS:_PARTSORDER:_ORDERLINE)
	Endif

	If !Empty(nPecas)
		For nX := 1 to nPecas
			if lPickList
				cDados := PadR(oXml:_PICKLIST:_ITEMS:_ITEM[nX]:_PARTNUMBER:TEXT,nTam)
				cQuant := oXml:_PICKLIST:_ITEMS:_ITEM[nX]:_QUANTITY:TEXT
			Else
				cDados := PadR(oXml:_PARTSORDERS:_PARTSORDER:_ORDERLINE[nX]:_PARTID:TEXT,nTam)
				cQuant := oXml:_PARTSORDERS:_PARTSORDER:_ORDERLINE[nX]:_QUANTITY:TEXT
			Endif
			cDet := ""
			if OX0010124_IncluiItemOrc(cDados, val(cQuant), @cDet, aExtData)
				nQtdInc += 1
			else
				cMessage += chr(13) + chr(10) + " " + STR0202 + " " + cDados + " " +STR0351+ " " + cDet // código do item XXX não pode ser importado.
			endif
		Next
	EndIf
...
Static Function OX0010263_CalculaDesconto(_cAuxReadVar)
	...
	If cMVMIL0026 == "S" .or. cPaisLoc <> "BRA" // DEFAULT
	...
	Else
		if _cAuxReadVar == "M->VS3_PERDES"
			M->VS3_VALDES := Round( (M->VS3_VALPEC*M->VS3_QTDITE) * ( M->VS3_PERDES / 100 ) , 2 )
			M->VS3_VALTOT := Round( (M->VS3_VALPEC*M->VS3_QTDITE) , 2 ) - M->VS3_VALDES
		else
			M->VS3_VALTOT := Round( (M->VS3_VALPEC*M->VS3_QTDITE) , 2 ) - M->VS3_VALDES
...
Local cCodVBM    := ""
Local nVS3PROMOC := FG_POSVAR("VS3_PROMOC","aHeaderP")
Local nSldPromoc := 0
Local cPicQtd    := ""
Local cMsgAviso  := ""
Local n_Opcao    := 1
		...
		If !Empty(cCodVBM)
			...
			If M->VS3_QTDITE > nSldPromoc
				...
				Else // Com Promoção
					...
					oGetPecas:aCols[oGetPecas:nAt,FG_POSVAR("VS3_QTDITE","aHeaderP")] := M->VS3_QTDITE := nSldPromoc // Saldo disponivel para Promoção
					oGetPecas:oBrowse:Refresh()
...
Function OX0010225_ReservaManual(nOpc)
	Local nI
	Local lResBal := At("R",GetNewPar("MV_FASEORC","0FX")) > 0
	Local lResOfi := ( GetNewPar("MV_RITEORC","N") == "S" )
	Local cMsgInfo:= ""
	Local nPosItem := oGetPecas:nAt

	If ( M->VS1_TIPORC == "2" .and. !lResOfi )
		cMsgInfo := STR0446 //"Habilitar a reserva de oficina (MV_RITEORC) para utilização da opção."
	ElseIf ( M->VS1_TIPORC == "1" .or. lPediVenda ) .and. !lResBal
		cMsgInfo := STR0445 //"Habilitar a reserva de balcão (MV_FASE?RC) para utilização da opção."
	End

	If !Empty(cMsgInfo)
		FMX_HELP("OX001ERR015", STR0429 , cMsgInfo ) //"Opção indisponível"
		Return .f.
	EndIf
	...
	if lLegendItem
		for nI := 1 to len( oGetPecas:aCols )
			oGetPecas:nAt := nI
			if empty( oGetPecas:aCols[oGetPecas:nAt,nVS3MOTPED] ) .and. ! oGetPecas:aCols[oGetPecas:nAt,len(aHeaderP)+1]
				FG_MEMVAR(aHeaderP,oGetPecas:aCols,oGetPecas:nAt)
				if nVS3QTDEST > 0 .and. OX0010016_MostraQuantidadeEmEstoque(oGetPecas:nAt, M->VS1_TIPORC)
					nAux := oGetPecas:aCols[oGetPecas:nAt,nVS3QTDEST]
					nAux -= oGetPecas:aCols[oGetPecas:nAt,nVS3QTDITE]
					M->ESTOQUE := iif( nAux >= 0 .or. oGetPecas:aCols[oGetPecas:nAt,nVS3RESERV] == "1", "br_verde", "br_vermelho" )
					oGetPecas:aCols[oGetPecas:nAt,FG_POSVAR("ESTOQUE","aHeaderP")] := M->ESTOQUE
				endif
...
Static Function OX0010245_ValidacaoGridPeca(oGetPeca,nOpc,lDadoPec,aItens,aPecSemEst)
	...
	If cPaisLoc $ "ARG/MEX/PAR"
		If M->VS1_TPFATR == "4" .and. (SF4->F4_ESTOQUE == "S" .OR. SF4->F4_DUPLIC == "N")
			FMX_HELP("OX001ERR011", STR0424 ,STR0425 ) // "TES da Fatura com Entrega Futura" / "Utilize somente TES que gere financeiro e não movimenta estoque."
			Return .f.
		EndIf
		If M->VS1_TPFATR == "2" .and. (SF4->F4_ESTOQUE == "N" .OR. SF4->F4_DUPLIC == "N")
			FMX_HELP("OX001ERR012", STR0434 ,STR0435 ) // "TES do Remito" / "Utilize somente TES que movimenta estoque e não gere financeiro."
			Return .f.
		EndIf
	EndIf
...
Static Function OX0010345_AjustaQtdRequisitadaConferida(lShowMessage)

	Local aArea    := {}
	Local lAtualiz := .f.
	Local nPosPec  := 0
	Local nSlvNat  := oGetPecas:nAt
	Local cSlvReadVar := __ReadVar
	Default lShowMessage := .F. // Para não Perguntar se deseja reprocessar, visto que é necessário executar

	aArea := sGetArea(aArea , "VS3")

	If !lShowMessage .or. FWAlertYesNo(STR0403,STR0025) //"Deseja ajustar as quantidades requisitadas automáticamente de acordo com as quantidades conferidas de todos os itens deste orçamento?"
		...
		cQuery +=	"AND ABS(VS3_VALTOT - (VS3_VALLIQ * VS3_QTDITE)) > 0.05 " // Aplica uma margem de diferença de 0,05 centavos devido a arredondamento
		cQuery += 	"AND VS3.D_E_L_E_T_ = ' ' "
		...
		While !TMPPEC->(Eof())
			...
			If nPosPec > 0
				...
				If ExistTrigger('VS3_QTDITE')
					RunTrigger(1, oGetPecas:nAt ,/*cMacro*/,/*oObj*/ , 'VS3_QTDITE')
					oGetPecas:nAt := nPosPec
					oGetPecas:aCols[oGetPecas:nAt, nVS3QTD2UM] := M->VS3_QTD2UM
				Endif

				If VS3->VS3_QTDCON > 0
					oGetPecas:aCols[oGetPecas:nAt,FG_POSVAR("VS3_QTDITE","aHeaderP")] := M->VS3_QTDITE := VS3->VS3_QTDCON
				Endif
				__ReadVar := 'M->VS3_PERDES'
				OX001FPOK(.f.,,.f.,.f.)
		...
		If lAtualiz
			VM5->(DBSetOrder(3))
			If VM5->(DBSeek(xFilial("VM5") + M->VS1_NUMORC))
				FWAlertSuccess(STR0404, STR0025) //"Atualização das quantidades requisitadas de acordo com a quantidades conferidas concluída com sucesso."
			Else
				FWAlertSuccess(STR0469, STR0025) //"Foi detectada uma divergência entre quantidade, valor unitário, desconto e valor total. A linha do item foi reprocessada."
			Endif
...
/*/{Protheus.doc} OX0010171_MOEDA()
	Validação do campo VS1_MOEDA

	@type function
	@author André Luis Almeida
	@since 22/05/2024
/*/
Function OX0010171_MOEDA()
Local lRet := .f.
If M->VS1_MOEDA >= 0 .and. M->VS1_MOEDA <= MoedFin()
	lRet := .t.

	MaFisRef("NF_MOEDA",,M->VS1_MOEDA)

	If M->VS1_MOEDA <= 1
		M->VS1_TXMOED := 0
		MaFisRef("NF_TXMOEDA",,M->VS1_TXMOED)
	EndIf
...
/*/{Protheus.doc} OX0010191_WHEN_MOEDA
	When do campo VS1_MOEDA/VS1_TXMOED

	@type function
	@author André Luis Almeida
	@since 22/05/2024
/*/
Function OX0010191_WHEN_MOEDA(cCampo)
Local lRet := .t.
If lRet .and. Type("oGetPecas:aCols") == "A"
	If aScan(oGetPecas:aCols,{|x| !Empty(x[nVS3CODITE]) }) > 0 // Se existir linha com um Item digitado mesmo que linha deletada, nao pode mexer na Moeda
		lRet := .f.
	EndIf
EndIf
If lRet .and. Type("oGetServ:aCols") == "A"
	If aScan(oGetServ:aCols,{|x| !Empty(x[nVS4CODSER]) }) > 0 // Se existir linha com um Serviço digitado mesmo que linha deletada, nao pode mexer na Moeda
		lRet := .f.
	EndIf
EndIf
Return lRet
...
/*/{Protheus.doc} OX0010201_FOLDERS
	Habilita/Desabilita os Folders da Tela dependendo do Tipo de Orçamento

	@type static function
	@author André Luis Almeida
	@since 17/06/2024
/*/
Static Function OX0010201_FOLDERS(lHabilita)
Default lHabilita := .t.
If !lOX001Auto // EXECUTAR BLOCO QUANDO NÃO FOR ROTINA AUTOMÁTICA
	oFoldX001:aEnable(nFolderP,.f.)
...
/*/{Protheus.doc} OX0010415_AlteraTipoFatura
	Altera o Tipo de Fatura e carrega a TES de acordo com o novo tipo selecionado

	@type static function
	@author Renato Vinicius
	@since 19/09/2024
/*/
Static Function OX0010415_AlteraTipoFatura()

	Local nI		:= 0
	Local nContPec  := Len(oGetPecas:aCols)
	Local cTES 		:= Space(GetSX3Cache("F4_CODIGO","X3_TAMANHO"))
	Local lPE_TES   := ExistBlock("OX001PTES")
	Local cRetTES   := cTES
	Local aRet 		:= {}
	Local aParamBox := {}
	Local lVldTES   := .t.
	...
	If cPaisLoc $ "ARG/MEX/PAR" .and. M->VS1_TIPORC <> "2"
		If INCLUI .or. (ALTERA .and. M->VS1_STATUS $ "0")
			cbkpTpFat := M->VS1_TPFATR
			nTpFatura := Aviso(STR0001,STR0420,{STR0421,STR0422,STR0423,STR0031},2) // Orçamento por Fases / Deseja gerar? / Fatura sem Remito / Remito / Entrega Futura / Cancela
			If nTpFatura == 4
				Return .f.
			EndIf
			...
			If M->VS1_TPFATR == "4" // Entrega Futura
				cVldTES := '( SF4->F4_DUPLIC == "S" .and. SF4->F4_ESTOQUE == "N" )'
				cTitTES := STR0423 // Entrega Futura
				cObsTES := STR0425 // Utilize somente TES que gere financeiro e não movimenta estoque.
			Else // Remito ou Fatura sem Remito
				cVldTES := '( SF4->F4_DUPLIC == "S" .and. SF4->F4_ESTOQUE == "S" )'
				cObsTES := STR0435 // Utilize somente TES que movimenta estoque e não gere financeiro.
			EndIf

			SF4->(DbSetOrder(1))
			For nI := 1 to nContPec
				nPosTES := aScan(aTESDePara, { |x| x[1] == oGetPecas:aCols[nI,nVS3CODTES] } )
				If nPosTES == 0
					If SF4->(DbSeek(xFilial("SF4")+oGetPecas:aCols[nI,nVS3CODTES]))
						lVldTES := &(cVldTES) // Executa o VALID do TES
						aAdd(aTESDePara,{SF4->F4_CODIGO,IIf(lVldTES,SF4->F4_CODIGO,"")})
					EndIf
				EndIf
			Next

			For nI := 1 to Len(aTESDePara)
				If aTESDePara[nI,1] <> aTESDePara[nI,2]
					If lPE_TES // Existe o PE OX001PTES ?
						cRetTES := ExecBlock("OX001PTES",.f.,.f.,{M->VS1_TPFATR,aTESDePara[nI,1]})
						If SF4->(DbSeek(xFilial("SF4")+cRetTES))
							If &(cVldTES) // Executa o VALID do TES
								aTESDePara[nI,2] := cRetTES
							EndIf
						EndIf
					EndIf
					If Empty(aTESDePara[nI,2])
						aParamBox := {}
						AADD(aParamBox,{1,STR0480,aTESDePara[nI,1],"@!",'.t.',"SF4",".F.",50,.F.}) // TES do Orçamento
						AADD(aParamBox,{1,STR0441,cTES,"@!",'vazio() .or. ( FG_Seek("SF4","MV_PAR02",1) .and. MaAvalTes("S",MV_PAR02) .and. '+cVldTES+' )',"SF4",".T.",50,.T.}) // TES Fatura
						AADD(aParamBox,{11,STR0025,cObsTES,"",".f.",.f.}) // Atenção
						While .t.
							If ParamBox(aParamBox,cTitTES,@aRet,,,,,,,,.f.)
								aTESDePara[nI,2] := aRet[2] // TES
								Exit
							Else
								MsgInfo(STR0440,STR0025) //"Informe uma TES para seguir com o processo." // "Atenção"
								Loop
							EndIf
						End
					EndIf
			...
			ProcRegua(nContPec)
			For nI := 1 to nContPec
				IncProc(STR0483+"   "+oGetPecas:aCols[nI,nVS3GRUITE]+" "+oGetPecas:aCols[nI,nVS3CODITE]) // Ajustando TES das Peças...
				nPosTES := aScan(aTESDePara, { |x| x[1] == oGetPecas:aCols[nI,nVS3CODTES] } ) 
				If nPosTES > 0 .and. aTESDePara[nPosTES,1] <> aTESDePara[nPosTES,2] .and. !Empty(aTESDePara[nPosTES,2])
					oGetPecas:nAt := nI
					oGetPecas:aCols[oGetPecas:nAt,nVS3CODTES] := M->VS3_CODTES := aTESDePara[nPosTES,2]
					__ReadVar := 'M->VS3_CODTES'
					FG_MEMVAR(aHeaderP,oGetPecas:aCols,oGetPecas:nAt)
					lPPrepec := .t.  // Controla se sera executada a funcao OX001PREPEC
					OX001PREPEC("", .f.)
				EndIf
		...
		Else
			FMX_HELP("OX001ERR013", STR0429, STR0430 ) // "Opção indisponível". "Essa opção está disponivel apenas para orçamentos de tipo Balcão e status Digitado"
		EndIf
	EndIf

Return

Function OX0010416_ValidaArmSegmento(oRpm)
	Default oRpm := OFJDRpmConfig():New()

	if oRpm:lNovaConfiguracao .and. !Empty(M->VS1_SEGMTO)
		lMesmoSegmento := cValtoChar(oRpm:oNovaConfiguracao:SegmentoDoArmazem(cFilAnt, M->VS3_LOCAL)) == M->VS1_SEGMTO
		if lMesmoSegmento
			return .t.
		else
...
/*/{Protheus.doc} OX0010432_RecalculoMargem
	Função que recalcula a margem
	@type function
	@version 1.0
	@author Bruno Forcato
	@since 31/10/2024
/*/
Static Function OX0010432_RecalculoMargem()
	aTempPro := OX005PERDES(;
		SBM->BM_CODMAR,;                              // cMarca
		M->VS1_CENCUS,;                               // cCenRes
		M->VS3_GRUITE,;                               // cGrupo
	...
	if lLegendItem
		...
		nPos := FG_POSVAR("MARGEM","aHeaderP")
		if nPos > 0
			oGetPecas:aCols[oGetPecas:nAt,nPos] := iif( OX001050C_ValidaMargem( .F. ), "br_verde", "br_vermelho" )
		endif
	endif
return nil

/*/{Protheus.doc} OX0010424_ChamaTransferenciasInternas
	Chama nova tela de transferencia rapida de peça

	@type static function
	@author Vinicius Gati
	@since 07/10/2024
/*/
Static Function OX0010424_ChamaTransferenciasInternas()
	local cB1COD
	local lNovoReg := oGetPecas:aCols[oGetPecas:nAt, nVS3REC_WT] == 0
	local lForca := .f.

	if len(oGetPecas:aCols) == 1 .and. empty(oGetPecas:aCols[oGetPecas:nAt,nVS3CODITE])
		MsgInfo(STR0436, STR0025)
		return
	endif
	if lNovoReg
		MsgInfo(STR0431, STR0025) //"Item recém adicionado. Não é possível transferir antes de gravar o nível de atendimento" "Atenção"
		return
	endif
	if M->VS3_QTDEST >= M->VS3_QTDITE
		lForca  := MsgNoYes(STR0432, STR0025) //"Quantidade disponível já atende a solicitação, Deseja prosseguir mesom assim?" "Atenção"
	endif
	if M->VS3_QTDEST < M->VS3_QTDITE .or. lForca
		cB1COD := FM_SQL("SELECT B1_COD FROM "+retsqlName("SB1")+ " WHERE B1_FILIAL = '"+xFiliaL("SB1")+"' AND B1_CODITE = '"+M->VS3_CODITE+"' AND B1_GRUPO = '"+M->VS3_GRUITE+"' AND D_E_L_E_T_ = ' ' ")
		if empty(cB1COD)
			MsgInfo(STR0036, STR0025) //"Item recém adicionado. Não é possível transferir antes de gravar o nível de atendimento" "Atenção"
			return
		endif
		OFIA506(cB1COD, M->VS3_QTDITE - M->VS3_QTDEST, M->VS3_LOCAL)
	endif
Return

/*/{Protheus.doc} OX0010444_ArmazemProvavelSegmto
	Altera o almox
	...
	@since 27/11/2024
/*/
Function OX0010444_ArmProvel(lGravaVS3, oRpm, cCodIte)
	local cArmPrv := space(GetSX3Cache("VS3_LOCAL","X3_TAMANHO"))
	Default lGravaVS3 := .f.
	Default oRpm := OFJDRpmConfig():New()
	Default cCodIte := M->VS3_CODITE
	
	if oRpm:lNovaConfiguracao .and. !Empty(M->VS1_SEGMTO) .and. !Empty(cCodIte)
		cArmPrv := oRpm:oNovaConfiguracao:PrimArmazemProvavel(M->VS1_SEGMTO)
	Endif
	If !Empty(cCodIte)
		If Empty(cArmPrv)
			cArmPrv := OX0010105_ArmazemOrigem() // Carregar como DEFAULT (SB1/SBZ)
		EndIf
		if ! Empty(cArmPrv)
			if lGravaVS3
				M->VS3_LOCAL := cArmPrv
...
/*/{Protheus.doc} OX001042C_ConsultaF7
Proteção para forçar a abertura da calculadora fiscal
@type function
@version 1.0
@author cristiamRossi
@since 10/8/2024
/*/
Function OX001042C_ConsultaF7()
local lCalcFis := MaFisFound("NF")
local aArea    := getArea()

	iif( lCalcFis, MaFisSave(), nil )

	OFIXC001()

	iif( lCalcFis, MaFisRestore(), nil )

	OX001FisPec()
	restArea(aArea)
return nil

Function OX001045G_VldSugCompra(_cOrc, lNewRes)

	Local cSql := ""
	Local cMsgSugCom := ""
	Local lSugAuto   := GetNewPar("MV_SUGCAU","N") == "S" //Não me preocupei com origem, pois a chamada da função anterior, sempre utiliza origem 1
	Local lGeraSug   := .F. //Se deve ou não gerar a sugestão de compra
	Local cCodVEJ    := ""
	Local cAmrLoc    := ""
	Local aParamVEJ  := {}
	Local aRetVEJ    := {}
	...
	//Filtra Peças do Orçamento que não estejam canceladas e que cuja TES movimenta estoque
	cSql := "SELECT VS3.VS3_GRUITE,  VS3.VS3_CODITE, VS3.VS3_QTDITE, VS3.VS3_LOCAL, VS3.VS3_RESERV "
	cSql += "FROM " + RetSqlName("VS3") + " VS3 "
	cSql += "JOIN " + RetSqlName("SF4") + " SF4 ON SF4.D_E_L_E_T_ = ' ' AND SF4.F4_FILIAL = '" + xFilial("SF4") + "' AND "
	cSql += "      SF4.F4_CODIGO =  VS3.VS3_CODTES AND SF4.F4_ESTOQUE = 'S' "
	cSql += "WHERE VS3.D_E_L_E_T_ = ' ' AND VS3.VS3_FILIAL = '" + xFilial("VS3") + "' AND "
	cSql += "      VS3.VS3_NUMORC = '" + _cOrc + "' AND VS3.VS3_MOTPED = ' ' "

	TcQuery cSql New Alias "_TMPSUG"

	While !_TMPSUG->(Eof())
		
		cAmrLoc := _TMPSUG->VS3_LOCAL

		If lNewRes .and. _TMPSUG->VS3_RESERV == "1"
			cAmrLoc := Subs(GetMv( "MV_MIL0177" ),1,GetSX3Cache("B2_LOCAL","X3_TAMANHO"))
		EndIf

		SB1->(DbSeek( xFilial("SB1") + _TMPSUG->VS3_GRUITE + _TMPSUG->VS3_CODITE ))

		If Empty(cAmrLoc)
			cAmrLoc := FM_PRODSBZ(SB1->B1_COD,"SB1->B1_LOCPAD")
		EndIf

		nSaldoSB2 := OX001SLDPC(xFilial("SB2") + SB1->B1_COD + cAmrLoc, .T. )
		If _TMPSUG->VS3_QTDITE > nSaldoSB2
			cMsgSugCom += AllTrim(SB1->B1_COD) + "-" + AllTrim(SB1->B1_DESC) + " - " + ;
				STR0450 + ": [" + AllTrim(Str(_TMPSUG->VS3_QTDITE)) + "] - " + ; //"Quantidade no Orçamento"
				STR0451 +": " + cAmrLoc + " [" + AllTrim(Str(nSaldoSB2)) + "]" + chr(13)//"Armazém"
				lPecSemEst := .t.
		EndIf
	...
	If lSugAuto .and. lPecSemEst // Gera sugestão de compra automática
		lGeraSug := .T. //
	ElseIf lPecSemEst .and. MsgYesNo(STR0452 + CHR(13) + CHR(10) + STR0453, STR0454)  //"Existe um ou mais produtos sem estoque disponivel. # Deseja gerar uma sugestão de compra dos produtos sem estoque disponivel # Atenção
		lGeraSug := .T.
	EndIf

	If lGeraSug
		aAdd(aParamVEJ, { 1, STR0455, Space(TamSx3("VEJ_TIPPED")[1]), "", "VEJ->(DBSeek(xFilial('VEJ')+FMX_RETMAR(GetNewPar('MV_MIL0006',''))+MV_PAR01))", "VEJPED", "", TamSx3("VEJ_TIPPED")[1], .F.})
		If ParamBox(aParamVEJ, STR0456, @aRetVEJ)
			If !Empty(aRetVEJ[1])
				VEJ->(DBSeek(xFilial('VEJ') + FMX_RETMAR(GetNewPar('MV_MIL0006','')) + aRetVEJ[1]))
				cCodVEJ := VEJ->VEJ_CODIGO
			EndIf
		Else
			lGeraSug := .F. // Se o botão Cancelar for selecionado, não gera Sugestão de Compra.
		EndIf				
	EndIf

Return({lGeraSug, cCodVEJ})

/*/{Protheus.doc} OX001002K_RecalcDIFAL
	Essa função irá recalcular o DIFAL em após a digitação do VS1_VALFRE (frete)
	em situação especifica para não prejuficar a performance
	@type  Static Function
...
/*/
Static Function OX001002K_RecalcDIFAL()

	Local nCntFor 		:= 0
	Local nSaveNAT		:= oGetPecas:nAt
	Local cTpCliICMRet 	:= GetNewPar('MV_TPSOLCF')
	Local cUFOriMerc 	:= GetNewPar('MV_ESTADO')
	Local cUFDestMerc	:= SA1->A1_EST

	If (M->VS1_TIPCLI $ cTpCliICMRet .and. cUFOriMerc <> cUFDestMerc)
		For nCntFor := 1 To Len(oGetPecas:aCols)
			If !oGetPecas:aCols[nCntFor,Len(oGetPecas:aCols[nCntFor])]
				oGetPecas:nAt := nCntFor
				If !Empty(oGetPecas:aCols[oGetPecas:nAt, nVS3CODTES])
					FG_MEMVAR(aHeaderP,oGetPecas:aCols,oGetPecas:nAt, .F.)
					M->VS3_DIFAL  := MaFisRet(oGetPecas:nAt,"IT_DIFAL")
					oGetPecas:aCols[ oGetPecas:nAt , nVS3DIFAL  ] := M->VS3_DIFAL
				Endif
			Endif
		Next

		M->VS1_DIFAL  := OX001TOTPF("ON","DIFAL")

		// Atualiza Browse
		oGetPecas:nAt := nSaveNAT
		OX001FisPec()
		FG_MEMVAR(aHeaderP,oGetPecas:aCols,oGetPecas:nAt, .F.)
		oGetPecas:oBrowse:Refresh()
	Endif
...
/*/{Protheus.doc} OX0010434_AtualizaVS3Segmto
	Atualiza dados do VS3 relacionados a saldo ao trocar de local no grid por conta do segmento
	...
	@static
/*/
Static Function OX0010434_AtualizaVS3Segmto()
	local nX := 1

	For nX := 1 to Len(oGetPecas:aCols)
		oGetPecas:aCols[nX, nVS3LOCAL] := OX0010444_ArmProvel(.F., oDpm, oGetPecas:aCols[nX, nVS3CODITE])
		if nVS3ESTNA > 0
			oGetPecas:aCols[nX, nVS3ESTNA] := -1 // para recalcular o qestna ao salvar pois trocou o local
		endif

		If lVeEstoqueNA .and. oGetPecas:aCols[nX, nVS3REC_WT] > 0 
			SB1->(DBSetOrder(7))
			SB1->(DBSeek(xFilial("SB1")+oGetPecas:aCols[nX, nVS3GRUITE]+oGetPecas:aCols[nX, nVS3CODITE]))
			SB1->(DBSetOrder(1))
			oGetPecas:aCols[nX, nVS3QTDEST] := OX001SLDPC( xFilial("SB2") + SB1->B1_COD + oGetPecas:aCols[nX, nVS3LOCAL] )
		endif
	Next
	oGetPecas:oBrowse:refresh()
return

/*/{Protheus.doc} OX0010451_LimpaVariaveisImpostos
	Limpa Variaveis de Impostos

	@author Andre Luis Almeida
	@since 22/05/2025
/*/
Static Function OX0010451_LimpaVariaveisImpostos()
	M->VS3_VALPIS := 0
	M->VS3_VALCOF := 0
	M->VS3_ICMCAL := 0
	M->VS3_PICMSB := 0
...
/*/{Protheus.doc} OX0010461_CarregaVariaveisImpostos
	Carrega Variaveis de Impostos com Fiscal

	@author Andre Luis Almeida
	@since 22/05/2025
/*/
Static Function OX0010461_CarregaVariaveisImpostos(n)
If MAFISFOUND('IT',n)
...
/*/{Protheus.doc} OX0010471_PreencheaColsImpostos
	Preenche campos de Impostos na aCols

	@author Andre Luis Almeida
	@since 22/05/2025
/*/
Static Function OX0010471_PreencheaColsImpostos(nLinaCols)
	oGetPecas:aCols[ nLinaCols , nVS3VALPIS ] := M->VS3_VALPIS
	oGetPecas:aCols[ nLinaCols , nVS3VALCOF ] := M->VS3_VALCOF
	oGetPecas:aCols[ nLinaCols , nVS3ICMCAL ] := M->VS3_ICMCAL
	oGetPecas:aCols[ nLinaCols , nVS3PICMSB ] := M->VS3_PICMSB
	oGetPecas:aCols[ nLinaCols , nVS3VICMSB ] := M->VS3_VICMSB
	oGetPecas:aCols[ nLinaCols , nVS3BICMSB ] := M->VS3_BICMSB
	oGetPecas:aCols[ nLinaCols , nVS3BASIRR ] := M->VS3_BASIRR
	oGetPecas:aCols[ nLinaCols , nVS3ALIIRR ] := M->VS3_ALIIRR
	oGetPecas:aCols[ nLinaCols , nVS3VALIRR ] := M->VS3_VALIRR
	oGetPecas:aCols[ nLinaCols , nVS3BASCSL ] := M->VS3_BASCSL
	oGetPecas:aCols[ nLinaCols , nVS3ALICSL ] := M->VS3_ALICSL
	oGetPecas:aCols[ nLinaCols , nVS3VALCSL ] := M->VS3_VALCSL
	oGetPecas:aCols[ nLinaCols , nVS3DIFAL  ] := M->VS3_DIFAL
	oGetPecas:aCols[ nLinaCols , nVS3VALCMP ] := M->VS3_VALCMP
	If nVS3PIPIFB > 0
		oGetPecas:aCols[ nLinaCols , nVS3PIPIFB ] := M->VS3_PIPIFB
	EndIf
	If nVS3VIPIFB > 0
		oGetPecas:aCols[ nLinaCols , nVS3VIPIFB ] := M->VS3_VIPIFB
	EndIf
	If nVS3VALIPI > 0
		oGetPecas:aCols[ nLinaCols , nVS3VALIPI ] := M->VS3_VALIPI
	EndIf
Return

/*/{Protheus.doc} OX0010484_PecaPersistida
	Pega a peca persistida no banco para verificar se foi alterada

	@author Vinicius Gati
	@since 22/05/2025
/*/
static function OX0010484_PecaPersistida(oBrowse, oSqlHlp)
	local cQuery := ""
	local aData  := {}
	default oSqlHlp := DMS_SqlHelper():New()

	cQuery := " SELECT VS3_CODITE, VS3_GRUITE "
	cQuery += "   FROM " + RetSqlName("VS3") + " VS3 "
	cQuery += "  WHERE VS3.VS3_FILIAL = '" + xFilial("VS3") + "' "
	cQuery += "    AND VS3.VS3_SEQUEN = '" + cValtoChar(oBrowse:aCols[oBrowse:nAt, FG_POSVAR("VS3_SEQUEN","aHeaderP")]) + "' "
	cQuery += "    AND VS3.D_E_L_E_T_ = ' ' "

	aData := oSqlHlp:GetSelectArray(cQuery, 2)
	if len(aData) > 0
		return aData[1]
	endif
return {" ", " "}

/*/{Protheus.doc} OX001050C_ValidaMargem
Preenche campos de Impostos na aCols
@author Cristiam Rossi
@since 04/08/2025
@param lCarga, logical, carga de dados salvos ou atualização de tela
@param logical, retorna se Desconto invalida a margem de lucro
/*/
Static Function OX001050C_ValidaMargem( lCarga )
local   aArea       := getArea()
local   lOk         := .F.
local   nI
local   lMostraHlp  := .F.
local   nTpProb     := 1
local   cVS1CONPRO  := iif( lVS1PERREM, iif( lCarga, VS1->VS1_CONPRO, M->VS1_CONPRO ), "2" )
local   nVS1PERREM  := iif( lVS1PERREM, iif( lCarga, VS1->VS1_PERREM, M->VS1_PERREM ), 0 )
local   cVS1_NUMORC := iif( lCarga, VS1->VS1_NUMORC, M->VS1_NUMORC )
local   dVS1_DATORC := iif( lCarga, VS1->VS1_DATORC, M->VS1_DATORC )
local   cVS1_CENCUS := iif( lCarga, VS1->VS1_CENCUS, M->VS1_CENCUS )
local   cVS1_CLIFAT := iif( lCarga, VS1->VS1_CLIFAT, M->VS1_CLIFAT )
local   cVS1_LOJA   := iif( lCarga, VS1->VS1_LOJA  , M->VS1_LOJA )
local   cVS1_TIPVEN := iif( lCarga, VS1->VS1_TIPVEN, M->VS1_TIPVEN )
local   cVS1_FORPAG := iif( lCarga, VS1->VS1_FORPAG, M->VS1_FORPAG )
local   cVS3_GRUITE := iif( lCarga, VS3->VS3_GRUITE, M->VS3_GRUITE )
local   cVS3_CODITE := iif( lCarga, VS3->VS3_CODITE, M->VS3_CODITE )
local   nVS3_QTDITE := iif( lCarga, VS3->VS3_QTDITE, M->VS3_QTDITE )
local   nVS3_PERDES := iif( lCarga, VS3->VS3_PERDES, M->VS3_PERDES )
local   nVS3_VALTOT := iif( lCarga, VS3->VS3_VALTOT, M->VS3_VALTOT )
local   dDatRefPD  := dDatabase
Private lPrecoFixo := .f. // Preco Fixo - variavel manipulada no OFIXX005 (OX005PERDES)
	...
	if ExistBlock("OXA012LP")
		aIDescont :=  ExecBlock("OXA012LP",.f.,.f.,{ cVS1_NUMORC } )
		for nI := 1 to Len(aIDescont)
			if !aIDescont[nI]
				lOk := .F.
			endif
		next
		...
		If VAI->(DBSeek(xFilial("VAI")+__cUserID))
			...
			If VAI->(FieldPos("VAI_DTCDES")) > 0 // Data para validar a Politica de Desconto
				If VAI->VAI_DTCDES == "1" // Utilizar 1=Data de Inclusão do Orçamento para validar a Politica de Desconto
					dDatRefPD := dVS1_DATORC
				EndIf
			EndIf
		EndIf

		SBM->(dbSetOrder(1))
		SBM->(dbSeek(xFilial("SBM") + cVS3_GRUITE ) )

		SB1->( dbSetOrder(7) )
		SB1->( dbSeek( xFilial("SB1") + cVS3_GRUITE + cVS3_CODITE ) )
		SB1->( dbSetOrder(1) )

		lOk := OX005PERDES(	SBM->BM_CODMAR,;
							cVS1_CENCUS,;
							cVS3_GRUITE,;
							cVS3_CODITE,;
							nVS3_QTDITE,;
		...
		lOk := iif( !lOk .and. nPDescUsu >= nVS3_PERDES+nVS1PERREM, .T., lOk )
...
/*/{Protheus.doc} OX001048C_ComboFase
	Retorna a string do combobox do campo de orçamento por fases

	@author Cristiam Rossi
	@since 29/07/2025
	@type function
	@return character, comboBox do campo Fases do orçamento
/*/
Function OX001048C_ComboFase()
Local  cUniverso := "0123456789ABDEF"
Local  cArea
Local  nI
Local  cLetra
Local  cRet
Static cRetorno  := ""
	...
	if empty( cRetorno )
		cArea := GetArea()
		for nI := 1 to len( cUniverso )
			cLetra := subStr( cUniverso, nI, 1 )
			cRet   := getMV( "MV_FASEOR" + cLetra, .T., "" )

			if ! empty( cRet )
				cRetorno += cLetra + "=" + alltrim( cRet ) + ";"
			endif
		next
		dbSelectArea( cArea )
	endif
...
/*/{Protheus.doc} OX001049C_validFase
    Validação do campo VS1_MVFASE

	@author Cristiam Rossi
	@since 29/07/2025
	@type function
	@return logical, validação do campo VS1_MVFASE
/*/
Function OX001049C_validFase( cValor )
Local  cUniverso := "0123456789ABDEF"
Local  cArea
Local  lOk       := .F.
Local  nI
...
Static cLstFase := ""
	...
	if empty( cValor )
		...
		if empty( cLstFase )
			...
			for nI := 1 to len( cUniverso )
				cLetra := subStr( cUniverso, nI, 1 )
				if ! empty( getMV( "MV_FASEOR" + cLetra, .T., "" ) )
					cLstFase += cLetra
				endif
			next
			dbSelectArea( cArea )
...
/*/{Protheus.doc} OX001051C_replicaDescontos
    replica o % de desconto informado no campo VS1_PERPEC para todos os itens do pedido

	@author Cristiam Rossi
	@since 04/09/2025
	@type function
/*/
function OX001051C_replicaDescontos()
local nI
local nPosPeca := oGetPecas:nAt

	if msgYesNo( STR0485 + CRLF + alltrim(transform(M->VS1_PERPEC, x3Picture("VS1_PERPEC"))) + " %", STR0486 )	// #"Confirma réplica de desconto para todos os itens?"		#"Replicar descontos"
		__ReadVar := 'M->VS3_PERDES'
		for nI := 1 to len( oGetPecas:aCols )
			if ! aTail(oGetPecas:aCols[nI]) .and. empty( oGetPecas:aCols[nI,nVS3MOTPED] )
				oGetPecas:nAt := nI
				FG_MEMVAR(aHeaderP,oGetPecas:aCols,oGetPecas:nAt)
				M->VS3_PERDES := M->VS1_PERPEC
				OX001FPOK(.f./* lMensagem */ ,,.f. /* lRecalc */ ,.f. /* lMsgLotMin */ )
			endif
		next
		oGetPecas:nAt := nPosPeca
		FG_MEMVAR(aHeaderP,oGetPecas:aCols,oGetPecas:nAt)
	endif
return nil

/*/{Protheus.doc} OX0010501_Recargo_do_Item()
	Carrega Vlr.Origem (SEM Recargo)
	Calcula Valor do Recargo e soma no Valor da Peça (VS3_VALPEC)

	@author Andre Luis Almeida
	@since 22/08/2025
	@type function
/*/
Static Function OX0010501_Recargo_do_Item( lDigRecVS3 , lDefRecVS1 )
Local nValRecVS3   := 0
Default lDigRecVS3 := .f. // Digitando o campo de % de Recargo do Item?
Default lDefRecVS1 := .t. // utilizar o % de Recargo Default do VS1
If nVS3VALORI > 0
	If lDigRecVS3 // Digitando o campo de % de Recargo do Item? --> VS3_PERREC
		M->VS3_VALPEC := M->VS3_VALORI := oGetPecas:aCols[oGetPecas:nAt,nVS3VALORI] // Volta Valor de Origem para recalcular o Recargo
	Else // Carrega o Valor de Origem com o Valor da Peça
		oGetPecas:aCols[oGetPecas:nAt,nVS3VALORI] := M->VS3_VALORI := M->VS3_VALPEC // Carrega Vlr.Origem (SEM Recargo) com o Valor da Peça
		M->VS3_PERREC := 0 // Zera Recargo
		If lDefRecVS1 // utilizar o % de Recargo Default do VS1
			M->VS3_PERREC := M->VS1_PERREC // % Default do VS1
		EndIf
	EndIf
	oGetPecas:aCols[oGetPecas:nAt,nVS3PERREC] := M->VS3_PERREC // % de Recargo
	If M->VS3_PERREC > 0
		nValRecVS3 := ( M->VS3_VALPEC * ( M->VS3_PERREC / 100 ) ) // Calcula o Valor de Recargo
	EndIf
	oGetPecas:aCols[oGetPecas:nAt,nVS3VALREC] := M->VS3_VALREC := nValRecVS3
	M->VS3_VALPEC += nValRecVS3 // SOMA Recargo no Valor da Peça (VS3_VALPEC)
EndIf
Return

/*/{Protheus.doc} OX0010511_Preencher_Recargos_nos_Itens()
	Preenche Recargos em todos os Itens do Orçamento

	@author Andre Luis Almeida
	@since 25/08/2025
	@type function
/*/
Static Function OX0010511_Preencher_Recargos_nos_Itens()
Local nCntFor := 0
If MsgYesNo(STR0482+CHR(13)+CHR(10)+CHR(13)+CHR(10)+; // Deseja preencher o Recargo em todos os Itens do Orçamento?
	Alltrim(RetTitle("VS1_PERREC"))+": "+Transform(M->VS1_PERREC,"@E 999.99"),STR0025) // Atencao
	For nCntFor := 1 to Len(oGetPecas:aCols)
		oGetPecas:nAt := nCntFor
		if !oGetPecas:aCols[oGetPecas:nAt,Len(oGetPecas:aCols[oGetPecas:nAt])]
			FG_MEMVAR(aHeaderP,oGetPecas:aCols,oGetPecas:nAt)
			M->VS3_PERREC := M->VS1_PERREC
			__ReadVar := "M->VS3_PERREC"
			OX0010235_Atualiza_Preco_Peca(.t.,__ReadVar)
			M->VS3_QTDITE := oGetPecas:aCols[oGetPecas:nAt,nVS3QTDITE]
			__ReadVar := "M->VS3_QTDITE" // executa o fieldok do VS3_QTDITE novamente
			OX001FPOK(.f.,,.f.,.f.,,.f.)
		EndIf
	Next
