...
Programa para cadastro das Terminologia Unificada da Saúde Suplementar
...
Function MDTA023()
	...
	oBrowse:SetMenuDef( "MDTA023" )		// Nome do fonte onde esta a função MenuDef
	oBrowse:SetDescription( STR0001 )	// Descrição do browse ###"TUSS"
	oBrowse:Activate()
...
Static Function ViewDef()
	...
	oView := FWFormView():New()
		...
		oView:AddField( "VIEW_TY2" , oStructTY2 , "TY2MASTER" )
			...
			oView:EnableTitleView( "VIEW_TY2" , STR0001 )	// Descrição do browse ###"TUSS"
