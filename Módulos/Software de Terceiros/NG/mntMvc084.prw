...
//-------------------------------------------------------------------
/*/  PUBLICACAO DO MNTA084 COMO ENDPOINT                          /*/
//-------------------------------------------------------------------
PUBLISH USER MODEL REST NAME mntVeiculos SOURCE MNTA084 RESOURCE OBJECT oMntMvcVei

//-------------------------------------------------------------------
/*/{Protheus.doc} oMntMvcVei
Classe que extende a FwRestModel, responsável pela configuração do
Model da rotina MNTA084 ( Veiculos )
...
/*/
//-------------------------------------------------------------------
Class oMntMvcVei From FwRestModel
...
/*/
//-------------------------------------------------------------------
Method SetFilter( cFilter ) Class oMntMvcVei
...
/*/
//-------------------------------------------------------------------
Method GetData( lFieldDetail, lFieldVirtual, lFieldEmpty, lFirstLevel, lInternalID ) Class oMntMvcVei
