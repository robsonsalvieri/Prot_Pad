...
@since 05/06/2013 - Revisão: 19/05/2014
@version 2.0
/*/
//---------------------------------------------------------------------
Function MDTA870()
	...
	Else
		oBrowse := FWMBrowse():New()
			...
			oBrowse:SetMenuDef( "MDTA870" )	// Nome do fonte onde esta a função MenuDef
			oBrowse:SetDescription( STR0001 )	// Descrição do browse ###"Delegacias"
		oBrowse:Activate()	
	Endif
...
Static Function ViewDef()
	...
	oView := FWFormView():New()
		...
		oView:AddField( "VIEW_TIE" , oStructTIE , "TIEMASTER" )
			...
			oView:EnableTitleView( "VIEW_TIE" , STR0001 )	// Descrição do browse ###"Delegacias"
