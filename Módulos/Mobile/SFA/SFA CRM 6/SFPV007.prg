...
Local oDlg,oCab,oFldProd,oObs,oObj,oBrwProd,oPrecos,oFldCN
Local aObj := { {},{},{},{},{},{},{} }
...
@ 125,71 BUTTON oObj CAPTION STR0004  ACTION PVGravarPed(aCabPed,aItePed,aColIte,cCondInt,cSfaInd,cSfaFpg) SIZE 40,12 OF oCab //"Gravar"
...
@ 40,03 BUTTON oObj CAPTION STR0006 SIZE 34,10 ACTION PVCond(aCabPed,aObj,aCmpPag,aIndPag,aColIte,aItePed,cCondInt,oFldCN) of oCab  //"Pagto:"
...
@ 40,80 BUTTON oObj CAPTION STR0007 SIZE 34,10 ACTION PVTrocaTab(aCabPed,aObj,aCmpTab,aIndTab,aColIte,aItePed,cCondInt,2,cA1GrpVen) of oCab //"Tabela:"
...
@ 68,03 BUTTON oObj CAPTION STR0009 SIZE 34,10 ACTION SFConsPadrao("HA4",aCabPed[13,1],aObj[2,7],aCmpTra,aIndTra,) of oCab //"Transp:"
...
@ 30,03 BROWSE oBrwProd SIZE 140,60 NO SCROLL ACTION PVSeleciona(oBrwProd,aColIte,aItePed,@nItePed,aCabPed,aObj,cManPrc,cManTes,@nOpIte) of oFldProd
...
@ 92,03 BUTTON oObj CAPTION STR0022 ACTION PVQTde(aObj[3,3],aColIte,aCabPed,aObj[3,5]) SIZE 30,11 of oFldProd //"Qtde."
...
Else
	@ 92,080 BUTTON oObj CAPTION STR0023 ACTION PVPrc(aObj[3,5]) SIZE 33,11 of oFldProd //"Preço"
	AADD(aObj[3],oObj) // 4 - Botao Preco
	@ 92,115 GET oObj VAR aColIte[6,1] PICTURE "@E 9,999.99" VALID PVValidaPrc(aObj[3,5],aColIte,aCabPed,cBloqPrc,aObj[3,7]) SIZE 40,15 of oFldProd
	AADD(aObj[3],oObj) // 5 - Get Preco                                                            
Endif
...
//Monta Folder da condição Negociada
