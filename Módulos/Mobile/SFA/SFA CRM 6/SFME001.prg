...
@130,40 BUTTON oBtnCanc CAPTION STR0008 ACTION CloseDialog() SIZE 50,12 of oDlg //"Cancelar"
@130,100 BUTTON oBtnAvan CAPTION STR0009 ACTION InitPergunta(aScr,oBrwScr) SIZE 50,12 of oDlg //"Iniciar >"
...
ADD COLUMN oCol TO oBrw ARRAY ELEMENT 2 HEADER STR0010	WIDTH 150 //"Respostas"
...
@ 145, 005	BUTTON oBtnCa	CAPTION STR0008		ACTION MECancResp(@lScript)	OF oDlg  //"Cancelar"
@ 145, 060	BUTTON oBtnGr	CAPTION STR0011		ACTION CloseDialog()	OF oDlg  //"Gravar"
...
ADD COLUMN oCol TO oBrw ARRAY ELEMENT 4 HEADER "" WIDTH 10 MARK EDITABLE
//campo descricao da resposta do array   
ADD COLUMN oCol TO oBrw ARRAY ELEMENT 2 HEADER STR0012 WIDTH 50    //"Resposta"

nCol := Len(Alltrim(Str(nPergC)) + "/" + Alltrim(Str(Len(aPergC))))
@135,144 -(nCol*3.33) SAY Alltrim(Str(nPergC)) + "/" + Alltrim(Str(Len(aPergC))) BOLD OF oDlg

@145,05 BUTTON oBtnCa CAPTION STR0008 ACTION MECancResp(@lScript) OF oDlg  //"Cancelar"
@145,60 BUTTON oBtnGr CAPTION STR0011 ACTION MEGrvResp(cCodScr,aPergC,tIni,@lScript) OF oDlg  //"Gravar"
...
@145,005 BUTTON oBtnCa CAPTION STR0008 ACTION MECancResp(@lScript) OF oDlg  //"Cancelar"
@145,060 BUTTON oBtnGr CAPTION STR0011 ACTION MEGrvResp(cCodScr,aPergC,tIni,@lScript) OF oDlg  //"Gravar"
