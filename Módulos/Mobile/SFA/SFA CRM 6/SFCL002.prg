...
@ 18,02 SAY oSay PROMPT STR0010 of oCliPrinc //"Cliente: "
@ 18,74 SAY oSay PROMPT "-" of oCliPrinc
@ 30,02 SAY oSay PROMPT STR0011 of oCliPrinc //"Raz. Social: "
@ 42,02 SAY oSay PROMPT STR0012 of oCliPrinc //"Fantasia: "
@ 54,02 SAY oSay PROMPT STR0013 of oCliPrinc //"Tel.: "
@ 66,02 SAY oSay PROMPT STR0014 of oCliPrinc //"CGC: "
@ 78,02 SAY oSay PROMPT STR0015 of oCliPrinc //"IE: "
@ 90,02 SAY oSay PROMPT STR0016 of oCliPrinc //"E-mail: "


ADD FOLDER oCliEnd CAPTION STR0017 OF oDlg // Folder de Informacoes de Endereco //"Endereco"
@ 18,02 SAY oSay PROMPT STR0018 of oCliEnd //"Endereço: "
@ 30,02 SAY oSay PROMPT STR0019 of oCliEnd //"Bairro: "
@ 42,02 SAY oSay PROMPT STR0020 of oCliEnd //"CEP: "
@ 54,02 SAY oSay PROMPT STR0021 of oCliEnd //"Cidade: "
@ 66,02 SAY oSay PROMPT STR0022 of oCliEnd //"UF: "

@ 132,110 BUTTON oRetornarBt CAPTION STR0023 ACTION CloseDialog() SIZE 50,12 of oDlg //"Cancelar"
...
if nOpCli==3 
	...
	@ 66,50 GET oCGC VAR cCGC READONLY NO UNDERLINE of oCliPrinc
...
Else
	...
	@ 66,50 GET oCGC VAR cCGC SIZE 80,12 of oCliPrinc 
...
//	@ 66,50 GET oUF VAR cUF of oCliEnd
	//PICTURE "@!"
	@ 132,55 BUTTON oGravarBt CAPTION STR0026 ACTION GrvCliente(nOpCli,cCodCli,cLojaCli,cTipo,cRazao,cFantasia,cEndereco,cBairro,cCep,cCidade,cUF,cTel,cCGC,cIE,cEmail,@nTop,aCliente,nCliente,oBrw,nCargMax,nCampo) SIZE 50,12 of oDlg //"Gravar"
	If nOpCli == 2 .And. HA1->A1_STATUS == "N"
		@ 132,01 BUTTON oExcluirBt CAPTION STR0027 ACTION ExcCliente(cCodCli,cLojaCli,@nTop,aCliente,nCliente,oBrw,nCargMax,nCampo) SIZE 50,12 of oDlg //"Excluir"
	Endif
Endif 
