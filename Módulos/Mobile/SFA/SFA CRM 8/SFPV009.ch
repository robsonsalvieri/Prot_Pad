#IFDEF SPANISH
   ...
   #define STR0009 "O valor do preço não pode ser negativo"
#ELSE
   #IFDEF ENGLISH
   ...
   #ELSE
      ...
      #define STR0006 "Preço com Desconto: "
      #define STR0007 "Desconto Inválido"
      #define STR0008 "Para vender abaixo da tabela, favor usar o campo Desconto"
      #define STR0009 "O valor do preço não pode ser negativo"
   #ENDIF
#ENDIF
