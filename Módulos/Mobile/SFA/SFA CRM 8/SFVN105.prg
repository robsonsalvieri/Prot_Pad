...
If !Empty(cCpf)
	...
	EndIf
	If !lCGCRet
		MsgStop(cMsg + STR0010,STR0003) //" Inválido!"###"Verifica Contato"
		Return .F.
	EndIf
Endif
...
Local cResp	:= "", nTam:=0
cResp:= if(MsgYesOrNo(STR0005,STR0006),STR0007,STR0008) //"Você deseja Excluir o Contato Selecionado?"###"Cancelar"###"Sim"###"Não"
If cResp=STR0007             //"Sim"
	...
	If HU5->(Found()) 
		dbDelete()
		dbSkip()
		Alert(STR0009) //"Contato de Cliente Excluído com Sucesso!"
		lAt	:= .T.
	Endif
	CloseDialog()	
Endif
