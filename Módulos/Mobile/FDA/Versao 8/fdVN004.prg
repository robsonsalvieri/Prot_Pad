...
ElseIf nOpCon == 2
	DEFINE DIALOG oDlg TITLE STR0004 //"Alteração do Contato"
ElseIf nOpCon == 3
	DEFINE DIALOG oDlg TITLE STR0005 //"Detalhe do Contato"
EndIf

@ 018,02  SAY oSay PROMPT STR0006  of oDlg //"Codigo: "
@ 032,02  SAY oSay PROMPT STR0007 of oDlg //"Contato: "
@ 046,02  SAY oSay PROMPT STR0008 	  of oDlg //"CPF: "
@ 060,02  SAY oSay PROMPT STR0009  of oDlg //"Função: "
@ 074,02  SAY oSay PROMPT STR0010 	  of oDlg //"Fone: "
@ 088,02  SAY oSay PROMPT STR0011 of oDlg //"Celular: "
@ 102,02  SAY oSay PROMPT STR0012  of oDlg //"E-mail: "
If nOpCon != 3
	@ 116,002 BUTTON oBtnDt CAPTION STR0013 ACTION DtNasc(oDtNasc,dDtNasc) SIZE 30,12 of oDlg  //"Nasc."
Else
	@ 116,002 SAY oSay PROMPT STR0013 of oDlg  //"Nasc."
EndIf
@ 142,108 BUTTON oBtnRetornar CAPTION STR0014 ACTION CloseDialog() SIZE 50,12 of oDlg //"Cancelar"
...
If nOpCon == 3
	...
	@ 142,01 BUTTON oBtnExcluir CAPTION STR0015 ACTION ExcContato(cCodCli,cLojaCli,@cCodCon, @lAt) SIZE 50,12 of oDlg //"Excluir"
Else
	...
	@ 142,55 BUTTON oBtnGravar CAPTION  BTN_BITMAP_GRAVAR SYMBOL ACTION GrvContato(nOpCon,cCodCli,cLojaCli,@cCodCon, cContat,cCpf,aFuncao,nFuncao,cFone,cCelular,cEmail,dDtNasc,@lAt) SIZE 50,12 of oDlg
EndIf
