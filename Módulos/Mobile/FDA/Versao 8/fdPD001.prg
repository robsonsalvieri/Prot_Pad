...
Local oDlg, oGrupo//, aGrupo := {}, nGrupo := 1
...
ADD COLUMN oCol TO oBrw ARRAY ELEMENT 1 HEADER STR0015 WIDTH 50 //"Tabela"
ADD COLUMN oCol TO oBrw ARRAY ELEMENT 2 HEADER STR0016 WIDTH 50 PICTURE "@E 999,999.99" ALIGN RIGHT //"Valor"
...
#IFDEF __PALM__
  @ 115,5 BUTTON oCtrl CAPTION BTN_BITMAP_SEARCH SYMBOL ACTION PD1Find(cPesq,lCodigo,aGrupo,@nGrupo,@cProduto,aControls,oProd,aPrecos,oBox, aPrdPrefix) OF oDlg
#ELSE
  @ 115,5 BUTTON oCtrl CAPTION STR0020 ACTION PD1Find(cPesq,lCodigo,aGrupo,@nGrupo,@cProduto,aControls,oProd,aPrecos,oBox, aPrdPrefix) OF oDlg //"Pesquisar"
#ENDIF
AADD(aControls[3],oCtrl)
@ 115,70 BUTTON oCtrl CAPTION STR0021 ACTION PD1Change(aControls,1,oBox) OF oDlg //"Retornar"
AADD(aControls[3],oCtrl)

PD1ShowHide(aControls,3,.f.)
#IFDEF __PALM__
  @ 144,2   BUTTON oCtrl CAPTION BTN_BITMAP_OK SYMBOL ACTION PD1End(@lRet,cProduto) SIZE 50,15 OF oDlg
#ELSE
...
#IFDEF __PALM__
  ...
  @ 144,108 BUTTON oCtrl CAPTION BTN_BITMAP_SEARCH SYMBOL ACTION PD1Change(aControls,3,oBox) SIZE 50,15 OF oDlg
#ELSE
  @ 144,55  BUTTON oCtrl CAPTION STR0023  ACTION CloseDialog() SIZE 50,15 OF oDlg //"Cancelar"
  @ 144,108 BUTTON oCtrl CAPTION STR0020 ACTION PD1Change(aControls,3,oBox) SIZE 50,15 OF oDlg //"Pesquisar"
#ENDIF
AADD(aControls[1],oCtrl)
AADD(aControls[2],oCtrl)
...
elseif nOpt == 2
  ...
  SetText(oBox,STR0020) //"Pesquisar"
  PD1ShowHide(aControls,1,.f. )
  PD1ShowHide(aControls,2,.f. )
...
@ 112,1 GET oDesc VAR cDesc READONLY NO UNDERLINE SIZE 155,30 OF oDlg
#IFDEF __PALM__
  @ 144,15 BUTTON oBtn CAPTION BTN_BITMAP_OK SYMBOL SIZE 60,15 ACTION PD1Set(aControls,@cProduto,nProduto,cGrupo,oProd,aPrecos,oBox,.t.) OF oDlg
...
#ELSE 
  ...
  @ 144,80 BUTTON oBtn CAPTION STR0024 SIZE 60,15 ACTION CloseDialog() OF oDlg //"CANCEL"
#ENDIF
...
While (!HPR->(Eof()) .And. HPR->HPR_FILIAL == RetFilial("HPR") .and. HPR->HPR_PROD == cProduto)
