...
ADD FOLDER oProd CAPTION STR0004 OF oDlg //"Produtos"

@ 18,1 TO 120,157 CAPTION STR0004 OF oProd //"Produtos"

@ 25,3 GET oPesq VAR cPesq SIZE 152,15 OF oProd
@ 40,3 BUTTON oBtnBusc CAPTION BTN_BITMAP_SEARCH SYMBOL ACTION PD2Find(@cProduto,@nTop,cPesq,aProduto, oBrwProd, @nOrder,aPrecos, oBrwPrc,aDetalhe, oBrwDet, aPrdPrefix) SIZE 35,12 OF oProd
...
#IFDEF __PALM__
   @ 125,2 BUTTON oBtnCanc CAPTION  BTN_BITMAP_CANCEL SYMBOL  ACTION CloseDialog() SIZE 70,15 of oDlg
   @ 125,77 BUTTON oBtnRet CAPTION STR0005 ACTION PD2End(lRet,cProduto)  SIZE 70,15 of oDlg //"Retornar"
#ELSE 
   @ 125,2 BUTTON oBtnCanc CAPTION STR0006  ACTION CloseDialog() SIZE 70,15 of oDlg //"Cancelar"
   @ 125,77 BUTTON oBtnRet CAPTION STR0005 ACTION PD2End(lRet,cProduto)  SIZE 70,15 of oDlg //"Retornar"
#ENDIF 
...
ADD COLUMN oCol TO oBrwProd ARRAY ELEMENT 1 HEADER STR0007 WIDTH 125 //"Descrição"
ADD COLUMN oCol TO oBrwProd ARRAY ELEMENT 2 HEADER STR0008 WIDTH 50 //"Código"


ADD FOLDER oDet CAPTION STR0009 OF oDlg //"Detalhe"
@ 18,1 TO 120,157 CAPTION STR0009 OF oDet //"Detalhe"
...
ADD FOLDER oPrc CAPTION STR0010 OF oDlg //"Preço"
@ 18,1 TO 120,157 CAPTION STR0010 OF oPrc //"Preço"

@ 30,3 BROWSE oBrwPrc SIZE 152,85 OF oPrc
SET BROWSE oBrwPrc ARRAY aPrecos
ADD COLUMN oCol TO oBrwPrc ARRAY ELEMENT 1 HEADER STR0011 WIDTH 40 //"Tabela"
ADD COLUMN oCol TO oBrwPrc ARRAY ELEMENT 2 HEADER STR0012 WIDTH 45 //"Valor"
