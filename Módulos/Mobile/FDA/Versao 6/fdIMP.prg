...
@ Prow()  ,24 PSAY STR0007 + Dtoc(HC5->C5_EMISS)  //"EMISSAO : "
...
@ Prow()  ,40 PSAY STR0011 + HC5->C5_TAB + " - " + HTC->TC_DESCRI //"TABELA : "
...
@ Prow()+2,1  PSAY STR0024 + cNumPed + STR0025 + Dtoc(HC5->C5_EMISS)  //"PEDIDO: "###"		EMISSAO: "
@ Prow()+1,1  PSAY STR0026 + HC5->C5_CLI + "/" + HC5->C5_LOJA + "-" + Alltrim(HA1->A1_NOME) //"CLIENTE: "
@ Prow()+1,1  PSAY STR0027 + HC5->C5_VEND1 + "-" + Alltrim(HA3->A3_NREDUZ) //"VENDEDOR: "
@ Prow()+1,1  PSAY STR0028 + HC5->C5_COND + "-" + Alltrim(HE4->E4_DESCRI) //"COND. PAGTO.: "
@ Prow()+1,1  PSAY STR0029 + HC5->C5_TAB + "-" + Alltrim(HTC->TC_DESCRI) //"TABELA: "
@ Prow()+1,1  PSAY STR0030 + HC5->C5_TRANSP + "-" + Alltrim(HA4->A4_NOME) //"TRANSP.: "
...
@ Prow()+1,1 PSAY Replicate("_",42) 
@ Prow()+1,1 PSAY STR0035 + Str(HC5->C5_VALOR,9,2) //"TOTAL PEDIDO: "
