...
//  Function CarregaDLL(vAPIPath : String) : Boolean;
  ...
  Function  AP5CreateConnControl(cServer: AnsiString; nPort: integer;
     cEnvironment, cUser, cPassWord: AnsiString): integer; stdcall; external 'APAPI.DLL';
  Function  AP5DestroyConnControl(ObjectID: integer): boolean; stdcall; external 'APAPI.DLL';
  Function  AP5Connect(ObjectID: integer): boolean; stdcall; external 'APAPI.DLL';
  Procedure APSecure(ObjectID: integer; value: boolean); stdcall; external 'APAPI.DLL';
  Procedure AP5Disconnect(ObjectID: integer); stdcall; external 'APAPI.DLL';
  Function  AddNumericParam(ObjectID: integer; value: double): boolean; stdcall; external 'APAPI.DLL';
  Function  AddStringParam(ObjectID: integer; value: AnsiString): boolean; stdcall; external 'APAPI.DLL';
  Function  ResultAsString( ObjectID: integer; cResult: PAnsiChar; nSize: integer): integer; stdcall; external 'APAPI.DLL';
  Function  CallProc(ObjectID: integer; cFunction: AnsiString): boolean; stdcall; external 'APAPI.DLL';
...
Begin
   ...
   While Not LeArquivo(cServer, cAmbiente, cPort, cUser,
                       cPass, cEmpresa, cFilial, cArqAPI) And Not bCancelou Do
   Begin
   ...
   Begin
      ...
      Begin
         ...
         WriteLog2(' AP5Connect - função CallProc -> preencheu ' +
                            'a variável interna ptrBuffProd ->' + ptrBuffProd);
