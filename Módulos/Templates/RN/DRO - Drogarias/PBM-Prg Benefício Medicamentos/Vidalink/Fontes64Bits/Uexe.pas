...
function RetProdProtheus(sCateg, sKey : AnsiString; byTrataPeso,
       ...
       var ptrBuffProd: AnsiString; prtBuffAssoc : AnsiString ): ShortInt; stdcall; external 'TotvsVida64.dll';
procedure ShowDLLForm; external 'TotvsVida64.dll';
procedure HideDLLForm; external 'TotvsVida64.dll';
procedure SetApplicationHandle(Handle: HWnd); external 'TotvsVida64.dll';
procedure Desconectar; external 'TotvsVida64.dll';
