...
ฑฑบPrograma   ณDROEDIPC    บAutor  ณCarlos A. Gomes Jr.          บ Data ณ  07/05/04   บฑฑ
ฑฑฬอออออออออออุออออออออออออสอออออออฯอออออออออออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.      ณ Configura็ใo dos arquivos EDI de Pedido de Compras (Somente Envio)    บฑฑ
...
cHelp1 := "Help Cabe็alho"+CTRL+CTRL+"Preencher os dados do cabe็alho a serem gravados no arquivo de envio."+CTRL
cHelp1 += "Os campos devem, obrigatoriamente, apresentar o alias do arquivo. Ex: SC7->C7_NUM"
cHelp2 := "Help อtens"+CTRL+CTRL+"Preencher os detalhes a serem exportados pelo processo EDI de "+CTRL
cHelp2 += "compras. Os campos devem, obrigatoriamente, apresentar o alias do arquivo. Ex: SC7->C7_ITEM"
cHelp3 := "Help Rodap้"+CTRL+CTRL+"Preencher os dados do rodap้ a serem gravados no arquivo de envio."+CTRL
...
Aadd(aHeader,{"Tipo"            ,"TMP_TIPO"   ,"@!" ,__TAMTIPO   ,0,,,"C",,"V","1=Caracter;2=Num้rico;3=Data;4=Logico","1"})  //6
Aadd(aHeader,{"Conte๚do"        ,"TMP_CONTE"  ,"@!" ,__TAMCONT   ,0,,,"C",,"V"})  //7
Aadd(aHeader,{"Picture"         ,"TMP_PICTURE","@!" ,__TAMPICTURE,0,,,"C",,"V"})  //8
Aadd(aHeader,{"Zeros เ esquerda","TMP_ZEROS"  ,"@!" ,__TAMZEROS  ,0,,,"C",,"V","1=Sim;2=Nใo","2"})  //9-Indica se deve gerar o registro com zeros a esquerda 
                                             
DEFINE MSDIALOG oDlg FROM  1,1 TO 480,640 TITLE "Configurador de Layout para Exporta็ใo de Pedidos de Compras" Pixel
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณAtuTamPC  บAutor  ณCarlos A. Gomes Jr. บ Data ณ  10/05/04   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณVlLinEDPC บAutor  ณCarlos A. Gomes Jr. บ Data ณ  10/05/04   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
	...
	If File(cArq)
		...
		If Len(aRestore) == 4
         ...
         If ((Len(oGd1:aCols) == 1 .And. Empty(oGd1:aCols[1,1])) .And. ;
               (Len(oGd2:aCols) == 1 .And. Empty(oGd2:aCols[1,1])) .And.; 
               (Len(oGd3:aCols) == 1 .And. Empty(oGd3:aCols[1,1])) )
               MsgInfo("Nใo foi possํvel realizar a importa็ใo, pois nใo possui layout vแlido no arquivo!!!","Importa็ใo de Layout")
         EndIf
