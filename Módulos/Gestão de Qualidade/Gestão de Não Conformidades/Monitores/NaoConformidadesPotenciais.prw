...
/*/{Protheus.doc} NaoConformidadesPotenciais
...
@return Nil
/*/
Class NaoConformidadesPotenciais FROM LongNameClass
...
/*/
Method CargaMonitor() Class NaoConformidadesPotenciais
    Local lRet        := .T.
    Local nIndTag     := 0
    ...
    If !PCPMonitorCarga():monitorAtualizado("NaoConformidadesPotenciais")
        ...
        oExemplo := OcorrenciasDeMelhoriasQNC():MontaJsonInfo(@oExemplo,123,{"10","0"},"1")
...
/*/
Method BuscaDados(oFiltros, cTipo, cSubTipo) Class NaoConformidadesPotenciais
    Local cTpFicha := "1"
...
/*/
Method BuscaDetalhes(oFiltros, nPagina, cTpFicha) Class NaoConformidadesPotenciais
       Local cTpFicha := "1"
...
/*/
Method ValidaPropriedades(oFiltros) Class NaoConformidadesPotenciais
