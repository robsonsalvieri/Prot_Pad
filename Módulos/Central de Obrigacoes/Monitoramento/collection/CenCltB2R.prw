...
Class CenCltB2R from CenCollection
...
Method New() Class CenCltB2R
    _Super:new()
    self:oMapper := CenMprB2R():New()
    self:oDao := CenDaoB2R():New(self:oMapper:getFields())
return self

Method initEntity() Class CenCltB2R
return CenB2R():New()

Method initRelation() Class CenCltB2R
