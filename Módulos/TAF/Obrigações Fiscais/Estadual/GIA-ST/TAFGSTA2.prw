...
Function TAFGSTA2 (aWizard as array, aFilial as array, cJobAux as char)
...
Begin Sequence	
	...
	BeginSql Alias cAliasR
	   SELECT C20.C20_NUMDOC C20_NUMDOC, 
        ...
        WHERE C20.C20_FILIAL = %Exp:aFilial[1]%
		  ...
		  AND C0Y.C0Y_CODIGO IN ( %Exp:'1603'%, %Exp:'2603'% ) 							//CFOP - RESSARCIMENTO
	...
	PutGlbValue( "nQtdAnxII_"+aFilial[1] , Str(nTotLin) )
	GlbUnlock()
