...
±±³Funcao    ³ GPEW015  ³ Autor ³ Totvs                      ³ Data ³ 08/04/2014 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡…o ³Workflow FLUIG - Transferencia                               ³±±
...
//-------------------------------------------------------------------
/*/{Protheus.doc} GPEW015()
WF Solicitação Transferencia - TIPO 4(Portal)
...
Static Function ViewDef()
	...
	Local aStr			:= { "RE_FILIALD","RE_MATD","RE_EMPP","RE_FILIALP","RE_MATP","TMP_NOME","RE_CCP","TMP_DCCP","RE_DEPTOP",;
							"TMP_DDEPTO","RE_PROCESS","TMP_DPROCP","RE_POSTOP"}
	Local aFields 		:= {}
