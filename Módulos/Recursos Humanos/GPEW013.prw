...
//-------------------------------------------------------------------
/*/{Protheus.doc} GPEW013()
WF Solicitação Postos - TIPO 3(Portal)
...
Static Function ViewDef()
	...
	Local aStr			:={	"RBT_FILIAL","RBT_CODMOV","RBT_DEPTO" ,"TMP_DDEPTO","RBT_CC"    ,"TMP_DCC"   ,"RBT_FUNCAO","TMP_DFUNCA","RBT_CARGO" ,;
							"TMP_DCARGO","RBT_PROCES","RBT_REMUNE","RBT_TPOSTO","RBT_TPCONT","RBT_QTDMOV","RBT_JUSTIF" ,;
