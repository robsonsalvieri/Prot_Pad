...
begin
    ...
    */
    If @IN_CALIAS = 'CQ4' begin
        ...
        for read only
        Open CUR_CTD
        Fetch CUR_CTD into  @cFILCT2, @cITEM, @cMOEDA, @cDATA, @cCT2_DTLP, @cCTX_LP, @nVALORDeb, @nVALORCred
		...
		for read only
	    Open CUR_CQD
	    Fetch CUR_CQD into  @cFILCT2, @cIdent, @cCodigo, @cMOEDA, @cDATACQ, @cCT2_DTLP, @cCTX_LP, @nVALORDeb, @nVALORCred
    ...
    */
    If @IN_CALIAS = 'CQ6' begin
        ...
        for read only
        Open CUR_CTH
        Fetch CUR_CTH into  @cFILCT2, @cCLVL, @cMOEDA, @cDATA, @cCTX_LP, @cCT2_DTLP,@nVALORDeb, @nVALORCred
		...
		for read only
	    Open CUR_CQH
	    Fetch CUR_CQH into @cFILCT2, @cIdent, @cCodigo, @cMOEDA, @cDATACQ, @cCT2_DTLP, @cCTX_LP, @nVALORDeb, @nVALORCred
