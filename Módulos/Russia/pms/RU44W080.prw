...
/*MAINTENANCE FOR Project Teams (simple model to be used in web forms for VISUALIZATION)*/

PUBLISH MODEL REST NAME RU44W080 RESOURCE OBJECT oRU44W080

/*/{Protheus.doc} oRU44W080
description
@type class
@version  
@author
@since 03/07/2023
/*/
Class oRU44W080 From FwRestModel
...
/*/{Protheus.doc} oRU44W080::Activate
description
@type method
@version  
@author 
...
/*/
Method Activate() Class oRU44W080
...
/*/{Protheus.doc} oRU44W080::DeActivate
description
@type method
@version  
@author
...
@return variant, return_description
/*/
Method DeActivate() Class oRU44W080
...
@return variant, return_description
/*/
Method Seek(cPK) Class oRU44W080
...
Method GetData() Class oRU44W080
	Local cRet := self:cResponse
Return cRet

Method Skip() Class oRU44W080
Return .F.

Method StartGetFormat(nTotal, nCount, nStartIndex) Class oRU44W080
...
/*/
//-------------------------------------------------------------------
Method EndGetFormat() Class oRU44W080
...
/*/
Method DelData(cPk,cError) Class oRU44W080
    Local lRet      := .T.
    Default cData   := ""
...
/*/
Method SaveData(cPk,cData,cError) Class oRU44W080
    Local lRet      := .T.
    Default cData   := ""
...
Static Function MenuDef()
	Local aRotina := {}
	aAdd( aRotina, { STR0002   , 'VIEWDEF.RU44W080', 0, 2, 0, NIL } )
	aAdd( aRotina, { STR0003   , 'VIEWDEF.RU44W080', 0, 3, 0, NIL } )
	aAdd( aRotina, { STR0004   , 'VIEWDEF.RU44W080', 0, 4, 0, NIL } )
	aAdd( aRotina, { STR0005   , 'VIEWDEF.RU44W080', 0, 5, 0, NIL } )
...
// Cria a estrutura a ser usada no Modelo de Dados
	...
	oStruAED := FWFormStruct( 1, 'AED' ,/* { |x| ALLTRIM(x) $ ' AF9_PROJETO, AF9_REVISA, AF9_EDTPAI, AF9_TAREFA, AF9_DESCRI, AF9_NIVEL, AF9_GRPCOM,AF9_REQ, AF9_START, AF9_FINISH, AF9_HDURAC,AF9_OBS,' } */ )
	oModel := MPFormModel():New('RU44W080',,,)

	oModel:AddFields( 'AEDMASTER', /*cOwner*/, oStruAED)
	oModel:SetPrimarykey({'AED_EQUIP'})
...
// Cria um objeto de Modelo de dados baseado no ModelDef() do fonte informado
	Local oModel := FWLoadModel( 'RU44W080' )
// Cria a estrutura a ser usada na View
	Local oStruAED := FWFormStruct( 2, 'AED' )
// Interface de visualiza??o constru?da
	Local oView

	oStruAED:SetNoFolder()
...
// (antiga Enchoice)
	oView:AddField( 'VIEW_AED', oStruAED, 'AEDMASTER' )

// Criar um "box" horizontal para receber algum elemento da view
	oView:CreateHorizontalBox( 'HEADER' , 100 )
// Relaciona o identificador (ID) da View com o "box" para exibi??o
	oView:SetOwnerView( 'VIEW_AED', 'HEADER' )
