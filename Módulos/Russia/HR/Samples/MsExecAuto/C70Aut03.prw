...
BEGIN TRANSACTION
	...
	aadd(aAutoCab,  {"RBR_DESCTA" 		,cArea+" - Тариф03"				,Nil		})
	...
	aadd(aAtLvl0101,{"RB6_DESCTA" 		,cArea+" - Тариф03"				,Nil		})
	...
	aadd(aAtLvl0102,{"RB6_DESCTA" 		,cArea+" - Тариф03"				,Nil		})
	...
	aadd(aAtLvl0201,{"RB6_DESCTA" 		,cArea+" - Тариф03"				,Nil		})
	...
	aadd(aAtLvl0202,{"RB6_DESCTA" 		,cArea+" - Тариф03"				,Nil		})
	...
	aadd(aAtLvl0301,{"RB6_DESCTA" 		,cArea+" - Тариф03"				,Nil		})
	...
	aadd(aAtLvl0302,{"RB6_DESCTA" 		,cArea+" - Тариф03"				,Nil		})
	...
	aadd(aAtLvl0401,{"RB6_DESCTA" 		,cArea+" - Тариф03"				,Nil		})
	...
	aadd(aAtLvl0402,{"RB6_DESCTA" 		,cArea+" - Тариф03"				,Nil		})
	...
	aadd(aAtLvl0501,{"RB6_DESCTA" 		,cArea+" - Тариф03"				,Nil		})
	...
	aadd(aAtLvl0502,{"RB6_DESCTA" 		,cArea+" - Тариф03"				,Nil		})
	...
	aadd(aAtLvl0601,{"RB6_DESCTA" 		,cArea+" - Тариф03"				,Nil		})
	...
	aadd(aAtLvl0602,{"RB6_DESCTA" 		,cArea+" - Тариф03"				,Nil		})
	...
	aadd(aAtLvl0701,{"RB6_DESCTA" 		,cArea+" - Тариф03"				,Nil		})
	...
	aadd(aAtLvl0702,{"RB6_DESCTA" 		,cArea+" - Тариф03"				,Nil		})
	...
	aadd(aAtLvl0801,{"RB6_DESCTA" 		,cArea+" - Тариф03"				,Nil		})
	...
	aadd(aAtLvl0802,{"RB6_DESCTA" 		,cArea+" - Тариф03"				,Nil		})
	...
	aadd(aAtLvl0901,{"RB6_DESCTA" 		,cArea+" - Тариф03"				,Nil		})
	...
	aadd(aAtLvl0902,{"RB6_DESCTA" 		,cArea+" - Тариф03"				,Nil		})
	...
	aadd(aAtLvl1001,{"RB6_DESCTA" 		,cArea+" - Тариф03"				,Nil		})
	...
	aadd(aAtLvl1002,{"RB6_DESCTA" 		,cArea+" - Тариф03"				,Nil		})
