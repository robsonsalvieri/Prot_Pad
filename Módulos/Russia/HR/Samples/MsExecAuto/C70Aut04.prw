...
BEGIN TRANSACTION
	...
	aadd(aAutoCab,  {"RBR_DESCTA" 		,cArea+" - Тариф04"				,Nil		})
	...
	aadd(aAtLvl0101,{"RB6_DESCTA" 		,cArea+" - Тариф04"				,Nil		})
	...
	aadd(aAtLvl0102,{"RB6_DESCTA" 		,cArea+" - Тариф04"				,Nil		})
	...
	aadd(aAtLvl0201,{"RB6_DESCTA" 		,cArea+" - Тариф04"				,Nil		})
	...
	aadd(aAtLvl0202,{"RB6_DESCTA" 		,cArea+" - Тариф04"				,Nil		})
