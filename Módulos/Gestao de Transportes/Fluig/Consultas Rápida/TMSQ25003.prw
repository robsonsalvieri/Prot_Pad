...
#include "tmsq25003.ch"

QSSTRUCT TMSQ25003 DESCRIPTION STR0001 MODULE 43 //CONTRATOS A LIBERAR
 
QSMETHOD INIT QSSTRUCT TMSQ25003 
...
QSFILTER STR0008 WHERE "DTY_STATUS = '2' AND DTY.DTY_DATCTC = '"+DTOS(dData)		+"'" //Ultimo dia 
QSFILTER STR0009 WHERE "DTY_STATUS = '2' AND DTY.DTY_DATCTC > '"+DTOS(dData-7)  	+"'" //Ultimos 7 dias
QSFILTER STR0010 WHERE "DTY_STATUS = '2' AND DTY.DTY_DATCTC > '"+DTOS(dData-30)	+"'" //Ultimos 30 dias 		
QSFILTER STR0011 WHERE "DTY_STATUS = '2' AND DTY.DTY_DATCTC > '"+DTOS(dData-365)	+"'	" //Ultimos 365 dias
