...
#include "tmsq20006.ch"

QSSTRUCT TMSQ20006 DESCRIPTION STR0001 MODULE 43 //"DOCUMENTOS EM VIAGENS"
 
QSMETHOD INIT QSSTRUCT TMSQ20006
...
QSFIELD "DT6_NUM"				LABEL STR0008 //"Num. Titulo"
QSFIELD "DT6_STATUS"			LABEL STR0009 //"Status"	
	
QSACTION MENUDEF "TMSA500" OPERATION 2 LABEL STR0010 //"Visualizar"
		
QSFILTER STR0011				WHERE "DT6_SERTMS <> '1' AND DT6_STATUS = '3' AND DT6_DATEMI = '"+DTOS(dData)		+"'" //"Ultimo dia"
QSFILTER STR0012				WHERE "DT6_SERTMS <> '1' AND DT6_STATUS = '3' AND DT6_DATEMI > '"+DTOS(dData-7)  	+"'" //"Ultimos 7 dias"
QSFILTER STR0013				WHERE "DT6_SERTMS <> '1' AND DT6_STATUS = '3' AND DT6_DATEMI > '"+DTOS(dData-30)	+"'" //"Ultimos 30 dias"
QSFILTER STR0014				WHERE "DT6_SERTMS <> '1' AND DT6_STATUS = '3' AND DT6_DATEMI > '"+DTOS(dData-360)	+"'" //"Ultimos 365 dias"
