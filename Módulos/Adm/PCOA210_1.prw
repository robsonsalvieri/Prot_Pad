...
±±ºPrograma  ³PCOA210_1 ºAutor  ³Paulo Carnelossi    º Data ³  11/11/05   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³Rotina para inclusao/alteracao de restricao de acesso para  º±±
±±º          ³configuracao de cubo(utiliza mesmo controle acesso por      º±±
±±º          ³entidade                                                    º±±
