...
Function FINSV027() 
    ...
    if !FWSX1Util():ExistPergunte("FINR350")
		FINSV027HLP()
        return
	endIf
    ...
    If GetRpoRelease() > '12.1.2210'
        ...
        lSuccess := totvs.framework.treports.callTReports("backoffice.sv.fin.suppliersituation",,,,,.F.,,.T., @cError)
        If !lSuccess
            Conout(cError)
        EndIf
    Else
...
/*/{Protheus.doc} FINSV027HLP
    Exibe Finhelp na chamada do menu FINSV027

    @author guilhermed.santos@totvs.com.br
    @since 19/12/2024
    @version 12.1.2410
*/
static function FINSV027HLP()
	...
	cTitulo  := STR0001 + " - " + STR0002 //FINSV027 - Posição de fornecedores

	cMsg := "<font size='5' color='"+ cColorTitle +"'><b>" + STR0003 + " - " + STR0001 + "</b></font><br/><br/>"//HELP - FINSV027

	cMsg += "<font size='3' color='"+ cColorSubTitle +"'><b>" + STR0004 + "</b></font><br/>" //Ocorrência
	cMsg += "<font size='3' color='"+ cColorText +"'>" + STR0005 + "</font><br/><br/>"//Grupo de perguntas FINR350 ausente.
	...
	aBtLinks[1,1] :=  STR0009 + " - " + STR0001 //Documento de referência - FINSV027
