	...
	If nOperation == MODEL_OPERATION_INSERT
		...
		If lRet
			...
			For nX := 1 To oModelDOP:Length()
				...
				If lRet .And. !F999SldOP(oModelDOP:GetValue("NSALDOPGOP",nX), oModelDOP:GetValue("DOCTERPA",nX), nMoeda)
					lRet := .F.
					Exit
				EndIf
...
/*/
Function F999SldOP(nSaldo, lGenPa, nMoeda)
Local lRet  := .T.
...
Default nMoeda := 1
	...
	If nSaldo != 0 .And. !(nSaldo < 0 .And. lGenPA)
		Help(,,STR0040,,; // "Aviso"
