...
±±ºPrograma  ³PCOA210_2 ºAutor  ³Paulo Carnelossi    º Data ³  11/11/05   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³Rotina para exclusao de restricao de acesso p/ configuracao º±±
±±º          ³de cubo(utiliza mesmo controle acesso por entidade          º±±
...
If SuperGetMV("MV_PCO_AL3",.F.,"2")=="1"  //1-Verifica acesso por entidade
	PcoAcess_CfgCubo(5)                   // 2-Nao verifica o acesso por entidade
Else
	Aviso(STR0007,STR0019, {"Ok"}) //"Atencao"###"Para ativar a exclusao de acesso por Configuracao de Cubo devera ser ativado o parametro MV_PCO_AL3."
EndIf
