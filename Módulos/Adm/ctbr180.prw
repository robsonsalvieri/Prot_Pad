...
TRCell():New(oSection2,"SALDODEB"	,"cArqTmp",STR0031,/*Picture*/,TAM_VALOR+2		,/*lPixel*/,{|| ValorCTB(cArqTmp->SALDODEB ,,,TAM_VALOR  ,nDecimais,.F.,cPicture,cArqTmp->NORMAL,,,,,,lPrintZero,.F.,lColDbCr)}, /*"RIGHT"*/,,"RIGHT",,,.F.)// Debito //"Débito"
TRCell():New(oSection2,"SALDOCRD"	,"cArqTmp",STR0032,/*Picture*/,TAM_VALOR+2		,/*lPixel*/,{|| ValorCTB(cArqTmp->SALDOCRD ,,,TAM_VALOR  ,nDecimais,.F.,cPicture,cArqTmp->NORMAL,,,,,,lPrintZero,.F.,lColDbCr)}, /*"RIGHT"*/,,"RIGHT",,,.F.)// Credito //"Crédito"
...
TRCell():New( oTotais,"TOT_ANT"		,,STR0030	,/*Picture*/,TAM_VALOR+2,/*lPixel*/,/*{|| code-block de impressao }*/) //"A N T E R I O R"
TRCell():New( oTotais,"TOT_DEBITO"	,,STR0031	,/*Picture*/,TAM_VALOR+2,/*lPixel*/,/*{|| code-block de impressao }*/) //"D E B I T O    "
TRCell():New( oTotais,"TOT_CREDITO"	,,STR0032	,/*Picture*/,TAM_VALOR+2,/*lPixel*/,/*{|| code-block de impressao }*/) //"C R E D I T O  "
...
aParam := {	"R",;		//Tipo R para relatorio P para processo
			"CTR180",;	//Nome do grupo de perguntas (SX1)
