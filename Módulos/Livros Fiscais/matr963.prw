...
Local cTitle	:= STR0001		//Manutenção CIAP   
Local cDesc		:= STR0002		//Este relatório apresenta uma relação com os bens lançados na Manutenção CIAP.
