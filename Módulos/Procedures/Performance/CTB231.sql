      ...
      While (@@Fetch_status = 0 ) begin
         ...
         If @iRecno = 0 begin
            ...
            ##CHECK_TRANSACTION_BEGIN @IN_TRANSACTION\
               If @cTIPO = '1' begin
                  Update CQ5###
                     set CQ5_DEBITO = CQ5_DEBITO + @nCTX_DEBITO
                  Where R_E_C_N_O_ = @iRecno
               End
               If @cTIPO = '2' begin
                  Update CQ5###
                     set CQ5_CREDIT  = CQ5_CREDIT + @nCTX_CREDIT
                  Where R_E_C_N_O_ = @iRecno
               End
            ##CHECK_TRANSACTION_COMMIT
         /* ---------------------------------------------------------------
         ...
         if @cCT2_DTLP != ' ' begin
            ...
            select @cIdent  = ' '
            select @cTabela = 'CQ5'
            Exec CTB025_##  @cFilial_CQ5, @cTabela, @cIdent, @cCONTA, @cCUSTO, @cITEM, @cCLVL, @cCT2_DTLP, @cMOEDA, @IN_TPSALDO, @IN_EMPANT,@IN_FILIAL, @IN_TRANSACTION, @OUT_RESULTADO OutPut
         ...
         If @cFilAnt = @cFILCT2 and @cContaAnt = @cCONTA and @cCustoAnt = @cCUSTO and @cItemAnt = @cITEM and @cMoedaAnt = @cMOEDA and @cAnoMes = SUBSTRING( @cDATA, 1, 6 ) and @cDtLpAnt = @cCT2_DTLP  begin
            ...
            If @iRecno = 0 begin
               ...
               Insert into CQ4### ( CQ4_FILIAL,   CQ4_CONTA,  CQ4_CCUSTO, CQ4_ITEM,  CQ4_MOEDA,  CQ4_DATA, CQ4_TPSALD,  CQ4_SLBASE,   CQ4_DTLP,   CQ4_LP, CQ4_STATUS,   CQ4_DEBITO, CQ4_CREDIT, R_E_C_N_O_ )
							    values( @cFilial_CQ4, @cContaAnt, @cCustoAnt, @cItemAnt, @cMoedaAnt, @cDataF,  @IN_TPSALDO, @cCTX_SLBASE, @cCTX_DTLP, @cCTX_LP, @cCTX_STATUS, 0, 0,   @iRecno )
               ##CHECK_TRANSACTION_COMMIT
               ##FIMTRATARECNO
                end
               /*---------------------------------------------------------------
            ...
            if @cCTX_DTLP != ' ' begin
               ...
               select @cIdent  = ' '
               select @cTabela = 'CQ4'
               Exec CTB025_##  @cFilial_CQ4, @cTabela, @cIdent, @cContaAnt, @cCustoAnt, @cItemAnt, @cCLVL, @cCTX_DTLP, @cMoedaAnt, @IN_TPSALDO, @IN_EMPANT,@IN_FILIAL, @IN_TRANSACTION, @OUT_RESULTADO OutPut
            End
         end
      end
      close CUR_CT4
      ...
      While (@@Fetch_status = 0 ) begin
         ...
         If @iRecno = 0 begin
            ...
            ##CHECK_TRANSACTION_BEGIN @IN_TRANSACTION\
               If @cTIPO = '1' begin
                  Update CQ7###
                     set CQ7_DEBITO = CQ7_DEBITO + @nCTX_DEBITO
                  Where R_E_C_N_O_ = @iRecno
               End
               If @cTIPO = '2' begin
                  Update CQ7###
                     set CQ7_CREDIT  = CQ7_CREDIT + @nCTX_CREDIT
                  Where R_E_C_N_O_ = @iRecno
               End
            ##CHECK_TRANSACTION_COMMIT
         /* ---------------------------------------------------------------
         ...
         if @cCT2_DTLP != ' ' begin
            ...
            select @cTabela = 'CQ7'
            select @cIdent  = ' '
            Exec CTB025_##  @cFilial_CQ7, @cTabela, @cIdent, @cCONTA, @cCUSTO, @cITEM, @cCLVL, @cCT2_DTLP, @cMOEDA, @IN_TPSALDO, @IN_EMPANT,@IN_FILIAL, @IN_TRANSACTION, @OUT_RESULTADO OutPut
         end
         /*---------------------------------------------------------------
         ...
         If @cFilAnt = @cFILCT2 and @cContaAnt = @cCONTA and @cCustoAnt = @cCUSTO and @cItemAnt = @cITEM and @cClvlAnt = @cCLVL and @cMoedaAnt = @cMOEDA and @cAnoMes = SUBSTRING( @cDATA, 1, 6 ) and @cDtLpAnt = @cCT2_DTLP  begin
            ...
            If @iRecno = 0 begin
               ...
               Insert into CQ6### ( CQ6_FILIAL,   CQ6_CONTA,  CQ6_CCUSTO, CQ6_ITEM,  CQ6_CLVL,  CQ6_MOEDA,  CQ6_DATA, CQ6_TPSALD,  CQ6_SLBASE,   CQ6_DTLP,   CQ6_LP, CQ6_STATUS,   CQ6_DEBITO, CQ6_CREDIT,  R_E_C_N_O_ )
							    values( @cFilial_CQ6, @cContaAnt, @cCustoAnt, @cItemAnt, @cClvlAnt, @cMoedaAnt, @cDataF,   @IN_TPSALDO, @cCTX_SLBASE, @cCTX_DTLP, @cCTX_LP, @cCTX_STATUS, 0,   0,    @iRecno )
               ##CHECK_TRANSACTION_COMMIT
               ##FIMTRATARECNO
                end
               /*---------------------------------------------------------------
            ...
            if @cCTX_DTLP != ' ' begin
               select @cTabela = 'CQ6'
               select @cIdent  = ' '
               Exec CTB025_##  @cFilial_CQ6, @cTabela, @cIdent, @cContaAnt, @cCustoAnt, @cItemAnt, @cClvlAnt, @cCTX_DTLP, @cMoedaAnt, @IN_TPSALDO, @IN_EMPANT, @IN_FILIAL, @IN_TRANSACTION, @OUT_RESULTADO OutPut
            end
         end
      end
      close CUR_CTI
