...
begin
   ...
   Declare CUR_CUBO190B insensitive cursor for
    Select CT2_FILIAL, Substring( CT2_DATA, 1, 6 ), CT2_MOEDLC, CT2_DEBITO, CT2_CCD, CT2_ITEMD, CT2_CLVLDB,CT2_TPSALD,
       ...
       Group By CT2_FILIAL, Substring( CT2_DATA, 1, 6 ), CT2_MOEDLC, CT2_DEBITO, CT2_CCD, CT2_ITEMD, CT2_CLVLDB,CT2_TPSALD
           ...
           ##ENDFIELDP21
       Union
      Select CT2_FILIAL, Substring( CT2_DATA, 1, 6 ), CT2_MOEDLC, CT2_CREDIT, CT2_CCC, CT2_ITEMC, CT2_CLVLCR,CT2_TPSALD,
      ...
      Group By CT2_FILIAL, Substring( CT2_DATA, 1, 6 ), CT2_MOEDLC, CT2_CREDIT, CT2_CCC, CT2_ITEMC, CT2_CLVLCR,CT2_TPSALD
   ...
   for read only
   Open CUR_CUBO190B
   Fetch CUR_CUBO190B into  @cFILCT2, @cDATAP, @cMOEDA, @cCONTA, @cCUSTO, @cITEM, @cCLVL,@cTPSALD,
   ...
   While (@@Fetch_status = 0 ) begin
      ...
      /* ---------------------------------------------------------------
         ...
         --------------------------------------------------------------- */
      If ((@cFILCT2||@cMOEDA||@cCONTA||@cDATAP||@cTPSALD) != (@cFILCT2Ant||@cMOEDAAnt||@cCONTAAnt||@cDATAPAnt||@cTPSALDAnt)) begin
         select @cConfig = '01'
         ...
         If @lCubo01 = '1' begin
            If @cCONTAAnt != ' ' begin
               ...
               Exec CTB210_## @cFILCT2Ant, @cDATA, @cMOEDAAnt, @cTPSALDAnt, @cCONTAAnt, @cNivAux, @cNivAux, @cNivAux,
                        ...
                        ##FIELDP51( 'CT2.CT2_EC09DB' )
                         @cNivAux,
                        ##ENDFIELDP51
                        @cConfig, @cAtu, @nTContaDebM, @nTContaCrdM, @IN_TRANSACTION
      ...
      /* ---------------------------------------------------------------
         ...
         --------------------------------------------------------------- */
      If ((@cFILCT2||@cMOEDA||@cCONTA||@cCUSTO||@cDATAP||@cTPSALD) != (@cFILCT2Ant||@cMOEDAAnt||@cCONTAAnt||@cCUSTOAnt||@cDATAPAnt||@cTPSALDAnt)) begin
         select @cConfig = '02'
         ...
         If @lCubo02 = '1' begin
            If @cCONTAAnt != ' ' begin
               Select @cDATA = @cDATAPAnt||'01'
               Exec CTB210_## @cFILCT2Ant, @cDATA, @cMOEDAAnt, @cTPSALDAnt, @cCONTAAnt, @cCUSTOAnt, @cNivAux, @cNivAux,
                        ...
                        ##FIELDP56( 'CT2.CT2_EC09DB' )
                         @cNivAux,
                        ##ENDFIELDP56
                        @cConfig, @cAtu, @nTCustoDebM, @nTCustoCrdM, @IN_TRANSACTION
      ...
      /* ---------------------------------------------------------------
         ...
         --------------------------------------------------------------- */
      If ((@cFILCT2||@cMOEDA||@cCONTA||@cCUSTO||@cITEM||@cDATAP||@cTPSALD) != (@cFILCT2Ant||@cMOEDAAnt||@cCONTAAnt||@cCUSTOAnt||@cITEMAnt||@cDATAPAnt||@cTPSALDAnt)) begin
         select @cConfig = '03'
         ...
         If @lCubo03 = '1' begin
            If @cCONTAAnt != ' ' begin
               Select @cDATA = @cDATAPAnt||'01'
               Exec CTB210_## @cFILCT2Ant, @cDATA, @cMOEDAAnt, @cTPSALDAnt, @cCONTAAnt, @cCUSTOAnt, @cITEMAnt, @cNivAux,
                        ...
                        ##FIELDP61( 'CT2.CT2_EC09DB' )
                         @cNivAux,
                        ##ENDFIELDP61
                        @cConfig, @cAtu, @nTItemDebM, @nTItemCrdM, @IN_TRANSACTION
               select @nTItemDebM = 0
               select @nTItemCrdM = 0
            End
         End
      ...
      /* ---------------------------------------------------------------
         ...
         --------------------------------------------------------------- */
      If ((@cFILCT2||@cMOEDA||@cCONTA||@cCUSTO||@cITEM||@cCLVL||@cDATAP||@cTPSALD) != (@cFILCT2Ant||@cMOEDAAnt||@cCONTAAnt||@cCUSTOAnt||@cITEMAnt||@cCLVLAnt||@cDATAPAnt||@cTPSALDAnt)) begin
         select @cConfig = '04'
         ...
         If @lCubo04 = '1' begin
            If @cCONTAAnt != ' ' begin
               Select @cDATA = @cDATAPAnt||'01'
               Exec CTB210_## @cFILCT2Ant, @cDATA, @cMOEDAAnt, @cTPSALDAnt, @cCONTAAnt, @cCUSTOAnt, @cITEMAnt, @cCLVLAnt,
                        ...
                        ##FIELDP66( 'CT2.CT2_EC09DB' )
                         @cNivAux,
                        ##ENDFIELDP66
                         @cConfig, @cAtu, @nTClvlDebM, @nTClvlCrdM, @IN_TRANSACTION
               select @nTClvlDebM = 0
               select @nTClvlCrdM = 0
            End
         End
      ...
      If ((@cFILCT2||@cMOEDA||@cCONTA||@cCUSTO||@cITEM||@cCLVL||@cEC05||@cDATAP||@cTPSALD) != (@cFILCT2Ant||@cMOEDAAnt||@cCONTAAnt||@cCUSTOAnt||@cITEMAnt||@cCLVLAnt||@cEC05Ant||@cDATAPAnt||@cTPSALDAnt)) begin
         select @cConfig = '05'
            ...
            If @cCONTAAnt != ' ' begin
               ...
               Exec CTB210_## @cFILCT2Ant, @cDATA, @cMOEDAAnt, @cTPSALDAnt, @cCONTAAnt, @cCUSTOAnt, @cITEMAnt, @cCLVLAnt,
                        ...
                        ##FIELDP72( 'CT2.CT2_EC09DB' )
                         @cNivAux,
                        ##ENDFIELDP72
                        @cConfig, @cAtu, @nTEC05DebM, @nTEC05CrdM, @IN_TRANSACTION
               select @nTEC05DebM = 0
               select @nTEC05CrdM = 0
            End
         End
      ...
      If ((@cFILCT2||@cMOEDA||@cCONTA||@cCUSTO||@cITEM||@cCLVL||@cEC05||@cEC06||@cDATAP||@cTPSALD) != (@cFILCT2Ant||@cMOEDAAnt||@cCONTAAnt||@cCUSTOAnt||@cITEMAnt||@cCLVLAnt||@cEC05Ant||@cEC06Ant||@cDATAPAnt||@cTPSALDAnt)) begin
         select @cConfig = '06'
            ...
            If @cCONTAAnt != ' ' begin
               ...
               Exec CTB210_## @cFILCT2Ant, @cDATA, @cMOEDAAnt, @cTPSALDAnt, @cCONTAAnt, @cCUSTOAnt, @cITEMAnt, @cCLVLAnt,
                        ...
                        ##FIELDP78( 'CT2.CT2_EC09DB' )
                         @cNivAux,
                        ##ENDFIELDP78
                        @cConfig, @cAtu, @nTEC06DebM, @nTEC06CrdM, @IN_TRANSACTION
               select @nTEC06DebM = 0
               select @nTEC06CrdM = 0
            End
         End
      ...
      If ((@cFILCT2||@cMOEDA||@cCONTA||@cCUSTO||@cITEM||@cCLVL||@cEC05||@cEC06||@cEC07||@cDATAP||@cTPSALD) != (@cFILCT2Ant||@cMOEDAAnt||@cCONTAAnt||@cCUSTOAnt||@cITEMAnt||@cCLVLAnt||@cEC05Ant||@cEC06Ant||@cEC07Ant||@cDATAPAnt||@cTPSALDAnt)) begin
         select @cConfig = '07'
            ...
            If @cCONTAAnt != ' ' begin
               ...
               Exec CTB210_## @cFILCT2Ant, @cDATA, @cMOEDAAnt, @cTPSALDAnt, @cCONTAAnt, @cCUSTOAnt, @cITEMAnt, @cCLVLAnt,
                        ...
                        ##FIELDP84( 'CT2.CT2_EC09DB' )
                         @cNivAux,
                        ##ENDFIELDP84
                        @cConfig, @cAtu, @nTEC07DebM, @nTEC07CrdM, @IN_TRANSACTION
               select @nTEC07DebM = 0
               select @nTEC07CrdM = 0
            End
         End
      ...
      If ((@cFILCT2||@cMOEDA||@cCONTA||@cCUSTO||@cITEM||@cCLVL||@cEC05||@cEC06||@cEC07||@cEC08||@cDATAP||@cTPSALD) != (@cFILCT2Ant||@cMOEDAAnt||@cCONTAAnt||@cCUSTOAnt||@cITEMAnt||@cCLVLAnt||@cEC05Ant||@cEC06Ant||@cEC07Ant||@cEC08Ant||@cDATAPAnt||@cTPSALDAnt)) begin
         select @cConfig = '08'
            ...
            If @cCONTAAnt != ' ' begin
               ...
               Exec CTB210_## @cFILCT2Ant, @cDATA, @cMOEDAAnt, @cTPSALDAnt, @cCONTAAnt, @cCUSTOAnt, @cITEMAnt, @cCLVLAnt,
                        ...
                        ##FIELDP90( 'CT2.CT2_EC09DB' )
                         @cNivAux,
                        ##ENDFIELDP90
                        @cConfig, @cAtu, @nTEC08DebM, @nTEC08CrdM, @IN_TRANSACTION
               select @nTEC08DebM = 0
               select @nTEC08CrdM = 0
            End
         End
      ...
      If ((@cFILCT2||@cMOEDA||@cCONTA||@cCUSTO||@cITEM||@cCLVL||@cEC05||@cEC06||@cEC07||@cEC08||@cEC09||@cDATAP||@cTPSALD) != (@cFILCT2Ant||@cMOEDAAnt||@cCONTAAnt||@cCUSTOAnt||@cITEMAnt||@cCLVLAnt||@cEC05Ant||@cEC06Ant||@cEC07Ant||@cEC08Ant||@cEC09Ant||@cDATAPAnt||@cTPSALDAnt)) begin
         select @cConfig = '09'
            ...
            If @cCONTAAnt != ' ' begin
               ...
               Exec CTB210_## @cFILCT2Ant, @cDATA, @cMOEDAAnt, @cTPSALDAnt, @cCONTAAnt, @cCUSTOAnt, @cITEMAnt, @cCLVLAnt,
                        ...
                        ##FIELDP96( 'CT2.CT2_EC09DB' )
                         @cEC09Ant,
                        ##ENDFIELDP96
                        @cConfig, @cAtu, @nTEC09DebM, @nTEC09CrdM, @IN_TRANSACTION
               select @nTEC09DebM = 0
               select @nTEC09CrdM = 0
            End
         End
