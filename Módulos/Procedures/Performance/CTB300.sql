...
/* ------------------------------------------------------------------------------------
    ...
    Obs: a variável @iTranCount = 0 será trocada por 'commit tran' no CFGX051 pro SQLSERVER 
         e SYBASE
    CTB300 - Reprecessamento de Cubos em Fila
      +--> CTB210 - Grava os cubos  em Fila
...
begin
   ...
   ##ENDFIELDP11
   /*---------------------------------------------------------------
     Gerar Saldos Diários, CVX, a partir do CT2
      --------------------------------------------------------------- */
   select @lPrim = '1'
   select @cAtu = '1'
   select @cNivAux = ' '
   Declare CUR_CUBO190 insensitive cursor for
    Select CT2_FILIAL, CT2_DATA, CT2_MOEDLC, CT2_DEBITO, CT2_CCD, CT2_ITEMD, CT2_CLVLDB,CT2_TPSALD,
       ...
       Group By CT2_FILIAL, CT2_DATA, CT2_MOEDLC, CT2_DEBITO, CT2_CCD, CT2_ITEMD, CT2_CLVLDB,CT2_TPSALD
           ...
           ##ENDFIELDP21
       Union
      Select CT2_FILIAL, CT2_DATA, CT2_MOEDLC, CT2_CREDIT, CT2_CCC, CT2_ITEMC, CT2_CLVLCR,CT2_TPSALD,
       ...
       Where (CT2_DC = '2' or CT2_DC = '3')
		 ...
		 and CT2_MOEDLC = CQA_MOEDLC
		 and CQA.R_E_C_N_O_  between @RecMin and @RecMax 
      Group By CT2_FILIAL, CT2_DATA, CT2_MOEDLC, CT2_CREDIT, CT2_CCC, CT2_ITEMC, CT2_CLVLCR,CT2_TPSALD
   ...
   for read only
   Open CUR_CUBO190
   Fetch CUR_CUBO190 into  @cFILCT2, @cDATA, @cMOEDA, @cCONTA, @cCUSTO, @cITEM, @cCLVL,@cTPSALD,
   ...
   While (@@Fetch_status = 0 ) begin
      ...
      /* ---------------------------------------------------------------
         Atualiza Cubo 1 - CONTA - CVX - Diário
         select @cAtu = '1' - Atualiza saldos diários 
         --------------------------------------------------------------- */
      If ((@cFILCT2||@cDATA||@cMOEDA||@cCONTA||@cTPSALD) != (@cFILCT2Ant||@cDATAAnt||@cMOEDAAnt||@cCONTAAnt||@cTPSALDAnt)) begin 
         select @cConfig = '01'
         ...
         If @lCubo01 = '1' begin
            If @cCONTAAnt != ' ' begin
               Exec CTB210_## @cFILCT2Ant, @cDATAAnt, @cMOEDAAnt, @cTPSALDAnt, @cCONTAAnt, @cNivAux, @cNivAux, @cNivAux,
                        ...
                        ##FIELDP51( 'CT2.CT2_EC09DB' )
                         @cNivAux,
                        ##ENDFIELDP51
                        @cConfig, @cAtu, @nTContaDebD, @nTContaCrdD, @IN_TRANSACTION
      ...
      /* ---------------------------------------------------------------
         ...
         --------------------------------------------------------------- */
      If ((@cFILCT2||@cDATA||@cMOEDA||@cCONTA||@cCUSTO||@cTPSALD) != (@cFILCT2Ant||@cDATAAnt||@cMOEDAAnt||@cCONTAAnt||@cCUSTOAnt||@cTPSALDAnt)) begin
         select @cConfig = '02'
         ...
         If @lCubo02 = '1' begin
            If @cCONTAAnt != ' ' begin
               Exec CTB210_## @cFILCT2Ant, @cDATAAnt, @cMOEDAAnt, @cTPSALDAnt, @cCONTAAnt, @cCUSTOAnt, @cNivAux, @cNivAux,
                        ...
                        ##FIELDP56( 'CT2.CT2_EC09DB' )
                         @cNivAux,
                        ##ENDFIELDP56
                        @cConfig, @cAtu, @nTCustoDebD, @nTCustoCrdD, @IN_TRANSACTION
      ...
      /* ---------------------------------------------------------------
         ...
         --------------------------------------------------------------- */
      If ((@cFILCT2||@cDATA||@cMOEDA||@cCONTA||@cCUSTO||@cITEM||@cTPSALD) != (@cFILCT2Ant||@cDATAAnt||@cMOEDAAnt||@cCONTAAnt||@cCUSTOAnt||@cITEMAnt||@cTPSALDAnt)) begin
         select @cConfig = '03'
         ...
         If @lCubo03 = '1' begin
            If @cCONTAAnt != ' ' begin
               Exec CTB210_## @cFILCT2Ant, @cDATAAnt, @cMOEDAAnt, @cTPSALDAnt, @cCONTAAnt, @cCUSTOAnt, @cITEMAnt, @cNivAux,
                        ...
                        ##FIELDP61( 'CT2.CT2_EC09DB' )
                         @cNivAux,
                        ##ENDFIELDP61
                        @cConfig, @cAtu, @nTItemDebD, @nTItemCrdD, @IN_TRANSACTION
               select @nTItemDebD = 0
               select @nTItemCrdD = 0
            End
         End
      ...
      /* ---------------------------------------------------------------
         ...
         --------------------------------------------------------------- */
      If ((@cFILCT2||@cDATA||@cMOEDA||@cCONTA||@cCUSTO||@cITEM||@cCLVL||@cTPSALD) != (@cFILCT2Ant||@cDATAAnt||@cMOEDAAnt||@cCONTAAnt||@cCUSTOAnt||@cITEMAnt||@cCLVLAnt||@cTPSALDAnt)) begin
         select @cConfig = '04'
         ...
         If @lCubo04 = '1' begin
            If @cCONTAAnt != ' ' begin
               Exec CTB210_## @cFILCT2Ant, @cDATAAnt, @cMOEDAAnt, @cTPSALDAnt, @cCONTAAnt, @cCUSTOAnt, @cITEMAnt, @cCLVLAnt,
                        ...
                        ##FIELDP66( 'CT2.CT2_EC09DB' )
                         @cNivAux,
                        ##ENDFIELDP66
                        @cConfig, @cAtu, @nTClvlDebD, @nTClvlCrdD, @IN_TRANSACTION
               select @nTClvlDebD = 0
               select @nTClvlCrdD = 0
            End
         End
      ...
      If ((@cFILCT2||@cDATA||@cMOEDA||@cCONTA||@cCUSTO||@cITEM||@cCLVL||@cEC05||@cTPSALD) != (@cFILCT2Ant||@cDATAAnt||@cMOEDAAnt||@cCONTAAnt||@cCUSTOAnt||@cITEMAnt||@cCLVLAnt||@cEC05Ant||@cTPSALDAnt)) begin
         select @cConfig = '05'
            ...
            If @cCONTAAnt != ' ' begin
               Exec CTB210_## @cFILCT2Ant, @cDATAAnt, @cMOEDAAnt, @cTPSALDAnt, @cCONTAAnt, @cCUSTOAnt, @cITEMAnt, @cCLVLAnt,
                        ...
                        ##FIELDP72( 'CT2.CT2_EC09DB' )
                         @cNivAux,
                        ##ENDFIELDP72
                        @cConfig, @cAtu, @nTEC05DebD, @nTEC05CrdD, @IN_TRANSACTION
               select @nTEC05DebD = 0
               select @nTEC05CrdD = 0
            End
         End
      ...
      If ((@cFILCT2||@cDATA||@cMOEDA||@cCONTA||@cCUSTO||@cITEM||@cCLVL||@cEC05||@cEC06||@cTPSALD) != (@cFILCT2Ant||@cDATAAnt||@cMOEDAAnt||@cCONTAAnt||@cCUSTOAnt||@cITEMAnt||@cCLVLAnt||@cEC05Ant||@cEC06Ant||@cTPSALDAnt)) begin
         select @cConfig = '06'
            ...
            If @cCONTAAnt != ' ' begin
               Exec CTB210_## @cFILCT2Ant, @cDATAAnt, @cMOEDAAnt, @cTPSALDAnt, @cCONTAAnt, @cCUSTOAnt, @cITEMAnt, @cCLVLAnt,
                        ...
                        ##FIELDP78( 'CT2.CT2_EC09DB' )
                         @cNivAux,
                        ##ENDFIELDP78
                        @cConfig, @cAtu, @nTEC06DebD, @nTEC06CrdD, @IN_TRANSACTION
               select @nTEC06DebD = 0
               select @nTEC06CrdD = 0
            End
         End
      ...
      If ((@cFILCT2||@cDATA||@cMOEDA||@cCONTA||@cCUSTO||@cITEM||@cCLVL||@cEC05||@cEC06||@cEC07||@cTPSALD) != (@cFILCT2Ant||@cDATAAnt||@cMOEDAAnt||@cCONTAAnt||@cCUSTOAnt||@cITEMAnt||@cCLVLAnt||@cEC05Ant||@cEC06Ant||@cEC07Ant||@cTPSALDAnt)) begin
         select @cConfig = '07'
            ...
            If @cCONTAAnt != ' ' begin
               Exec CTB210_## @cFILCT2Ant, @cDATAAnt, @cMOEDAAnt, @cTPSALDAnt, @cCONTAAnt, @cCUSTOAnt, @cITEMAnt, @cCLVLAnt,
                        ...
                        ##FIELDP84( 'CT2.CT2_EC09DB' )
                         @cNivAux,
                        ##ENDFIELDP84
                        @cConfig, @cAtu, @nTEC07DebD, @nTEC07CrdD, @IN_TRANSACTION
               select @nTEC07DebD = 0
               select @nTEC07CrdD = 0
            End
         End
      ...
      If ((@cFILCT2||@cDATA||@cMOEDA||@cCONTA||@cCUSTO||@cITEM||@cCLVL||@cEC05||@cEC06||@cEC07||@cEC08||@cTPSALD) != (@cFILCT2Ant||@cDATAAnt||@cMOEDAAnt||@cCONTAAnt||@cCUSTOAnt||@cITEMAnt||@cCLVLAnt||@cEC05Ant||@cEC06Ant||@cEC07Ant||@cEC08Ant||@cTPSALDAnt)) begin
         select @cConfig = '08'
            ...
            If @cCONTAAnt != ' ' begin
               Exec CTB210_## @cFILCT2Ant, @cDATAAnt, @cMOEDAAnt, @cTPSALDAnt, @cCONTAAnt, @cCUSTOAnt, @cITEMAnt, @cCLVLAnt,
                        ...
                        ##FIELDP90( 'CT2.CT2_EC09DB' )
                         @cNivAux,
                        ##ENDFIELDP90
                        @cConfig, @cAtu, @nTEC08DebD, @nTEC08CrdD, @IN_TRANSACTION
               select @nTEC08DebD = 0
               select @nTEC08CrdD = 0
            End
         End
      ...
      If ((@cFILCT2||@cDATA||@cMOEDA||@cCONTA||@cCUSTO||@cITEM||@cCLVL||@cEC05||@cEC06||@cEC07||@cEC08||@cEC09||@cTPSALD) != (@cFILCT2Ant||@cDATAAnt||@cMOEDAAnt||@cCONTAAnt||@cCUSTOAnt||@cITEMAnt||@cCLVLAnt||@cEC05Ant||@cEC06Ant||@cEC07Ant||@cEC08Ant||@cEC09Ant||@cTPSALDAnt)) begin
         select @cConfig = '09'
            ...
            If @cCONTAAnt != ' ' begin
               Exec CTB210_## @cFILCT2Ant, @cDATAAnt, @cMOEDAAnt, @cTPSALDAnt, @cCONTAAnt, @cCUSTOAnt, @cITEMAnt, @cCLVLAnt,
                        ...
                        ##FIELDP96( 'CT2.CT2_EC09DB' )
                         @cEC09Ant,
                        ##ENDFIELDP96
                        @cConfig, @cAtu, @nTEC09DebD, @nTEC09CrdD, @IN_TRANSACTION
               select @nTEC09DebD = 0
               select @nTEC09CrdD = 0
            End
         End
   ...
   --------------------------------------------------------------- */
   ##FIELDP2K( 'CT0.CT0_ID' )
   Exec CTB310_##  @RecMin, @RecMax, @IN_TRANSACTION , @OUT_RESULTADO OutPut
   ##ENDFIELDP2K
   /*---------------------------------------------------------------
