...
Function NfseM002(cCodMun,cTipo,dDtEmiss,cSerie,cNota,cClieFor,cLoja,cMotCancela)
Local nX        := 0
Local nZ		 := 0
...
If cTipo == "1" .And. !Empty(cMotCancela)
	...
	If tssHasRdm("NFseM102")
			...
			cString := tssExecRdm("NFseM102",.F.,SM0->M0_CODMUN, cTipo, dDtEmiss, cSerie, cNota, cClieFor, cLoja, cMotCancela)[1]
	Else
