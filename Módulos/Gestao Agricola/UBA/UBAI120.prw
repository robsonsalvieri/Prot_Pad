...
@type function
/*/
Function UBAI120( cXML, nTypeTrans, cTypeMessage )
	...
	If ( nTypeTrans == TRANS_RECEIVE )
		...
		If ( cTypeMessage == EAI_MESSAGE_BUSINESS )
			...
			If ( ( oXML <> Nil ) .And. ( Empty(cError) ) .And. ( Empty(cWarning) ) )
				...
				Else
					lRet := .F.
					cXmlRet := STR0002 //'Erro no retorno. A Referencia/Marca é obrigatória!' //STR0003 //
					//Carrega array de retorno
					aRet := {lRet, cXmlRet,  "AgriculturalSector" } 
					Return aRet
				EndIf
			Else
