...
Method GetNames() CLASS FWemployeeAdapter
	...
	oFieldsJson['id']			:= 'DA4_COD'
	oFieldsJson['instance']		:= 'DA4_FILIAL' 
	oFieldsJson['cdDriver']		:= 'DA4_COD' 
	...
	oFieldsJson['fgType']		:= 'DA4_FGTYPE'	  //Tipo: M - Motorista e F - Funcionário	
...
Method CreateQuery(cCod) CLASS FWemployeeAdapter
	...
	if lRet
		...
		cQuery1 := "SELECT DA4_FILIAL,DA4_COD, DA4_NOME, DA4_CGC, DA4_NUMCNH, DA4_DTVCNH, DA4_RG, DA4_CATCNH, 'M' as DA4_FGTYPE, 'V' as DA4_STATUS   "
