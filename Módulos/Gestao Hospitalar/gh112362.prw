...
±±³Fun‡ao    ³GH112362  ³ Autor ³ MICROSIGA             ³ Data ³ 31/10/06 ³±±
...
ACTIVATE WINDOW oMainWnd 	ON INIT If(	lHistorico,(Processa({|lEnd| lRet := ProcATU(@lEnd)},"Processando","Aguarde , processando preparação dos arquivos",.F.) , IIF(lRet, Final("Atualização efetuada!"),oMainWnd:End())),oMainWnd:End())
