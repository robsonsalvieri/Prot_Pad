...
±±³Fun‡ao    ³GH127194  ³ Autor ³ MICROSIGA             ³ Data ³ 05/06/2007 ³±±
...
Processa({|| ProcATU()},"Processando [GH127194]","Aguarde , processando preparação dos arquivos")
	...
	If lOpen
		For nI := 1 To Len(aRecnoSM0)
 		...
 		nModulo := 51 // modulo SIGAHSP
			...
			FWLogMsg('WARN',, 'SIGAPLS', funName(), '', '01', "Funções descontinuadas pelo SGBD: GeraSX1()" , 0, 0, {})
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH127194] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
