...
±±³Fun‡ao    ³GH150476  ³ Autor ³ MICROSIGA             ³ Data ³ 03/04/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH150476]","Aguarde , processando preparação dos arquivos")
	...
	If lOpen
		For nI := 1 To Len(aRecnoSM0)
 		...
 		nModulo := 51 // modulo SIGAHSP
			...
			FWLogMsg('WARN',, 'SIGAPLS', funName(), '', '01', "Funções descontinuadas pelo SGBD: GeraSIX(),GeraSX2(),GeraSX3(),GeraSX6() e GeraSIX()" , 0, 0, {})
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH150476] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
