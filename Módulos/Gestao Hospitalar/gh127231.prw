...
±±³Fun‡ao    ³GH127231  ³ Autor ³ MICROSIGA             ³ Data ³ 07/08/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH127231]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH127231] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
