...
±±³Fun‡ao    ³GH153697  ³ Autor ³ MICROSIGA             ³ Data ³ 10/09/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH153697]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH153697] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
