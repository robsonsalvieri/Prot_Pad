...
±±³Fun‡ao    ³GH140800  ³ Autor ³ MICROSIGA             ³ Data ³ 23/01/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH140800]","Aguarde , processando preparação dos arquivos")
	...
	If lOpen
		For nI := 1 To Len(aRecnoSM0)
 		...
 		nModulo := 51 // modulo SIGAHSP
			...
			FWLogMsg('WARN',, 'SIGAPLS', funName(), '', '01', "Funções descontinuadas pelo SGBD: GeraSIX(),GeraSX3() e GeraSX2()" , 0, 0, {})
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH140800] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
