...
±±³Fun‡ao    ³GH149028  ³ Autor ³ MICROSIGA             ³ Data ³ 14/07/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH149028]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH149028] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
