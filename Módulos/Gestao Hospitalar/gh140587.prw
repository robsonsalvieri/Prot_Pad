...
±±³Fun‡ao    ³GH140587  ³ Autor ³ MICROSIGA             ³ Data ³ 15/02/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH140587]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH140587] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
