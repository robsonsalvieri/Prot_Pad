...
±±³Fun‡ao    ³GH138950  ³ Autor ³ MICROSIGA             ³ Data ³ 01/02/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH138950]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH138950] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
