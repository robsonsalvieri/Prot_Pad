...
±±³Fun‡ao    ³GH132904  ³ Autor ³ MICROSIGA             ³ Data ³ 01/10/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH132904]","Aguarde , processando preparação dos arquivos")
	...
	If lOpen
		For nI := 1 To Len(aRecnoSM0)
 		...
 		nModulo := 51 // modulo SIGAHSP
			...
			FWLogMsg('WARN',, 'SIGAPLS', funName(), '', '01', "Funções descontinuadas pelo SGBD: GeraSIX(),GeraSX3() e GeraSX6()" , 0, 0, {})
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH132904] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
