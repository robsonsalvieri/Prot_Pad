...
±±³Fun‡ao    ³GH132777  ³ Autor ³ MICROSIGA             ³ Data ³ 26/09/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH132777]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH132777] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
