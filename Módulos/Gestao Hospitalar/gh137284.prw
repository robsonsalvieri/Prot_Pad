...
±±³Fun‡ao    ³GH137284  ³ Autor ³ MICROSIGA             ³ Data ³ 07/12/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH137284]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH137284] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
