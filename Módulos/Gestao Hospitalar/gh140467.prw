...
±±³Fun‡ao    ³GH140467  ³ Autor ³ MICROSIGA             ³ Data ³ 18/02/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH140467]","Aguarde , processando preparação dos arquivos")
	...
	If lOpen
		For nI := 1 To Len(aRecnoSM0)
 		...
 		nModulo := 51 // modulo SIGAHSP
			...
			FWLogMsg('WARN',, 'SIGAPLS', funName(), '', '01', "Funções descontinuadas pelo SGBD: GeraSX2(),GeraSX3() e GeraSIX()" , 0, 0, {})
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH140467] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
