...
±±³Fun‡ao    ³GH132472  ³ Autor ³ MICROSIGA             ³ Data ³ 10/09/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH132472]","Aguarde , processando preparação dos arquivos")
	...
	If lOpen
		For nI := 1 To Len(aRecnoSM0)
 		...
 		nModulo := 51 // modulo SIGAHSP
			...
			FWLogMsg('WARN',, 'SIGAPLS', funName(), '', '01', "Funções descontinuadas pelo SGBD: GeraSXB()" , 0, 0, {})
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH132472] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
