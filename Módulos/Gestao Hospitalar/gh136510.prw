...
±±³Fun‡ao    ³GH136510  ³ Autor ³ MICROSIGA             ³ Data ³ 23/05/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH136510]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH136510] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
