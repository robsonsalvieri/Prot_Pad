...
±±³Fun‡ao    ³GH144714  ³ Autor ³ MICROSIGA             ³ Data ³ 04/06/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH144714]","Aguarde , processando preparação dos arquivos")
	...
	If lOpen
		For nI := 1 To Len(aRecnoSM0)
 		...
 		nModulo := 51 // modulo SIGAHSP
			...
			FWLogMsg('WARN',, 'SIGAPLS', funName(), '', '01', "Funções descontinuadas pelo SGBD: GeraSX1() e GeraSXB()" , 0, 0, {})
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH144714] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
