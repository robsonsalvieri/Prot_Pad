...
±±³Fun‡ao    ³GH129764  ³ Autor ³ MICROSIGA             ³ Data ³ 09/08/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH129764]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH129764] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
