...
±±³Fun‡ao    ³GH135910  ³ Autor ³ MICROSIGA             ³ Data ³ 03/01/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH135910]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH135910] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
