...
±±³Fun‡ao    ³GH151779  ³ Autor ³ MICROSIGA             ³ Data ³ 05/09/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH151779]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH151779] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
