...
±±³Fun‡ao    ³GH126937  ³ Autor ³ MICROSIGA             ³ Data ³ 16/07/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH126937]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH126937] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
