...
±±³Fun‡ao    ³GH145668  ³ Autor ³ Saude                 ³ Data ³ 16/06/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH145668]","Aguarde , processando preparação dos arquivos")
...
±±³Fun‡…o    ³ProcATU   ³ Autor ³ Saude                 ³ Data ³16/06/2008³±±
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH145668] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
...
±±³Fun‡…o    ³MyOpenSM0Ex³ Autor ³ Saude                ³ Data ³07/01/2003³±±
