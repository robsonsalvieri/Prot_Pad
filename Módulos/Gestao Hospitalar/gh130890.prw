...
±±³Fun‡ao    ³GH130890  ³ Autor ³ MICROSIGA             ³ Data ³ 10/09/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH130890]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH130890] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
