...
±±³Fun‡ao    ³GH127977  ³ Autor ³ MICROSIGA             ³ Data ³ 11/07/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH127977]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH127977] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
