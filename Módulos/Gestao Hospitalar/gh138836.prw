...
±±³Fun‡ao    ³GH138836  ³ Autor ³ MICROSIGA             ³ Data ³ 22/01/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH138836]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH138836] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
