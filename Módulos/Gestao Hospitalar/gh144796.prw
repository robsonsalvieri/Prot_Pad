...
±±³Fun‡ao    ³GH144796  ³ Autor ³ MICROSIGA             ³ Data ³ 14/08/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH144796]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH144796] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
