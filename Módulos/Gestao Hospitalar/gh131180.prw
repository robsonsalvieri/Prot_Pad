...
±±³Fun‡ao    ³GH131180  ³ Autor ³ MICROSIGA             ³ Data ³ 17/09/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH131180]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH131180] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
