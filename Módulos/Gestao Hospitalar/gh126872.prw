...
±±³Fun‡ao    ³GH126872  ³ Autor ³ MICROSIGA             ³ Data ³ 29/05/2007 ³±±
...
Processa({|| ProcATU()},"Processando [GH126872]","Aguarde , processando preparação dos arquivos")
	...
	If lOpen
		For nI := 1 To Len(aRecnoSM0)
 		...
 		nModulo := 51 // modulo SIGAHSP
			...
			FWLogMsg('WARN',, 'SIGAPLS', funName(), '', '01', "Funções descontinuadas pelo SGBD: GeraSX6()" , 0, 0, {})
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH126872] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
