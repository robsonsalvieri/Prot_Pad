...
±±³Fun‡ao    ³GH144708  ³ Autor ³ MICROSIGA             ³ Data ³ 09/05/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH144708]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH144708] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
