...
±±³Fun‡ao    ³GH150500  ³ Autor ³ MICROSIGA             ³ Data ³ 18/07/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH150500]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH150500] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
