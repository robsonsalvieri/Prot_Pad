...
±±³Fun‡ao    ³GH144609  ³ Autor ³ MICROSIGA             ³ Data ³ 13/10/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH144609]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH144609] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
