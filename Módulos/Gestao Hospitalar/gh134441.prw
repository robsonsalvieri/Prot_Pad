...
±±³Fun‡ao    ³GH134441  ³ Autor ³ MICROSIGA             ³ Data ³ 04/12/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH134441]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH134441] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
