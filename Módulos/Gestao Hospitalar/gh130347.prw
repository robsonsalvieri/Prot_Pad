...
±±³Fun‡ao    ³GH130347  ³ Autor ³ MICROSIGA             ³ Data ³ 30/08/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH130347]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH130347] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
