...
±±³Fun‡ao    ³GH148116  ³ Autor ³ MICROSIGA             ³ Data ³ 30/06/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH148116]","Aguarde , processando preparação dos arquivos")
	...
	If lOpen
		For nI := 1 To Len(aRecnoSM0)
 		...
 		nModulo := 51 // modulo SIGAHSP
			...
			FWLogMsg('WARN',, 'SIGAPLS', funName(), '', '01', "Funções descontinuadas pelo SGBD: GeraSXD()" , 0, 0, {})
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH148116] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
