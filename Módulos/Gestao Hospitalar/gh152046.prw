...
±±³Fun‡ao    ³GH152046  ³ Autor ³ MICROSIGA             ³ Data ³ 04/09/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH152046]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH152046] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
