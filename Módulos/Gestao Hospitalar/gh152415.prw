...
±±³Fun‡ao    ³GH152415  ³ Autor ³ MICROSIGA             ³ Data ³ 25/08/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH152415]","Aguarde , processando preparação dos arquivos")
	...
	If lOpen
		For nI := 1 To Len(aRecnoSM0)
 		...
 		nModulo := 51 // modulo SIGAHSP
			...
			FWLogMsg('WARN',, 'SIGAPLS', funName(), '', '01', "Funções descontinuadas pelo SGBD: GeraSX2()" , 0, 0, {})
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH152415] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
