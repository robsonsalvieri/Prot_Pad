...
±±³Fun‡ao    ³GH129645  ³ Autor ³ MICROSIGA             ³ Data ³ 25/09/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH129645]","Aguarde , processando preparação dos arquivos")
  ...
  If Ascan(aRecnoSM0,{ |x| x[2] == M0_CODIGO}) == 0
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH129645] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
