...
±±³Fun‡ao    ³GH148108  ³ Autor ³ MICROSIGA             ³ Data ³ 02/07/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH148108]","Aguarde , processando preparação dos arquivos")
	...
	If lOpen
		For nI := 1 To Len(aRecnoSM0)
 		...
 		nModulo := 51 // modulo SIGAHSP
			...
			conout( "Funções descontinuadas pelo SGBD: GeraSX3()" )
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH148108] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
