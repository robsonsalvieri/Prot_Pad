...
±±³Fun‡ao    ³GH127240  ³ Autor ³ MICROSIGA             ³ Data ³ 29/06/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH127240]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH127240] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
