...
±±³Fun‡ao    ³GH133870  ³ Autor ³ MICROSIGA             ³ Data ³ 22/10/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH133870]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH133870] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
