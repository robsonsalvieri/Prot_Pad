...
±±³Fun‡ao    ³GH127140  ³ Autor ³ MICROSIGA             ³ Data ³ 31/05/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH127140]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH127140] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
