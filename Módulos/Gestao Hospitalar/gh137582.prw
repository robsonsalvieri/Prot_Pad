...
±±³Fun‡ao    ³GH137582  ³ Autor ³ MICROSIGA             ³ Data ³ 21/12/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH137582]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH137582] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
