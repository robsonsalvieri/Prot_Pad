...
±±³Fun‡ao    ³GH129309  ³ Autor ³ MICROSIGA             ³ Data ³ 06/11/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH129309]","Aguarde , processando preparação dos arquivos")
	...
	If lOpen
		For nI := 1 To Len(aRecnoSM0)
 		...
 		nModulo := 51 // modulo SIGAHSP
			...
			FWLogMsg('WARN',, 'SIGAPLS', funName(), '', '01', "Funções descontinuadas pelo SGBD: GeraSX1(),GeraSX2(),GeraSX3(),GeraSX6() e GeraSIX()" , 0, 0, {})
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH129309] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
