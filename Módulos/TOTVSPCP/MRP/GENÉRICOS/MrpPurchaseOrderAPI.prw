...
//Em outros fontes, utilizar a função SOLCAPICnt
//para recuperar o valor das constantes.
//Ao criar novas constantes, adicionar na função SOLCAPICnt
...
#DEFINE ARRAY_SOLCOM_POS_DOCUM   13
#DEFINE ARRAY_SOLCOM_POS_RESIDUO 14
#DEFINE ARRAY_SOLCOM_POS_APROV   15
#DEFINE ARRAY_SOLCOM_RECNO       16
#DEFINE ARRAY_SOLCOM_SIZE        16
...
Function SOLCAPICnt(cInfo)
	...
	Do Case
		...
		Case cInfo == "ARRAY_SOLCOM_POS_DOCUM"
			nValue := ARRAY_SOLCOM_POS_DOCUM
		Case cInfo == "ARRAY_SOLCOM_POS_RESIDUO"
			nValue := ARRAY_SOLCOM_POS_RESIDUO
		Case cInfo == "ARRAY_SOLCOM_SIZE"
			nValue := ARRAY_SOLCOM_SIZE
		Case cInfo == "ARRAY_SOLCOM_POS_APROV"
		    nValue := ARRAY_SOLCOM_POS_APROV
	...
	For nIndex := 1 To nTotal
		...
		If ! (lOnlyDel .And. cOperation == "SYNC")
			...
			If cOperation $ "|INSERT|SYNC|"
				...
				oJsonData["items"][nIndex]["itemGrade"] := aDados[nIndex][ARRAY_SOLCOM_POS_ITGRD]
				oJsonData["items"][nIndex]["document" ] := aDados[nIndex][ARRAY_SOLCOM_POS_DOCUM]

				//DMANSMARTSQUAD1-30175 - Inclusão C1_APROV na T4T
				If lT4TAprov
					oJsonData["items"][nIndex]["approved"       ] := aDados[nIndex][ARRAY_SOLCOM_POS_APROV]
				EndIf
			EndIf
		EndIf
	Next nIndex
