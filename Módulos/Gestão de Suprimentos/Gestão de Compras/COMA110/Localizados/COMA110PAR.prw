...
//-------------------------------------------------------------------
/*/{Protheus.doc} COMA110PAR
Solicitação de compras para a localização Paraguai.
...
/*/
//-------------------------------------------------------------------
Function COMA110PAR(xAutoCab,xAutoItens, nOpcAuto,lWhenGet)	
	Local oBrowse
...
Definição do browse para a localização Paraguai.
@author Luiz Henrique Bourscheid
@since 21/10/2017
@version 1.0
@return NIL
...
Definição do modelo para a localização Paraguai.
@author Luiz Henrique Bourscheid
@since 21/10/2017
@version 1.0
@return NIL
...
Static Function ModelDef()
	...
	oModel:InstallEvent("COMA110EVPAR",,oEvent)		
	
Return oModel
//-------------------------------------------------------------------
/*/{Protheus.doc} ViewDef
Definição da view para a localização Paraguai.
@author Luiz Henrique Bourscheid
@since 21/10/2017
@version 1.0
@return NIL
...
Static Function ViewDef()
	Local oView
	Local oModel    := FWLoadModel( 'COMA110PAR' )
...
Definição do menu para a localização Paraguai.
@author Luiz Henrique Bourscheid
@since 21/10/2017
@version 1.0
@return NIL
...
Static Function MenuDef()
	...
	ADD OPTION aRotina TITLE  STR0017       ACTION 'VIEWDEF.COMA110PAR'   OPERATION MODEL_OPERATION_VIEW   ACCESS 0 //Visualizar
	ADD OPTION aRotina TITLE  STR0018       ACTION 'VIEWDEF.COMA110PAR'   OPERATION MODEL_OPERATION_INSERT ACCESS 0 //Incluir
	ADD OPTION aRotina TITLE  STR0019       ACTION 'VIEWDEF.COMA110PAR'   OPERATION MODEL_OPERATION_UPDATE ACCESS 0 //Alterar
	ADD OPTION aRotina TITLE  STR0020       ACTION 'C110Excl'             OPERATION MODEL_OPERATION_DELETE ACCESS 0 //Excluir
	ADD OPTION aRotina TITLE  STR0021       ACTION 'VIEWDEF.COMA110PAR'   OPERATION 8 ACCESS 0                      //Imprimir
	ADD OPTION aRotina TITLE  STR0022       ACTION 'VIEWDEF.COMA110PAR'   OPERATION 9 ACCESS 0                      //Copiar
