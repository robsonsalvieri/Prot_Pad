...
//-------------------------------------------------------------------
/*/{Protheus.doc} COMA110BRA
Solicitação de compras para a localização Brasil.
...
/*/
//-------------------------------------------------------------------
Function COMA110BRA(xAutoCab,xAutoItens, nOpcAuto,lWhenGet,xRatSC,xRatProj)	
	Local oBrowse
	...
	Private bPmsDlgSC
	PRIVATE cFieldsSC1 := "C1_NUM|C1_UNIDREQ|C1_CODCOMP|C1_SOLICIT|C1_EMISSAO|C1_FILENT"	
	PRIVATE cFieldSC1V := "C1_NUM|C1_UNIDREQ|C1_CODCOMP|C1_SOLICIT|C1_EMISSAO|C1_FILENT"
...
Definição do browse para a localização Brasil.
@author Luiz Henrique Bourscheid
@since 21/10/2017
@version 1.0
@return NIL
...
Definição do modelo para a localização Brasil.
@author Luiz Henrique Bourscheid
@since 21/10/2017
@version 1.0
@return NIL
...
Static Function ModelDef()
	...
	Local oEvent   := COMA110EVBRA():New()
	Local oStruLoc := oModel:GetModelStruct('SC1MASTER')[3]:oFormModelStruct
	
	oModel:InstallEvent("COMA110EVBRA",,oEvent)
	
Return oModel
//-------------------------------------------------------------------
/*/{Protheus.doc} ViewDef
Definição da view para a localização Brasil.
@author Luiz Henrique Bourscheid
@since 21/10/2017
@version 1.0
@return NIL
...
Static Function ViewDef()
	Local oView
	Local oModel    := FWLoadModel( 'COMA110BRA' )
...
Definição do menu para a localização Brasil.
@author Luiz Henrique Bourscheid
@since 21/10/2017
@version 1.0
@return NIL
...
Static Function MenuDef()
	...
	ADD OPTION aRotina TITLE  STR0017       ACTION 'VIEWDEF.COMA110BRA'   OPERATION MODEL_OPERATION_VIEW   ACCESS 0 //Visualizar
	ADD OPTION aRotina TITLE  STR0018       ACTION 'VIEWDEF.COMA110BRA'   OPERATION MODEL_OPERATION_INSERT ACCESS 0 //Incluir
	ADD OPTION aRotina TITLE  STR0019       ACTION 'VIEWDEF.COMA110BRA'   OPERATION MODEL_OPERATION_UPDATE ACCESS 0 //Alterar
	ADD OPTION aRotina TITLE  STR0020       ACTION 'C110Excl'             OPERATION MODEL_OPERATION_DELETE ACCESS 0 //Excluir
	ADD OPTION aRotina TITLE  STR0021       ACTION 'VIEWDEF.COMA110BRA'   OPERATION 8 ACCESS 0                      //Imprimir
	ADD OPTION aRotina TITLE  STR0022       ACTION 'VIEWDEF.COMA110BRA'   OPERATION 9 ACCESS 0                      //Copiar
