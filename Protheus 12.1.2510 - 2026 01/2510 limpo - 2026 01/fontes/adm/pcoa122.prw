...
//Xfilial
cQuery +="   Select @cAK2_FILIAL = '"+xFilial("AK2")+"' "+CRLF
...
cQuery +="   Select @cAK3_FILIAL = '"+xFilial("AK3")+"' "+CRLF
...
/* ------------------------------------------------------------------------------------------------------------------------------------------
	...
	1. Cria e Instala Procedure de inserção de dados no AK2 e AK3
		- Popula_AK2  .....................................................-  aProc[1]
    2. Cria tabela temporária para copiar AK3 recnos de linhas com campo memo
   ------------------------------------------------------------------------------------------------------------------------------------------ */
...
If lRet
	aResult := TCSPExec( aProc[1], cFilAnt, cCodigoAK1, cVerAtu, cNextVer )
...
cQuery +="begin"+CRLF
   /* --------------------------------------------------------------
      Recuperando Filiais
      -------------------------------------------------------------- */
cQuery +="   select @cFil_AKT ='"+xFilial("AKT")+"' "+CRLF   
...
cQuery+=cQueryAux
   /* --------------------------------------------------------------
      Recuperando Filiais
      -------------------------------------------------------------- */
cQuery+="   SELECT @cFil_AKD = '"+xFilial("AKD")+"' "+CRLF
cQuery+="   SELECT @cFil_AK2 = '"+xFilial("AK2")+"' "+CRLF
   /* --------------------------------------------------------------
...
cQuery+="      If @lAtuAKT = '1' begin"+CRLF
         /* --------------------------------------------------------------
            ...
            PCOA122B  - proc[1]
            -------------------------------------------------------------- */
cQuery+="         EXEC "+aProc[1]+" @cFilAnt,  @IN_CONFIG, @cDataAnt, @cChaveR, @nValorD1,  @nValorD2,  @nValorD3,    @nValorD4,      @nValorD5,"+CRLF
