							...
							For nZ := 1 To nlimFK3
								...
								If !oFK4:IsEmpty()
									...
									If Alltrim(cTpImp) $ "IRF|PIS|COF|CSL"
										aAdd( aTpImp, cTpImp) 
										aAdd( aImposBx, {cTpImp, oFK4:GetValue("FK4_IDFK4"), oFK3:GetValue("FK3_BASIMP"), oFK4:GetValue("FK4_VALOR"), aDadosFK2[3], "FK4", aRatIRPF, aDadosFK2[5] } )
									Endif
								Else
									If Alltrim(cTpImp) $ "IRF|PIS|COF|CSL"
										aAdd( aTpImp, cTpImp) 
			...
			For nY := 1 To nTamFKA
				...
				If !oFK5:IsEmpty()		
					...
					If oFKA:AddLine() == nLen + 1
						...
						If cPaisLoc <> "BRA" .And. FwIsInCallStack("FINA847")
