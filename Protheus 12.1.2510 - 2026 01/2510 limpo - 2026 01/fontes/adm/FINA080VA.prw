...
aAdd(aAuxFK7, {"FK7_FILTIT"	,"E2_FILIAL"	 })
aAdd(aAuxFK7, {"FK7_PREFIX"	,"E2_PREFIXO"	 })
aAdd(aAuxFK7, {"FK7_NUM"	,"E2_NUM"		 })
aAdd(aAuxFK7, {"FK7_PARCEL"	,"E2_PARCELA" 	 })
aAdd(aAuxFK7, {"FK7_TIPO"   ,"E2_TIPO" 		 })
aAdd(aAuxFK7, {"FK7_CLIFOR"	,"E2_FORNECE" 	 })
aAdd(aAuxFK7, {"FK7_LOJA"	,"E2_LOJA" 		 })
