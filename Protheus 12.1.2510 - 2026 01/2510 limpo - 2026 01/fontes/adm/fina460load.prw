	...
	If lRet 
		...
		If lExecElse
			...
			If oModelFO1:GetValue("FO1_MARK")
				...
				if oModelFO1:GetValue("FO1_MOEDA") != oModelFO0:GetValue("FO0_MOEDA")
					nDescon := Round(NoRound(xMoeda(oModelFO1:GetValue("FO1_DESCON"),oModelFO1:GetValue("FO1_MOEDA"),oModelFO0:GetValue("FO0_MOEDA"), dDataBase, 3, oModelFO1:GetValue("FO1_TXMOED")),3),2)
				endIf
		...
		If !lMarkAll .Or. (lMarkAll .And. lUltTit)
			...
			Else
				...
				EndIf
				If cCampo == "FO0_TXJUR" .Or. cCampo == "FO0_TXMUL" .or. cCampo == "FO1_MARK" .Or. cCampo == "FO1_DESCON"
...
Function FA460LOAD(oModelLiq )
	...
	For nX := 1 To oFO1:Length()
		...
		If FK7->(MsSeek(xFilial("FK7",oFO1:GetValue("FO1_FILORI"))+ oFO1:GetValue("FO1_IDDOC")))
			cChaveTit:= FK7->(FK7_FILTIT+FK7_PREFIX+FK7_NUM+FK7_PARCEL+FK7_TIPO+FK7_CLIFOR+FK7_LOJA)
