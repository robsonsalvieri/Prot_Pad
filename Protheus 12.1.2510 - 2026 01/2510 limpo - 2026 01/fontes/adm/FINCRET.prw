...
Function FINIniDsc(cFonte)
	...
	If !Empty(cFonte)
		...
		ElseIf cFonte == 'FK4T'		//Titulo de imposto
			...
			cChaveFK7 := "FK7_FILTIT + FK7_PREFIX + FK7_NUM + FK7_PARCEL + FK7_TIPO + FK7_CLIFOR + FK7_LOJA"
			cDescric := Posicione('FK7',1,xFilial('FK7')+cIdDoc,cChaveFK7)
		EndIf
