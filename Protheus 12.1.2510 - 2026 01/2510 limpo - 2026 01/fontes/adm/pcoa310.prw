...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
Static Function A310ExProc(aRet,lAtuSld, cAliasEnt, cFiltAKD) // Executa o reprocessamento de lancamentos por procedure
	...
	If Len(aRet) > 0 .And. !Empty(cAliasEnt) .And. A310FilAKD( cFiltAKD, @cFiltQry)
		...
		If !Empty(aRet[DEF_FILTRO])
			...
			If lRet
				Processa({|| ProcDel(aRet, cFiltAKD)}, STR0013, STR0014 )
			EndIf
