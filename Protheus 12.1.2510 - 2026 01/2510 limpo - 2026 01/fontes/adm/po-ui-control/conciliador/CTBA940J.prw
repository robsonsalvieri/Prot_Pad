                            ...
                            '"rules": ['+;
                                '{'+;
                                    ...
                                    '"rule": {'+;
                                        ...
                                        '"ori_link": "CV3_IDORIG = E1_MSUIDT",'+;
                                        '"des_fields": "CT2_MSUIDT",'+;
                                        '"des_link": "CV3_IDDEST = CT2_MSUIDT",'+;
                                        '"condition": "CV3_IDORIG = E1_MSUIDT AND CV3_IDDEST = CT2_MSUIDT"'+;
                                    '}'+;
                                '}'+;
                            ']'+;
                        '}'
                            ...
                            '"rules": ['+;
                                '{'+;
                                    ...
                                    '"rule": {'+;
                                        ...
                                        '"ori_link": "CV3_IDORIG = E2_MSUIDT",'+;
                                        '"des_fields": "CT2_MSUIDT",'+;
                                        '"des_link": "CV3_IDDEST = CT2_MSUIDT",'+;
                                        '"condition": "CV3_IDORIG = E2_MSUIDT AND CV3_IDDEST = CT2_MSUIDT"'+;
                                    '}'+;
                                '}'+;
                            ']'+;
                        '}'
                            ...
                            '"rules": ['+;
                                '{'+;
                                    ...
                                    '"rule": {'+;
                                        ...
                                        '"ori_link": "CV3_IDORIG = E5_MSUIDT",'+;
                                        '"des_fields": "CT2_MSUIDT",'+;
                                        '"des_link": "CV3_IDDEST = CT2_MSUIDT",'+;
                                        '"condition": "CV3_IDORIG = E5_MSUIDT AND CV3_IDDEST = CT2_MSUIDT"'+;
                                    '}'+;
                                '}'+;
                            ']'+;
                        '}'
                            ...
                            '"rules": ['+;
                                '{'+;
                                    ...
                                    '"rule": {'+;
                                        ...
                                        '"ori_link": "CV3_IDORIG = F1_MSUIDT",'+;
                                        '"des_fields": "CT2_MSUIDT",'+;
                                        '"des_link": "CV3_IDDEST = CT2_MSUIDT",'+;
                                        '"condition": "CV3_IDORIG = F1_MSUIDT AND CV3_IDDEST = CT2_MSUIDT"'+;
                                    '}'+;
                                '}'+;
                            ']'+;
                        '}'
                            ...
                            '"rules": ['+;
                                '{'+;
                                    ...
                                    '"rule": {'+;
                                        ...
                                        '"ori_link": "CV3_IDORIG = D1_MSUIDT",'+;
                                        '"des_fields": "CT2_MSUIDT",'+;
                                        '"des_link": "CV3_IDDEST = CT2_MSUIDT",'+;
                                        '"condition": "CV3_IDORIG = D1_MSUIDT AND CV3_IDDEST = CT2_MSUIDT"'+;
                                    '}'+;
                                '}'+;
                            ']'+;
                        '}'
                            ...
                            '"rules": ['+;
                                '{'+;
                                    ...
                                    '"rule": {'+;
                                        ...
                                        '"ori_link": "CV3_IDORIG = D3_MSUIDT",'+;
                                        '"des_fields": "CT2_MSUIDT",'+;
                                        '"des_link": "CV3_IDDEST = CT2_MSUIDT",'+;
                                        '"condition": "CV3_IDORIG = D3_MSUIDT AND CV3_IDDEST = CT2_MSUIDT"'+;
                                    '}'+;
                                '}'+;
                            ']'+;
                        '}'
                            ...
                            '"rules": ['+;
                                '{'+;
                                    ...
                                    '"rule": {'+;
                                        ...
                                        '"ori_link": "CV3_IDORIG = C7_MSUIDT",'+;
                                        '"des_fields": "CT2_MSUIDT",'+;
                                        '"des_link": "CV3_IDDEST = CT2_MSUIDT",'+;
                                        '"condition": "CV3_IDORIG = C7_MSUIDT AND CV3_IDDEST = CT2_MSUIDT"'+;
                                    '}'+;
                                '}'+;
                            ']'+;
                        '}'
                            ...
                            '"rules": ['+;
                                '{'+;
                                    ...
                                    '"rule": {'+;
                                        ...
                                        '"ori_link": "CV3_IDORIG = C8_MSUIDT",'+;
                                        '"des_fields": "CT2_MSUIDT",'+;
                                        '"des_link": "CV3_IDDEST = CT2_MSUIDT",'+;
                                        '"condition": "CV3_IDORIG = C8_MSUIDT AND CV3_IDDEST = CT2_MSUIDT"'+;
                                    '}'+;
                                '}'+;
                            ']'+;
                        '}'
                            ...
                            '"rules": ['+;
                                '{'+;
                                    ...
                                    '"rule": {'+;
                                        ...
                                        '"ori_link": "CV3_IDORIG = C5_MSUIDT",'+;
                                        '"des_fields": "CT2_MSUIDT",'+;
                                        '"des_link": "CV3_IDDEST = CT2_MSUIDT",'+;
                                        '"condition": "CV3_IDORIG = C5_MSUIDT AND CV3_IDDEST = CT2_MSUIDT"'+;
                                    '}'+;
                                '}'+;
                            ']'+;
                        '}'
                            ...
                            '"rules": ['+;
                                '{'+;
                                    ...
                                    '"rule": {'+;
                                        ...
                                        '"ori_link": "CV3_IDORIG = C6_MSUIDT",'+;
                                        '"des_fields": "CT2_MSUIDT",'+;
                                        '"des_link": "CV3_IDDEST = CT2_MSUIDT",'+;
                                        '"condition": "CV3_IDORIG = C6_MSUIDT AND CV3_IDDEST = CT2_MSUIDT"'+;
                                    '}'+;
                                '}'+;
                            ']'+;
                        '}'
                            ...
                            '"rules": ['+;
                                '{'+;
                                    ...
                                    '"rule": {'+;
                                        ...
                                        '"ori_link": "CV3_IDORIG = F2_MSUIDT",'+;
                                        '"des_fields": "CT2_MSUIDT",'+;
                                        '"des_link": "CV3_IDDEST = CT2_MSUIDT",'+;
                                        '"condition": "CV3_IDORIG = F2_MSUIDT AND CV3_IDDEST = CT2_MSUIDT"'+;
                                    '}'+;
                                '}'+;
                            ']'+;
                        '}'
                            ...
                            '"rules": ['+;
                                '{'+;
                                    ...
                                    '"rule": {'+;
                                        ...
                                        '"ori_link": "CV3_IDORIG = D2_MSUIDT",'+;
                                        '"des_fields": "CT2_MSUIDT",'+;
                                        '"des_link": "CV3_IDDEST = CT2_MSUIDT",'+;
                                        '"condition": "CV3_IDORIG = D2_MSUIDT AND CV3_IDDEST = CT2_MSUIDT"'+;
                                    '}'+;
                                '}'+;
                            ']'+;
                        '}'
                            ...
                            '"rules": ['+;
                                '{'+;
                                    ...
                                    '"rule": {'+;
                                        ...
                                        '"ori_link": "CV3_IDORIG = EF_MSUIDT",'+;
                                        '"des_fields": "CT2_MSUIDT",'+;
                                        '"des_link": "CV3_IDDEST = CT2_MSUIDT",'+;
                                        '"condition": "CV3_IDORIG = EF_MSUIDT AND CV3_IDDEST = CT2_MSUIDT"'+;
                                    '}'+;
                                '}'+;
                            ']'+;
                        '}'
                            ...
                            '"rules": ['+;
                                '{'+;
                                    ...
                                    '"rule": {'+;
                                        ...
                                        '"ori_link": "CV3_IDORIG = AGH_MSUIDT",'+;
                                        '"des_fields": "CT2_MSUIDT",'+;
                                        '"des_link": "CV3_IDDEST = CT2_MSUIDT",'+;
                                        '"condition": "CV3_IDORIG = AGH_MSUIDT AND CV3_IDDEST = CT2_MSUIDT"'+;
                                    '}'+;
                                '}'+;
                            ']'+;
                        '}'
                            ...
                            '"rules": ['+;
                                '{'+;
                                    ...
                                    '"rule": {'+;
                                        ...
                                        '"ori_link": "CV3_IDORIG = AGG_MSUIDT",'+;
                                        '"des_fields": "CT2_MSUIDT",'+;
                                        '"des_link": "CV3_IDDEST = CT2_MSUIDT",'+;
                                        '"condition": "CV3_IDORIG = AGG_MSUIDT AND CV3_IDDEST = CT2_MSUIDT"'+;
                                    '}'+;
                                '}'+;
                            ']'+;
                        '}'
                            ...
                            '"rules": ['+;
                                '{'+;
                                    ...
                                    '"rule": {'+;
                                        ...
                                        '"ori_link": "CV3_IDORIG = FIP_MSUIDT",'+;
                                        '"des_fields": "CT2_MSUIDT",'+;
                                        '"des_link": "CV3_IDDEST = CT2_MSUIDT",'+;
                                        '"condition": "CV3_IDORIG = FIP_MSUIDT AND CV3_IDDEST = CT2_MSUIDT"'+;
                                    '}'+;
                                '}'+;
                            ']'+;
                        '}'
                            ...
                            '"rules": ['+;
                                '{'+;
                                    ...
                                    '"rule": {'+;
                                        ...
                                        '"ori_link": "CV3_IDORIG = EZ_MSUIDT",'+;
                                        '"des_fields": "CT2_MSUIDT",'+;
                                        '"des_link": "CV3_IDDEST = CT2_MSUIDT",'+;
                                        '"condition": "CV3_IDORIG = EZ_MSUIDT AND CV3_IDDEST = CT2_MSUIDT"'+;
                                    '}'+;
                                '}'+;
                            ']'+;
                        '}'
                            ...
                            '"rules": ['+;
                                '{'+;
                                    ...
                                    '"rule": {'+;
                                        ...
                                        '"ori_link": "CV3_IDORIG = FIS_MSUIDT",'+;
                                        '"des_fields": "CT2_MSUIDT",'+;
                                        '"des_link": "CV3_IDDEST = CT2_MSUIDT",'+;
                                        '"condition": "CV3_IDORIG = FIS_MSUIDT AND CV3_IDDEST = CT2_MSUIDT"'+;
                                    '}'+;
                                '}'+;
                            ']'+;
                        '}'
                            ...
                            '"rules": ['+;
                                '{'+;
                                    ...
                                    '"rule": {'+;
                                        ...
                                        '"ori_link": "CV3_IDORIG = EU_MSUIDT",'+;
                                        '"des_fields": "CT2_MSUIDT",'+;
                                        '"des_link": "CV3_IDDEST = CT2_MSUIDT",'+;
                                        '"condition": "CV3_IDORIG = EU_MSUIDT AND CV3_IDDEST = CT2_MSUIDT"'+;
                                    '}'+;
                                '}'+;
                            ']'+;
                        '}'
