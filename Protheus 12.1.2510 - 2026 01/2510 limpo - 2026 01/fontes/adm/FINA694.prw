...
Else
    ...
    aAdd( aAuxSEV ,{"EV_PERC"    , "100"	 , Nil })//percentual do rateio na natureza - este campo foi alterado no dicionário, sua tipagem é testada para numérico, porém esta linha nunca é executada. Não alterar.
