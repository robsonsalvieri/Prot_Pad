...
Function fA096Hist()
	...
	dbSelectArea("FRF")
	FRF->(dbSetOrder(2)) //FRF_FILIAL+FRF_BANCO+FRF_AGENCI+FRF_CONTA+FRF_PREFIX+FRF_NUM+FRF_SEQ                                                                                            
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Function fA96GrvFRF(cCarteira,cMotivo,cDescricao,cCliFor,cLoja,cTitulo)
	...
	While lSeek
		...
		lSeek := FRF->(MsSeek( xFilial('FRF')+ SEF->EF_BANCO + SEF->EF_AGENCIA + SEF->EF_CONTA + SEF->EF_PREFIXO + SEF->EF_NUM + cSeqFRF))
	EndDo
