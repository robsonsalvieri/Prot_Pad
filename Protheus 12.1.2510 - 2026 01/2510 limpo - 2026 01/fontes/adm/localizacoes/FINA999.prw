...
Local nLenDesMoe	:= F999LnDesM()
	...
	oStruEOP:AddField('NPAGAR'	, 'NPAGAR'	, 'NPAGAR'		, 'N' , 1, 0)

	//Detalle OP
	oStruDOP:AddTable('' , { '' } , "DETALLEOP", {|| ''})
	oStruDOP:AddField(' '		, 'Marca'	, 'MARK'		, 'N' , 1, 0)
	oStruDOP:AddField(STR0019   , STR0019	, 'FORNECE'		, 'C' , GetSx3Cache("EK_FORNECE","X3_TAMANHO"))	// "Proveedor"
	oStruDOP:AddField(STR0020   , STR0020	, 'LOJA'		, 'C' , GetSx3Cache("EK_LOJA","X3_TAMANHO"))	// "Tienda"
	oStruDOP:AddField(STR0021	, STR0021	, 'NOMBRE'		, 'C' , GetSx3Cache("A2_NOME","X3_TAMANHO"))	// "Nombre"
	...
	oStruDOP:AddField(STR0015	, STR0015	, 'CNATUREZA'	, 'C' , GetSx3Cache("FJR_NATURE","X3_TAMANHO"))	// "Modalidad"
