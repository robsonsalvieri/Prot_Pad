...
Static Function ModelDef()
	...
	aAdd(aAuxFK7, {"FK7_FILTIT"	,"E1_FILIAL"	 })
	aAdd(aAuxFK7, {"FK7_PREFIX"	,"E1_PREFIXO"	 })
	aAdd(aAuxFK7, {"FK7_NUM"	,"E1_NUM"		 })
	aAdd(aAuxFK7, {"FK7_PARCEL"	,"E1_PARCELA" 	 })
	aAdd(aAuxFK7, {"FK7_TIPO"   ,"E1_TIPO" 		 })
	aAdd(aAuxFK7, {"FK7_CLIFOR"	,"E1_CLIENTE" 	 })
	aAdd(aAuxFK7, {"FK7_LOJA"	,"E1_LOJA" 		 })
