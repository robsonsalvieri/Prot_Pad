	...
	For nX := nNivComp+1 TO nMaxNiveis
		...
		If lQuery                 
			...
			Else
				...
				Else
					If Alltrim(aChave[nX]) $ "AK5->AK5_CODIGO|CTT->CTT_CUSTO|CTD->CTD_ITEM|CTH->CTH_CLVL"
...
If lQuery .And. lExecQry
	...
	If lFaz_Join
		...
		Else
			...
			Else
				If Alltrim(aChave[nNivel]) $ "AK5->AK5_CODIGO|CTT->CTT_CUSTO|CTD->CTD_ITEM|CTH->CTH_CLVL"
