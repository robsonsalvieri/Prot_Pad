...
//	GTPSetRules(cParameter	, cDataType	, cPicture	, cContent			,cGroupFunc		, cDescription		, cF3, cSeekFil, nOperation)
	...
	GTPSetRules("VALIDCHVBP", "3"		,""			,".T." 			    , "GTPA115"	    , STR0160, "")	//"Valida chave BPE na integração de bilhetes"		
	GTPSetRules("NRTHIA421D", "2"       ,""         ,"6"                , "GTPA421D"    , STR0161, "")  //"Nr. threads Fech.Arrecadação limitada a 20"
