...
oStruH81:AddField("ANEXO","01",STR0003,STR0003,{""},"GET","@BMP",Nil,"",.T.,Nil,"",Nil,Nil,Nil,.T.,Nil,.F.) // "Anexos"
...
oStruH7PT:SetProperty("H7P_SLDATU" , MVC_VIEW_ORDEM, '05')
...
oView:AddSheet('FOLDER1','SHEET1',"Receita e Despesa") // "Receita e Despesa"  
...
oView:AddSheet('FOLDER1','SHEET2',STR0012) // "Depósitos"  
...
oView:EnableTitleView("VIEW_H81DEPOSITO", STR0012)  // "Depósitos"
...
oStruH81:SetProperty('*', MVC_VIEW_CANCHANGE, .F.)
