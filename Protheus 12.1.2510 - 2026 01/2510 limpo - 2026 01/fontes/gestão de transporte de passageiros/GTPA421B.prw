...
If !(IsBlind()) .And. !(FwIsInCallStack('GA421BAuto')) .AND. !(FwIsInCallStack('GTPJ010'))
	FwMsgRun(, {|| FWExecView( cDescri , "VIEWDEF.GTPA421", 4,  /*oDlgKco*/, {|| .T. } , /*bOk*/ , /*nPercReducao*/, /*aEnableButtons*/, {|| CancG6X() }/*bCancel*/, /*cOperatId*/ , /*cToolBar*/ , /*oModel*/ )}, , STR0018) //"Aguarde enquanto os Bilhetes estão sendo carregados na Ficha de Remessa."
EndIf
...
Static Function CancG6X()

local oMdl421  := FwLoadModel('GTPA421')

	oMdl421:SetOperation(MODEL_OPERATION_DELETE)
	oMdl421:Activate()
