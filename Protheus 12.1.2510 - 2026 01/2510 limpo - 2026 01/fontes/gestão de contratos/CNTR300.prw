...
Local dDtCorte := CTOD("01/03/2026")

If !IsBlind() .and. TRepInUse()
	If FindFunction("MsgEndRot") .And. cRelease >= "12.1.2510"
		MsgEndRot("CNTR300",;
					STR0003+" (CNTSV010)",;
					"https://tdn.totvs.com.br/pages/releaseview.action?pageId=860251495","20260301" )
	EndIf
Endif

If date() <= dDtCorte .OR. cRelease < "12.1.2510"
