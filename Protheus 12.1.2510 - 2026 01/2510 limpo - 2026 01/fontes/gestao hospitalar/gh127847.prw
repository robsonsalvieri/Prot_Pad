...
±±³Fun‡ao    ³GH127847  ³ Autor ³ MICROSIGA             ³ Data ³ 20/06/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH127847]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH127847] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
