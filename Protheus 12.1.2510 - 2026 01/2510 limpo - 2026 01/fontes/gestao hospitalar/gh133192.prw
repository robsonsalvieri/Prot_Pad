...
±±³Fun‡ao    ³GH133192  ³ Autor ³ MICROSIGA             ³ Data ³ 25/09/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH133192]","Aguarde , processando preparação dos arquivos")
	...
	If lOpen
		For nI := 1 To Len(aRecnoSM0)
 		...
 		nModulo := 51 // modulo SIGAHSP
			...
			FWLogMsg('WARN',, 'SIGAPLS', funName(), '', '01', "Funções descontinuadas pelo SGBD: HS_GERX2UN()" , 0, 0, {})
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH133192] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
