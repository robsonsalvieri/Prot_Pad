...
±±³Fun‡ao    ³GH134793  ³ Autor ³ MICROSIGA             ³ Data ³ 30/10/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH134793]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH134793] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
