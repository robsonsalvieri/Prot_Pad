...
±±³Fun‡ao    ³GH131703  ³ Autor ³ MICROSIGA             ³ Data ³ 24/08/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH131703]","Aguarde , processando preparação dos arquivos")
	...
	If lOpen
		For nI := 1 To Len(aRecnoSM0)
 		...
 		nModulo := 51 // modulo SIGAHSP
			...
			conout( "Funções descontinuadas pelo SGBD: GeraSX1()" )
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH131703] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
