...
±±³Fun‡ao    ³GH143144  ³ Autor ³ MICROSIGA             ³ Data ³ 28/03/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH143144]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH143144] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
