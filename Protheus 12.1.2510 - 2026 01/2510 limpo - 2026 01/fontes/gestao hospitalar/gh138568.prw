...
±±³Fun‡ao    ³GH138568  ³ Autor ³ MICROSIGA             ³ Data ³ 03/01/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH138568]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH138568] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
