...
±±³Fun‡ao    ³ UPDGH039()³ Autor ³ Saude                 ³ Data ³ 30.08.11 ³±±
...
Private cCompat   := "UPDGH039"
Private cFnc      := "Repasse Particular - Mogidonto"
Private cRef      := ""
Private cRef2     := ""
Set Dele On      
//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
...
IncProc(STR0010)//"Verificando integridade dos dicionários...."
   	...
   	If lOpen  
		...
		For nI := 1 To Len(aRecnoSM0)
			...
			cTexto += STR0025 + aRecnoSM0[nI][2] + chr(10) + chr(13)//"Grupo Empresa: "
			...
			If  SM0->M0_CODIGO <> cCodigo   //Só irá executar manutenção no SX se For Grupo Empresas Diferentes
				...
				conout( "Funções descontinuadas pelo SGBD: GeraSX3() e GeraSX6()" )
