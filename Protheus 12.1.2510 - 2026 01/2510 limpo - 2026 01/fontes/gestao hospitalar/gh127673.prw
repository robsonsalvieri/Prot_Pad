...
±±³Fun‡ao    ³GH127673  ³ Autor ³ MICROSIGA             ³ Data ³ 05/07/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH127673]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH127673] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
