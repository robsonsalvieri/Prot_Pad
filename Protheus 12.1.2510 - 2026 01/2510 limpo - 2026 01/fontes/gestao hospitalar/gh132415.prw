...
±±³Fun‡ao    ³GH132415  ³ Autor ³ MICROSIGA             ³ Data ³ 06/09/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH132415]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH132415] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
