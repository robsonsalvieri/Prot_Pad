...
±±³Fun‡ao    ³GH126941  ³ Autor ³ MICROSIGA             ³ Data ³ 29/05/2007 ³±±
...
Processa({|| ProcATU()},"Processando [GH126941]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH126941] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
