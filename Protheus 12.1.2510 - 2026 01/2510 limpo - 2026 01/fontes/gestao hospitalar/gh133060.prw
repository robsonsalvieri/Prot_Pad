...
±±³Fun‡ao    ³GH133060  ³ Autor ³ MICROSIGA             ³ Data ³ 18/09/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH133060]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH133060] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
