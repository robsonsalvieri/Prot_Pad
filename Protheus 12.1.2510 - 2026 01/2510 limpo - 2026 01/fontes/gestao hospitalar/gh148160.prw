...
±±³Fun‡ao    ³GH148160  ³ Autor ³ MICROSIGA             ³ Data ³ 20/06/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH148160]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH148160] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
