...
±±³Fun‡ao    ³GH121681  ³ Autor ³ MICROSIGA             ³ Data ³ 17/04/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH121681]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH121681] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
