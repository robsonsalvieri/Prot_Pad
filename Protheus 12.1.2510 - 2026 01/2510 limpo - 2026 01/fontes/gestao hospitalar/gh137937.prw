...
±±³Fun‡ao    ³GH137937  ³ Autor ³ MICROSIGA             ³ Data ³ 20/12/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH137937]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH137937] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
