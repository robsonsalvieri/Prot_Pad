...
±±³Fun‡ao    ³GH137828  ³ Autor ³ MICROSIGA             ³ Data ³ 14/12/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH137828]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH137828] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
