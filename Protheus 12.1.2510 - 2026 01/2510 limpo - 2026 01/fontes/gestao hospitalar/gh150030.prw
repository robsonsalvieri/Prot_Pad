...
±±³Fun‡ao    ³GH150030  ³ Autor ³ MICROSIGA             ³ Data ³ 31/07/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH150030]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH150030] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
