...
±±³Fun‡ao    ³GH155315  ³ Autor ³ MICROSIGA             ³ Data ³ 03/10/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH155315]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH155315] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
