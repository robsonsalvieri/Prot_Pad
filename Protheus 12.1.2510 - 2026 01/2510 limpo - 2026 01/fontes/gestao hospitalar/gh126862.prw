...
±±³Fun‡ao    ³GH126862  ³ Autor ³ MICROSIGA             ³ Data ³ 28/05/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH126862]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH126862] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
