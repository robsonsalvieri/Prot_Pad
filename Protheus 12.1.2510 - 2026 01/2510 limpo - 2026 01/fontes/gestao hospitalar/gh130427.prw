...
±±³Fun‡ao    ³GH130427  ³ Autor ³ MICROSIGA             ³ Data ³ 13/08/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH130427]","Aguarde , processando preparação dos arquivos")
	...
	If lOpen
		For nI := 1 To Len(aRecnoSM0)
 		...
 		nModulo := 51 // modulo SIGAHSP
			...
			FWLogMsg('WARN',, 'SIGAPLS', funName(), '', '01', "Funções descontinuadas pelo SGBD: GeraSX1(), GeraSX3() E GeraSX6()" , 0, 0, {})
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH130427] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
