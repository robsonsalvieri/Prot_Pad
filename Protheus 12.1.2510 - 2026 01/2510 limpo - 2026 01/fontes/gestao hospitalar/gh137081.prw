...
±±³Fun‡ao    ³GH137081  ³ Autor ³ MICROSIGA             ³ Data ³ 11/02/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH137081]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH137081] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
