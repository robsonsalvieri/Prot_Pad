...
±±³Fun‡ao    ³GH140678  ³ Autor ³ MICROSIGA             ³ Data ³ 03/04/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH140678]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH140678] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
