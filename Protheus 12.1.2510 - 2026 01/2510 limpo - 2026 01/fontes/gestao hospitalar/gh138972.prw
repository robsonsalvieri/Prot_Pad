...
±±³Fun‡ao    ³GH138972  ³ Autor ³ MICROSIGA             ³ Data ³ 27/05/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH138972]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH138972] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
