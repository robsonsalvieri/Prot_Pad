...
Local cUFCRD20	  := SuperGetMv("MV_UFCRD20",.F.,"RJ/MG/SC/RS/PR/MT") //GeraÁ„o de GNRE com reduÁ„o do ICMS em 20% Conforme ConvÍnio ICMS 106/96 somente para os Estado.
Local aTGCalc     := {}
Local aTGRet      := {}
Local aTGCalcRet  := {}
Local aTGCalcRec  := {}
...
EndIf
	...
	If cPaisLoc == "BRA" .AND. FindFunction("xFisAddGNRE").And. AliasIndic("CIN") .And. cTMSMFat == "2"
