...
/*/{Protheus.doc} MATA180EVBRA
Eventos do MVC para o BRASIL, qualquer regra que se aplique somente para BRASIL
deve ser criada aqui, se for uma regra geral deve estar em MATA180EVBRA.
...
CLASS MATA180EVBRA From FWModelEvent 
...
/*/
//-------------------------------------------------------------------
METHOD AfterTTS(oModel, cModelId) CLASS MATA180EVBRA

	if findFunction("f166ProfOp")
		f166ProfOp(oModel:GetOperation(), oModel:GetValue("SB5MASTER","B5_COD")) // Otimizador do Perfil de Produtos
	endIf
