...
/*/{Protheus.doc} ProcAglt
    Realiza a gravação formatada dos dados referente aglutinação de Filiais
    @type  METHOD
    @author SQUAD Estoque
    @since 30/10/2025
    @version P12.1.25
/*/
METHOD ProcAglt(nHandle) CLASS MAPASPF
