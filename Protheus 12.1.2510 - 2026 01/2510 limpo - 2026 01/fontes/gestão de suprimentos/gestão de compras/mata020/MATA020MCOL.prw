...
/*/{Protheus.doc} MATA020COL
Cadastro de fornecedor localizado para COLOMBIA.
...
Local oEvent := MATA020EVCOL():New()
	
	oModel:InstallEvent("COLOMBIA",,oEvent)	
