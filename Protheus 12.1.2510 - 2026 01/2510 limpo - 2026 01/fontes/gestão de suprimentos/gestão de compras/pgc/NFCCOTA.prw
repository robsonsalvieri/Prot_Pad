...
PUBLISH MODEL REST NAME NFCCOTA SOURCE NFCCOTA
...
ADD OPTION aRotina TITLE STR0001 ACTION 'VIEWDEF.NFCCOTA' OPERATION 2 ACCESS 0 //--Visualizar
...
Static Function ModelDef()
    ...
    oModel:GetModel( 'SC8DETAIL' ):SetDescription(STR0002) //-- Cotação
...
static function NFCC8VW()
	...
	oStrSC8:AddField('LEGEND'       , '01', STR0003      , STR0003   ,, 'C' , '@BMP' , , , .F., , , , , , , , )                             //-- Vencedor
    oStrSC8:AddField('C8_NUMPRO'    , '02', STR0004      , STR0004   ,, 'C' , Nil , , , .F., , , , , , .T., , )                             //-- Proposta
	oStrSC8:AddField('C8_FORNECE'   , '03', STR0005      , STR0005   ,, 'C' , Nil , , , .F., , , , , , .T., , )                             //-- Fornecedor
	oStrSC8:AddField('C8_LOJA'      , '04', STR0006      , STR0006   ,, 'C' , Nil , , , .F., , , , , , .T., , )                             //-- Loja
	oStrSC8:AddField('C8_FORNOME'   , '05', STR0007      , STR0007   ,, 'C' , Nil , , , .F., , , , , , .T., , )                             //-- Nome
    oStrSC8:AddField('C8_PRECO'     , '06', STR0008      , STR0008   ,, 'N' , PesqPict("SC8","C8_PRECO") , , , .F., , , , , , .T., , )      //-- Preco Unit.
    oStrSC8:AddField('C8_QUANT'     , '07', STR0009      , STR0009   ,, 'N' , PesqPict("SC8","C8_QUANT") , , , .F., , , , , , .T., , )      //-- Quantidade
    oStrSC8:AddField('C8_TOTAL'     , '08', STR0010      , STR0010   ,, 'N' , PesqPict("SC8","C8_TOTAL") , , , .F., , , , , , .T., , )      //-- Total Item
    oStrSC8:AddField('C8_EMISSAO'   , '09', STR0011      , STR0011   ,, 'D' , PesqPict("SC8","C8_EMISSAO") , , , .F., , , , , , .T., , )    //-- DT Emissao
    oStrSC8:AddField('CE_QUANT'     , '10', STR0012      , STR0012   ,, 'N' , PesqPict("SCE","CE_QUANT") , , , .F., , , , , , .T., , )      //-- Qtd. Entrega
return oStrSC8
...
static function NFCC8MD()
    ...
    oStrSC8:AddField(STR0003     , STR0003     , 'LEGEND'      , 'C', aSzNumPro[1] , aSzNumPro[2] , , Nil, {}, .F., , Nil, Nil, .T.)  //-- Vencedor
	oStrSC8:AddField(STR0004     , STR0004     , 'C8_NUMPRO'   , 'C', aSzNumPro[1] , aSzNumPro[2], , Nil, {}, .F., , .F., .F., .T.)   //-- Proposta
	oStrSC8:AddField(STR0005     , STR0005     , 'C8_FORNECE'  , 'C', aSzFornec[1] , aSzFornec[2], , Nil, {}, .F., , .F., .F., .T.)   //-- Fornecedor
	oStrSC8:AddField(STR0006     , STR0006     , 'C8_LOJA'     , 'C', aSzLoja[1]   , aSzLoja[2], , Nil, {}, .F., , .F., .F., .T.)     //-- Loja
	oStrSC8:AddField(STR0007     , STR0007     , 'C8_FORNOME'  , 'C', aSzFNome[1]  , aSzFNome[2], , Nil, {}, .F., , .F., .F., .T.)    //-- Nome
    oStrSC8:AddField(STR0008     , STR0008     , 'C8_PRECO'    , 'N', aSzPreco[1]  , aSzPreco[2], , Nil, {}, .F., , .F., .F., .T.)    //-- Preco Unit.
    oStrSC8:AddField(STR0009     , STR0009     , 'C8_QUANT'    , 'N', aSzQuant[1]  , aSzQuant[2], , Nil, {}, .F., , .F., .F., .T.)    //-- Quantidade
    oStrSC8:AddField(STR0010     , STR0010     , 'C8_TOTAL'    , 'N', aSzTotIt[1]  , aSzTotIt[2], , Nil, {}, .F., , .F., .F., .T.)    //-- Total Item
    oStrSC8:AddField(STR0011     , STR0011     , 'C8_EMISSAO'  , 'D', aSzEmiss[1]  , aSzEmiss[2], , Nil, {}, .F., , .F., .F., .T.)    //-- DT Emissao
    oStrSC8:AddField(STR0012     , STR0012     , 'CE_QUANT'    , 'N', aSzQtdEnt[1] , aSzQtdEnt[2], , Nil, {}, .F., , .F., .F., .T.)   //-- Qtd. Entrega
