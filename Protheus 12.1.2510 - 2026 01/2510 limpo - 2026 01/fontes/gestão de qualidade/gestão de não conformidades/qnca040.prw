...
ACTIVATE MSDIALOG oDlg ON INIT EnchoiceBar(oDlg,;
					{||If(Qnc040VldFNC(aGets,aTela,nOpc) .And. QNCAUTUSR(M->QI2_FILRES,M->QI2_MATRES),(nOpcao := 1,oDlg:End()),) },;
...
If ExistBlock("QN040AGV")
	ExecBlock("QN040AGV",.F.,.F.,{nOpc, M->QI2_FILRES, M->QI2_MATRES, M->QI2_FNC,M->QI2_REV})
Endif
