...
METHOD AvaliaPELaboratoriosRelacionadosAoUsuario(cModulo) CLASS QualityAPIManager
	...
	Else
		...
		Self:lPEQIELaboratoriosRelacionadosAoUsuario := Iif(Self:lPEQIELaboratoriosRelacionadosAoUsuario == Nil, lQIEIntAPI, Self:lPEQIELaboratoriosRelacionadosAoUsuario)
	EndIf
