function createDataset(fields, constraints, sortFields) {
	...
	var campos = new Array('cdAssJur', 'sAssJur', 'cdTipoSol', 'sTipoSol', 'cdGrupo', 'sGrupo',  'cdUser', 'sUser', 'sPrioridade', 'sPrazo' , 'sPrazoEnc');
...
function getValores(constraints){
	...
	for (var i = 0; i < constraints.length; i++){
		...
		} else if (constraints[i].fieldName == "sPrazoEnc"){
