...
{$ENDIF}
procedure Base64Encode(const InText: PWideChar; var OutText: PWideChar); overload;
procedure Base64Decode(const InText: PWideChar; var OutText: PWideChar); overload;
...
var
  vRetorno: PWideChar;
begin
  Base64Encode(PWideChar(AnsiString(InText)), vRetorno);
  Result := AnsiString(vRetorno);
end;
