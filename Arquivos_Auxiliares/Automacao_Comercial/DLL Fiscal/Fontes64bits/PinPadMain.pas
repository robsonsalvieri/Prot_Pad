...
function PinPad_Listar( var aBuff:AnsiString ):Integer; StdCall;
function PinPad_Abrir( sModelo,sPorta:PChar ):Integer; StdCall;
function PinPad_LeCartao( iHdl:Integer;sModalidade:String;aBuff:AnsiString ):Integer; StdCall;
...
//
//
function PinPad_Listar( var aBuff:AnsiString ):Integer;
begin
  aBuff := _z_ListaPinPad.CommaText;
  result := 0;
end;
