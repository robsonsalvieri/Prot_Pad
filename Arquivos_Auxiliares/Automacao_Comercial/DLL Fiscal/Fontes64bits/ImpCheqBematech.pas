...
Type
  ...
  private
    fHandle: THandle;
    fFuncImprimeCheque          : Function (sBanco, sValor, sFavor, sCidad, sData, sMsg: AnsiString): Integer; StdCall;
    fFuncImprimeChequeTransf    : Function ( sBanco, sValor, sCidade, sData, sAgencia, sConta, sMensagem:AnsiString ):Integer; StdCall;
    fFuncIniciaPorta            : Function (pCom: PChar): Integer; StdCall;
    fFuncFechaPorta             : Function ():Integer; StdCall;
    fFuncImprimeTexto           : Function (Texto: AnsiString; AvancaLinha: integer): integer; stdcall;
...
//---------------------------------------------------------------------------
function TImpChequeBematechDP10.Abrir( aPorta:AnsiString ): Boolean;
...
//---------------------------------------------------------------------------
function TImpChequeBematechDP10.Fechar( aPorta:AnsiString ): Boolean;
begin
...
var
  ...
  pPath    : PChar;
  sPath    : AnsiString;
  aCoordimp : Array[1..13] of AnsiString;
  nPos      : Integer;
  nItem     : Integer;
  nLin      : Integer;
  nCol      : Integer;
  sCoordimp : AnsiString;
  sLinha    : AnsiString;
...
//----------------------------------------------------------------------------
function TImpChequeBematechDP10.StatusCh( Tipo:Integer ):AnsiString;
begin
