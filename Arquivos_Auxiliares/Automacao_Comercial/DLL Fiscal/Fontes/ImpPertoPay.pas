...
///
Function TImpChequePertoPay.Abrir( aPorta: String ) : Boolean;
...
End;
//----------------------------------------------------------------------------
Function TImpChequePertoPay.Fechar( aPorta:String ) : Boolean;
Begin
...
//----------------------------------------------------------------------------
function TImpChequePertoPay.StatusCh( Tipo:Integer ):String;
begin
