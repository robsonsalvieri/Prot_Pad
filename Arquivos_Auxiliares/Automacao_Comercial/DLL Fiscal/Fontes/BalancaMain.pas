...
function Balanca_Listar( aBuff:PChar ):Integer; StdCall;
function Balanca_PegaPeso( iHdl:Integer; sPeso:pchar ):Integer; StdCall;
...
Type
  ...
  public
    ...
    function PegaPeso():String; virtual; abstract;
...
//----------------------------------------------------------------------------
constructor TBalanca.Create( sModelo,sPorta:String );
begin
  fModelo := sModelo;
  fPorta  := sPorta;
end;
...
//
//
function Balanca_Listar( aBuff:PChar ):Integer;
begin
  StrPCopy( aBuff,_z_ListaBalanca.CommaText );
  result := 0;
end;
...
//----------------------------------------------------------------------------
function Balanca_PegaPeso( iHdl:Integer; sPeso:pchar ): Integer;
var
  sRet: String;
  aBalanca : TBalanca;
  iPos : integer;
begin
  ...
  iPos := Pos('|',sRet);
  StrPCopy( sPeso,Copy(sRet,iPos+1,Length(sRet)) );
