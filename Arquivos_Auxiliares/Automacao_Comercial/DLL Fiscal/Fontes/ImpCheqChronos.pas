...
//---------------------------------------------------------------------------
function TImpChequeChronos.Abrir( aPorta:String ): Boolean;
...
//---------------------------------------------------------------------------
function TImpChequeChronos.Fechar( aPorta:String ): Boolean;
Var
  nRet: Integer;
Begin
...
//----------------------------------------------------------------------------
function TImpChequeChronos.StatusCh( Tipo:Integer ):String;
begin
