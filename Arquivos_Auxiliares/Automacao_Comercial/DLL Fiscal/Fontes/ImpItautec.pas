...
Function OpenItautec ( sPorta:String ) : String;
Function CloseItautec( sPorta:String ) : String;
...
//---------------------------------------------------------------------------
function TImpFiscalItautec.Abrir( sPorta:String; iHdlMain:Integer ):String;
begin
  Result := '0';
  If not bOpened then
  begin
...
//-----------------------------------------------------------
function TImpFiscalItautec.PegaPDV:String;
Begin
  Result := '0|'+PDV;
end;

//-----------------------------------------------------------
function TImpFiscalItautec.PegaCupom(Cancelamento:String):String;
var
...
//---------------------------------------------------------------------------
function TImpFiscalItautec.ImpostosCupom(Texto: String): String;
begin
  Result := '0';
end;

//---------------------------------------------------------------------------
function TImpFiscalItautec.Fechar( sPorta:String ) : String;
begin
  Result := CloseItautec( sPorta );
end;

//---------------------------------------------------------------------------
function TImpFiscalItautec.LeituraX : String;
begin
  Result := '1|';
...
//-----------------------------------------------------------
function TImpFiscalItautec.AbreEcf:String;
begin
  Result:='0|';
  TrataErro(fFuncE4Reset(0));
end;
...
//-----------------------------------------------------------
function TImpFiscalItautec.FechaEcf:String;
begin
  Result := ReducaoZ('S');
end;

//-----------------------------------------------------------
function TImpFiscalItautec.ReducaoZ( MapaRes:String ):String;
Var
  nI : Integer;
...
End;
//-----------------------------------------------------------
function TImpFiscalItautec.LeAliquotas : String;
begin
  Result := '0|'+ICMS;
end;
//-----------------------------------------------------------
function TImpFiscalItautec.LeAliquotasISS : String;
begin
  Result := '0|'+ISS;
end;

//-----------------------------------------------------------
function TImpFiscalItautec.AdicionaAliquota( Aliquota:String; Tipo:Integer ): String;
var
  i      : Integer;
  sRet   : String;
  aAliq  : TaString;
...
//-----------------------------------------------------------
function TImpFiscalItautec.Pagamento( Pagamento,Vinculado,Percepcion:String ): String;
var
  i ,nPos : Integer;
  sRet    : String;
  aFormas : TaString;
...
//-----------------------------------------------------------
function TImpFiscalItautec.MemoriaFiscal( DataInicio,DataFim:TDateTime;ReducInicio,ReducFim,Tipo:String  ): String;
Var
...
//-----------------------------------------------------------
function TImpFiscalItautec.AbreCupom(Cliente:String; MensagemRodape:String):String;
begin
...
//-----------------------------------------------------------
function TImpFiscalItautec.FechaCupom( Mensagem:String ):String;
var
   sMsg : String;
begin
  Result := '1|';
...
//-----------------------------------------------------------
function TImpFiscalItautec.Autenticacao( Vezes:Integer; Valor,Texto:String ): String;
var
  Retorno: Word;
  nI     : Integer;
...
//-----------------------------------------------------------
function TImpFiscalItautec.RegistraItem( codigo,descricao,qtde,vlrUnit,vlrdesconto,aliquota,vlTotIt,UnidMed:String; nTipoImp:Integer ): String;
Var
  sAliq: string;
  sTipo: String;
  bReg : Byte;
...
//-----------------------------------------------------------
function TImpFiscalItautec.CancelaCupom( Supervisor:String ): String;
begin
  Result:='1|';
...
//-----------------------------------------------------------
function TImpFiscalItautec.DescontoTotal( vlrDesconto:String;nTipoImp:Integer ): String;
begin
  Result:='1|';
...
//-----------------------------------------------------------
function TImpFiscalItautec.AcrescimoTotal( vlrAcrescimo:String ): String;
begin
  Result:='1|';
...
//-----------------------------------------------------------
function TImpFiscalItautec.CancelaItem( numitem,codigo,descricao,qtde,vlrunit,vlrdesconto,aliquota:String ):String;
begin
  Result:='1|';
...
//-----------------------------------------------------------
function TImpFiscalItautec.GravaCondPag(condicao:String ):String;
var
  i       : Integer;
  sRet    : String;
  aFormas : TaString;
...
//-----------------------------------------------------------
function TImpFiscalItautec.LeCondPag : String;
begin
  Result := '0|'+FormasPgto;
end;
//-----------------------------------------------------------
function TImpFiscalItautec.AbreCupomNaoFiscal( Condicao,Valor,Totalizador,Texto:String ): String;
    Procedure BuscaTotaliz(sTotalizador: String; var bIndice: Byte);
...
//-----------------------------------------------------------
function TImpFiscalItautec.TextoNaoFiscal( Texto:String;Vias:Integer ):String;
Var
  sLinha: String;
  nI,nX : Integer;
  sTextoAux : String;
...
End;
//----------------------------------------------------------------------------
function TImpFiscalItautec.FechaCupomNaoFiscal: String;
var
  sRet : String;
  aFormas : TaString;
  i : Integer;
...
//----------------------------------------------------------------------------
function TImpFiscalItautec.RelGerInd( cIndTotalizador , cTextoImp : String ; nVias : Integer; ImgQrCode: String) : String;
begin
  Result := RelatorioGerencial(cTextoImp , nVias, ImgQrCode);
end;

//----------------------------------------------------------------------------
function TImpFiscalItautec.RelatorioGerencial( Texto:String;Vias:Integer; ImgQrCode: String):String;
begin
  Result:='1|';
  fFuncE4Reset(0);
...
//----------------------------------------------------------------------------
function TImpFiscalItautec.ImprimeCodBarrasITF( Cabecalho , Codigo, Rodape : String ; Vias : Integer):String;
...
//----------------------------------------------------------------------------
function TImpFiscalItautec.TotalizadorNaoFiscal( Numero,Descricao:String ):String;
var
  RP: Byte;
begin
  Result:='1|';
...
End;
//----------------------------------------------------------------------------
function TImpFiscalItautec.Suprimento( Tipo:Integer;Valor:String; Forma:String; Total:String; Modo:Integer; FormaSupr:String ):String;
    Procedure BuscaTotaliz(sTotalizador: String; var bIndice: Byte);
    var Descricao: array [0..16] of Char;
        sDescr: String;
        Sinal: array [0..1] of Char;
...
var
  ...
  sRet : String;
  aFormas : TaString;
  sNomeCNF, sTexto, sForma, sValor : String;
begin
...
//------------------------------------------------------------------------------
function TImpFiscalItautec.Gaveta:String;
begin
...
//----------------------------------------------------------------------------
function TImpFiscalItautec.StatusImp( Tipo:Integer ):String;
var
...
//----------------------------------------------------------------------------
function TImpFiscalItautec.PegaSerie : String;
Var
  Serie:  array[0..20]  of char;
  CGC:    array[0..20]  of char;
  IE:     array[0..20]  of char;
...
//-----------------------------------------------------------
function TImpFiscalItautec.Pedido( Totalizador, Tef, Texto, Valor, CondPagTef:String ): String;
    Procedure BuscaTotaliz(sTotalizador: String; var bIndice: Byte);
    var Descricao: array [0..16] of Char;
        sDescr: String;
        Sinal: array [0..1] of Char;
...
//----------------------------------------------------------------------------
function TImpFiscalItautec.RecebNFis( Totalizador, Valor, Forma:String ): String;
begin
...
//------------------------------------------------------------------------------
function TImpFiscalItautec.DownloadMFD( sTipo, sInicio, sFinal : String ):String;
Begin
...
End;
 ...
 //------------------------------------------------------------------------------
function TImpFiscalItautec.GeraRegTipoE( sTipo, sInicio, sFinal, sRazao, sEnd, sBinario : String ):String;
Begin
  MessageDlg( MsgIndsImp, mtError,[mbOK],0);
  Result := '1';
End;
...
//------------------------------------------------------------------------------
function TImpFiscalItautec.LeTotNFisc:String;
var
  Compl: array[0..17] of char;
  Sinal: array[0..2]  of char;
  RP: Byte;
...
begin
 ...
 //------------------------------------------------------------------------------
function TImpFiscalItautec.DownMF(sTipo, sInicio, sFinal : String):String;
Begin
  MessageDlg( MsgIndsImp, mtError,[mbOK],0);
  Result := '1';
End;
...
//------------------------------------------------------------------------------
function TImpFiscalItautec.RedZDado( MapaRes : String):String;
Begin
  Result := '0';
End;

//------------------------------------------------------------------------------
function TImpFiscalItautec.IdCliente( cCPFCNPJ , cCliente , cEndereco : String ): String;
begin
...
//------------------------------------------------------------------------------
function TImpFiscalItautec.EstornNFiscVinc( CPFCNPJ , Cliente , Endereco , Mensagem , COOCDC : String ) : String;
begin
...
//------------------------------------------------------------------------------
function TImpFiscalItautec.ImpTxtFis(Texto : String) : String;
begin
...
///  Impressora de Cheque Itautec POS 4000 - ECF-IF/3EII
///
function TImpChequeItautec.Abrir( aPorta:String ): Boolean;
begin
  Result := True;
  If not bOpened then
  begin
...
//---------------------------------------------------------------------------
function TImpChequeItautec.Fechar( aPorta:String ): Boolean;
begin
    Result := True;
    If bOpened then
    begin
...
//----------------------------------------------------------------------------
function TImpChequeItautec.StatusCh( Tipo:Integer ):String;
begin
//Tipo - Indica qual o status quer se obter da impressora
...
//----------------------------------------------------------------------------
function TImpFiscalItautec.GrvQrCode(SavePath, QrCode: String): String;
begin
