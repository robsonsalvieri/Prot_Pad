...
type
  ...
  public
    ...
    function WaitFor(Timeout: UINT): TEventWaitResult;
    procedure SetEvent;
...
constructor TEvent.Create(EventAttributes: PSecurityAttributes; ManualReset,
  InitialState: Boolean; const Name: AnsiString);
var
   cNewName: array [0..200] of Char;
begin
  StrPCopy(cNewName,Name);
  FHandle := CreateEvent(EventAttributes, ManualReset, InitialState, cNewName);
end;

function TEvent.WaitFor(Timeout: UINT): TEventWaitResult;
begin
