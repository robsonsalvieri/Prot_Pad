...
type
  ...
  Function OpenNF( sPorta:AnsiString; iVelocidade : Integer ):AnsiString;
  Function CloseNF : AnsiString;
...
//----------------------------------------------------------------------------
function TImpNfEmulador.Abrir(sPorta : AnsiString; iVelocidade : Integer ; iHdlMain:Integer) : AnsiString;
begin
...
//----------------------------------------------------------------------------
function TImpNfEmulador.Fechar( sPorta:AnsiString ):AnsiString;
begin
...
//----------------------------------------------------------------------------
function TImpNfEmulador.ImpTexto( Texto : AnsiString):AnsiString;
Var
  sTextoImp,sQRCode: AnsiString;
  bCorte : Boolean;
  iInd   : Integer;
Begin
sTextoImp := Texto;
...
function TImpNfEmulador.StatusImp(Tipo: Integer): AnsiString;
begin
...
Function RemoveTags( Mensagem : AnsiString): AnsiString;
var
    aTagsProtheus : array [1..30] of AnsiString;
...
//----------------------------------------------------------------------------
function TImpNfEmulador.ImpCodeBar( Tipo,Texto:AnsiString  ):AnsiString;
begin
...
//----------------------------------------------------------------------------
function TImpNfEmulador.ImpBitMap( Arquivo:AnsiString ):AnsiString;
begin
...
//-----------------------------------------------------------------------------
function TImpNfEmulador.AbreGaveta(): AnsiString;
begin
...
initialization
  RegistraImpressora('Emulador Nao fiscal'  , TImpNfEmulador  , '' ,'      ');
