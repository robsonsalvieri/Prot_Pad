...
///
  ...
  public
    ...
    function GeraArquivoMFD(cDadoInicial, cDadoFinal, cTipoDownload, cUsuario: string; iTipoGeracao: integer; cChavePublica, cChavePrivada: string; iUnicoArquivo: integer): String; Override;
    function CapturaBaseISSRedZ : String;
...
Function CompNaoFiscalFW(sIndTotalizador,sCondicao,Valor,Texto : String) : String;
Function CompCredDebFW(sCOO,sCondicao,Valor,Texto : String) : Integer;
Function OpenDarumaFW( sPorta:String ) : String;
Function CloseDarumaFW : String;
Function TrataRetornoDarumaFW( var iRet:Integer ):String;
Function MsgErroDarumaFW( iIndice:Integer ):String;
Function Status_ImpressoraFW( lMensagem:Boolean ): Integer;
Function HabRetEstendido( nRespEstendida: Integer ) : String;
Function RegistroDarumaFW( sProduto1 , sProduto2, sProduto3, sProduto4 : String;  ValorChave : String ; Retorna : String = 'N' ): String;
Function RetornaInfoECFFW( pszIndiceInfo : String ; var pszRetorno : String ) : Integer;
Function TrataArq(cPathArq : String): Boolean;
...
var
  ...
  //--------------------------------------
  fFuncDaruma_FW_iCFAbrir_ECF_Daruma		: function (pszCPF: String; pszNome: String; pszEndereco: String): Integer; StdCall;
  fFuncDaruma_FW_iCFAbrirPadrao_ECF_Daruma	: function (): Integer; StdCall;

  fFuncDaruma_FW_iCFVender_ECF_Daruma           : function (pszCargaTributaria:String; pszQuantidade:String; pszPrecoUnitario:String; pszTipoDescAcresc:String; pszValorDescAcresc:String; pszCodigoItem:String; pszUnidadeMedida:String; pszDescricaoItem:String): Integer; StdCall;
  fFuncDaruma_FW_iCFVenderSemDesc_ECF_Daruma    : function (pszCargaTributaria:String; pszQuantidade:String; pszPrecoUnitario:String; pszCodigoItem:String; pszUnidadeMedida:String; pszDescricaoItem:String): Integer; StdCall;
  fFuncDaruma_FW_iCFVenderResumido_ECF_Daruma   : function (pszCargaTributaria:String; pszPrecoUnitario:String; pszCodigoItem:String; pszDescricaoItem:String): Integer; StdCall;
  fFuncDaruma_FW_iCFLancarAcrescimoItem_ECF_Daruma: function (pszNumItem:String; pszTipoDescAcresc:String; pszValorDescAcresc:String): Integer; StdCall;
  fFuncDaruma_FW_iCFLancarDescontoItem_ECF_Daruma: function (pszNumItem:String; pszTipoDescAcresc:String; pszValorDescAcresc:String): Integer; StdCall;
  fFuncDaruma_FW_iCFLancarAcrescimoUltimoItem_ECF_Daruma: function (pszTipoDescAcresc:String; pszValorDescAcresc:String): Integer; StdCall;
  fFuncDaruma_FW_iCFLancarDescontoUltimoItem_ECF_Daruma: function (pszTipoDescAcresc: String; pszValorDescAcresc:String): Integer; StdCall;

  fFuncDaruma_FW_iCFCancelarItem_ECF_Daruma     : function (pszNumItem: String): Integer; StdCall;
  fFuncDaruma_FW_iCFCancelarUltimoItem_ECF_Daruma: function (): Integer; StdCall;

  fFuncDaruma_FW_iCFCancelarItemParcial_ECF_Daruma: function (pszNumItem:String;pszQuantidade: String): Integer; StdCall;
  fFuncDaruma_FW_iCFCancelarUltimoItemParcial_ECF_Daruma: function (pszQuantidade: String): Integer; StdCall;

  fFuncDaruma_FW_iCFCancelarDescontoItem_ECF_Daruma: function (pszNumItem:String): Integer; StdCall;
  fFuncDaruma_FW_iCFCancelarDescontoUltimoItem_ECF_Daruma: function (): Integer; StdCall;
  fFuncDaruma_FW_iCFCancelarAcrescimoItem_ECF_Daruma: function (pszNumItem:string):Integer; StdCall;
  fFuncDaruma_FW_iCFCancelarAcrescimoUltimoItem_ECF_Daruma: function ():Integer; StdCall;

  fFuncDaruma_FW_iCFTotalizarCupom_ECF_Daruma   : function (pszTipoDescAcresc:String; pszValorDescAcresc:String): Integer; StdCall;
  ...
  fFuncDaruma_FW_iCFEfetuarPagamentoFormatado_ECF_Daruma: function (pszFormaPgto:String; pszValor:String): Integer; StdCall;
  fFuncDaruma_FW_iCFEfetuarPagamento_ECF_Daruma         : function (pszFormaPgto:String;pszValor:String;pszInfoAdicional:String): Integer; StdCall;

  fFuncDaruma_FW_iCFEncerrar_ECF_Daruma                 : function (pszCupomAdicional:string;pszMensagem:string):Integer; StdCall;
  fFuncDaruma_FW_iCFEncerrarPadrao_ECF_Daruma           : function (): Integer; StdCall;
  fFuncDaruma_FW_iCFEncerrarConfigMsg_ECF_Daruma        : function (pszMensagem:string): Integer; StdCall;
  ...
  fFuncDaruma_FW_iCFIdentificarConsumidor_ECF_Daruma    : function (pszNome:string;pszEndereco:String; pszDoc:string): Integer; StdCall;

  fFuncDaruma_FW_iEstornarPagamento_ECF_Daruma          : function (pszFormaPgtoEstornado:string;pszFormaPgtoEfetivado:string;pszValor:string;pszInfoAdicional:string): Integer; StdCall;

  fFuncDaruma_FW_iCCDAbrir_ECF_Daruma                   : function (pszFormaPgto:String;pszParcelas:String;pszDocOrigem:String;pszValor:String;pszCPF:String;pszNome:String;pszEndereco:String): Integer; StdCall;
  fFuncDaruma_FW_iCCDAbrirSimplificado_ECF_Daruma       : function (pszFormaPgto:String; pszParcelas:String;pszDocOrigem:String;pszValor: String): Integer; StdCall;
  fFuncDaruma_FW_iCCDAbrirPadrao_ECF_Daruma             : function (): Integer; StdCall;
  fFuncDaruma_FW_iCCDImprimirTexto_ECF_Daruma           : function (pszTexto:string): Integer; StdCall;
  fFuncDaruma_FW_iCCDImprimirArquivo_ECF_Daruma         : function (pszArqOrigem:String): Integer; StdCall;
  ...
  fFuncDaruma_FW_iCCDEstornar_ECF_Daruma                : function (pszCOO:String;pszCPF:String; pszNome:String; pszEndereco:String): Integer; StdCall;

  //TEF
  fFuncDaruma_FW_iTEF_ImprimirResposta_ECF_Daruma       : function (szArquivo:String; bTravarTeclado:Boolean):Integer; StdCall;
  fFuncDaruma_FW_iTEF_ImprimirRespostaCartao_ECF_Daruma : function (szArquivo:string; bTravarTeclado:Boolean; szForma:string; szValor:string):Integer; StdCall;
  fFuncDaruma_FW_iTEF_Fechar_ECF_Daruma                 : function (): Integer; StdCall;
  fFuncDaruma_FW_eTEF_EsperarArquivo_ECF_Daruma         : function (szArquivo: String; iTempo:integer; bTravar:Boolean): Integer; StdCall;
  fFuncDaruma_FW_eTEF_TravarTeclado_ECF_Daruma          : function (bTravar:Boolean):Integer; StdCall;
  fFuncDaruma_FW_eTEF_SetarFoco_ECF_Daruma              : function (szNomeTela:String):Integer; StdCall;

  fFuncDaruma_FW_iCNFAbrir_ECF_Daruma                   : function (pszCPF:string; pszNome:string;pszEndereco:string): Integer; StdCall;
  fFuncDaruma_FW_iCNFAbrirPadrao_ECF_Daruma             : function (): Integer; StdCall;

  fFuncDaruma_FW_iCNFReceber_ECF_Daruma                 : function (pszIndice:string;pszValor:string;pszTipoDescAcresc:string;pszValorDescAcresc:string): Integer; StdCall;
  fFuncDaruma_FW_iCNFReceberSemDesc_ECF_Daruma          : function (pszIndice:string;pszValor:string): Integer; StdCall;

  fFuncDaruma_FW_iCNFCancelarItem_ECF_Daruma            : function (pszNumItem:string): Integer; StdCall;
  fFuncDaruma_FW_iCNFCancelarUltimoItem_ECF_Daruma      : function (): Integer; StdCall;

  fFuncDaruma_FW_iCNFCancelarAcrescimoItem_ECF_Daruma   : function (pszNumItem:string): Integer; StdCall;
  fFuncDaruma_FW_iCNFCancelarAcrescimoUltimoItem_ECF_Daruma : function (): Integer; StdCall;

  fFuncDaruma_FW_iCNFCancelarDescontoItem_ECF_Daruma    : function (pszNumItem:string): Integer; StdCall;
  fFuncDaruma_FW_iCNFCancelarDescontoUltimoItem_ECF_Daruma : function (): Integer; StdCall;

  fFuncDaruma_FW_iCNFTotalizarComprovante_ECF_Daruma    : function (pszTipoDescAcresc:string;pszValorDescAcresc:string): Integer; StdCall;
  ...
  fFuncDaruma_FW_iCNFEfetuarPagamento_ECF_Daruma        : function (pszFormaPgto:string;pszValor:string;pszInfoAdicional:string): Integer; StdCall;
  fFuncDaruma_FW_iCNFEfetuarPagamentoFormatado_ECF_Daruma: function (pszFormaPgto:string;pszValor:string): Integer; StdCall;
  fFuncDaruma_FW_iCNFEfetuarPagamentoPadrao_ECF_Daruma  : function (): Integer; StdCall;

  fFuncDaruma_FW_iCNFEncerrar_ECF_Daruma                : function (pszMensagem:string): Integer; StdCall;
  ...
  fFuncDaruma_FW_iRGAbrir_ECF_Daruma                    : function (pszNomeRG:String): Integer; StdCall;
  ...
  fFuncDaruma_FW_iRGImprimirTexto_ECF_Daruma            : function (pszTexto:String): Integer; StdCall;
  fFuncDaruma_FW_iRGFechar_ECF_Daruma                   : function (): Integer; StdCall;
  fFuncDaruma_FW_iRGImprimirArquivo_ECF_Daruma          : function (pszArquivo : String ) : Integer; StdCall;

  fFuncDaruma_FW_iLeituraX_ECF_Daruma                   : function : Integer; StdCall;
  fFuncDaruma_FW_rLeituraX_ECF_Daruma                   : function : Integer; StdCall;
  fFuncDaruma_FW_rLeituraXCustomizada_ECF_Daruma        : function (pszCaminho:String): Integer; StdCall;
  fFuncDaruma_FW_iReducaoZ_ECF_Daruma                   : function (pszData:string; pszHora:String): Integer; StdCall;
  fFuncDaruma_FW_iSangriaPadrao_ECF_Daruma              : function (): Integer; StdCall;
  fFuncDaruma_FW_iSangria_ECF_Daruma                    : function (pszValor:string; pszMensagem:String): Integer; StdCall;
  fFuncDaruma_FW_iSuprimentoPadrao_ECF_Daruma           : function (): Integer; StdCall;
  fFuncDaruma_FW_iSuprimento_ECF_Daruma                 : function (pszValor:string; pszMensagem:String): Integer; StdCall;
  fFuncDaruma_FW_rGerarMapaResumo_ECF_Daruma            : function (): Integer; StdCall;

  fFuncDaruma_FW_iMFLerSerial_ECF_Daruma                : function (pszInicial:string; pszFinal:string): Integer; StdCall;
  fFuncDaruma_FW_iMFLer_ECF_Daruma                      : function (pszInicial:string; pszFinal:string): Integer; StdCall;

  fFuncDaruma_FW_iAutenticarDocumento_DUAL_DarumaFramework : function(stTexto: String; stLocal: String; stTimeOut: String): Integer; StdCall;

  //Programação do ECF
  fFuncDaruma_FW_confCadastrarPadrao_ECF_Daruma         : function (pszCadastrar:string;pszValor:string): Integer; StdCall;
  fFuncDaruma_FW_confCadastrar_ECF_Daruma               : function (pszCadastrar:string;pszValor:string;pszSeparador:string): Integer; StdCall;
  ...
  fFuncDaruma_FW_confProgramarOperador_ECF_Daruma       : function (pszValor:string): Integer; StdCall;
  fFuncDaruma_FW_confProgramarIDLoja_ECF_Daruma         : function (pszValor:string): Integer; StdCall;
  fFuncDaruma_FW_confProgramarAvancoPapel_ECF_Daruma    : function (pszSepEntreLinhas:string;pszSepEntreDoc:string;pszLinhasGuilhotina:string;pszGuilhotina:string;pszImpClicheAntecipada:string): Integer; StdCall;
  ...
  //Retornos
  fFuncDaruma_FW_rRetornarInformacao_ECF_Daruma         : function (pszIndice:string;pszRetornar:string): Integer; StdCall;
  fFuncDaruma_FW_rLerAliquotas_ECF_Daruma               : function (cAliquotas:string): Integer; StdCall;
  fFuncDaruma_FW_rLerMeiosPagto_ECF_Daruma              : function (pszRelatorios:string): Integer; StdCall;
  fFuncDaruma_FW_rLerRG_ECF_Daruma                      : function (pszRelatorios:string): Integer; StdCall;
  fFuncDaruma_FW_rLerCNF_ECF_Daruma                     : function (pszRelatorios:string): Integer; StdCall;
  fFuncDaruma_FW_rLerDecimais_ECF_Daruma                : function (pszDecimalQtde:string;pszDecimalValor:string;var piDecimalQtde:Integer; var piDecimalValor:Integer): Integer; StdCall;
  fFuncDaruma_FW_rLerDecimaisInt_ECF_Daruma             : function (piDecimalQtde:integer;piDecimalValor:integer): Integer; StdCall;
  fFuncDaruma_FW_rLerDecimaisStr_ECF_Daruma              : function (pszDecimalQtde:string;pszDecimalValor:string): Integer; StdCall;
  fFuncDaruma_FW_rDataHoraImpressora_ECF_Daruma         : function (pszData:string;pszHora:string): Integer; StdCall;
  fFuncDaruma_FW_rVerificarImpressoraLigada_ECF_Daruma  : function (): Integer; StdCall;
  fFuncDaruma_FW_rVerificarReducaoZ_ECF_Daruma          : function (zPendente:string): Integer; StdCall;
  fFuncDaruma_FW_rRetornarDadosReducaoZ_ECF_Daruma      : function (pszDados:string): Integer; StdCall;
  fFuncDaruma_FW_rRetornarVendaBruta_ECF_Daruma         : function (pszRetorno: string): Integer; StdCall;
  fFuncDaruma_FW_rRetornarVendaLiquida_ECF_Daruma       : function (pszVendaLiquida: String): Integer; StdCall;

  //Status
  fFuncDaruma_FW_rStatusImpressora_ECF_Daruma           : function (pszStatus:string): Integer; StdCall;
  fFuncDaruma_FW_rInfoEstendida_ECF_Daruma              : function (var int:integer; char:string): Integer; StdCall;
  fFuncDaruma_FW_rInfoEstendida1_ECF_Daruma             : function (cInfoEx:string): Integer; StdCall;
  fFuncDaruma_FW_rInfoEstendida2_ECF_Daruma             : function (cInfoEx:string): Integer; StdCall;
  fFuncDaruma_FW_rInfoEstendida3_ECF_Daruma             : function (cInfoEx:string): Integer; StdCall;
  fFuncDaruma_FW_rInfoEstendida4_ECF_Daruma             : function (cInfoEx:string): Integer; StdCall;
  fFuncDaruma_FW_rInfoEstendida5_ECF_Daruma             : function (cInfoEx:string): Integer; StdCall;
  fFuncDaruma_FW_rStatusUltimoCmd_ECF_Daruma            : function (pszErro:string;pszAviso:string;var piErro:integer;var piAviso:integer): Integer; StdCall;
  fFuncDaruma_FW_rStatusUltimoCmdInt_ECF_Daruma         : function (var piErro:integer;var piAviso:integer): Integer; StdCall;
  fFuncDaruma_FW_rStatusUltimoCmdStr_ECF_Daruma         : function (cErro:string;cAviso:string): Integer; StdCall;

  //Status Cupom Fiscal
  fFuncDaruma_FW_rCFVerificarStatus_ECF_Daruma          : function (pszStatus:string; var piStatus:Integer): Integer; StdCall;
  fFuncDaruma_FW_rCFVerificarStatusInt_ECF_Daruma       : function (var iStatusCF:Integer): Integer; StdCall;
  fFuncDaruma_FW_rCFVerificarStatusStr_ECF_Daruma       : function (cStatusCF:string): Integer; StdCall;

  //Saldo a Pagar
  fFuncDaruma_FW_rCFSaldoAPagar_ECF_Daruma              : function (pszValor:string):Integer; StdCall;

  //Subtotal Cupom Fiscal
  fFuncDaruma_FW_rCFSubTotal_ECF_Daruma                 : function (pszValor:string):Integer; StdCall;
  ...
  //Guilhotina
  fFuncDaruma_FW_eAcionarGuilhotina_ECF_Daruma          : function (pszTipoCorte:string): Integer; StdCall;

  //Código de Barras
  fFuncDaruma_FW_iImprimirCodigoBarras_ECF_Daruma       :function(pszTipo:string; pszLargura:string; pszAltura:string; pszImprTexto:string; pszCodigo:string; pszOrientacao:string; pszTextoLivre:string): Integer; StdCall;

  //Registry
  //Registry Cupom Fiscal
  fFuncDaruma_FW_regCFCupomAdicional_ECF_Daruma         : function (pszParametro:string):Integer; StdCall;
  fFuncDaruma_FW_regCFCupomAdicionalDllConfig_ECF_Daruma: function (pszParametro:string):Integer; StdCall;
  fFuncDaruma_FW_regCFCupomAdicionalDllTitulo_ECF_Daruma: function (pszParametro:string):Integer; StdCall;
  fFuncDaruma_FW_regCFCupomMania_ECF_Daruma             : function (pszParametro:string):Integer; StdCall;
  fFuncDaruma_FW_regCFFormaPgto_ECF_Daruma              : function (pszParametro:string):Integer; StdCall;
  fFuncDaruma_FW_regCFMensagemPromocional_ECF_Daruma    : function (pszParametro:string):Integer; StdCall;
  fFuncDaruma_FW_regCFQuantidade_ECF_Daruma             : function (pszParametro:string):Integer; StdCall;
  fFuncDaruma_FW_regCFTamanhoMinimoDescricao_ECF_Daruma : function (pszParametro:string):Integer; StdCall;
  fFuncDaruma_FW_regCFTipoDescAcresc_ECF_Daruma         : function (pszParametro:string):Integer; StdCall;
  fFuncDaruma_FW_regCFUnidadeMedida_ECF_Daruma          : function (pszParametro:string):Integer; StdCall;
  fFuncDaruma_FW_regCFValorDescAcresc_ECF_Daruma        : function (pszParametro:string):Integer; StdCall;

  //Registry CCD
  fFuncDaruma_FW_regCCDDocOrigem_ECF_Daruma             : function (pszParametro:string):Integer; StdCall;
  fFuncDaruma_FW_regCCDFormaPgto_ECF_Daruma             : function (pszParametro:string):Integer; StdCall;
  fFuncDaruma_FW_regCCDLinhasTEF_ECF_Daruma             : function (pszParametro:string):Integer; StdCall;
  fFuncDaruma_FW_regCCDParcelas_ECF_Daruma              : function (pszParametro:string):Integer; StdCall;
  fFuncDaruma_FW_regCCDValor_ECF_Daruma                 : function (pszParametro:string):Integer; StdCall;

  //Registry Cheque
  fFuncDaruma_FW_regChequeXLinha1_ECF_Daruma            : function (pszParametro:string):Integer; StdCall;
  fFuncDaruma_FW_regChequeXLinha2_ECF_Daruma            : function (pszParametro:string):Integer; StdCall;
  fFuncDaruma_FW_regChequeXLinha3_ECF_Daruma            : function (pszParametro:string):Integer; StdCall;
  fFuncDaruma_FW_regChequeYLinha1_ECF_Daruma            : function (pszParametro:string):Integer; StdCall;
  fFuncDaruma_FW_regChequeYLinha2_ECF_Daruma            : function (pszParametro:string):Integer; StdCall;
  fFuncDaruma_FW_regChequeYLinha3_ECF_Daruma            : function (pszParametro:string):Integer; StdCall;

  //Registry Compatibilidade
  fFuncDaruma_FW_regCompatibilidadeStatusFuncao_ECF_Daruma: function (pszParametro:string):Integer; StdCall;

  //Registry Sintegra
  fFuncDaruma_FW_regSintegra_ECF_Daruma                 : function (pszChave:string;pszValor:string):Integer; StdCall;

  //Registry Gerais
  fFuncDaruma_FW_regAlterarValor_Daruma                 : function (pszPathChave:string;pszValor:string):Integer; StdCall;
  fFuncDaruma_FW_regRetornaValorChave_DarumaFramework   : function (pszProduto:string;pszChave:string;pszValor:string):Integer; StdCall;
  fFuncDaruma_FW_regRetornaValorChave                   : function (pszProduto:string;pszChave:string;pszValor:string):Integer; StdCall;
  fFuncDaruma_FW_regLogin                               : function (pszPDV:string):Integer; StdCall;

  //Registry ECF
  fFuncDaruma_FW_regECFAguardarImpressao_ECF_Daruma     : function (pszParametro:string):Integer; StdCall;
  fFuncDaruma_FW_regECFArquivoLeituraX_ECF_Daruma       : function (pszParametro:string):Integer; StdCall;
  fFuncDaruma_FW_regECFAuditoria_ECF_Daruma             : function (pszParametro:string):Integer; StdCall;
  fFuncDaruma_FW_regECFCaracterSeparador_ECF_Daruma     : function (pszParametro:string):Integer; StdCall;
  fFuncDaruma_FW_regECFMaxFechamentoAutomatico_ECF_Daruma: function (pszParametro:string):Integer; StdCall;

  //Geração Arquivos
  //Espelho MFD PAF-ECF
  fFuncDaruma_FW_rGerarEspelhoMFD_ECF_Daruma            : function (pszTipo:string; pszInicial:string;pszFinal:string): Integer; StdCall;

  //Relatório PAF-ECF ON-line
  fFuncDaruma_FW_rGerarRelatorio_ECF_Daruma             : function (szRelatorio:string; szTipo:string; szInicial:string; szFinal:string): Integer; StdCall;

  //Relatório PAF-ECF Off-line
  fFuncDaruma_FW_rGerarRelatorioOffline_ECF_Daruma      : function (szRelatorio:string; szTipo:string; szInicial:string; szFinal:string; szArquivo_MF:string; szArquivo_MFD:string; szArquivo_INF:string): Integer; StdCall;

  //Download Memórias
  fFuncDaruma_FW_rEfetuarDownloadMFD_ECF_Daruma         : function (pszTipo:string;pszInicial:string;pszFinal:string;pszNomeArquivo:string): Integer; StdCall;
  fFuncDaruma_FW_rEfetuarDownloadMF_ECF_Daruma          : function (pszNomeArquivo:string): Integer; StdCall;
  fFuncDaruma_FW_rEfetuarDownloadTDM_ECF_Daruma         : function (pszTipo:string; pszInicial:string;pszFinal:string;pszNomeArquivo:string): Integer; StdCall;

  //PAF-ECF
  //RSA - EAD PAF-ECF
  fFuncDaruma_FW_rAssinarRSA_ECF_Daruma                 : function (pszPathArquivo:string;pszChavePrivada:string;pszAssinaturaGerada:string): Integer; StdCall;

  //MD5
  fFuncDaruma_FW_rCalcularMD5_ECF_Daruma                : function (pszPathArquivo:string;pszMD5GeradoHex:string;pszMD5GeradoAscii:string): Integer; StdCall;
  fFuncDaruma_FW_rRetornarNumeroSerieCodificado_ECF_Daruma: function (pszSerialCriptografado:string): Integer; StdCall;
  fFuncDaruma_FW_rVerificarNumeroSerieCodificado_ECF_Daruma: function (pszSerialCriptografado:string): Integer; StdCall;
  fFuncDaruma_FW_rRetornarGTCodificado_ECF_Daruma       : function (pszGTCodificado:string): Integer; StdCall;
  fFuncDaruma_FW_rVerificarGTCodificado_ECF_Daruma      : function (pszGTCodificado:string): Integer; StdCall;
  fFuncDaruma_FW_rCodigoModeloFiscal_ECF_Daruma         : function (szCodModelo:string): Integer; StdCall;
  ...
  fFuncDaruma_FW_eEnviarComando_ECF_Daruma              : function (cComando:string;var intiTamanhoComando:integer; var intiType:integer): Integer; StdCall;
  ...
  fFuncDaruma_FW_eAuditar_Daruma                        : function (cAuditoria:string;var intiFlag:integer): Integer; StdCall;
  fFuncDaruma_FW_eDefinirProduto_Daruma                 : function (pszProduto:string): Integer; StdCall;
  fFuncDaruma_FW_eDefinirModoRegistro_Daruma            : function (intiTipo:integer): Integer; StdCall;
  fFuncDaruma_FW_eVerificarVersaoDLL_Daruma             : function (pszRet:string): Integer; StdCall;
  fFuncDaruma_FW_eVerificarVersaoDLL                    : function (pszRet:string): Integer; StdCall;
  fFuncDaruma_FW_eInterpretarErro_ECF_Daruma            : function (iIndice:Integer; pszRetorno:string): Integer; StdCall;
  fFuncDaruma_FW_eInterpretarAviso_ECF_Daruma           : function (iIndice:Integer; pszRetorno:string): Integer; StdCall;
  ffuncDaruma_FW_eMemoriaFiscal_ECF_Daruma              : function (pszInicial:string; pszFinal:string; pszCompleta: Boolean; pszTipo:string):Integer; StdCall;
  fFuncDaruma_FW_eInterpretarRetorno_ECF_Daruma         : function (iIndice: Integer; pszRetorno: String): Integer; StdCall;
  fFuncDaruma_FW_eGerarQrCodeArquivo_DUAL_Daruma        : function ( pszPath , pszDados : String) : Integer; StdCall;
  fFuncDaruma_FW_eCarregarBitmapPromocional_ECF_Daruma  : function ( pszPathLogotipo , pszNumBitmap, pszOrientacao : String): Integer; StdCall;
...
var
  ...
  bRet : Boolean;
  pTempPath  : PChar;
  sTempPath,sRetorno,sVelocidade,sIni : String;
...
//------------------------------------------------------------------------------
function TImpDarumaFrameWork.AbreCupom(Cliente,MensagemRodape: String): String;
var
  iRet : Integer;
  aAuxiliar : TaString;
...
//------------------------------------------------------------------------------
function TImpDarumaFrameWork.AbreCupomNaoFiscal(Condicao,Valor,Totalizador, Texto: String): String;
var
  iRet,iPos : Integer;
  sRet,sRetFormas,sForma,sCOORecebimento : String;
begin
...
//------------------------------------------------------------------------------
function TImpDarumaFrameWork.AbreEcf: String;
begin
    Result := '0';
end;

function TImpDarumaFrameWork.Abrir(sPorta: String; iHdlMain: Integer): String;
begin
  sMarca := 'DARUMA';
...
//------------------------------------------------------------------------------
function TImpDarumaFrameWork.CancelaCupom(Supervisor: String): String;
var
  iRet : Integer;
begin
...
//------------------------------------------------------------------------------
function TImpDarumaFrameWork.DescontoTotal(vlrDesconto: String;nTipoImp: Integer): String;
var iRet: integer;
begin
...
//------------------------------------------------------------------------------
function TImpDarumaFrameWork.FechaCupom(Mensagem: String): String;
var
  iRet : Integer;
  sMsg : String;
begin
...
//------------------------------------------------------------------------------
function TImpDarumaFrameWork.FechaCupomNaoFiscal: String;
var
  iRet : Integer;
begin
...
//------------------------------------------------------------------------------
function TImpDarumaFrameWork.FechaEcf: String;
var
  iRet : Integer;
  sData : String;
  sHora : String;
...
//------------------------------------------------------------------------------
function TImpDarumaFrameWork.Fechar(sPorta: String): String;
begin
  Result := '0';
end;

//------------------------------------------------------------------------------
function TImpDarumaFrameWork.ImpostosCupom(Texto: String): String;
begin
  Result := '0';
end;

//------------------------------------------------------------------------------
function TImpDarumaFrameWork.LeAliquotas: String;
begin
  Result := '0|' + ICMS;
end;

//------------------------------------------------------------------------------
function TImpDarumaFrameWork.LeAliquotasISS: String;
begin
  Result := '0|' + ISS;
end;

//------------------------------------------------------------------------------
function TImpDarumaFrameWork.LeituraX: String;
var
  iRet : Integer;
begin
...
//------------------------------------------------------------------------------
function TImpDarumaFrameWork.Pagamento(Pagamento, Vinculado, Percepcion: String): String;
var iRet    : integer;
    sFrmPag : String;
    sVlrPag : String;
begin
...
//------------------------------------------------------------------------------
function TImpDarumaFrameWork.PegaCupom(Cancelamento: String): String;
var
  iRet : Integer;
  lFinaliza : Boolean;
  iCont : Integer;
...
//------------------------------------------------------------------------------
function TImpDarumaFrameWork.PegaPDV: String;
begin
  Result := '0|' + Pdv;
end;

//------------------------------------------------------------------------------
function TImpDarumaFrameWork.PegaSerie: String;
begin
  Result := '0|' + NumSerie;
end;

//------------------------------------------------------------------------------
function TImpDarumaFrameWork.RecebNFis(Totalizador, Valor,Forma: String): String;
var
   sRet : String;
begin
...
//------------------------------------------------------------------------------
function TImpDarumaFrameWork.ReducaoZ(MapaRes: String): String;
...
var
  ...
  sAux, sTribIS1, sTribNS1, sTribFS1 : String;
...
begin
 ...
 begin
  ...
  DateTimeToString( sHora, 'hhmmss', Time );
...
var
   iRet : Integer;
   sChave,sParam1 , sParam2, sParam3,sParam4,sRet : String;
begin
...
//------------------------------------------------------------------------------
function RetornoEstendido( iRetorno : Integer ): String;
Var
  sRet : String;
  iRet : Integer;
begin
...
//------------------------------------------------------------------------------
function TImpDarumaFrameWork.StatusImp(Tipo: Integer): String;
var
  iRet, i : Integer;
  sRet, Data, Hora, sDataHoje, sUltimoItem,sFormas : String;
  dDtHoje,dDtMov:TDateTime;
  FlagTruncamento : String;
  sVendaBruta, sSubTotal : String;
  sGrandeTotal : String;
  sContadorCrz: String;
  sLetraIndicativa: String;
  sDataIntEprom,sHoraIntEprom,sDataUltDoc,sCuponsEmitidos,sOperacoes,sGRG, sCDC: String;
begin
...
//------------------------------------------------------------------------------
function TImpDarumaFrameWork.TextoNaoFiscal(Texto: String; Vias: Integer): String;
var
  i: Integer;
  sTexto   : String;
  iRet,nPos: Integer;
...
//----------------------------------------------------------------------------
function TImpDarumaFrameWork.LeCondPag:String;
var
  iRet : Integer;
  sRet : String;
  sPagto : String;
...
//----------------------------------------------------------------------------
function TImpDarumaFrameWork.AcrescimoTotal( vlrAcrescimo:String ): String;
var iRet: integer;
begin
    GravaLog('-> iCFTotalizarCupom_ECF_Daruma');
...
//----------------------------------------------------------------------------
function TImpDarumaFrameWork.MemoriaFiscal( DataInicio,DataFim:TDateTime;ReducInicio,ReducFim,Tipo:String ): String;
var
  iRet : Integer;
  sParam1,sParam2,sTipoAux,sPathDestino,sArqDest: String;
  bPorCOO : Boolean;
begin

  //Parametro "Tipo" recebe string com duas posições, sendo a segunda posição: "S" para leitura simplificada e "C" para leitura completa
  ...
  Begin
      ...
      begin
        ...
        begin
          ...
          If not CopyFile(pChar(sTipoAux+'Retorno.txt'),pChar(sPathDestino+sArqDest),False) then
          begin
...
//----------------------------------------------------------------------------
function TImpDarumaFrameWork.ReImpCupomNaoFiscal( Texto:String ):String;
begin
  MsgStop( MsgIndsImp );
  GravaLog(MsgIndsImp);
  Result := '0';
...
//----------------------------------------------------------------------------
function TImpDarumaFrameWork.AdicionaAliquota( Aliquota:String; Tipo:Integer ): String;
// Tipo = 1 - ICMS
// Tipo = 2 - ISS
var
  iRet : Integer;
...
//----------------------------------------------------------------------------
function TImpDarumaFrameWork.Autenticacao( Vezes:Integer; Valor,Texto:String ): String;
var
  iRet : Integer;
begin
...
//----------------------------------------------------------------------------
function TImpDarumaFrameWork.Gaveta:String;
var
  iRet : Integer;
begin
...
//----------------------------------------------------------------------------
function TImpDarumaFrameWork.Status( Tipo:Integer; Texto:String ):String;
var
  bErro : Boolean;
begin
  bErro := False;
...
//----------------------------------------------------------------------------
function TImpDarumaFrameWork.GravaCondPag( Condicao:String ):String;
var
  iRet : Integer;
begin
  GravaLog('-> confCadastrarPadrao_ECF_Daruma');
...
//----------------------------------------------------------------------------
function TImpDarumaFrameWork.TotalizadorNaoFiscal( Numero,Descricao:String ) : String;
var
  iRet : Integer;
begin
  GravaLog('-> confCadastrarPadrao_ECF_Daruma');
...
//----------------------------------------------------------------------------
function TImpDarumaFrameWork.RelatorioGerencial( Texto:String ;Vias:Integer; ImgQrCode: String):String;
var
  i       : Integer;
  iRet    : Integer;
  sTexto  : String;
...
//------------------------------------------------------------------------------
function TImpDarumaFrameWork.DownloadMFD(sTipo, sInicio, sFinal : String ):String;
Var
  iRet : Integer;   // Retorno da dll
  sMsg,sMsgOk,sMsgErr,sReg,sValIni,
  sValFim,sRetorno,sPathOrigem,
  sPathDestino,sNomeArq,sTpDown: String;
Begin
  sRetorno  := '1';
  ...
  Then begin
          ...
          If not (CopyFile(pChar(sPathOrigem+sNomeArq),pChar(sPathDestino + sNomeArq),False)) then
          begin
...
//------------------------------------------------------------------------------
function TImpDarumaFrameWork.GeraRegTipoE(sTipo, sInicio, sFinal, sRazao,sEnd, sBinario: String): String;
Var
  tFindFile : TSearchRec;
  iRet,iX: integer;
  sTpIntervalo,sPathOrigem,sPathDestino,sNomeArq,sNomeArqBin,sPathBin,sLinha: String;
...
begin
  ...
  begin
    ...
    If not (CopyFile(pChar(sPathBin),pChar(sPathDestino + sNomeArqBin),False)) then
    begin
  ...
  begin
     ...
     If (CopyFile(pChar(sPathOrigem+sNomeArq),pChar(sPathBin),False))
...
//-------------------------------------------------------------------------------
function TImpDarumaFrameWork.RelGerInd( cIndTotalizador , cTextoImp : String ; nVias : Integer ; ImgQrCode: String) : String;
Var
  iRet,i,nPos  : Integer;
  cTextoImpAux,sInformacao : String;
  sLista       : TStringList;
begin
...
//----------------------------------------------------------------------------
function TImpDarumaFrameWork.LeTotNFisc:String;
var
  iRet, i , iPosFim : Integer;
  sRet,sTotaliz,sSeparador : String;
begin
  sRet := Space( 360 );
...
//----------------------------------------------------------------------------
function TImpDarumaFrameWork.Pedido( Totalizador, Tef, Texto, Valor, CondPagTef:String ): String;
Var
  iRet : Integer;
  sPedido ,sRet   : String;
  sTefPedido      : String;
...
//------------------------------------------------------------------------------
function TImpDarumaFrameWork.RedZDado( MapaRes : String): String ;
Var
  aRetTemp: TaString;
  i,iRet: Integer;
  sAux: String;
...
//------------------------------------------------------------------------------
function TImpDarumaFrameWork.DownMF( sTipo, sInicio, sFinal : String ):String;
var
  sPath,sArquivo,sArquivoTxt,sLinha : String;
  iRet  : Integer;
  mArqMF: TStringList;
  aArquivo : TextFile;
Begin
...
//------------------------------------------------------------------------------
function TImpDarumaFrameWork.ImpTxtFis(Texto : String) : String;
begin
...
//------------------------------------------------------------------------------
function TImpDarumaFrameWork.HorarioVerao( Tipo:String ):String;
var iRet : Integer;
begin
  Result := '0';
  If Trim( Tipo ) = '+' then
...
//----------------------------------------------------------------------------
function TImpDarumaFrameWork.IdCliente( cCPFCNPJ , cCliente , cEndereco : String): String;
var
  iRet : Integer;
begin
...
//----------------------------------------------------------------------------
function TImpDarumaFrameWork.EstornNFiscVinc( CPFCNPJ , Cliente , Endereco , Mensagem , COOCDC : String ) : String;
var
  iRet : Integer;
begin
...
//----------------------------------------------------------------------------
function TImpDarumaFrameWork.ImprimeCodBarrasITF( Cabecalho , Codigo, Rodape : String ; Vias : Integer):String;
var
  i       : Integer;
  iRet    : Integer;
  sTexto,sAux,sInformacao,sRetorno : String;
begin
  sRetorno := '0';
...
Var
  iRet: Integer;   // Retorno da dll
  sNumSerie2,sNomeArq, sArqOrigem, sArqDestino, sTpArquivo,sNomeArqDest : String;
begin
  ...
  Begin
    ...
    If not CopyFile(pChar(sArqOrigem),pChar(sArqDestino),False) then
    begin
...
//------------------------------------------------------------------------------
Function TImpDarumaFrameWork.CapturaBaseISSRedZ : String;
var
  sLinhaISS,sAliquotas,sIss,
  sVlrBISS, sLinhaAux,sAImp: String;
...
//------------------------------------------------------------------------------
function TImpDarumaFrameWork.GrvQrCode(SavePath, QrCode: String): String;
var
  iRet : Integer;
begin
...
//------------------------------------------------------------------------------
function  TImpDarumaFrameWork.AbreCNF(CPFCNPJ, Nome, Endereco : String): String;
var
  iRet : Integer;
begin
...
//------------------------------------------------------------------------------
function  TImpDarumaFrameWork.RecCNF( IndiceTot , Valor, ValorAcresc,ValorDesc : String): String;
var
  iRet : Integer;
  cTipoAD,VlrAdDesc : String;
begin
...
//------------------------------------------------------------------------------
function  TImpDarumaFrameWork.PgtoCNF( FrmPagto , Valor, InfoAdicional, ValorAcresc,ValorDesc : String): String;
var
  iRet : Integer;
  cTipoAD,VlrAdDesc,sFrmPag,sVlrPag : String;
begin
...
//------------------------------------------------------------------------------
function  TImpDarumaFrameWork.FechaCNF( Mensagem : String): String;
var
  iRet : Integer;
begin
...
Function TrataRetornoDarumaFw( var iRet:Integer  ):String;
var
  sMsg,sErro,sWarning : String;
  iErro,iWarning,iFuncRet: Integer;
begin
  iErro := 0;
  iWarning := 0;
...
Function Status_ImpressoraFW( lMensagem:Boolean ): Integer;
var
   sRet,sRet2,sRet3,sRet4,sRet5,sMsg,sLinha : String;
   iRet : Integer;
begin
...
(*function TImpDarumaFrameCV0909.DownMF(sTipo, sInicio, sFinal: String): String;
var
  sPath,sArquivo,sArquivoTxt,sLinha : String;
  iRet  : Integer;
  mArqMF: TStringList;
...
//------------------------------------------------------------------------------
function TImpDarumaFrameCV0909.PegaCupom(Cancelamento: String): String;
var
  lFinaliza : Boolean;
  iCont,iRet : Integer;
  sNumCupom : String;
