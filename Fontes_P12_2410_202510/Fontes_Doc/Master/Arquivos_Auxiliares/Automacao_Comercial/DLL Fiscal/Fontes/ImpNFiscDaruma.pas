...
type
  ...
  Function OpenDarumaNF( sPorta:String; iVelocidade : Integer ):String;
  Function CloseDarumaNF : String;
...
var
    ...
    fFunc_rConsultaStatusImpressora_DUAL_DarumaFramework : function( stIndice: String; StTipo: String; StRetorno:String): Integer; StdCall;
    ...
    fFunc_rStatusGaveta_DUAL_DarumaFramework             : function (var iStatusGaveta: Integer): Integer;StdCall;
    fFunc_rStatusImpressora_DUAL_DarumaFramework         : function : Integer; StdCall;
    fFunc_regAguardarProcesso_DUAL_DarumaFramework       : function (stParametro: String): Integer;StdCall;
    fFunc_regCodePageAutomatico_DUAL_DarumaFramework     : function (stParametro: String): Integer;StdCall;
    fFunc_regEnterFinal_DUAL_DarumaFramework             : function (stParametro: String): Integer; StdCall;
    fFunc_regLinhasGuilhotina_DUAL_DarumaFramework       : function (stParametro: String): Integer; StdCall;
    fFunc_regModoGaveta_DUAL_DarumaFramework             : function (stParametro: String): Integer; StdCall;
    fFunc_regPortaComunicacao_DUAL_DarumaFramework       : function (stParametro: String): Integer; StdCall;
    fFunc_regTabulacao_DUAL_DarumaFramework              : function (stParametro: String): Integer; StdCall;
    fFunc_regTermica_DUAL_DarumaFramework                : function (stParametro: String): Integer; StdCall;
    fFunc_regVelocidade_DUAL_DarumaFramework             : function (stParametro: String): Integer; StdCall;
    fFunc_regZeroCortado_DUAL_DarumaFramework            : function (stParametro: String): Integer; StdCall;
    fFunc_eGerarQrCodeArquivo_DUAL_DarumaFramework       : function (stPath: String; stCodigo: String): Integer; StdCall;
    fFunc_iImprimirTexto_DUAL_DarumaFramework            : function (stTexto: String; iTam: Integer ): Integer; StdCall;
    fFunc_iImprimirBMP_DUAL_DarumaFramework              : function (stArqOrigem: String): Integer; StdCall;
    fFunc_iImprimirArquivo_DUAL_DarumaFramework          : function (stPath: String): Integer; StdCall;
    fFunc_iEnviarBMP_DUAL_DarumaFramework                : function (stArqOrigem: String): Integer; StdCall;
    fFunc_iAcionarGaveta_DUAL_DarumaFramework            : function : Integer; StdCall;
    fFunc_iAutenticarDocumento_DUAL_DarumaFramework      : function (stTexto: String; stLocal: String; stTimeOut: String): Integer; StdCall;
    fFunc_iConfigurarGuilhotina_DUAL_DarumaFramework     : function (iHabilitar: Integer; iQtdeLinha: Integer): Integer; StdCall;
    fFunc_regRetornaValorChave_DarumaFramework           : function (pszProduto:string;pszChave:string;pszValor:string):Integer; StdCall;
    fFunc_rVersaoFW_DUAL_DarumaFramework                 : function (pszRetornaVersao: String): Integer; StdCall;
...
//------------------------------------------------------------------------------
Function OpenDarumaNF( sPorta:String; iVelocidade : Integer) : String;
  function ValidPointer( aPointer: Pointer; sMSg:String; sArqDll:String = 'DarumaFrameWork.DLL' ) : Boolean;
  begin
...
var
  ...
  iRet : Integer;
  bRet : Boolean;
  sPathLog , sMsg , sIniVeloci,sIniPorta,sIni: String;
...
//----------------------------------------------------------------------------
function TImpNfDaruma.Abrir(sPorta : String; iVelocidade : Integer ; iHdlMain:Integer) : String;
Var
  sRet : String;
begin
...
//----------------------------------------------------------------------------
function TImpNfDaruma.Fechar( sPorta:String ):String;
begin
Result := CloseDarumaNF;
end;

//----------------------------------------------------------------------------
function TImpNfDaruma.ImpTexto( Texto : String):String;
Var
  iRet,nPos  : Integer;
  oTexto : TStringList;
  sAux,sTextoImp: String;
  bCorte : Boolean;
Begin
...
//----------------------------------------------------------------------------
function TImpNfDaruma.ImpCodeBar( Tipo,Texto:String  ):String;
begin
  ImpTexto(Texto);
end;

//----------------------------------------------------------------------------
function TImpNfDaruma.ImpBitMap( Arquivo:String ):String;
var
  iRet : Integer;
begin
...
//-----------------------------------------------------------------------------
function TImpNfDaruma.AbreGaveta(): String;
var
  iRet : Integer;
begin
...
//=============================================================================
function TImpNfDaruma.StatusImp(Tipo: Integer): String;
var
  strVersao : String;
  iRet : Integer;
begin
