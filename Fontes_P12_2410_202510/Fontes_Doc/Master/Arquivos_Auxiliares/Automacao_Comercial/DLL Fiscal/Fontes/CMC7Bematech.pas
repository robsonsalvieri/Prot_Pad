...
Type
  ...
  public
    ...
    function Status( iRetorno:Integer ):String;
  end;

//----------------------------------------------------------------------------
implementation
//----------------------------------------------------------------------------
function TCMC7_Bematech.Abrir(sPorta, sMensagem: String) : String;
...
//---------------------------------------------------------------------------
function TCMC7_Bematech.Fechar : String;
begin
  if (fHandle <> 0 ) then
  begin
...
//---------------------------------------------------------------------------
function TCMC7_Bematech.LeDocumento : String;
var
  iRet : Integer;
  sRet,sLinha,sPath : String;
  f : TextFile;
begin
...
//----------------------------------------------------------------------------
function TCMC7_Bematech.Status( iRetorno:Integer ) : String;
begin
  if iRetorno = 1 then
    result := '0'
  else
