...
Function OpenToledo( sPorta:String ):String;
...
var
  ...
  fArquivo : TIniFile;
  sPath,sBaud,sDtBits,sParity : String;
begin
...
//------------------------------------------------------------------------------
Function TToledo.Abrir( sPorta:String ):String;
Begin
  If Not bOpened Then
...
End;
//------------------------------------------------------------------------------
function TToledo.Fechar( sPorta:String ):String;
begin
  Result := CloseToledo;
end;
//------------------------------------------------------------------------------
Function TToledo.PegaPeso():String;
Var
  iRet : Integer;
  pPeso : Pchar;
  sPeso : String;
...
Begin
  ...
  Begin
    ...
    Try
      If iRet = 1 Then
      Begin
        sPeso := FloatToStr( StrToFloat( StrPas( pPeso ) ) / 1000  );
...
function TToledo9091.PegaPeso: String;
Var
  iRet : Integer;
  pPeso : Pchar;
  sPeso : String;
...
Begin
  ...
  Begin
    ...
    Try
      If iRet = 1 Then
      Begin
        sPeso := FloatToStr( StrToFloat( StrPas( pPeso ) ) / 100  );
        lCaptura := False; //Não continua o While, já capturou o peso
      End;
    Except
      iRet := 0
