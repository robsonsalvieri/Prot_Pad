...
function ShowSearch(oSender, cReturnID, cConsPadName) {
	if (!($('SearchForm'))) {
		...
		FrameBody.appendChild(new Element('img', {'src':'imagens/ajax-loader.gif'}));
	}
	...
	AjaxStartSearch(oSender, $('SearchForm'), cReturnID, cConsPadName);
}
