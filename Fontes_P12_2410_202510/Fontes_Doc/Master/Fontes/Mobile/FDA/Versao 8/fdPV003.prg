...
@ 60,03 BUTTON oObj CAPTION STR0010 ACTION PVQTde(aObjIte[1,5]) SIZE 39,11 of oFld //"Qtde."
...
If cEstOnLine = "T"
	...
	@ 60,120 BUTTON oObj CAPTION "Estoque" ACTION ConsEstOnLine(aColIte[1,1]) SIZE 39,11 of oFld
EndIf
*/
...
Endif
#IFDEF __PALM__
  @ 130,55 BUTTON oBtnOK CAPTION BTN_BITMAP_OK SYMBOL SIZE 33,11 ACTION PVGrvIte(aColIte,aItePed, nItePed, aCabPed,aObj,@cManTes,cProDupl,nOpIte,1,"P") of oIte
#ELSE
  @ 130,55 BUTTON oBtnOK CAPTION STR0014 SIZE 33,11 ACTION PVGrvIte(aColIte,aItePed, nItePed, aCabPed,aObj,@cManTes,cProDupl,nOpIte,1,"P") of oIte //"OK"
#ENDIF
