...
#IFDEF __PALM__
  @ 143,05 BUTTON oBtnOK CAPTION BTN_BITMAP_OK SYMBOL SIZE 45,12 ACTION CPRet(oBrwCP,aArray,@cVar,oObj, aCamp, aRet) of oDlg
  @ 143,55 BUTTON oBtnCanc CAPTION BTN_BITMAP_CANCEL SYMBOL SIZE 45,12 ACTION CloseDialog() of oDlg
  @ 143,105 BUTTON oBtnPesq CAPTION BTN_BITMAP_SEARCH SYMBOL SIZE 45,12 ACTION CPPesq(cAlias,@cPesq,aArray,oBrwCP,@nTop,aCamp,aInd,nInd) of oDlg
#ELSE
  @ 144,05 BUTTON oBtnOK    CAPTION STR0003        SIZE 45,10 ACTION CPRet(oBrwCP,aArray,@cVar,oObj, aCamp, aRet) of oDlg	 //"OK"
  @ 144,55 BUTTON oBtnCanc  CAPTION STR0004  SIZE 45,10 ACTION CloseDialog() of oDlg //"Cancelar"
  @ 144,105 BUTTON oBtnPesq CAPTION STR0005 SIZE 45,10 ACTION CPPesq(cAlias,@cPesq,aArray,oBrwCP,@nTop,aCamp,aInd,nInd) of oDlg //"Pesquisar"
#ENDIF
