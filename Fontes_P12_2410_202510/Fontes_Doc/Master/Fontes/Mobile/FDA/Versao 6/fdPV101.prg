...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
*/
Function PVGrvIte(aColIte,aItePed, nItePed, aCabPed,aObj,cManTes,cProDupl,nOpIte,nTelaPed,cOrigem)
...
Elseif aColIte[6,1] == 0
  MsgStop(STR0005,STR0002)   //"Escolha/Escreva o Preço!"###"Verifica Item"
  Return .f.
Elseif aColIte[7,1] > nDescMax
  MsgStop(STR0006 + str(nDescMax,3,2) + " %",STR0002) //"Desconto acima do máximo permitido: "###"Verifica Item"
  Return .f.
Elseif Empty(aColIte[8,1])
  MsgStop(STR0007,STR0002)   //"Tes não Selecionado!"###"Verifica Item"
  Return .f.                                      
endif
