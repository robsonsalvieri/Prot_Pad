...
If cFolderDes == "T"
	...
	PVFldDesc(@oPVDesc,@aObj,@oObj,@aCabPed,@cCliente)//Chamada de uma funcao para criacao do folder de desconto pois o segmento para o fonte já estourou
EndIf
If cSfaFpg = "T"
	//Forma de Pagto.
...
Else
	...
	@ 18,89 CHECKBOX oCod VAR lCodigo CAPTION STR0027 ACTION SetFocus(oCtrlPsq) OF oFldProd //"Código"
