...
Local cResp	:= "", nPos := 0
cResp:= if(MsgYesOrNo(STR0005,STR0006),STR0007,STR0008) //"Você deseja Excluir a Mensagem Selecionada?"###"Cancelar"###"Sim"###"Não"
If cResp=STR0007 //"Sim"
	...
	If HMV->(Found()) 
		dbDelete()
		dbSkip()
		Alert(STR0009) //"Mensagem Excluída com Sucesso!"
	Endif
	nPos := GridRow(oBrwMsg)
	aDel(aMsg, nPos)
