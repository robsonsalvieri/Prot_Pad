...
±±³Funcao    ³ GPEW012  ³ Autor ³ Totvs                      ³ Data ³ 08/04/2014 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡…o ³Workflow FLUIG - Justificativa Horario                                ³±±
...
//-------------------------------------------------------------------
/*/{Protheus.doc} GPEW012()
WF Solicitação Justificativa Horario - TIPO 8(Portal)
...
Static Function ViewDef()
	...
	Local aStr			:={	"RF0_FILIAL","RF0_MAT","TMP_NOME","RF0_DTPREI","RF0_DTPREF","RF0_HORINI","RF0_HORFIM","RF0_CODABO";
							,"TMP_ABOND"}
	Local aFields 		:= {}
