...
ฑฑบPrograma    ณ GPER905     บAutor  ณKelly Soares        บ Data ณ  27/10/2011 บฑฑ
ฑฑฬออออออออออออุอออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.       ณ Relatorio Oficial de Decima Quarta Remuneracao.               บฑฑ
ฑฑบ            ณ                                                               บฑฑ
...
ฑฑณEmerson Campณ22/12/11ณTEEDLX     ณAjustes para funcionamento da Query.      ณฑฑ
ฑฑณMohanad Odehณ27/02/12ณTENIP7     ณInclusใo de obrigatoriedade de            ณฑฑ
ฑฑณ                     ณ003659/2012ณpreenchimento dos parโmetros Mes/Ano e    ณฑฑ
ฑฑณ                     ณ           ณRoteiro                                   ณฑฑ
ฑฑศออออออออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function GPER905()
	...
	AADD(aButtons, { 5,.T., { || Pergunte("GPER905", .T. ) } } )
...
ฑฑบPrograma  ณR905ImpB    บAutor  ณAlex Sandro Fagundes บ Data ณ  02/09/2010 บฑฑ
...
ฑฑบUso       ณ Gper905 - Chamado na funcao: R905ImpB e R905ImpA           บฑฑ
...
Static Function ImpInfFunc(nLin,nCont,nContGeral)
	...
	oPrint:say ( nLin, 0130, SubStr(QSRA->NOME,1,27), oFont11 ) 
	...
	oPrint:say ( nLin, 1900, Transform(QSRA->TOTAL,"@E 999,999,999.99"), oFont11 ) 
...
Static Function ImpArrFunc(nX)
	...
	oPrint:say ( nLin, 1900, aFuncs[nX, 6], oFont11 ) 
...
Static Function AddInfFunc(nLin,nCont,nContGeral)
	...
	AADD(aFuncs, {Transform(nContGeral,"9999") , SubStr(QSRA->NOME,1,27) , SubStr(QSRA->FUNCAO,1,13) , cSexo , Transform(QSRA->TOTDIAS,"99999") , Transform(QSRA->TOTAL,"@E 999,999,999.99") } )
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัอออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณR905ImpA    บAutor  ณAlex Sandro Fagundes บ Data ณ  02/09/2010 บฑฑ
ฑฑฬออออออออออุอออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
Static Function R905ImpA()                   
	...
	oFont17n:= TFont():New("Courier New",17,17,,.T.,,,,.T.,.F.)     //Negrito//
		...
		oPrint:StartPage() 							//Inicia uma nova pagina   
			...
			oPrint:say ( 0720, 0200, cRUC, oFont11 )
			oPrint:say ( 0720, 0880, cCnae, oFont11 )
			oPrint:say ( 0720, 1320, cDesProv, oFont11 )    // Provincia
			oPrint:say ( 0720, 1900, cDescCan, oFont11 )	// Canton
			oPrint:say ( 0720, 2480, cDesParr, oFont11 )	// Parroquia
                                 
			// Dados da Empresa
			oPrint:say ( 0960, 0540, cEmpresa, oFont11 )
			oPrint:say ( 0960, 2500, cTelef, oFont11 )
                                                           
			//Endere็o da Empresa
			oPrint:say ( 1090, 0280, cEnde, oFont11 )
			...
			oPrint:say ( 1530, 2350, Transform(cTotHomVl+cTotMujVl,"@E 999,999,999.99"), oFont11 )	// Valor total DecimaTerceira Remuneracion
			...
			oPrint:say ( 1665, 2350, Transform(cTotHomVl,"@E 999,999,999.99"), oFont11 )	// Total DecimaTerceira HOMBRES
			...
			oPrint:say ( 1795, 2350, Transform(cTotMujVl,"@E 999,999,999.99"), oFont11 )	// Total DecimaTerceira MUJERES
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัอออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณfFuncs14     บAutor  ณAlex Sandro Fagundesบ Data ณ  02/09/2010 บฑฑ
ฑฑฬออออออออออุอออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
Static Function fFuncs14(cPeriodos,cRoteiro)
	Local cPDVALOR		:= ""
	Local nReg		:= 0	
	Local cRotQuery := ""
	Local cFiltro		:= ""
	...
	If !(len(aPerAberto) < 1)
		...
		BeginSql alias cAliasSRA
			SELECT	FILIAL, MATRICULA, NOME, SEXO, PAIS, FUNCAO, PERIODO, CATEGORIA,
					SUM(DIAS) TOTDIAS, SUM(DQUARTA) TOTAL
			FROM
				(SELECT	RA_FILIAL FILIAL, RA_MAT MATRICULA, RA_NOME NOME, RA_CATFUNC CATEGORIA, RA_SEXO SEXO, 
						RA_CODPAIS PAIS, RJ_DESC FUNCAO, RC_PERIODO PERIODO, RC_HORAS DIAS, RC_VALOR DQUARTA, 0 BASE
				FROM  %table:SRA% SRA	
	...
	ElseIf !(len(aPerFechado) < 1)
		BeginSql alias cAliasSRA
			...
			FROM
				(SELECT	RA_FILIAL FILIAL, RA_MAT MATRICULA, RA_NOME NOME, RA_CATFUNC CATEGORIA, RA_SEXO SEXO, 
						RA_CODPAIS PAIS, RJ_DESC FUNCAO, RD_PERIODO PERIODO, RD_HORAS DIAS, RD_VALOR DQUARTA, 0 BASE
				FROM  %table:SRA% SRA	
...
ฑฑณFuno    ณLimpa5    ณ Autor ณ Alex Sandro Fagundes  ณ Data ณ13/09/2010ณฑฑ
...
Static Function fSetVar()
	...
	If Empty(AllTrim(mv_par02)) .OR. Empty(AllTrim(cRoteiro))
		MsgAlert(OemToAnsi(STR0021)) // "Os parโmetros M๊s/Ano e Roteiro sใo de preenchimento obrigat๓rio!"
		Return Nil
	EndIf
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณFuno    ณfDuplexS5 ณ Autor ณ Alex Sandro Fagundes  ณ Data ณ13/09/2010ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescrio ณ Monta dialogo para selecao com botoes Duplex SIM           ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณ Uso      ณ                                                            ณฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณFuno    ณfDuplexN5 ณ Autor ณ Alex Sandro Fagundes  ณ Data ณ13/09/2010ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescrio ณ Monta dialogo para selecao com botoes Duplex SIM           ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณ Uso      ณ                                                            ณฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณFuno    ณImpDtrA5  ณ Autor ณ Alex Sandro Fagundes  ณ Data ณ14/09/2010ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณFuno    ณImpDtrB5  ณ Autor ณ Alex Sandro Fagundes  ณ Data ณ14/09/2010ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescrio ณ Monta dialogo para selecao com botoes Duplex NAO           ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณ Uso      ณ                                                            ณฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณFuno    ณImpDtrBV5 ณ Autor ณ Alex Sandro Fagundes  ณ Data ณ14/09/2010ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescrio ณ Monta dialogo para selecao com botoes Duplex NAO           ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณ Uso      ณ                                                            ณฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณFuno    ณR905ImpBV ณ Autor ณ Alex Sandro Fagundes  ณ Data ณ17/09/2010ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
