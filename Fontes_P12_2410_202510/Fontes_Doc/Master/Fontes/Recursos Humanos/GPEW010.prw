...
±±³Descri‡…o ³Workflow FLUIG - Solicitação Aumento                                ³±±
...
//-------------------------------------------------------------------
/*/{Protheus.doc} GPEW010()
WF Solicitação Aumento salarial - TIPO 7(Portal)
...
Static Function ViewDef()
	...
	//Local aStr			:= {"RB7_FILIAL","RB7_MAT","TMP_NOME","RB7_TPALT","RB7_FUNCAO","RB7_CARGO","RB7_PERCEN","RB7_SALARI","RB7_CATEG"}
	Local aStr			:= {"RB7_FILIAL","RB7_MAT","TMP_NOME","RB7_TPALT","RB7_FUNCAO","RB7_CARGO","RB7_CATEG","RB7_SALARI","RB7_PERCEN"}
	Local aFields 		:= {}
