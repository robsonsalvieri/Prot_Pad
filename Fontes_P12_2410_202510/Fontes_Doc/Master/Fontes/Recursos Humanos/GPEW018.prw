...
±±³Funcao    ³ GPEW018  ³ Autor ³ Totvs                      ³ Data ³ 08/04/2014 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡…o ³Workflow FLUIG - Reserva Treinamento                               ³±±
...
//-------------------------------------------------------------------
/*/{Protheus.doc} GPEW018()
WF Solicitação Reserva Treinamento - TIPO A(Portal)
...
Static Function ViewDef()
	...
	Local aStr			:={	"RA3_FILIAL","RA3_MAT","TMP_NOME","RA3_CALEND","RA3_CURSO","RA3_TURMA","RA3_DATA"}
	Local aFields 		:= {}
