...
±±³Fun‡…o    ³ VDFR170  ³ Autor ³ Robson Soares de Morais³ Data ³  02.01.14 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡…o ³ Relatório de Afastamentos                                    ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Sintaxe   ³ VDFR170(void)                                                ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Parametros³                                                              ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³ Uso      ³ Generico                                                     ³±±
...
Private oReport
Private cString		:= "SRA"
Private cPerg		:= "VDFR170"
Private aOrd    	:= {}
Private cTitulo		:= STR0001 //'Relatório de Afastamentos'
Private nSeq 		:= 0
Private cAliasQRY	:= ""
...
±±³Parametros³                                                              ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³ Uso      ³ VDFR170 - Generico - Release 4                               ³±±
...
TRCell():New(oFunc,"RA_MAT","SRA",STR0005,,14,/*lPixel*/,/*bBlock*/, "CENTER") //'Matrícula'
...
TRCell():New(oFunc,"RCM_DESCRI","RCM",STR0008,, 60) //'Afastamento/Motivo'
TRCell():New(oFunc,"RI6_DTEFEI","RI6",STR0009,, 14,/*lPixel*/,/*bBlock*/, "CENTER") //'Efeito'
TRCell():New(oFunc,"RI6_NUMDOC","RI6",STR0010) //'Ato'
TRCell():New(oFunc,"RI5_DTATPO","RI5",STR0011,, 14,/*lPixel*/,/*bBlock*/, "CENTER") //'Data'
...
cWhere += " AND SR8.R8_DATAINI BETWEEN '" + Right(mv_par03, 4) + Left(mv_par03, 2) + "01' AND " +;
...
BeginSql Alias cAliasQRY
	...
	Column RI5_DTATPO As Date
		
	SELECT RA_FILIAL, RA_MAT, RA_NOME, SQB.QB_DESCRIC, Q3_DESCSUM, RCM_DESCRI, SR8.R8_DATAINI AS RI6_DTEFEI, 
	       RI6_NUMDOC, RI5_DTATPO, R8_DATAINI
	  FROM %table:SR8% SR8
	 ...
	 ORDER BY SRA.RA_FILIAL, RI6.RI6_NUMDOC, SR8.R8_DATAINI, SRA.RA_NOME 
