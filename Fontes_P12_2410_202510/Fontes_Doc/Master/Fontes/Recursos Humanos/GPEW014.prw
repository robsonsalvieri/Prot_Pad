...
//-------------------------------------------------------------------
/*/{Protheus.doc} GPEW014()
WF Solicitação Admissao - TIPO 5(Portal)
...
Static Function ViewDef()
	...
	Local aStr			:= {"RBT_DEPTO","RBT_CODPOS","TMP_TIPO","TMP_FILIAL","TMP_MAT"}
	Local aFields 		:= {}
