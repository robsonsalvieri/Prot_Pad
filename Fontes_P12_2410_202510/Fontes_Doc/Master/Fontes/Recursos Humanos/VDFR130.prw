...
±±³Descri‡…o ³ Relatório de Controle de Nomeações                           ³±±
...
Private aOrd    	:= {}
Private cTitulo	:= STR0001 //'Relatório de Controle de Nomeações'
Private nSeq 		:= 0
Private cAliasQRY	:= ""
...
Local cDescri   := STR0002 //"Relatório de Controle de Nomeações"
...
TRCell():New(oFunc,"Q3_DESCSUM","SQ3",STR0008,, 32) //Função do servidor //'Cargo/Função'
TRCell():New(oFunc,"QB_DESCRIC","SQB",STR0007) //Lotação atual do servidor //'Lotação'
TRCell():New(oFunc,"RI6_DTEFEI","RI6",STR0009) //'Exercício'
