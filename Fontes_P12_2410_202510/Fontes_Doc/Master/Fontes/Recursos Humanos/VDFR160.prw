...
±±³Fun‡…o    ³ VDFR160  ³ Autor ³ Robson Soares de Morais³ Data ³  02.01.14 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡…o ³ Relatório de Remoções                                        ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Sintaxe   ³ VDFR160(void)                                                ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Parametros³                                                              ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³ Uso      ³ Generico                                                     ³±±
...
Private oReport
Private cString		:= "SRA"
Private cPerg		:= "VDFR150" //usa mesmo grupo que o relatório VDFR150
Private aOrd    	:= {}
Private cTitulo		:= STR0001 //'Relatório de Remoções'
Private nSeq 		:= 0
Private cAliasQRY	:= ""
...
±±³Parametros³                                                              ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³ Uso      ³ VDFR160 - Generico - Release 4                               ³±±
...
Local cDescri   := STR0012 //"Relatório de Remoções"

oReport := TReport():New("VDFR160", cTitulo, cPerg, {|oReport| ReportPrint(oReport, cTitulo)}, cDescri,;
...
oFunc := TRSection():New(oFilial, STR0003, ( "SRA","SQ3","SQB","RI5","RI6" )) //'Servidores'
...
TRCell():New(oFunc,"RA_NOME","SRA",STR0005,,40) 		//'Nome'
TRCell():New(oFunc,"Q3_DESCSUM","SQ3",STR0006,,40) 		//'Cargo'
TRCell():New(oFunc,"QB_DESCRIC_D","SRE",STR0007,,40)   	// 'Lotação'
TRCell():New(oFunc,"QB_DESCRIC_P","SRE",STR0008,,40) 		// 'Remoção'
TRCell():New(oFunc,"RE_DATA","RI6",STR0009) 		//'Efeito'
...
cWhere += "SRE.RE_MATP = CASE WHEN SRA.RA_CATFUNC IN ('2', '3', '6') " +;
                             "THEN CASE WHEN SQB_D.QB_COMARC <> SQB_P.QB_COMARC THEN SRE.RE_MATP ELSE '' END ELSE " +;
                        "CASE WHEN SRA.RA_CATFUNC IN ('0', '1') THEN SRE.RE_MATP ELSE '' END END"
...
SELECT SRA.RA_FILIAL, SRA.RA_MAT, SRA.RA_NOME, SQ3.Q3_DESCSUM, SQB_D.QB_DESCRIC AS QB_DESCRIC_D,
       SQB_P.QB_DESCRIC AS QB_DESCRIC_P, RI6.RI6_DTEFEI, RI6.RI6_NUMDOC, RI5.RI5_DTATPO, SRE.RE_DEPTOD, 
       SRE.RE_DEPTOP, SRE.RE_EMPD, SRE.RE_FILIALD, SRE.RE_MATD, SRE.RE_DATA
  FROM %table:SRE% SRE
