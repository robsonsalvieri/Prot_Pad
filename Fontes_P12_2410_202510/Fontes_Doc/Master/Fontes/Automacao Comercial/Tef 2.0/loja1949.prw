...
ฑฑบPrograma  ณLJCDadosTransacaoDeditoParcelado  บAutorณVENDAS CRMบ Data ณ  29/10/09   บฑฑ
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿     
*/
Class LJCDadosTransacaoDebitoParcelado From LJADadosTransacaoCCCD 
...
Method New(nValor, 		 nCupom, 		dData,		cHora, ;
			...
			nIdCartao, 		nParcela,	lUltimaTrn,	cRede) Class LJCDadosTransacaoDebitoParcelado 

	_Super:New(nValor, nCupom, dData, cHora, cFormaPagto, cDescPagto, cAdmFin, lCarManual, nIdCartao, _DEBITOPARCELADO, lUltimaTrn, cRede)
