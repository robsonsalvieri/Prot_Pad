...
ฑฑบClasse    ณLJCDadosTransacaoRC  บAutor  ณVendas Clientes     บ Data ณ  11/02/10   บฑฑ
ฑฑฬออออออออออุอออออออออออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณDados da transacao de recarga de celular     							 บฑฑ
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
Class LJCDadosTransacaoRC From LJADadosTransacao
	
	Data cFormaPgto						//Forma de Pagamento Ex: R$,CH,CC,CD
...
ฑฑบDesc.     ณMetodo construtor da classe LJCDadosTransacaoRC.		    	     บฑฑ
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
Method New(nValor, nCupom, dData, cHora, lUltimaTrn, cRede, cFormaPgto) Class LJCDadosTransacaoRC
    
	_Super:New(nValor, nCupom, dData, cHora, _RECARGACELULAR, lUltimaTrn, cRede)
