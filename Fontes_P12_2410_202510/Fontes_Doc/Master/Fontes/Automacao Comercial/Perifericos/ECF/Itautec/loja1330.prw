...
ฑฑบClasse    ณLJAItautec       บAutor  ณVendas Clientes     บ Data ณ  24/02/10   บฑฑ
...
Class LJAItautec From LJAEcf
	...
	Data dDataFimE                                                              //Data Final da Gera็ใo do Registro
	Data cIdModECF                                                              //Modelo do ECF
	Data dDataSW                                                                //Data de Grava็ใo do Software Bแsico
	Data cHoraSW                                                                //Hora de grava็ใo do Software Bแsico
    ...
    Method DownMF()																			//Gerar Arquivo da mem๓ria fiscal
    Method RedZDado()	
...
ฑฑฬออออออออออุอออออออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณMetodo construtor da classe LJAItautec.     			    	     บฑฑ
ฑฑฬออออออออออุอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณSigaLoja / FrontLoja                                        		 บฑฑ
ฑฑฬออออออออออุอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบParametrosณ																	 บฑฑ
...
Method CarregMsg() Class LJAItautec
	...
	Self:AdicMsgECF("998",	STR0129, ERRO)   	//"Data final de Emissใo do ultimo cupom nใo encontrada."
	Self:AdicMsgECF("999",	STR0130, ERRO)   	//"Fun็ใo nใo suportada pelo modelo de ECF utilizado." 		
...
/*ÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜ
ฑฑบPrograma  ณLeTotDesIssบAutor  ณVendas Clientes     บ Data ณ  06/03/08   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณMetodo responsavel pela leitura do somatorio dos    		  บฑฑ
ฑฑบ          ณdescontos executados na impressora ( ICMS + ISS )  	  	  บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
Method TipoEData(cDatInicio, cDatFim, cPathArq, cBinario) Class LJAItautec
	...
	Default cPathArq := ""
	Default cBinario := "0" //Gera arquivo binแrio?	
...
ฑฑบUso       ณSigaLoja / FrontLoja                                  	  			 บฑฑ
ฑฑฬออออออออออุอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบParametrosณEXPC1 (1 - cCOOnicio) - COO inicial						 			 บฑฑ
ฑฑบ			 ณEXPC2 (2 - cCOOFim) - COO final							 			 บฑฑ
ฑฑฬออออออออออุอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบRetorno   ณObjeto LJCRetornoEcf										 			 บฑฑ
ฑฑศออออออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
...
Method TipoECrz(cCOOInicio, cCOOFim, cBinario) Class LJAItautec
	...
	If cBinario <> "1"
		...
		//Caso nao encontre, vai retrocedendo a mem๓ria da impressora ate encontrar     
		...
		Do While !SFI->(Bof()) .and. lProcessa  
			If  cSeriePDV = Alltrim(SFI->FI_SERPDV) //Guarda os dados da ๚tima redu็ao processada
				If Val(cCOOFim) <= (Val(SFI->FI_NUMFIM)+1) //So alimenta as variแveis se o COO for menor igual ao registrado na redu็ใo Z
	    ...
	    Else 
	        ...
	        oRetorno := Self:TratarRet("998")    //"Data final de Emissใo do ultimo cupom nใo encontrada." 	    
	 	 	oRetorno:oRetorno := ""				//Copia o valor da propriedade da classe
	    EndIf
    Else
		oRetorno := Self:TratarRet("999")
    ...
    //If(oRetorno:cAcao == OK)    	
	 ...
	 //	cBuffer := space(255)
	    ...
	    If(oRetorno:cAcao == OK)    	
			...
			//FirmWare 
			oParams := Self:PrepParam({ITAUTEC, "E4InfEspECF", "8", cBuffer})   //Versใo firmware
		    //Envia o comando    	
			cRetorno := Self:EnviarCom(oParams)
		    //Trata o retorno    
		    oRetorno := Self:TratarRet(cRetorno)
