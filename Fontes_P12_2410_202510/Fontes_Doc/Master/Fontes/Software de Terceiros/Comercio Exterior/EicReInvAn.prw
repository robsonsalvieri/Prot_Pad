...
Function EicReInvAn()
*========================*
If EasyEntryPoint("EicReInvAn")
   ExecBlock("EicReInvAn",.F.,.F.)
Else
...
IF EICLoja()
   IndRegua("Work",cArqDBF+TEOrdBagExt(),"WK_FORN+WK_FORLOJ+WK_AGEMB+WK_MOEDA+WK_INVOICE")
Else
   IndRegua("Work",cArqDBF+TEOrdBagExt(),"WK_FORN+WK_AGEMB+WK_MOEDA+WK_INVOICE")
EndIf
...
If cTipoRel == "2"
   ...
   EndIf
    ...
    If EICLoja()
      IndRegua("Work2",cArqDBF2+TEOrdBagExt(),"WK_FORN+WK_FORLOJ+WK_INVOICE")
   Else
      IndRegua("Work2",cArqDBF2+TEOrdBagExt(),"WK_FORN+WK_INVOICE")
   EndIf
