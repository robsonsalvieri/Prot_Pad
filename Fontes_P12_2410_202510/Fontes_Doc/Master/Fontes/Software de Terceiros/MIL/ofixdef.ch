// ÉÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÍÍ» //                     --------
// º Versao º 15     º // ABRIR UM CHAMADO NO   GCAD   PARA ATUALIZACAO NA TOTVS
// ÈÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÍ¼ //                     --------
// ------------------------------------------------------------------------------------------ //
// ------------------------------------------------------------------------------------------ //
// Email com orientações da TOTVS recebido em 20/06/2014 ( Daiane Santos Nunes )              // 
// Toda vez que atualizar o CH, abrir chamado para o GCAD informando o local do mesmo,        // 
// para que baixemos do TFS e atualizemos manualmente no diretório de includes do Robopatch   // 
// ------------------------------------------------------------------------------------------ //
// ------------------------------------------------------------------------------------------ //
...
#DEFINE PECA_CLVL           42      // Classe de Valor Contábil
#DEFINE PECA_LOTECT         43      // Lote
#DEFINE PECA_NUMLOT         44      // Sub-Lote
#DEFINE PECA_MARLUC         45      // Margem de Lucro
#DEFINE PECA_QTDVEC         46      // Quantidade do VEC
#DEFINE PECA_FUNDIS         47      // Tecnico da Liberacao do Tipo de Tempo (VO3_FUNDIS)

#DEFINE SRVC_NTAM_RETORNO   58
...
#DEFINE SRVC_APONT_TEMVEN /*14*/ 27 // Tempo vendido por Apontamento
#DEFINE SRVC_APONT_HOREXT /*14*/ 28 // Tipo da Hora
#DEFINE SRVC_APONT_CLAHAB /*14*/ 29 // Classificacao da Habilidade
...
#DEFINE SRVC_CLVL           51      // Classe de Valor Contábil
#DEFINE SRVC_INCTEM         52      // Tempo para Calculo
#DEFINE SRVC_GENERICO       53      // Servico Generico ?
#DEFINE SRVC_FUNDIS         54      // Tecnico da Liberacao do Tipo de Tempo (VO4_FUNDIS)
#DEFINE SRVC_SITTPO         55      // Situação do tipo de tempo
#DEFINE SRVC_NNFCOM         56      // Numero da Nota Fiscal de Compra
#DEFINE SRVC_SNFCOM         57      // Serie da Nota Fiscal de Compra
#DEFINE SRVC_HORFEC         58      // Hora do fechamento 