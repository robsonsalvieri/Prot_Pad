...
Function MNA613VLD( cCampo )
	...
	Do Case
		...
		Case cCampo == 'TQF_CONVEN'
			...
			If ExistBlock( 'MNTA613X' )

				lReturn := ExecBlock( 'MNTA613X', .F., .F., { oModel:GetModel( 'MNTA613_TQF' ) } )
...
Function MNA613RELA( cCampo )
	...
	If oModel != Nil
		...
		If aScan( oModel:GetDependency(), { | x | x[ 2 ] == 'MNTA613_TQF' } ) == 0
	...
	Do Case
		...
		Case cCampo == 'TQF_COMBOI'
			...
			If oModel <> Nil
				...
				xRet := IIf( lInclui, '2', oModel:GetValue( 'MNTA613_TQF', 'TQF_COMBOI' ) )
		...
		Case cCampo == 'TQF_LOJA'
			...
			If oModel <> Nil
				...
				xRet := SA2->( VDISP( oModel:GetValue( 'MNTA613_TQF', 'TQF_CODIGO' ) ,'A2_LOJA' ) )
		...
		Case cCampo == 'TQF_POSTO'
			...
			If oModel <> Nil
				...
				xRet := SA2->( VDISP( oModel:GetValue( 'MNTA613_TQF', 'TQF_CODIGO' ) + oModel:GetValue( 'MNTA613_TQF', 'TQF_LOJA' ), 'A2_NOME' ) )
		...
		Case cCampo == 'TQF_NREDUZ'
			...
			If oModel <> Nil
				...
				xRet := SA2->( VDISP( oModel:GetValue( 'MNTA613_TQF', 'TQF_CODIGO' ) + oModel:GetValue( 'MNTA613_TQF', 'TQF_LOJA' ),'A2_NREDUZ' ) )
		...
		Case cCampo == 'TQF_CIDADE'
			...
			If oModel <> Nil
				...
				xRet := SA2->( VDISP( oModel:GetValue( 'MNTA613_TQF', 'TQF_CODIGO' ) + oModel:GetValue( 'MNTA613_TQF', 'TQF_LOJA' ), 'A2_MUN' ) )
		...
		Case cCampo == 'TQF_BAIRRO'
			...
			If oModel <> Nil
				...
				xRet := SA2->( VDISP( oModel:GetValue( 'MNTA613_TQF', 'TQF_CODIGO' ) + oModel:GetValue( 'MNTA613_TQF', 'TQF_LOJA' ), 'A2_BAIRRO' ) )
		...
		Case cCampo == 'TQF_ESTADO'
			...
			If oModel <> Nil
				...
				xRet := SA2->( VDISP( oModel:GetValue( 'MNTA613_TQF', 'TQF_CODIGO' ) + oModel:GetValue( 'MNTA613_TQF', 'TQF_LOJA' ), 'A2_EST' ) )
		...
		Case cCampo == 'TQF_TIPPOS'
			...
			If oModel <> Nil
				...
				xRet := IIf( lInclui, '1', oModel:GetValue( 'MNTA613_TQF', 'TQF_TIPPOS' ) )
		...
		Case cCampo == 'TQF_CONVEN'
			...
			If oModel <> Nil
				...
				xRet := IIf( lInclui, '1', oModel:GetValue( 'MNTA613_TQF', 'TQF_CONVEN' ) )
		...
		Case cCampo == 'TQF_ATIVO'
			...
			If oModel <> Nil
				...
				xRet := IIf( lInclui,'1', oModel:GetValue( 'MNTA613_TQF', 'TQF_ATIVO' ) )
		...
		Case cCampo == 'TQF_LANMAN'
			...
			If oModel <> Nil
				...
				xRet := IIf( lInclui, '1', oModel:GetValue( 'MNTA613_TQF', 'TQF_LANMAN' ) )
