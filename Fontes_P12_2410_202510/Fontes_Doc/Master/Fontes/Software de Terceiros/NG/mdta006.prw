...
If !lSigaMdtps
	msgStop(STR0007)  //"Esse programa é de uso exclusivo de empresas prestadoras de serviço."
	Return .T.
Endif

If !ChkFile("SZ1",.F.)
	msgStop(STR0008 + CHR(13)+CHR(10) +;  //"A tabela SZ1 (Cidades) não existe. Favor executar a rotina"
		    STR0009)  //"UPDMDTPS através do IDE, digitando U_UPDMDTPS na barra de execução."
	Return .T.
Endif
