...
Function SGAA780()
	...
	oBrowse := FWMBrowse():New()
		...
		oBrowse:SetMenuDef( "SGAA780" )	// Nome do fonte onde esta a função MenuDef
...
Static Function ViewDef()
	...
	oView := FWFormView():New()
		...
		oView:AddField( "VIEW_TFC" , oStructTFC , "TFCMASTER" )
			...
			oView:EnableTitleView( "VIEW_TFC" , STR0001 )	// Descrição do browse
