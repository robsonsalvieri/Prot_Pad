...
Programa para cadastro dos sub-grupos da Terminologia Unificada da Saúde Suplementar
...
Function MDTA022()
	...
	oBrowse := FWMBrowse():New()
		...
		oBrowse:SetMenuDef( "MDTA022" )	// Nome do fonte onde esta a função MenuDef
		oBrowse:SetDescription( STR0001 )	// Descrição do browse ###"Subgrupos da TUSS"
	oBrowse:Activate()
...
Static Function ViewDef()
	...
	oView := FWFormView():New()
		...
		oView:AddField( "VIEW_TY1", oStructTY1, "TY1MASTER" )
			...
			oView:EnableTitleView( "VIEW_TY1", STR0001 )	// Descrição do browse ###"Subgrupos da TUSS"
    ...
    ElseIf nOperation == MODEL_OPERATION_UPDATE //Alteracao
    	...
    	If TY1->TY1_GRUPO <> oModel:GetValue( "TY1MASTER", "TY1_GRUPO" )
    		...
    		If dbSeek( xFilial( "TY2" ) + TY1->TY1_GRUPO + TY1->TY1_SUBGRU )
	    		Help( ' ', 1, STR0002, , STR0003, 2, 0 ) //"ATENÇÃO"##"Este SubGrupo e Grupo já foram vinculados a um TUSS, portanto o relacionamento deve ser mantido."
				lRet := .F.
	    	EndIf
    	EndIf
