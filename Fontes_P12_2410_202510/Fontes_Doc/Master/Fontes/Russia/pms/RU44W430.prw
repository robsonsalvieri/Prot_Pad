...
/*MAINTENANCE FOR Project Management Query (simple model to be used in web forms for VISUALIZATION)*/

PUBLISH MODEL REST NAME RU44W430 RESOURCE OBJECT oRU44W430

/*/{Protheus.doc} oRU44W430
description
@type class
@version  
@author
@since 03/07/2023
/*/
Class oRU44W430 From FwRestModel
...
/*/{Protheus.doc} oRU44W430::Activate
description
@type method
@version  
@author 
...
/*/
Method Activate() Class oRU44W430
...
/*/{Protheus.doc} oRU44W430::DeActivate
description
@type method
@version  
@author
...
@return variant, return_description
/*/
Method DeActivate() Class oRU44W430
...
@return variant, return_description
/*/
Method Seek(cPK) Class oRU44W430
...
Method GetData() Class oRU44W430
	Local cRet := self:cResponse
Return cRet

Method Skip() Class oRU44W430
Return .F.

Method StartGetFormat(nTotal, nCount, nStartIndex) Class oRU44W430
...
/*/
//-------------------------------------------------------------------
Method EndGetFormat() Class oRU44W430
...
Static Function MenuDef()
	Local aRotina := {}
	aAdd( aRotina, { STR0002  , 'VIEWDEF.RU44W430', 0, 2, 0, NIL } )
Return aRotina
...
//Local oRestModel:= oRU44W430():New()
	oStruAJ8 := FWFormStruct( 1, 'AJ8' ,/* { |x| ALLTRIM(x) $ ' AF9_PROJETO, AF9_REVISA, AF9_EDTPAI, AF9_TAREFA, AF9_DESCRI, AF9_NIVEL, AF9_GRPCOM,AF9_REQ, AF9_START, AF9_FINISH, AF9_HDURAC,AF9_OBS,' } */ )
	oModel := MPFormModel():New('RU44W430',,,)

//oModel:SetVldActivate( { |oModel| ACTIVATE( oModel ) } )
SX3->(DbSetOrder(2))
SX3->(DBSEEK( 'AF9_DESCRI'))
oStruAJ8:AddField(STR0006, ''/*<cTooltip >*/, SX3->X3_CAMPO, SX3->X3_TIPO, SX3->X3_TAMANHO, SX3->X3_DECIMAL,;
 					/*[ bValid ]*/, ;
					{|| .F. }/*[ bWhen ]*/,;
					/* [ aValues ]*/, ;
					/*[ lObrigat ]*/,;
 					{|| Posicione('AF9',5,xFilial('AF9')+ AJ8->AJ8_PROJPM + AJ8->AJ8_TASKPM, 'AF9_DESCRI')}, ;
 					.F. /*<lKey >*/,;
  					.T. /*[ lNoUpd ]*/,;
  					.T. /* [ lVirtual ]*/,;
    				/*[ cValid ]*/)
...
oStruAJ8:AddField(STR0007, ''/*<cTooltip >*/, SX3->X3_CAMPO, SX3->X3_TIPO, SX3->X3_TAMANHO, SX3->X3_DECIMAL,;
 					/*[ bValid ]*/, ;
					{|| .F. }/*[ bWhen ]*/,;
					/* [ aValues ]*/, ;
					/*[ lObrigat ]*/,;
 					{|| Posicione('AF8',1,xFilial('AF8')+ AJ8->AJ8_PROJPM, 'AF8_DESCRI')}, ;
 					.F. /*<lKey >*/,;
  					.T. /*[ lNoUpd ]*/,;
  					.T. /* [ lVirtual ]*/,;
    				/*[ cValid ]*/)
...
// Adiciona ao modelo um componente de formul?rio
	oModel:AddFields( 'AJ8MASTER', /*cOwner*/, oStruAJ8)
...
// Cria um objeto de Modelo de dados baseado no ModelDef() do fonte informado
	Local oModel := FWLoadModel( 'RU44W430' )
// Cria a estrutura a ser usada na View
	Local oStruAJ8 := FWFormStruct( 2, 'AJ8' )
// Interface de visualiza??o constru?da
	Local oView

	oStruAJ8:SetNoFolder()
...
// (antiga Enchoice)
	oView:AddField( 'VIEW_AJ8', oStruAJ8, 'AJ8MASTER' )

// Criar um "box" horizontal para receber algum elemento da view
	oView:CreateHorizontalBox( 'HEADER' , 100 )
// Relaciona o identificador (ID) da View com o "box" para exibi??o
	oView:SetOwnerView( 'VIEW_AJ8', 'HEADER' )
