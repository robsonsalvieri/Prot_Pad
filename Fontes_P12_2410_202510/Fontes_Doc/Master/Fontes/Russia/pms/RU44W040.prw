...
PUBLISH MODEL REST NAME RU44W040 RESOURCE OBJECT oRU44W040

/*/{Protheus.doc} oRU44W040
description
@type class
@version  
@author
@since 03/07/2023
/*/
Class oRU44W040 From FwRestModel
...
/*/{Protheus.doc} oRU44W040::Activate
description
@type method
@version  
@author 
...
/*/
Method Activate() Class oRU44W040
...
/*/{Protheus.doc} oRU44W040::DeActivate
description
@type method
@version  
@author
...
@return variant, return_description
/*/
Method DeActivate() Class oRU44W040
...
@return variant, return_description
/*/
Method Seek(cPK) Class oRU44W040
...
Method GetData() Class oRU44W040
	Local cRet := self:cResponse
Return cRet

Method Skip() Class oRU44W040
Return .F.

Method StartGetFormat(nTotal, nCount, nStartIndex) Class oRU44W040
...
/*/
//-------------------------------------------------------------------
Method EndGetFormat() Class oRU44W040
...
Static Function MenuDef()
	Local aRotina := {}
	aAdd( aRotina, { STR0002   	, 'VIEWDEF.RU44W040', 0, 2, 0, NIL } )
	aAdd( aRotina, { STR0003   , 'VIEWDEF.RU44W040', 0, 3, 0, NIL } )
	aAdd( aRotina, { STR0004   , 'VIEWDEF.RU44W040', 0, 4, 0, NIL } )
	aAdd( aRotina, { STR0005   , 'VIEWDEF.RU44W040', 0, 4, 0, NIL } )
Return aRotina
...
//Local oRestModel:= oRU44W040():New()
	oStruAE7 := FWFormStruct( 1, 'AE7' ,/* { |x| ALLTRIM(x) $ ' AF9_PROJETO, AF9_REVISA, AF9_EDTPAI, AF9_TAREFA, AF9_DESCRI, AF9_NIVEL, AF9_GRPCOM,AF9_REQ, AF9_START, AF9_FINISH, AF9_HDURAC,AF9_OBS,' } */ )
	oModel := MPFormModel():New('RU44W040',,,)

//oModel:SetVldActivate( { |oModel| ACTIVATE( oModel ) } )

// Adiciona ao modelo um componente de formul?rio
	oModel:AddFields( 'AE7MASTER', /*cOwner*/, oStruAE7)
...
// Cria um objeto de Modelo de dados baseado no ModelDef() do fonte informado
	Local oModel := FWLoadModel( 'RU44W040' )
// Cria a estrutura a ser usada na View
	Local oStruAE7 := FWFormStruct( 2, 'AE7' )
// Interface de visualiza??o constru?da
	Local oView

	oStruAE7:SetNoFolder()
...
// (antiga Enchoice)
	oView:AddField( 'VIEW_AE7', oStruAE7, 'AE7MASTER' )

// Criar um "box" horizontal para receber algum elemento da view
	oView:CreateHorizontalBox( 'HEADER' , 100 )
// Relaciona o identificador (ID) da View com o "box" para exibi??o
	oView:SetOwnerView( 'VIEW_AE7', 'HEADER' )
