...
/*MAINTENANCE FOR Compositon Groups (simple model to be used in web forms for VISUALIZATION)*/

PUBLISH MODEL REST NAME RU44W020 RESOURCE OBJECT oRU44W020

/*/{Protheus.doc} oRU44W020
description
@type class
@version  
@author
@since 03/07/2023
/*/
Class oRU44W020 From FwRestModel
...
/*/{Protheus.doc} oRU44W020::Activate
description
@type method
@version  
@author 
...
/*/
Method Activate() Class oRU44W020
...
/*/{Protheus.doc} oRU44W020::DeActivate
description
@type method
@version  
@author
...
@return variant, return_description
/*/
Method DeActivate() Class oRU44W020
...
@return variant, return_description
/*/
Method Seek(cPK) Class oRU44W020
...
Method GetData() Class oRU44W020
	Local cRet := self:cResponse
Return cRet

Method Skip() Class oRU44W020
Return .F.

Method StartGetFormat(nTotal, nCount, nStartIndex) Class oRU44W020
...
/*/
//-------------------------------------------------------------------
Method EndGetFormat() Class oRU44W020
...
/*/
Method DelData(cPk,cError) Class oRU44W020
    Local lRet      := .T.
    Default cData   := ""
...
/*/
Method SaveData(cPk,cData,cError) Class oRU44W020
    Local lRet      := .T.
    Default cData   := ""
...
Static Function MenuDef()
	Local aRotina := {}
	aAdd( aRotina, { STR0002   , 'VIEWDEF.RU44W020', 0, 2, 0, NIL } )
	aAdd( aRotina, { STR0003   , 'VIEWDEF.RU44W020', 0, 3, 0, NIL } )
	aAdd( aRotina, { STR0004   , 'VIEWDEF.RU44W020', 0, 4, 0, NIL } )
	aAdd( aRotina, { STR0005   , 'VIEWDEF.RU44W020', 0, 5, 0, NIL } )
...
// Cria a estrutura a ser usada no Modelo de Dados
	Local oStruAE5
	Local oModel 
	//Local bPost		:= {|oModel| RU44W020PosValidation(oModel)}
	oStruAE5 := FWFormStruct( 1, 'AE5' ,/* { |x| ALLTRIM(x) $ ' AF9_PROJETO, AF9_REVISA, AF9_EDTPAI, AF9_TAREFA, AF9_DESCRI, AF9_NIVEL, AF9_GRPCOM,AF9_REQ, AF9_START, AF9_FINISH, AF9_HDURAC,AF9_OBS,' } */ )
	oModel := MPFormModel():New('RU44W020',,/*bPost*/,)
	oModel:AddFields( 'AE5MASTER', /*cOwner*/, oStruAE5)
	oModel:SetPrimarykey({'AE5_GRPCOM'})
...
// Cria um objeto de Modelo de dados baseado no ModelDef() do fonte informado
	Local oModel := FWLoadModel( 'RU44W020' )
// Cria a estrutura a ser usada na View
	Local oStruAE5 := FWFormStruct( 2, 'AE5' )
// Interface de visualiza??o constru?da
	Local oView

	oStruAE5:SetNoFolder()
...
// (antiga Enchoice)
	oView:AddField( 'VIEW_AE5', oStruAE5, 'AE5MASTER' )

// Criar um "box" horizontal para receber algum elemento da view
	oView:CreateHorizontalBox( 'HEADER' , 100 )
// Relaciona o identificador (ID) da View com o "box" para exibi??o
	oView:SetOwnerView( 'VIEW_AE5', 'HEADER' )
