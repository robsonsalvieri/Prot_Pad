...
{Protheus.doc} RUREF182N
    ...
    @version 12.1.23
*/
Class RUREF182N From RUHRReference
...
{Protheus.doc} New(cMat)
    Default constructor for RUREF182N class.
    ...
    @version 12.1.23
*/
Method New(cMat) Class RUREF182N
...
{Protheus.doc} GetByYear(dBaseDate As Date)
    ...
    @version 12.1.23
*/
Method GetByYear(dBaseDate) Class RUREF182N
    ...
    If nYearIndex != 0
        aYearInfo := { Val(StrTokArr(aSplittedContent[nYearIndex + 1], "=")[2]),;
                       Val(StrTokArr(aSplittedContent[nYearIndex + 2], "=")[2]) }
    EndIf
