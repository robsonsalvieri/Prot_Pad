...
If cRD0 != cF4J .Or. cRD0 != cF4M .Or. cRD0 != cF4L .Or. cRD0 != cF4H  .Or. cRD0 != cF4G
	MsgInfo( STR0020 + CRLF + CRLF + ; 		//"Mode Access betwen tables People/Participants (RD0) and folowing tables must be tha same:"
	 		 STR0022 + CRLF +;				//"F4M-SNILS"
	 		 STR0023 + CRLF + ;				//"F4H-Military Services"
			 STR0024 + CRLF + CRLF +; 		//"F4G-Documents"	
	 		 STR0021 ) 						//"Edit Mode Access through Configurator Module."
	Return (.F.)
EndIf
...
Local aRotina :=  FWLoadMenuDef("RU07D06")
