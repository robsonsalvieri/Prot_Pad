...
BEGIN TRANSACTION
	...
	aadd(aAutoCab,  {"RBR_DESCTA" 		,cArea+" - Тариф07"				,Nil		})
	...
	aadd(aAtLvl0101,{"RB6_DESCTA" 		,cArea+" - Тариф07"				,Nil		})
	...
	aadd(aAtLvl0102,{"RB6_DESCTA" 		,cArea+" - Тариф07"				,Nil		})
	...
	aadd(aAtLvl0201,{"RB6_DESCTA" 		,cArea+" - Тариф07"				,Nil		})
	...
	aadd(aAtLvl0202,{"RB6_DESCTA" 		,cArea+" - Тариф07"				,Nil		})
	...
	aadd(aAtLvl0301,{"RB6_DESCTA" 		,cArea+" - Тариф07"				,Nil		})
	...
	aadd(aAtLvl0302,{"RB6_DESCTA" 		,cArea+" - Тариф07"				,Nil		})
	...
	aadd(aAtLvl0401,{"RB6_DESCTA" 		,cArea+" - Тариф07"				,Nil		})
	...
	aadd(aAtLvl0402,{"RB6_DESCTA" 		,cArea+" - Тариф07"				,Nil		})
