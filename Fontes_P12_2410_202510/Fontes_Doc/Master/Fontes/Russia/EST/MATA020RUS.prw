...
oView:AddUserButton(STR0108,'AddrButton', {|| RU34XREP01("MATA020", .F.) },,,{MODEL_OPERATION_VIEW})
Return oView
...
aAdd(aRotina,{STR0109, "RU34XREP01('MATA020', .T.)", 0, 2})
Return aRotina
