...
cCNPJ		:= If( Len(AllTrim(cCNPJ)) == 11, "000" + AllTrim(cCNPJ), cCNPJ )
...
aAdd( aTipo0, { 'NÚMERO DO CNPJ DA EMPRESA            ', 083, 096,   'C',  14,  0, .T. ,'cCNPJ' } )
...
aAdd( aTipo9, { 'NÚMERO DO CNPJ DA EMPRESA            ', 022, 035,   'C',  14,  0, .T. , 'cCNPJ' } )
...
cAux       := StrTran(AllTrim( SRA->RA_CTDEPSA ), "-", "")
