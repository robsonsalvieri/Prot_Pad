...
Static lSaOrdSep := AcdVldSA("CB7","CB7_NUMSA")
...
If oSetup:Activate() == PD_OK 
	...
	RptStatus({|lEnd| ACD100Imp(@lEnd,@oPrinter)},STR0003)//"Imprimindo Relatorio..."
Else 
...
Function ACD100Imp(lEnd,oPrinter)
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß*/
Function CabItem(oPrinter,cOrigem)
...
If lSaOrdSep
	cNumSA	:= AllTrim((cAliasOS)->CB7_NUMSA)
EndIf
...
ElseIf Alltrim(cOrigem) == "4" //Solicitação ao Armazém
	oPrinter:SayAlign(li+60,nMargDir+160,STR0049,oFontC8,200,200,,0)//"Solicitação ao Armazém:"
	oPrinter:SayAlign(li+60,nMargDir+255,cNumSA,oFontC8,200,200,,0)
EndIf
