...
Function CQ0BlnQry(dDataIni as Date,dDataFim as Date,cContaIni as Character,cContaFim as Character,cMoeda as Character,cTpSald as Character,aSetOfBook as Array,lImpMov as Logical,;
	lVlrZerado as Logical,lImpAntLP as Logical,dDataLP as Date,cFilUsu as Character,cMoedaDsc as Character,aSelFil as Array,dDtCorte as Date,lTodasFil as Logical,aTmpFil as Array,cModEsc as Character, lLstSldZero as Logical)
...
If !Empty(dDtCorte) .And. ValType(dDtCorte) == "D" //data de corte para calculo do saldo anterior - Usado em Portugal	
	cQuery += " SUM(CASE WHEN CQ1_DATA >= '"+DTOS(dDtCorte)+"' AND CQ1_DATA < '"+DTOS(dDataIni)+"' AND CQ1_TPSALD = '"+cTpSald+"' AND CQ1_MOEDA = '"+cMoeda+"' THEN CQ1_DEBITO ELSE 0 END) AS SALDOANTDB,"+CRLF
	cQuery += " SUM(CASE WHEN CQ1_DATA < '"+DTOS(dDtCorte)+"' AND CQ1_TPSALD = '"+cTpSald+"' AND CQ1_MOEDA = '"+cMoeda+"' THEN CQ1_DEBITO ELSE 0 END) AS SLDANTCTDB,"+CRLF
	cQuery += " SUM(CASE WHEN CQ1_DATA >='"+DTOS(dDtCorte)+"' AND CQ1_DATA < '"+DTOS(dDataIni)+"' AND CQ1_TPSALD = '"+cTpSald+"' AND CQ1_MOEDA = '"+cMoeda+"' THEN CQ1_CREDIT ELSE 0 END) AS SALDOANTCR,"+CRLF
	cQuery += " SUM(CASE WHEN CQ1_DATA < '"+DTOS(dDtCorte)+"' AND CQ1_TPSALD = '"+cTpSald+"' AND CQ1_MOEDA = '"+cMoeda+"' THEN CQ1_CREDIT ELSE 0 END) AS SLDANTCTCR,"+CRLF
	If lImpAntLP
		...
		cQuery += " ((CQ1_DTLP <> ' ' AND CQ1_DTLP >= '"+DTOS(dDataLP)+"') OR (CQ1_DTLP = '' AND CQ1_DATA >= '"+DTOS(dDataLP)+"')) THEN CQ1_DEBITO ELSE 0 END) AS SLDLPANTDB,"+CRLF
		cQuery += " SUM(CASE WHEN CQ1_DATA < '"+DTOS(dDtCorte)+"' AND CQ1_TPSALD = '"+cTpSald+"' AND CQ1_MOEDA = '"+cMoeda+"' AND CQ1_LP = 'Z' AND" 
		cQuery += " ((CQ1_DTLP <> ' ' AND CQ1_DTLP >= '"+DTOS(dDataLP)+"') OR (CQ1_DTLP = ' ' AND CQ1_DATA >= '"+DTOS(dDataLP)+"')) THEN CQ1_DEBITO ELSE 0 END) AS SLLPATCTDB,"+CRLF
		...
		cQuery += " AND ((CQ1_DTLP <> ' ' AND CQ1_DTLP >= '"+DTOS(dDataLP)+"') OR (CQ1_DTLP = '' AND CQ1_DATA >= '"+DTOS(dDataLP)+"')) THEN CQ1_CREDIT ELSE 0 END) AS SLDLPANTCR,"+CRLF
		cQuery += " SUM(CASE WHEN CQ1_DATA < '"+DTOS(dDtCorte)+"' AND CQ1_TPSALD = '"+cTpSald+"' AND CQ1_MOEDA = '"+cMoeda+"' AND CQ1_LP = 'Z' AND"
		cQuery += " ((CQ1_DTLP <> ' ' AND CQ1_DTLP >= '"+DTOS(dDataLP)+"') OR (CQ1_DTLP = '' AND CQ1_DATA >= '"+DTOS(dDataLP)+"')) THEN CQ1_CREDIT ELSE 0 END) AS SLLPATCTCR,"+CRLF
	EndIf	
Else
	cQuery += " SUM(CASE WHEN CQ1_DATA < '"+DTOS(dDataIni)+"' AND CQ1_TPSALD"+If(cModEsc == "ECF", " IN ("+cTpSald+")", " = '"+cTpSald+"'")+" AND CQ1_MOEDA = '"+cMoeda+"' THEN CQ1_DEBITO ELSE 0 END) AS SALDOANTDB,"+CRLF
	cQuery += " SUM(CASE WHEN CQ1_DATA < '"+DTOS(dDataIni)+"' AND CQ1_TPSALD"+If(cModEsc == "ECF", " IN ("+cTpSald+")", " = '"+cTpSald+"'")+" AND CQ1_MOEDA = '"+cMoeda+"' THEN CQ1_CREDIT ELSE 0 END) AS SALDOANTCR,"+CRLF
	If lImpAntLP
		...
		cQuery += " ((CQ1_DTLP <> ' ' AND CQ1_DTLP >= '"+DTOS(dDataLP)+"') OR (CQ1_DTLP = '' AND CQ1_DATA >= '"+DTOS(dDataLP)+"')) THEN CQ1_DEBITO ELSE 0 END) AS SLDLPANTDB,"+CRLF
		cQuery += " SUM(CASE WHEN CQ1_DATA < '"+DTOS(dDataIni)+"' AND CQ1_TPSALD"+If(cModEsc == "ECF", " IN ("+cTpSald+")", " = '"+cTpSald+"'")+" AND CQ1_MOEDA = '"+cMoeda+"' AND CQ1_LP = 'Z' AND"
		cQuery += " ((CQ1_DTLP <> ' ' AND CQ1_DTLP >= '"+DTOS(dDataLP)+"') OR (CQ1_DTLP = '' AND CQ1_DATA >= '"+DTOS(dDataLP)+"')) THEN CQ1_CREDIT ELSE 0 END) AS SLDLPANTCR,"+CRLF
	EndIf	
EndIf
...
// ---------------------------  Saldo Atual ------------------------------------------------------------
cQuery += " SUM(CASE WHEN CQ1_DATA BETWEEN '"+DTOS(dDataIni)+"' AND '"+DTOS(dDataFim)+"' AND CQ1_TPSALD"+If(cModEsc == "ECF", " IN ("+cTpSald+")", " = '"+cTpSald+"'")+" AND CQ1_MOEDA = '"+cMoeda+"' THEN CQ1_DEBITO ELSE 0 END) AS SALDODEB,"+CRLF
cQuery += " SUM(CASE WHEN CQ1_DATA BETWEEN '"+DTOS(dDataIni)+"' AND '"+DTOS(dDataFim)+"' AND CQ1_TPSALD "+If(cModEsc == "ECF", " IN ("+cTpSald+")", " = '"+cTpSald+"'")+" AND CQ1_MOEDA = '"+cMoeda+"' THEN CQ1_CREDIT ELSE 0 END) AS SALDOCRD"+CRLF
If lImpAntLP	
	...
	cQuery += " ((CQ1_DTLP <> ' ' AND CQ1_DTLP >= '"+DTOS(dDataLP)+"') OR (CQ1_DTLP = '' AND CQ1_DATA >= '"+DTOS(dDataLP)+"')) THEN CQ1_DEBITO ELSE 0 END) AS MOVLPDEB,"+CRLF
	cQuery += " SUM(CASE WHEN CQ1_DATA BETWEEN '"+DTOS(dDataIni)+"' AND '"+DTOS(dDataFim)+"' AND CQ1_TPSALD "+If(cModEsc == "ECF", " IN ("+cTpSald+")", " = '"+cTpSald+"'")+" AND CQ1_MOEDA = '"+cMoeda+"' AND CQ1_LP = 'Z' AND"
	cQuery += " ((CQ1_DTLP <> ' ' AND CQ1_DTLP >= '"+DTOS(dDataLP)+"') OR (CQ1_DTLP = '' AND CQ1_DATA >= '"+DTOS(dDataLP)+"')) THEN CQ1_CREDIT ELSE 0 END) AS MOVLPCRD"+CRLF
EndIf
...
cQuery += " SELECT CT1_CONTA AS CONTA,  CT1_NORMAL AS NORMAL, CT1_RES AS CTARES, CT1_CTASUP AS SUPERIOR, CT1_CLASSE AS TIPOCONTA, CT1_GRUPO AS GRUPO,"+CRLF
...
if lPageControl .and. (FWIsInCallStack("TOTVS.FRAMEWORK.TREPORTS.CALLTREPORTS") .Or.;
	FWIsInCallStack("TOTVS.FRAMEWORK.TREPORTS.INTEGRATEDPROVIDER.EXECDATA"))
...
cQuery += " AND ARQ2.CT1_CLASSE = '2'"+CRLF
cQuery += " AND ARQ2.CT1_CONTA BETWEEN '"+cContaIni+"' AND '"+cContaFim+"'"+CRLF
If Alltrim(Upper(FunName())) == "CTBR185" .Or.;
	(FWIsInCallStack("TOTVS.FRAMEWORK.TREPORTS.CALLTREPORTS") .Or.;
     FWIsInCallStack("TOTVS.FRAMEWORK.TREPORTS.INTEGRATEDPROVIDER.EXECDATA") .And. lCTBR185SV)
...
If cTipo == '2'
	cQuery += " 	AND "+cTabDia+"_LP <= ? " + CRLF
EndIf
cQuery += " 	AND  D_E_L_E_T_ = ? " + CRLF 


If !(ALLTRIM(TcGetDB()) $ "MSSQL|ORACLE|INFORMIX|POSTGRES")  
	cQuery := ChangeQuery(cQuery)		
Endif
