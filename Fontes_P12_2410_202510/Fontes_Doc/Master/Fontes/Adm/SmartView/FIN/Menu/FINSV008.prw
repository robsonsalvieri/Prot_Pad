...
/*/{Protheus.doc} FINSV008
    Chamada do Smart View no menu - listofinterests - Juros recebidos e pagos
...
Function FINSV008()
    ...
    if !FWSX1Util():ExistPergunte("FINT010")
		FINSV08HLP()
        return
	endIf

    If GetRpoRelease() > '12.1.2210'
        lSuccess := totvs.framework.treports.callTReports("backoffice.sv.fin.listofinterests",,,,,.F.,,.T., @cError)
        If !lSuccess
            Conout(cError)
        EndIf
    Else
...
/*/{Protheus.doc} FINSV08HLP
    Exibe Finhelp na chamada do menu FINSV008

    @author guilhermed.santos@totvs.com.br
    @since 19/12/2024
    @version 12.1.2410
*/
static function FINSV08HLP()
	...
	cTitulo  := STR0001 + " - " + STR0002 //FINSV008 - Juros recebidos e pagos

	cMsg := "<font size='5' color='"+ cColorTitle +"'><b>" + STR0003 + " - " + STR0001 + "</b></font><br/><br/>"//HELP - FINSV008

	cMsg += "<font size='3' color='"+ cColorSubTitle +"'><b>" + STR0004 + "</b></font><br/>" //Ocorrência
	cMsg += "<font size='3' color='"+ cColorText +"'>" + STR0005 + "</font><br/><br/>"//Grupo de perguntas FINT010 ausente.
	...
	aBtLinks[1,1] :=  STR0009 + " - " + STR0001 //Documento de referência - FINSV008
