...
Function CTBSV019()
    ...
    Local cNome := "backoffice.sv.ctb.balancesheet"
    Local cError as character

    Local aHiddenParams := {} As Array
    Local jParams as json

    aHiddenParams := {"MV_PAR09","MV_PAR16","MV_PAR21","MV_PAR12","MV_PAR13","MV_PAR14","MV_PAR15","MV_PAR17","MV_PAR11","MV_PAR24","MV_PAR28"} 
