...
±±³Fun‡ao    ³GH144805  ³ Autor ³ MICROSIGA             ³ Data ³ 09/10/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH144805]","Aguarde , processando preparação dos arquivos")
	...
	If lOpen
		For nI := 1 To Len(aRecnoSM0)
 		...
 		nModulo := 51 // modulo SIGAHSP
			...
			conout( "Funções descontinuadas pelo SGBD: GeraSX1(),GeraSX2(),GeraSX3() E GeraSIX()" )
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH144805] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
