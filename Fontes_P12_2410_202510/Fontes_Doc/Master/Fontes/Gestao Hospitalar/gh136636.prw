...
±±³Fun‡ao    ³GH136636  ³ Autor ³ MICROSIGA             ³ Data ³ 26/11/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH136636]","Aguarde , processando preparação dos arquivos")
	...
	If lOpen
		For nI := 1 To Len(aRecnoSM0)
 		...
 		nModulo := 51 // modulo SIGAHSP
			...
			FWLogMsg('WARN',, 'SIGAPLS', funName(), '', '01', "Funções descontinuadas pelo SGBD: GeraSX2(),GeraSX3(),GeraSIX() e GeraSXB()" , 0, 0, {})
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH136636] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
