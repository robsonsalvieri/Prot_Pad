...
±±³Fun‡ao    ³GH135065  ³ Autor ³ MICROSIGA             ³ Data ³ 20/12/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH135065]","Aguarde , processando preparação dos arquivos")
	...
	If lOpen
		For nI := 1 To Len(aRecnoSM0)
 		...
 		nModulo := 51 // modulo SIGAHSP
			...
			FWLogMsg('WARN',, 'SIGAPLS', funName(), '', '01', "Funções descontinuadas pelo SGBD: GeraSX3(),GeraSX6() E GeraSIX()" , 0, 0, {})
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH135065] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
