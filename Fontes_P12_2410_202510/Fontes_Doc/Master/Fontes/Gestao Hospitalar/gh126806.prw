...
±±³Fun‡ao    ³GH126806  ³ Autor ³ MICROSIGA             ³ Data ³ 12/06/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH126806]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH126806] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
