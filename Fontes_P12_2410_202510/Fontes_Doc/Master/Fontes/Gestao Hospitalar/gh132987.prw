...
±±³Fun‡ao    ³GH132987  ³ Autor ³ MICROSIGA             ³ Data ³ 19/09/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH132987]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH132987] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
