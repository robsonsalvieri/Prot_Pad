...
±±³Fun‡ao    ³GH128424  ³ Autor ³ MICROSIGA             ³ Data ³ 20/07/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH128424]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH128424] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
