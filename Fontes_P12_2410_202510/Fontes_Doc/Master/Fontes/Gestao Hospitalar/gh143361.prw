...
±±³Fun‡ao    ³GH143361  ³ Autor ³ MICROSIGA             ³ Data ³ 02/04/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH143361]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH143361] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
