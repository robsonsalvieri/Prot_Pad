...
±±³Fun‡ao    ³GH140847  ³ Autor ³ MICROSIGA             ³ Data ³ 14/02/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH140847]","Aguarde , processando preparação dos arquivos")
	...
	If lOpen
		For nI := 1 To Len(aRecnoSM0)
 		...
 		nModulo := 51 // modulo SIGAHSP
			...
			FWLogMsg('WARN',, 'SIGAPLS', funName(), '', '01', "Funções descontinuadas pelo SGBD: GeraSX1(),GeraSX2(),GeraSX3(),GeraSIX() e GeraSXB()" , 0, 0, {})
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH140847] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
