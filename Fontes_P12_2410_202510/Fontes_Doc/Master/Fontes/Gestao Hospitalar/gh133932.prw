...
±±³Fun‡ao    ³GH133932  ³ Autor ³ MICROSIGA             ³ Data ³ 04/10/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH133932]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH133932] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
