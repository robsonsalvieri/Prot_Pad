...
±±³Fun‡ao    ³GH130396  ³ Autor ³ MICROSIGA             ³ Data ³ 07/08/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH130396]","Aguarde , processando preparação dos arquivos")
	...
	If lOpen
		For nI := 1 To Len(aRecnoSM0)
 		...
 		nModulo := 51 // modulo SIGAHSP
			...
			FWLogMsg('WARN',, 'SIGAPLS', funName(), '', '01', "Funções descontinuadas pelo SGBD: GeraSIX()" , 0, 0, {})
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH130396] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
