...
±±³Fun‡ao    ³GH129174  ³ Autor ³ MICROSIGA             ³ Data ³ 26/07/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH129174]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH129174] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
