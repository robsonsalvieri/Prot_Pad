...
±±³Fun‡ao    ³GH133732  ³ Autor ³ MICROSIGA             ³ Data ³ 28/09/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH133732]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH133732] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
