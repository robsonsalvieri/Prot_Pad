...
±±³Fun‡ao    ³GH139951  ³ Autor ³ MICROSIGA             ³ Data ³ 02/09/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH139951]","Aguarde , processando preparação dos arquivos")
	...
	If lOpen
		For nI := 1 To Len(aRecnoSM0)
 		...
 		nModulo := 51 // modulo SIGAHSP
			...
			FWLogMsg('WARN',, 'SIGAPLS', funName(), '', '01', "Funções descontinuadas pelo SGBD: GeraSX2(),GeraSXB() e GeraSX3()" , 0, 0, {})
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH139951] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
