...
±±³Fun‡ao    ³GH128476  ³ Autor ³ MICROSIGA             ³ Data ³ 05/07/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH128476]","Aguarde , processando preparação dos arquivos")
...
±±³Fun‡…o    ³ProcATU   ³ Autor ³                       ³ Data ³05/07/07  ³±±
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH128476] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
