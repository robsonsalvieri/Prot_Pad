...
ฑฑบPrograma  ณHSPAHACJ  บ Autor ณ Saude		         บ Data ณ  01/12/10   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณ CADASTRO DE DISPONIBILIDADE CLINICA                        บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  | HS_ACJ   บ Autor ณ PAULO JOSE         บ Data ณ 16/11/04    บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
DEFINE MSDIALOG oDlg TITLE OemToAnsi(STR0006) From aSize[7],0 TO aSize[6]+25,aSize[5]	PIXEL of oMainWnd //"Disponibilidade M้dica"

oEnchoi:= MsMGet():New(cAlias, nReg, nOpc,,,,,{aPObjs[1, 1], aPObjs[1, 2], aPObjs[1, 3], aPObjs[1, 4]},,,,,, oDlg)
oEnchoi:oBox:Align := CONTROL_ALIGN_TOP

@ 120, 000 FOLDER oFolder SIZE 317, 117 OF oDlg PROMPTS STR0007, STR0008, STR0009, STR0059 PIXEL //"Dia da Semana"###"Planos nใo Atendidos"###"Procedimentos"###"Perํodos Indisponํveis"
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณHS_VldACJ บ Autor ณ Paulo Jose         บ Data ณ  18/11/04   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ElseIf ReadVar() == "M->GM6_CODLOC"
	...
	Else
		If GCS->GCS_TIPLOC <> "1" .AND. GCS->GCS_TIPLOC <> "J"
			HS_MsgInf(STR0073, STR0011, STR0053)//"Setor invแlido. Utilize um setor do tipo Atend. Clinica"###"Aten็ใo"###"Valida็ใo dos Campos"
			lRet := .F.
		Else
...
ElseIf ReadVar() == "M->GMK_CODREC"
	If !(lRet := HS_SeekRet("GO2","__cCodSal+M->GMK_CODREC",1,.F.,,,,, .T.))
		HS_MsgInf(STR0074, STR0011, STR0053) //"Recurso nใo cadastrado para sala" ### Aten็ใo"###"Valida็ใo dos Campos"
	EndIf
EndIf
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณFS_VldHACJบ Autor ณ Paulo Jose         บ Data ณ  18/11/04   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณFS_GrvACJ บ Autor ณ Paulo Jose         บ Data ณ  18/11/04   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
