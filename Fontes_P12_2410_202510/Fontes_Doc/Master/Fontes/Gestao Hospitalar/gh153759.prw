...
±±³Fun‡ao    ³GH153759  ³ Autor ³ MICROSIGA             ³ Data ³ 18/09/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH153759]","Aguarde , processando preparação dos arquivos")
	...
	If lOpen
		For nI := 1 To Len(aRecnoSM0)
 		...
 		nModulo := 51 // modulo SIGAHSP
			...
			FWLogMsg('WARN',, 'SIGAPLS', funName(), '', '01', "Funções descontinuadas pelo SGBD: GeraSXB(),GeraSX3() E GeraSIX()" , 0, 0, {})
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH153759] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
