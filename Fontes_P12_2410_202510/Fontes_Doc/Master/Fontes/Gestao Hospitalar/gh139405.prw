...
±±³Fun‡ao    ³GH139405  ³ Autor ³ MICROSIGA             ³ Data ³ 16/01/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH139405]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH139405] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
