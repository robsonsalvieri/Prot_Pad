...
±±³Fun‡ao    ³GH141079  ³ Autor ³ MICROSIGA             ³ Data ³ 03/09/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH141079]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH141079] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
