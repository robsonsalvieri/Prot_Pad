...
±±³Fun‡ao    ³GH140949  ³ Autor ³ MICROSIGA             ³ Data ³ 24/03/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH140949]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH140949] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
