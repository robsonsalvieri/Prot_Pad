...
±±³Fun‡ao    ³GH146888  ³ Autor ³ MICROSIGA             ³ Data ³ 03/06/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH146888]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH146888] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
