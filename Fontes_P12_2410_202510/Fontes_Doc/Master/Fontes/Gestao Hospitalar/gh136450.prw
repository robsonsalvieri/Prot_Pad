...
±±³Fun‡ao    ³GH136450  ³ Autor ³ MICROSIGA             ³ Data ³ 11/12/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH136450]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH136450] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
