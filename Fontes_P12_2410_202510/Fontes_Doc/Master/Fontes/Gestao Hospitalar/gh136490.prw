...
±±³Fun‡ao    ³GH136490  ³ Autor ³ MICROSIGA             ³ Data ³ 21/12/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH136490]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH136490] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
