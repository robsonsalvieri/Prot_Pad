...
±±³Fun‡ao    ³GH135645  ³ Autor ³ MICROSIGA             ³ Data ³ 05/11/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH135645]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH135645] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
