...
±±³Fun‡ao    ³GH135147  ³ Autor ³ MICROSIGA             ³ Data ³ 10/12/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH135147]","Aguarde , processando preparação dos arquivos")
	...
	If lOpen
		For nI := 1 To Len(aRecnoSM0)
 		...
 		nModulo := 51 // modulo SIGAHSP
			...
			FWLogMsg('WARN',, 'SIGAPLS', funName(), '', '01', "Funções descontinuadas pelo SGBD: GeraSX3() E GeraSX1()" , 0, 0, {})
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH135147] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
