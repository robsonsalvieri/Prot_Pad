...
±±³Fun‡ao    ³GH137080  ³ Autor ³ MICROSIGA             ³ Data ³ 10/01/08 ³±±
...
Processa({|| ProcATU()},"Processando [GH137080]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH137080] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
