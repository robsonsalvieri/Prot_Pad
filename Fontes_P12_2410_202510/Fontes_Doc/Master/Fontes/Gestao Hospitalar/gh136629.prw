...
±±³Fun‡ao    ³GH136629  ³ Autor ³ MICROSIGA             ³ Data ³ 14/12/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH136629]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH136629] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
