...
begin
   ...
   ##ENDFIELDP11
   /*---------------------------------------------------------------
     Exclusao de Saldos Diários e Mensais, CVX e CVY
      --------------------------------------------------------------- */ 
   Exec CTB209_## @IN_FILIAL, @IN_FILIALATE, @IN_DATADE, @IN_DATAATE, @IN_LMOEDAESP, @IN_MOEDA, @IN_TPSALDO, @IN_TRANSACTION
   /*---------------------------------------------------------------
   ...
   Select CT2_FILIAL, CT2_DATA, CT2_MOEDLC, CONTA, CCUSTO, ITEM, CLASSE,             
    ...
    From ( Select CT2_FILIAL, CT2_DATA, CT2_MOEDLC, CT2_DEBITO CONTA, CT2_CCD CCUSTO, CT2_ITEMD ITEM, CT2_CLVLDB CLASSE,
                     ...
                     ##FIELDP16( 'CT2.CT2_EC09DB' )
                        CT2_EC09DB EC09,
                     ##ENDFIELDP16
                     CT2_VALOR, 'D' DC, CT2_LOTE, CT2_SBLOTE, CT2_DOC, CT2_LINHA, CT2_TPSALD, CT2_EMPORI, CT2_FILORI
            From CT2###
         ...
         Union
            Select CT2_FILIAL, CT2_DATA, CT2_MOEDLC, CT2_CREDIT CONTA, CT2_CCC CCUSTO, CT2_ITEMC ITEM, CT2_CLVLCR CLASSE,
                     ...
                     ##FIELDP26( 'CT2.CT2_EC09CR' )
                        CT2_EC09CR EC09,
                     ##ENDFIELDP26
                     CT2_VALOR, 'C' DC, CT2_LOTE, CT2_SBLOTE, CT2_DOC, CT2_LINHA, CT2_TPSALD, CT2_EMPORI, CT2_FILORI
            From CT2###
            Where CT2_FILIAL between @cFilial_CT2 and @IN_FILIALATE 
   ...
   Where NOT EXISTS (Select 1 
                        ...
                        and CQA.D_E_L_E_T_ = ' ')
      Group By CT2_FILIAL, CT2_DATA, CT2_MOEDLC, CONTA, CCUSTO, ITEM, CLASSE, DC
            ##FIELDP12( 'CT2.CT2_EC05DB' ) 
               ,EC05
            ##ENDFIELDP12
            ##FIELDP13( 'CT2.CT2_EC06DB' ) 
   ...
   --------------------------------------------------------------- */
   ##FIELDP2K( 'CT0.CT0_ID' )
   Exec CTB211_## @IN_FILIAL, @IN_FILIALATE, @IN_DATADE, @IN_DATAATE, @IN_LMOEDAESP, @IN_MOEDA, @IN_TPSALDO, @IN_TRANSACTION, @OUT_RESULTADO OutPut
   ##ENDFIELDP2K
   /*---------------------------------------------------------------
