...
begin
   ...
   Select CT2_FILIAL, Substring( CT2_DATA, 1, 6 ), CT2_MOEDLC, CONTA, CCUSTO, ITEM, CLASSE, 
               /* Se tem a entidade débito, tem que ter a crédito
               por isso, nesse ponto, checo somente a débito*/
   ...
   From (   Select CT2_FILIAL, CT2_DATA, CT2_MOEDLC, CT2_DEBITO CONTA, CT2_CCD CCUSTO, CT2_ITEMD ITEM, CT2_CLVLDB CLASSE,
          ...
          Where NOT EXISTS (Select 1 
                            ...
                            and CQA.D_E_L_E_T_ = ' ')
      Group By CT2_FILIAL, Substring( CT2_DATA, 1, 6 ), CT2_MOEDLC, CONTA, CCUSTO, ITEM, CLASSE, DC
           ##FIELDP27( 'CT2.CT2_EC05DB' )
            ,EC05
           ##ENDFIELDP27
           ##FIELDP28( 'CT2.CT2_EC06DB' )
            ,EC06
           ##ENDFIELDP28
           ##FIELDP29( 'CT2.CT2_EC07DB' )
            ,EC07
           ##ENDFIELDP29
           ##FIELDP30( 'CT2.CT2_EC08DB' )
            ,EC08
           ##ENDFIELDP30
           ##FIELDP31( 'CT2.CT2_EC09DB' )
            ,EC09
           ##ENDFIELDP31           
      order by CT2_FILIAL, Substring( CT2_DATA, 1, 6 ), CT2_MOEDLC, CONTA, CCUSTO, ITEM, CLASSE
