...
##FIELDP01( 'CT2.CT2_EC07DB' )
Create Procedure CTB206_## (
   @IN_LATUAL Char( 01 ),
   @IN_CUBO   Char( 'CT0_ID' ),
...
/* ------------------------------------------------------------------------------------
    ...
    Descricao       - <d>  Atualizar CUBO 07 - NIV07 </d>
