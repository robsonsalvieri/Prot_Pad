...
##FIELDP01( 'CT2.CT2_EC06DB' )
Create Procedure CTB205_## (
   @IN_LATUAL Char( 01 ),
   @IN_CUBO   Char( 'CT0_ID' ),
...
/* ------------------------------------------------------------------------------------
    ...
    Descricao       - <d>  Atualizar CUBO 06 - NIV06 </d>
