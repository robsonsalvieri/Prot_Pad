...
##FIELDP01( 'CT2.CT2_EC08DB' )
Create Procedure CTB207_## (
   @IN_LATUAL Char( 01 ),
   @IN_CUBO   Char( 'CT0_ID' ),
...
/* ------------------------------------------------------------------------------------
    ...
    Descricao       - <d>  Atualizar CUBO 08 - NIV08 </d>
