...
//---------------------------------------------------------------------
/*/{Protheus.doc} TAFDAPI21

Rotina de geração do Detalhamento Tipo 21 da DAPI-MG
...
/*/
//---------------------------------------------------------------------
Function TAFDAPI21(aWizard, nCont, aFil)
...
Begin Sequence
	...
	/***** DETALHAMENTO TIPO 21 - Créditos Transferidos ********/
	aDetalhe := DapiAprSQL(cFilDapi, cUFID, DToS(aWizard[1][1]), DTOS(aWizard[1][2]), "00073","1","ICMS")
