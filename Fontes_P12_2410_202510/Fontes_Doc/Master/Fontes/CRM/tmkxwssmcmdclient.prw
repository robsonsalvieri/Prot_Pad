...
Gerado em        12/21/11 16:42:39
Observações      Código-Fonte gerado por ADVPL WSDL Client 1.110425
                 Alterações neste arquivo podem causar funcionamento incorreto
                 e serão perdidas caso o código-fonte seja gerado novamente.
=============================================================================== */

User Function _EVGHOAO ; Return  // "dummy" function - Internal Use 

WSCLIENT WSSmartCTIWSCommandService
...
WSMETHOD NEW WSSEND _URL WSCLIENT WSSmartCTIWSCommandService
::_URL := _URL
::Init()
Return Self

WSMETHOD INIT WSCLIENT WSSmartCTIWSCommandService
Return

WSMETHOD RESET WSCLIENT WSSmartCTIWSCommandService
	::cdevice            := NIL 
	::cagentID           := NIL 
	::cgroupID           := NIL 
	::cagentPass         := NIL 
...
WSMETHOD CLONE WSCLIENT WSSmartCTIWSCommandService
...
WSMETHOD LogonPass WSSEND cdevice,cagentID,cgroupID,cagentPass WSRECEIVE nreturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD GetInfoChamAtiv WSSEND ccDevice WSRECEIVE creturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD queryAgentState WSSEND ccDevice WSRECEIVE nreturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD SystemStatus WSSEND NULLPARAM WSRECEIVE nreturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD ImmediateTransfer WSSEND cdevice,cdeviceTo WSRECEIVE nreturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD Logoff WSSEND cdevice,cagentID,cgroupID WSRECEIVE nreturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD Redirect WSSEND cdevice,cdeviceTo WSRECEIVE nreturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD AgentOutOfService WSSEND cdevice WSRECEIVE nreturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD Logon WSSEND cdevice,cagentID,cgroupID WSRECEIVE nreturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD ReadyPass WSSEND cdevice,cagentID,cgroupID,cagentPass WSRECEIVE nreturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD LogoffPass WSSEND cdevice,cagentID,cgroupID,cagentPass WSRECEIVE nreturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD NotReady WSSEND cdevice,cagentID,cgroupID WSRECEIVE nreturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD selfTest WSSEND NULLPARAM WSRECEIVE nreturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD Alternate WSSEND cdevice WSRECEIVE nreturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD showVersion WSSEND NULLPARAM WSRECEIVE creturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD MakeCallPass WSSEND cdevice,ctelephoneNumber,cagentID,cagentPass,croute WSRECEIVE nreturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD StartRec WSSEND cdevice WSRECEIVE nreturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD Ready WSSEND cdevice,cagentID,cgroupID WSRECEIVE nreturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD Consultation WSSEND cdevice,cdeviceTo WSRECEIVE nreturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD OneStepCallTransfer WSSEND cdevice,cdeviceTo WSRECEIVE nreturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD Answer WSSEND cdevice WSRECEIVE nreturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD Transfer WSSEND cdevice WSRECEIVE nreturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD Retrieve WSSEND cdevice WSRECEIVE nreturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD MakeCall WSSEND cdevice,ctelephoneNumber WSRECEIVE nreturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD AgentInService WSSEND cdevice,cipaddress WSRECEIVE nreturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD ConnectionClear WSSEND cdevice,cCallID WSRECEIVE nreturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD Hold WSSEND cdevice WSRECEIVE nreturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD getActiveCallInfo WSSEND ccDevice WSRECEIVE creturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD StopRec WSSEND cdevice WSRECEIVE nreturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD NotReadyPass WSSEND cdevice,cagentID,cgroupID,cagentPass WSRECEIVE nreturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
...
WSMETHOD Conference WSSEND cdevice WSRECEIVE nreturn WSCLIENT WSSmartCTIWSCommandService
Local cSoap := "" , oXmlRet
