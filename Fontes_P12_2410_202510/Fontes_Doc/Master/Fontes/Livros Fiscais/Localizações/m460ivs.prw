...
±±³Fun‡…o	 ³ M460IVS	³ Autor ³ MARCELLO GABRIEL     ³ Data ³ 23.11.1999 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡…o ³ CALCULO IVA SERVICO                                         ³±±
...
*/
FUNCTION M460IVS(cCalculo,nItem,aInfo)
local aItem,lXFis,cImp,xRet,nOrdSFC,nRegSFC
Local nBase:=0,nAliq:=0,lALIQ:=.f.,lIsento:=.f.,cFil,cAux,cImpIncid,nE,nI
Local cGrp,cDbf:=alias(),nOrd:=IndexOrd()
