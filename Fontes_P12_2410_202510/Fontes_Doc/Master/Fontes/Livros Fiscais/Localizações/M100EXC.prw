...
±±³Funcao    ³ M100EXC  ³ Autor ³ Luciana Pires³ Data ³ 30.11.11  ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descricao ³ Calculo do imposto EXC nas notas de entrada para Austrália                          ³±±
...
*/
Function M100EXC(cCalculo,nItem,aInfo)
Local aImp 		:= {}
Local aItem 		:= {}
Local aArea		:= GetArea()
...
If (SB1->(FieldPos("B1_CONEXC")) > 0 .And. !Empty(SB1->B1_CONEXC))				                                              
	cConcept := SB1->B1_CONEXC
Endif
...
If !lXFis
	...
	aImp[04] 	:= Round(aItem[01] * nAliq,nDecs)	                                                             
...
Else
	...
	nImp 	:= Round(nQtdade * nAliq,nDecs)
