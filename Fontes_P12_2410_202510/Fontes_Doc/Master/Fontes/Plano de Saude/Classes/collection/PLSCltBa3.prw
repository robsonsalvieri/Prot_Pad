...
Class PLSCltBa3 from CenCollection
...
Method New() Class PLSCltBa3
    _Super:new()
    self:oMapper := PLSMprBa3():New()
    self:oDao := PLSDaoBa3():New(self:oMapper:getFields())
return self

Method initEntity() Class PLSCltBa3
return PLSBa3():New()

Method initRelation() Class PLSCltBa3
