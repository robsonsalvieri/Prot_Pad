...
#include "tmsq25001.ch"

QSSTRUCT TMSQ25001 DESCRIPTION STR0001 MODULE 43 //CONTRATOS EMITIDOS
 
QSMETHOD INIT QSSTRUCT TMSQ25001 
...
QSFILTER STR0008 WHERE "DTY.DTY_DATCTC = '"+DTOS(dData)		+"'" //Ultimo dia 
QSFILTER STR0009 WHERE "DTY.DTY_DATCTC > '"+DTOS(dData-7)  	+"'" //Ultimos 7 dias
QSFILTER STR0010 WHERE "DTY.DTY_DATCTC > '"+DTOS(dData-30)	+"'" //Ultimos 30 dias
QSFILTER STR0011 WHERE "DTY.DTY_DATCTC > '"+DTOS(dData-365)	+"'	" //Ultimos 365 dias
