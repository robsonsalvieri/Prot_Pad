...
#include "tmsq25005.ch"

QSSTRUCT TMSQ25005 DESCRIPTION STR0001 MODULE 43 //"CONTRATOS COM PAGAMENTO BLOQUEADO"
 
QSMETHOD INIT QSSTRUCT TMSQ25005 
...
QSFILTER STR0008 WHERE "DTY_STATUS IN(9) AND DTY.DTY_DATCTC = '"+DTOS(dData)		+"'" //"Ultimo dia" 
QSFILTER STR0009 WHERE "DTY_STATUS IN(9) AND DTY.DTY_DATCTC > '"+DTOS(dData-7)  +"'" //"Ultimos 7 dias"
QSFILTER STR0010 WHERE "DTY_STATUS IN(9) AND DTY.DTY_DATCTC > '"+DTOS(dData-30)	+"'" //"Ultimos 30 dias"
QSFILTER STR0011 WHERE "DTY_STATUS IN(9) AND DTY.DTY_DATCTC > '"+DTOS(dData-365)+"'	" //"Ultimos 365 dias
