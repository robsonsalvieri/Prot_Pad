...
#include "tmsq20004.ch"

QSSTRUCT TMSQ20004 DESCRIPTION STR0001 MODULE 43 //DOCUMENTOS ENTREGUES
 
QSMETHOD INIT QSSTRUCT TMSQ20004
...
QSFILTER STR0011 WHERE "DT6_SERTMS <> '1' AND DT6_STATUS = '7' AND DT6_DATEMI = '"+DTOS(dData)		+"'"	//"Ultimo dia"
QSFILTER STR0012 WHERE "DT6_SERTMS <> '1' AND DT6_STATUS = '7' AND DT6_DATEMI > '"+DTOS(dData-7) 	+"'"	//"Ultimos 7 dias"
QSFILTER STR0013 WHERE "DT6_SERTMS <> '1' AND DT6_STATUS = '7' AND DT6_DATEMI > '"+DTOS(dData-30)	+"'"	//"Ultimos 30 dias"
QSFILTER STR0014 WHERE "DT6_SERTMS <> '1' AND DT6_STATUS = '7' AND DT6_DATEMI > '"+DTOS(dData-360)+"'"	//"Ultimos 365 dias"
